...
class UpdateDistributionResultDistributionDistributionConfigOriginsItemsItem(UniversalBaseModel):
    """
    ...
    custom_headers: typing_extensions.Annotated[
        typing.Optional[UpdateDistributionResultDistributionDistributionConfigOriginsItemsItemCustomHeaders],
    ...
    s3origin_config: typing_extensions.Annotated[
        typing.Optional[UpdateDistributionResultDistributionDistributionConfigOriginsItemsItemS3OriginConfig],
    ...
    custom_origin_config: typing_extensions.Annotated[
        typing.Optional[UpdateDistributionResultDistributionDistributionConfigOriginsItemsItemCustomOriginConfig],
