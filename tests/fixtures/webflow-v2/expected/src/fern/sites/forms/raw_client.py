...
class RawFormsClient:
    ...
    def list_submissions_by_site(
        ...
        *,
    ...
    ) -> HttpResponse[ListSubmissionsBySiteFormsResponse]:
        """
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"sites/{encode_path_param(site_id)}/form_submissions",
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=ListSubmissionsBySiteFormsResponse,
    ...
    def list_submissions(
        ...
        *,
        ...
        limit: typing.Optional[int] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[ListSubmissionsFormsResponse]:
        """
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"sites/{encode_path_param(site_id)}/forms/{encode_path_param(form_id)}/submissions",
            base_url=self._client_wrapper.get_environment().base,
            method="GET",
            params={
                "offset": offset,
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=ListSubmissionsFormsResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def get_submission(
    ...
    ) -> HttpResponse[GetSubmissionFormsResponse]:
        """
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"sites/{encode_path_param(site_id)}/form_submissions/{encode_path_param(form_submission_id)}",
            base_url=self._client_wrapper.get_environment().base,
            method="GET",
            request_options=request_options,
        )
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=GetSubmissionFormsResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def update_submission(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[UpdateSubmissionFormsResponse]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=UpdateSubmissionFormsResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawFormsClient:
    ...
    async def list_submissions_by_site(
        ...
        *,
        ...
        limit: typing.Optional[int] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[ListSubmissionsBySiteFormsResponse]:
        """
        List all form submissions for a given site with the ability to filter submissions by a centralized `elementId`.
    ...
    async def list_submissions(
        ...
        *,
        ...
        limit: typing.Optional[int] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[ListSubmissionsFormsResponse]:
        """
        List form submissions for a given form ID within a specific site.
    ...
    async def get_submission(
        self, site_id: str, form_submission_id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[GetSubmissionFormsResponse]:
        """
        Get information about a form submission within a specific site.
    ...
    async def update_submission(
        ...
        *,
        form_submission_data: typing.Optional[typing.Dict[str, typing.Any]] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[UpdateSubmissionFormsResponse]:
        """
        Update hidden fields on a form submission within a specific site.
