...
from .order_fulfillment_pickup_details_curbside_pickup_details import OrderFulfillmentPickupDetailsCurbsidePickupDetails
from .order_fulfillment_recipient import OrderFulfillmentRecipient


class OrderFulfillmentPickupDetails(UniversalBaseModel):
    """
    ...
    curbside_pickup_details: typing.Optional[OrderFulfillmentPickupDetailsCurbsidePickupDetails] = None
    ...
    schedule_type: typing.Optional[str] = pydantic.Field(default=None)
    """
