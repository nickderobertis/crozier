...
class DocPagesSetScaleRequestMeasureAngleItem(UniversalBaseModel):
    unit: str
    conversion: float
    fraction: typing.Optional[DocPagesSetScaleRequestMeasureAngleItemFraction] = None
    ...
    label_position: typing_extensions.Annotated[
        typing.Optional[DocPagesSetScaleRequestMeasureAngleItemLabelPosition],
