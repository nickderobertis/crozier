...
class PostV2VectordbCollectionsCreateRequestIndexParamsItem(UniversalBaseModel):
    ...
    index_config: typing_extensions.Annotated[
        typing.Optional[PostV2VectordbCollectionsCreateRequestIndexParamsItemIndexConfig],
