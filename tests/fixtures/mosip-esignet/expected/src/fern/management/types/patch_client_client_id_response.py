...
class PatchClientClientIdResponse(UniversalBaseModel):
    ...
    response: typing.Optional[PatchClientClientIdResponseResponse] = None
    errors: typing.Optional[typing.List[PatchClientClientIdResponseErrorsItem]] = pydantic.Field(default=None)
    """
    List of Errors in case of request validation / processing failure.
    """
