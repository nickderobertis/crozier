...
class GetEventsResponseEventsItemFortyFourData(UniversalBaseModel):
    """
    ...
    can_add_members_group: typing.Optional[GetEventsResponseEventsItemFortyFourDataCanAddMembersGroup] = pydantic.Field(
        default=None
    )
    """
    ...
    **Changes**: New in Zulip 10.0 (feature level 305). Previously, this
    ...
    can_join_group: typing.Optional[GetEventsResponseEventsItemFortyFourDataCanJoinGroup] = pydantic.Field(default=None)
    """
    A [group-setting value][setting-values] defining the set of users who
    ...
    **Changes**: New in Zulip 10.0 (feature level 301).
    ...
    can_leave_group: typing.Optional[GetEventsResponseEventsItemFortyFourDataCanLeaveGroup] = pydantic.Field(
        default=None
    )
    """
    A [group-setting value][setting-values] defining the set of users who
    ...
    **Changes**: New in Zulip 10.0 (feature level 308).
    ...
    can_manage_group: typing.Optional[GetEventsResponseEventsItemFortyFourDataCanManageGroup] = pydantic.Field(
        default=None
    )
    """
    A [group-setting value][setting-values] defining the set of users who
    ...
    **Changes**: New in Zulip 10.0 (feature level 283).
    ...
    can_mention_group: typing.Optional[GetEventsResponseEventsItemFortyFourDataCanMentionGroup] = pydantic.Field(
        default=None
    )
    """
    A [group-setting value][setting-values] defining the set of users who
    ...
    **Changes**: Before Zulip 9.0 (feature level 258), this setting was
    ...
    can_remove_members_group: typing.Optional[GetEventsResponseEventsItemFortyFourDataCanRemoveMembersGroup] = (
