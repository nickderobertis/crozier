...
class DistributionConfigDefaultCacheBehaviorLambdaFunctionAssociations(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[typing.List[DistributionConfigDefaultCacheBehaviorLambdaFunctionAssociationsItemsItem]],
