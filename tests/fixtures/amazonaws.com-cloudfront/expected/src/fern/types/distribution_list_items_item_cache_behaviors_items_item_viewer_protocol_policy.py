...
class DistributionListItemsItemCacheBehaviorsItemsItemViewerProtocolPolicy(enum.StrEnum):
    """
    ...
    def visit(
        ...
        if self is DistributionListItemsItemCacheBehaviorsItemsItemViewerProtocolPolicy.ALLOW_ALL:
            return allow_all()
        if self is DistributionListItemsItemCacheBehaviorsItemsItemViewerProtocolPolicy.HTTPS_ONLY:
            return https_only()
        if self is DistributionListItemsItemCacheBehaviorsItemsItemViewerProtocolPolicy.REDIRECT_TO_HTTPS:
