...
class PostInternalSandboxRuntimeResolveDesignerRuntimeEgressRouteResponseRouteAdditionalCredentialHeadersItemCredentialResolverMistleMcpSetupAssistantToken(
    UniversalBaseModel
):
