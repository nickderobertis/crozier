...
class PostPortfolioAnalysisVolatilityRequestAssets(UniversalBaseModel):
    ...
    portfolios: typing.List[PostPortfolioAnalysisVolatilityRequestAssetsPortfoliosItem]
