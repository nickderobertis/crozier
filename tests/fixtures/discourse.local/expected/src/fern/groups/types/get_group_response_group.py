...
class GetGroupResponseGroup(UniversalBaseModel):
    ...
    associated_group_ids: typing.Optional[typing.List[typing.Any]] = None
    automatic: bool
    ...
    imap_mailboxes: typing.List[typing.Any]
    ...
    imap_updated_by: typing.Optional[typing.Dict[str, typing.Any]] = None
    ...
    muted_tags: typing.Optional[typing.List[typing.Any]] = None
    name: str
    primary_group: bool
    ...
    regular_tags: typing.Optional[typing.List[typing.Any]] = None
    ...
    smtp_updated_by: typing.Optional[typing.Dict[str, typing.Any]] = None
    title: typing.Optional[str] = None
    tracking_category_ids: typing.List[typing.Any]
    tracking_tags: typing.Optional[typing.List[typing.Any]] = None
    user_count: int
    visibility_level: int
    watching_category_ids: typing.List[typing.Any]
    watching_first_post_category_ids: typing.List[typing.Any]
    watching_first_post_tags: typing.Optional[typing.List[typing.Any]] = None
    watching_tags: typing.Optional[typing.List[typing.Any]] = None
