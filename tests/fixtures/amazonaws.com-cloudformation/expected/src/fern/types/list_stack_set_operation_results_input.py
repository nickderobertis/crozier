...
class ListStackSetOperationResultsInput(UniversalBaseModel):
    ...
    call_as: typing_extensions.Annotated[
        typing.Optional[ListStackSetOperationResultsInputCallAs], FieldMetadata(alias="CallAs")
    ...
    filters: typing_extensions.Annotated[
        typing.Optional[typing.List[OperationResultFilter]], FieldMetadata(alias="Filters")
    ] = pydantic.Field(default=None)
    """
