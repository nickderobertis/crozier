...
class GetEventsResponseEventsItemSixtyEight(UniversalBaseModel):
    """
    ...
    **Changes**: New in Zulip 5.0 (feature level 95).
    ...
    type: typing.Optional[GetEventsResponseEventsItemSixtyEightType] = pydantic.Field(default=None)
    """
    The event's type, relevant both for client-side dispatch and server-side
    filtering by event type in [POST /register](/api/register-queue).
    """

    op: typing.Optional[GetEventsResponseEventsItemSixtyEightOp] = None
    property: typing.Optional[str] = pydantic.Field(default=None)
    """
    The name of the property that was changed.
    """

    value: typing.Optional[GetEventsResponseEventsItemSixtyEightValue] = pydantic.Field(default=None)
    """
