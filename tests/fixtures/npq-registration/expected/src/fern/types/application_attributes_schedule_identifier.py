...
class ApplicationAttributesScheduleIdentifier(enum.StrEnum):
    """
    ...
    def visit(
        ...
        if self is ApplicationAttributesScheduleIdentifier.NPQ_ASO_MARCH:
            return npq_aso_march()
        if self is ApplicationAttributesScheduleIdentifier.NPQ_ASO_JUNE:
            return npq_aso_june()
        if self is ApplicationAttributesScheduleIdentifier.NPQ_ASO_NOVEMBER:
            return npq_aso_november()
        if self is ApplicationAttributesScheduleIdentifier.NPQ_ASO_DECEMBER:
            return npq_aso_december()
        if self is ApplicationAttributesScheduleIdentifier.NPQ_EHCO_MARCH:
            return npq_ehco_march()
        if self is ApplicationAttributesScheduleIdentifier.NPQ_EHCO_JUNE:
            return npq_ehco_june()
        if self is ApplicationAttributesScheduleIdentifier.NPQ_EHCO_NOVEMBER:
            return npq_ehco_november()
        if self is ApplicationAttributesScheduleIdentifier.NPQ_EHCO_DECEMBER:
            return npq_ehco_december()
        if self is ApplicationAttributesScheduleIdentifier.NPQ_LEADERSHIP_AUTUMN:
            return npq_leadership_autumn()
        if self is ApplicationAttributesScheduleIdentifier.NPQ_LEADERSHIP_SPRING:
            return npq_leadership_spring()
        if self is ApplicationAttributesScheduleIdentifier.NPQ_SPECIALIST_AUTUMN:
            return npq_specialist_autumn()
        if self is ApplicationAttributesScheduleIdentifier.NPQ_SPECIALIST_SPRING:
