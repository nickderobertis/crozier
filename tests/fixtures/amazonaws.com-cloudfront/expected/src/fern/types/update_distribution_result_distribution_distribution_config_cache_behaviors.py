...
class UpdateDistributionResultDistributionDistributionConfigCacheBehaviors(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[typing.List[UpdateDistributionResultDistributionDistributionConfigCacheBehaviorsItemsItem]],
