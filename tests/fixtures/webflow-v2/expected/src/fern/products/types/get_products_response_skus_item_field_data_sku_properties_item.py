...
class GetProductsResponseSkusItemFieldDataSkuPropertiesItem(UniversalBaseModel):
    """
    ...
    enum: typing.List[GetProductsResponseSkusItemFieldDataSkuPropertiesItemEnumItem] = pydantic.Field()
    """
