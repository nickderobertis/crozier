...
class DistributionSummaryOriginsItemsItemCustomOriginConfigOriginSslProtocols(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.List[DistributionSummaryOriginsItemsItemCustomOriginConfigOriginSslProtocolsItemsItem],
