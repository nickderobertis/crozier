...
class DestinyResponsesDestinyProfileUserInfoCard(UniversalBaseModel):
    ...
    is_cross_save_primary: typing_extensions.Annotated[
        typing.Optional[bool], FieldMetadata(alias="isCrossSavePrimary")
    ] = pydantic.Field(default=None)
    """
    If true, this account is hooked up as the "Primary" cross save account for one or more platforms.
    """

    is_overridden: typing_extensions.Annotated[typing.Optional[bool], FieldMetadata(alias="isOverridden")] = (
        pydantic.Field(default=None)
    )
    """
    ...
    platform_silver: typing_extensions.Annotated[
        typing.Optional[DestinyComponentsInventoryDestinyPlatformSilverComponent], FieldMetadata(alias="platformSilver")
    ] = pydantic.Field(default=None)
    """
    ...
    unpaired_game_versions: typing_extensions.Annotated[
        typing.Optional[int], FieldMetadata(alias="unpairedGameVersions")
    ] = pydantic.Field(default=None)
    """
