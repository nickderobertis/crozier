...
class GetQuoteByIdQuoteResponseData(UniversalBaseModel):
    id: float
    ...
    sections: typing.Optional[typing.List[GetQuoteByIdQuoteResponseDataSectionsItem]] = None
    deposit: typing.Optional[GetQuoteByIdQuoteResponseDataDeposit] = None
    links: typing.Optional[typing.List[GetQuoteByIdQuoteResponseDataLinksItem]] = None
...
update_forward_refs(GetQuoteByIdQuoteResponseData)
