...
class PowerOutletTypeLabel(str, enum.Enum):
    C5 = "C5"
    C7 = "C7"
    C13 = "C13"
    C15 = "C15"
    ...
    def visit(
        ...
        if self is PowerOutletTypeLabel.C5:
            return c5()
        if self is PowerOutletTypeLabel.C7:
            return c7()
        if self is PowerOutletTypeLabel.C13:
            return c13()
        if self is PowerOutletTypeLabel.C15:
            return c15()
        if self is PowerOutletTypeLabel.C19:
            return c19()
        if self is PowerOutletTypeLabel.C21:
            return c21()
        if self is PowerOutletTypeLabel.PNE4H:
            return pne4h()
        if self is PowerOutletTypeLabel.PNE6H:
            return pne6h()
        if self is PowerOutletTypeLabel.PNE9H:
            return pne9h()
        if self is PowerOutletTypeLabel.TWO_PE4H:
            return two_pe4h()
        if self is PowerOutletTypeLabel.TWO_PE6H:
            return two_pe6h()
        if self is PowerOutletTypeLabel.TWO_PE9H:
            return two_pe9h()
        if self is PowerOutletTypeLabel.THREE_PE4H:
            return three_pe4h()
        if self is PowerOutletTypeLabel.THREE_PE6H:
            return three_pe6h()
        if self is PowerOutletTypeLabel.THREE_PE9H:
            return three_pe9h()
        if self is PowerOutletTypeLabel.THREE_PNE4H:
            return three_pne4h()
        if self is PowerOutletTypeLabel.THREE_PNE6H:
            return three_pne6h()
        if self is PowerOutletTypeLabel.THREE_PNE9H:
            return three_pne9h()
        if self is PowerOutletTypeLabel.NEMA115R:
            return nema115r()
        if self is PowerOutletTypeLabel.NEMA515R:
            return nema515r()
        if self is PowerOutletTypeLabel.NEMA520R:
            return nema520r()
        if self is PowerOutletTypeLabel.NEMA530R:
            return nema530r()
        if self is PowerOutletTypeLabel.NEMA550R:
            return nema550r()
        if self is PowerOutletTypeLabel.NEMA615R:
            return nema615r()
        if self is PowerOutletTypeLabel.NEMA620R:
            return nema620r()
        if self is PowerOutletTypeLabel.NEMA630R:
            return nema630r()
        if self is PowerOutletTypeLabel.NEMA650R:
            return nema650r()
        if self is PowerOutletTypeLabel.NEMA1030R:
            return nema1030r()
        if self is PowerOutletTypeLabel.NEMA1050R:
            return nema1050r()
        if self is PowerOutletTypeLabel.NEMA1420R:
            return nema1420r()
        if self is PowerOutletTypeLabel.NEMA1430R:
            return nema1430r()
        if self is PowerOutletTypeLabel.NEMA1450R:
            return nema1450r()
        if self is PowerOutletTypeLabel.NEMA1460R:
            return nema1460r()
        if self is PowerOutletTypeLabel.NEMA1515R:
            return nema1515r()
        if self is PowerOutletTypeLabel.NEMA1520R:
            return nema1520r()
        if self is PowerOutletTypeLabel.NEMA1530R:
            return nema1530r()
        if self is PowerOutletTypeLabel.NEMA1550R:
            return nema1550r()
        if self is PowerOutletTypeLabel.NEMA1560R:
            return nema1560r()
        if self is PowerOutletTypeLabel.NEMA_L115R:
            return nema_l115r()
        if self is PowerOutletTypeLabel.NEMA_L515R:
            return nema_l515r()
        if self is PowerOutletTypeLabel.NEMA_L520R:
            return nema_l520r()
        if self is PowerOutletTypeLabel.NEMA_L530R:
            return nema_l530r()
        if self is PowerOutletTypeLabel.NEMA_L550R:
            return nema_l550r()
        if self is PowerOutletTypeLabel.NEMA_L615R:
            return nema_l615r()
        if self is PowerOutletTypeLabel.NEMA_L620R:
            return nema_l620r()
        if self is PowerOutletTypeLabel.NEMA_L630R:
            return nema_l630r()
        if self is PowerOutletTypeLabel.NEMA_L650R:
            return nema_l650r()
        if self is PowerOutletTypeLabel.NEMA_L1030R:
            return nema_l1030r()
        if self is PowerOutletTypeLabel.NEMA_L1420R:
            return nema_l1420r()
        if self is PowerOutletTypeLabel.NEMA_L1430R:
            return nema_l1430r()
        if self is PowerOutletTypeLabel.NEMA_L1450R:
            return nema_l1450r()
        if self is PowerOutletTypeLabel.NEMA_L1460R:
            return nema_l1460r()
        if self is PowerOutletTypeLabel.NEMA_L1520R:
            return nema_l1520r()
        if self is PowerOutletTypeLabel.NEMA_L1530R:
            return nema_l1530r()
        if self is PowerOutletTypeLabel.NEMA_L1550R:
            return nema_l1550r()
        if self is PowerOutletTypeLabel.NEMA_L1560R:
            return nema_l1560r()
        if self is PowerOutletTypeLabel.NEMA_L2120R:
            return nema_l2120r()
        if self is PowerOutletTypeLabel.NEMA_L2130R:
            return nema_l2130r()
        if self is PowerOutletTypeLabel.NEMA_L2230R:
            return nema_l2230r()
        if self is PowerOutletTypeLabel.CS6360C:
            return cs6360c()
        if self is PowerOutletTypeLabel.CS6364C:
            return cs6364c()
        if self is PowerOutletTypeLabel.CS8164C:
            return cs8164c()
        if self is PowerOutletTypeLabel.CS8264C:
            return cs8264c()
        if self is PowerOutletTypeLabel.CS8364C:
            return cs8364c()
        if self is PowerOutletTypeLabel.CS8464C:
            return cs8464c()
        if self is PowerOutletTypeLabel.ITA_TYPE_E_CEE75:
            return ita_type_e_cee75()
        if self is PowerOutletTypeLabel.ITA_TYPE_F_CEE73:
            return ita_type_f_cee73()
        if self is PowerOutletTypeLabel.ITA_TYPE_G_BS1363:
            return ita_type_g_bs1363()
        if self is PowerOutletTypeLabel.ITA_TYPE_H:
            return ita_type_h()
        if self is PowerOutletTypeLabel.ITA_TYPE_I:
            return ita_type_i()
        if self is PowerOutletTypeLabel.ITA_TYPE_J:
            return ita_type_j()
        if self is PowerOutletTypeLabel.ITA_TYPE_K:
            return ita_type_k()
        if self is PowerOutletTypeLabel.ITA_TYPE_L_CEI2350:
            return ita_type_l_cei2350()
        if self is PowerOutletTypeLabel.ITA_TYPE_M_BS546:
            return ita_type_m_bs546()
        if self is PowerOutletTypeLabel.ITA_TYPE_N:
            return ita_type_n()
        if self is PowerOutletTypeLabel.ITA_TYPE_O:
            return ita_type_o()
        if self is PowerOutletTypeLabel.ITA_MULTISTANDARD:
            return ita_multistandard()
        if self is PowerOutletTypeLabel.USB_TYPE_A:
            return usb_type_a()
        if self is PowerOutletTypeLabel.USB_MICRO_B:
            return usb_micro_b()
        if self is PowerOutletTypeLabel.USB_TYPE_C:
            return usb_type_c()
        if self is PowerOutletTypeLabel.DC_TERMINAL:
            return dc_terminal()
        if self is PowerOutletTypeLabel.HDOT_CX:
            return hdot_cx()
        if self is PowerOutletTypeLabel.SAF_D_GRID:
            return saf_d_grid()
        if self is PowerOutletTypeLabel.NEUTRIK_POWER_CON20A:
            return neutrik_power_con20a()
        if self is PowerOutletTypeLabel.NEUTRIK_POWER_CON32A:
            return neutrik_power_con32a()
        if self is PowerOutletTypeLabel.NEUTRIK_POWER_CON_TRUE1:
            return neutrik_power_con_true1()
        if self is PowerOutletTypeLabel.NEUTRIK_POWER_CON_TRUE1TOP:
            return neutrik_power_con_true1top()
        if self is PowerOutletTypeLabel.UBIQUITI_SMART_POWER:
            return ubiquiti_smart_power()
        if self is PowerOutletTypeLabel.HARDWIRED:
            return hardwired()
        if self is PowerOutletTypeLabel.OTHER:
            return other()
