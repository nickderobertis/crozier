...
class RawTokenQrRequestSofortClient:
    ...
    def create_token_qr_request_sofort_for_user(
    ...
    ) -> HttpResponse[TokenQrRequestSofortCreate]:
        """
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"user/{encode_path_param(user_id)}/token-qr-request-sofort",
            method="POST",
            json={
                "token": token,
            },
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=TokenQrRequestSofortCreate,
...
class AsyncRawTokenQrRequestSofortClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._client_wrapper = client_wrapper

    async def create_token_qr_request_sofort_for_user(
        self, user_id: int, *, token: str, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[TokenQrRequestSofortCreate]:
        """
        Create a request from an SOFORT transaction.
