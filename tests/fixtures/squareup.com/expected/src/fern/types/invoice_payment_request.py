...
class InvoicePaymentRequest(UniversalBaseModel):
    """
    ...
    automatic_payment_source: typing.Optional[str] = pydantic.Field(default=None)
    """
    ...
    computed_amount_money: typing.Optional[Money] = None
    ...
    fixed_amount_requested_money: typing.Optional[Money] = None
    ...
    request_type: typing.Optional[str] = pydantic.Field(default=None)
    """
    ...
    rounding_adjustment_included_money: typing.Optional[Money] = None
    ...
    total_completed_amount_money: typing.Optional[Money] = None
