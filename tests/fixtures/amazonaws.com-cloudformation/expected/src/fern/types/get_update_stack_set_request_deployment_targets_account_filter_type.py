...
class GetUpdateStackSetRequestDeploymentTargetsAccountFilterType(str, enum.Enum):
    """
    ...
    def visit(
        ...
        if self is GetUpdateStackSetRequestDeploymentTargetsAccountFilterType.NONE:
            return none()
        if self is GetUpdateStackSetRequestDeploymentTargetsAccountFilterType.INTERSECTION:
            return intersection()
        if self is GetUpdateStackSetRequestDeploymentTargetsAccountFilterType.DIFFERENCE:
            return difference()
        if self is GetUpdateStackSetRequestDeploymentTargetsAccountFilterType.UNION:
            return union()
