...
class DescribeStackSetOutputStackSetStackSetDriftDetectionDetailsDriftDetectionStatus(str, enum.Enum):
    """
    ...
    def visit(
        ...
        if self is DescribeStackSetOutputStackSetStackSetDriftDetectionDetailsDriftDetectionStatus.COMPLETED:
            return completed()
        if self is DescribeStackSetOutputStackSetStackSetDriftDetectionDetailsDriftDetectionStatus.FAILED:
            return failed()
        if self is DescribeStackSetOutputStackSetStackSetDriftDetectionDetailsDriftDetectionStatus.PARTIAL_SUCCESS:
            return partial_success()
        if self is DescribeStackSetOutputStackSetStackSetDriftDetectionDetailsDriftDetectionStatus.IN_PROGRESS:
            return in_progress()
        if self is DescribeStackSetOutputStackSetStackSetDriftDetectionDetailsDriftDetectionStatus.STOPPED:
            return stopped()
