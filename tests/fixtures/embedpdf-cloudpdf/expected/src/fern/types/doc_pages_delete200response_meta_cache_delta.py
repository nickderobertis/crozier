...
from .doc_pages_delete200response_meta_cache_delta_pages_item import DocPagesDelete200ResponseMetaCacheDeltaPagesItem


class DocPagesDelete200ResponseMetaCacheDelta(UniversalBaseModel):
    ...
    pages: typing.List[DocPagesDelete200ResponseMetaCacheDeltaPagesItem]
