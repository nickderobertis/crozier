...
from ...types.destiny_definitions_destiny_definition import DestinyDefinitionsDestinyDefinition


class Destiny2GetDestinyEntityDefinitionResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[DestinyDefinitionsDestinyDefinition], FieldMetadata(alias="Response")
    ] = None
