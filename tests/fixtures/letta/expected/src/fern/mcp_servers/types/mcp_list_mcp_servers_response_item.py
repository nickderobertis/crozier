...
class McpListMcpServersResponseItem_Stdio(UniversalBaseModel):
...
class McpListMcpServersResponseItem_Sse(UniversalBaseModel):
...
class McpListMcpServersResponseItem_StreamableHttp(UniversalBaseModel):
...
McpListMcpServersResponseItem = typing_extensions.Annotated[
    typing.Union[
