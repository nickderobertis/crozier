...
class GetOrdersResponse(UniversalBaseModel):
    ...
    status: typing.Optional[GetOrdersResponseStatus] = pydantic.Field(default=None)
    """
    ...
    dispute_last_status: typing_extensions.Annotated[
        typing.Optional[GetOrdersResponseDisputeLastStatus],
    ...
    customer_paid: typing_extensions.Annotated[
        typing.Optional[GetOrdersResponseCustomerPaid],
    ...
    net_amount: typing_extensions.Annotated[
        typing.Optional[GetOrdersResponseNetAmount],
    ...
    application_fee: typing_extensions.Annotated[
        typing.Optional[GetOrdersResponseApplicationFee],
    ...
    all_addresses: typing_extensions.Annotated[
        typing.Optional[typing.List[GetOrdersResponseAllAddressesItem]],
    ...
    shipping_address: typing_extensions.Annotated[
        typing.Optional[GetOrdersResponseShippingAddress],
    ...
    billing_address: typing_extensions.Annotated[
        typing.Optional[GetOrdersResponseBillingAddress],
    ...
    customer_info: typing_extensions.Annotated[
        typing.Optional[GetOrdersResponseCustomerInfo],
    ...
    purchased_items: typing_extensions.Annotated[
        typing.Optional[typing.List[GetOrdersResponsePurchasedItemsItem]],
    ...
    stripe_details: typing_extensions.Annotated[
        typing.Optional[GetOrdersResponseStripeDetails],
    ...
    stripe_card: typing_extensions.Annotated[
        typing.Optional[GetOrdersResponseStripeCard],
    ...
    paypal_details: typing_extensions.Annotated[
        typing.Optional[GetOrdersResponsePaypalDetails],
    ...
    metadata: typing.Optional[GetOrdersResponseMetadata] = None
    ...
    totals: typing.Optional[GetOrdersResponseTotals] = pydantic.Field(default=None)
    """
    An object describing various pricing totals
    """

    download_files: typing_extensions.Annotated[
        typing.Optional[typing.List[GetOrdersResponseDownloadFilesItem]],
