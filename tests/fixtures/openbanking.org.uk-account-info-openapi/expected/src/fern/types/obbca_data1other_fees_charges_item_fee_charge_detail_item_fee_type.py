...
class ObbcaData1OtherFeesChargesItemFeeChargeDetailItemFeeType(str, enum.Enum):
    """
    Fee/Charge Type
    """
    ...
    def visit(
        ...
        if self is ObbcaData1OtherFeesChargesItemFeeChargeDetailItemFeeType.OTHER:
            return other()
        if self is ObbcaData1OtherFeesChargesItemFeeChargeDetailItemFeeType.SERVICE_C_ACCOUNT_FEE:
            return service_c_account_fee()
        if self is ObbcaData1OtherFeesChargesItemFeeChargeDetailItemFeeType.SERVICE_C_ACCOUNT_FEE_MONTHLY:
            return service_c_account_fee_monthly()
        if self is ObbcaData1OtherFeesChargesItemFeeChargeDetailItemFeeType.SERVICE_C_ACCOUNT_FEE_QUARTERLY:
            return service_c_account_fee_quarterly()
        if self is ObbcaData1OtherFeesChargesItemFeeChargeDetailItemFeeType.SERVICE_C_FIXED_TARIFF:
            return service_c_fixed_tariff()
        if self is ObbcaData1OtherFeesChargesItemFeeChargeDetailItemFeeType.SERVICE_C_BUSI_DEP_ACC_BREAKAGE:
            return service_c_busi_dep_acc_breakage()
        if self is ObbcaData1OtherFeesChargesItemFeeChargeDetailItemFeeType.SERVICE_C_MINIMUM_MONTHLY_FEE:
            return service_c_minimum_monthly_fee()
        if self is ObbcaData1OtherFeesChargesItemFeeChargeDetailItemFeeType.SERVICE_C_OTHER:
