...
class RawOrganisationAuthorityClaimsClient:
    ...
    def get_the_authority_claims_for_the_given_organisation(
    ...
    ) -> HttpResponse[OrganisationAuthorityClaims]:
        """
        Parameters
        ----------
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"organisations/{encode_path_param(organisation_id)}/authorityclaims",
            method="GET",
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=OrganisationAuthorityClaims,
    ...
    def get_an_authority_claim_by_id(
        ...
        *,
    ...
    ) -> HttpResponse[OrganisationAuthorityClaim]:
        """
        Parameters
        ----------
        organisation_id : OrganisationId
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"organisations/{encode_path_param(organisation_id)}/authorityclaims/{encode_path_param(organisation_authority_claim_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=OrganisationAuthorityClaim,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawOrganisationAuthorityClaimsClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._client_wrapper = client_wrapper

    async def get_the_authority_claims_for_the_given_organisation(
        self, organisation_id: OrganisationId, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[OrganisationAuthorityClaims]:
        """
        Parameters
        ----------
        organisation_id : OrganisationId
    ...
    async def get_an_authority_claim_by_id(
        ...
        *,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[OrganisationAuthorityClaim]:
        """
        Parameters
        ----------
        organisation_id : OrganisationId
