...
class RawAuthorisationServersApiResourcesClient:
    ...
    def get_all_api_resources_for_the_given_authorisation_server(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"organisations/{encode_path_param(organisation_id)}/authorisationservers/{encode_path_param(authorisation_server_id)}/apiresources",
            method="GET",
            params={
                "page": page,
                "size": size,
    ...
    def get_an_authorisation_server_api_resource_by_id(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"organisations/{encode_path_param(organisation_id)}/authorisationservers/{encode_path_param(authorisation_server_id)}/apiresources/{encode_path_param(api_resource_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def get_an_authorisation_server_api_resource_by_id_and_returns_the_latest_family_status(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"organisations/{encode_path_param(organisation_id)}/authorisationservers/{encode_path_param(authorisation_server_id)}/familystatus",
            method="GET",
            request_options=request_options,
        )
        try:
...
class AsyncRawAuthorisationServersApiResourcesClient:
    ...
    async def get_all_api_resources_for_the_given_authorisation_server(
        ...
        *,
        ...
        sort: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[ApiResources]:
        """
        Parameters
        ----------
        organisation_id : OrganisationId
