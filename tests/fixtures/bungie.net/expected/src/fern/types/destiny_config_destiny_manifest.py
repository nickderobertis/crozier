...
class DestinyConfigDestinyManifest(UniversalBaseModel):
    ...
    icon_image_pyramid_info: typing_extensions.Annotated[
        typing.Optional[typing.List[DestinyConfigImagePyramidEntry]], FieldMetadata(alias="iconImagePyramidInfo")
    ...
    json_world_component_content_paths: typing_extensions.Annotated[
        typing.Optional[typing.Dict[str, typing.Dict[str, str]]], FieldMetadata(alias="jsonWorldComponentContentPaths")
    ] = pydantic.Field(default=None)
    """
    ...
    json_world_content_paths: typing_extensions.Annotated[
        typing.Optional[typing.Dict[str, str]], FieldMetadata(alias="jsonWorldContentPaths")
    ] = pydantic.Field(default=None)
    """
    ...
    mobile_asset_content_path: typing_extensions.Annotated[
        typing.Optional[str], FieldMetadata(alias="mobileAssetContentPath")
    ] = None
    mobile_clan_banner_database_path: typing_extensions.Annotated[
        typing.Optional[str], FieldMetadata(alias="mobileClanBannerDatabasePath")
    ] = None
    ...
    mobile_gear_cdn: typing_extensions.Annotated[
        typing.Optional[typing.Dict[str, str]], FieldMetadata(alias="mobileGearCDN")
    ] = None
    mobile_world_content_paths: typing_extensions.Annotated[
        typing.Optional[typing.Dict[str, str]], FieldMetadata(alias="mobileWorldContentPaths")
    ] = None
