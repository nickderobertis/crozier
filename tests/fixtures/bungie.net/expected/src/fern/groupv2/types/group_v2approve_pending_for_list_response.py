...
from ...types.entities_entity_action_result import EntitiesEntityActionResult


class GroupV2ApprovePendingForListResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[typing.List[EntitiesEntityActionResult]], FieldMetadata(alias="Response")
    ] = None
