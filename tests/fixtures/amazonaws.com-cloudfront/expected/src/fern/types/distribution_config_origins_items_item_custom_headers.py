...
class DistributionConfigOriginsItemsItemCustomHeaders(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[typing.List[DistributionConfigOriginsItemsItemCustomHeadersItemsItem]],
