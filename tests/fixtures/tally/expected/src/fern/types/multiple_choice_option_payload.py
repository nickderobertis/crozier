...
class MultipleChoiceOptionPayload(UniversalBaseModel):
    """
    Payload for MULTIPLE_CHOICE_OPTION block type. Used for single-select radio questions.
    """
    ...
    allow_multiple: typing_extensions.Annotated[
        typing.Optional[AllowMultiple], FieldMetadata(alias="allowMultiple"), pydantic.Field(alias="allowMultiple")
    ] = None
    ...
    color_code_options: typing_extensions.Annotated[
        typing.Optional[ColorCodeOptions],
        FieldMetadata(alias="colorCodeOptions"),
        pydantic.Field(alias="colorCodeOptions"),
    ] = None
    color: typing.Optional[OptionColor] = None
    has_badge: typing_extensions.Annotated[
        typing.Optional[bool],
        FieldMetadata(alias="hasBadge"),
        pydantic.Field(
            alias="hasBadge",
    ...
    """
    Enable option badges (numbers or letters). Only needs to be set on the first option in the group.
    """

    badge_type: typing_extensions.Annotated[
        typing.Optional[MultipleChoiceOptionPayloadBadgeType],
        FieldMetadata(alias="badgeType"),
        pydantic.Field(
            alias="badgeType", description="Badge display type. Only needs to be set on the first option in the group."
        ),
    ] = None
    """
