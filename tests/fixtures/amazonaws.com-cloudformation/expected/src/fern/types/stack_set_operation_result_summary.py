...
class StackSetOperationResultSummary(UniversalBaseModel):
    ...
    status: typing_extensions.Annotated[
        typing.Optional[StackSetOperationResultSummaryStatus], FieldMetadata(alias="Status")
    ...
    account_gate_result: typing_extensions.Annotated[
        typing.Optional[StackSetOperationResultSummaryAccountGateResult], FieldMetadata(alias="AccountGateResult")
    ] = pydantic.Field(default=None)
    """
