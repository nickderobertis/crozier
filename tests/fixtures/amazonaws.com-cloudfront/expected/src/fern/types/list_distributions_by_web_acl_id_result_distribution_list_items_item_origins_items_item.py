...
class ListDistributionsByWebAclIdResultDistributionListItemsItemOriginsItemsItem(UniversalBaseModel):
    """
    ...
    custom_headers: typing_extensions.Annotated[
        typing.Optional[ListDistributionsByWebAclIdResultDistributionListItemsItemOriginsItemsItemCustomHeaders],
    ...
    s3origin_config: typing_extensions.Annotated[
        typing.Optional[ListDistributionsByWebAclIdResultDistributionListItemsItemOriginsItemsItemS3OriginConfig],
    ...
    custom_origin_config: typing_extensions.Annotated[
        typing.Optional[ListDistributionsByWebAclIdResultDistributionListItemsItemOriginsItemsItemCustomOriginConfig],
