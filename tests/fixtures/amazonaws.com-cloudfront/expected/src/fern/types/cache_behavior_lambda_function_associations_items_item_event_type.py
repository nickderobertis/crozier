...
class CacheBehaviorLambdaFunctionAssociationsItemsItemEventType(enum.StrEnum):
    """
    ...
    def visit(
        ...
        if self is CacheBehaviorLambdaFunctionAssociationsItemsItemEventType.VIEWER_REQUEST:
            return viewer_request()
        if self is CacheBehaviorLambdaFunctionAssociationsItemsItemEventType.VIEWER_RESPONSE:
            return viewer_response()
        if self is CacheBehaviorLambdaFunctionAssociationsItemsItemEventType.ORIGIN_REQUEST:
            return origin_request()
        if self is CacheBehaviorLambdaFunctionAssociationsItemsItemEventType.ORIGIN_RESPONSE:
