...
class PostPortfolioOptimizationMaximumReturnDiversifiedRequestConstraints(UniversalBaseModel):
    ...
    delta_return: typing_extensions.Annotated[
        ...
        pydantic.Field(
            alias="deltaReturn", description="The relative tolerance over the maximum return portfolio return"
        ),
    ] = None
    """
