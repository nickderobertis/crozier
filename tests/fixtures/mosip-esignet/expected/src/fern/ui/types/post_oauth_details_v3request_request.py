...
class PostOauthDetailsV3RequestRequest(UniversalBaseModel):
    ...
    code_challenge_method: typing_extensions.Annotated[
        typing.Optional[PostOauthDetailsV3RequestRequestCodeChallengeMethod],
    ...
    id_token_hint: typing.Optional[str] = pydantic.Field(default=None)
    """
