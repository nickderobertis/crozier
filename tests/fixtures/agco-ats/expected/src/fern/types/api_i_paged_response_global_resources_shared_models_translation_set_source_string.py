...
class ApiIPagedResponseGlobalResourcesSharedModelsTranslationSetSourceString(UniversalBaseModel):
    entities: typing_extensions.Annotated[
        typing.Optional[typing.List[GlobalResourcesSharedModelsTranslationSetSourceString]],
