...
from .doc_pages_insert200response_meta_cache_delta_pages_item import DocPagesInsert200ResponseMetaCacheDeltaPagesItem


class DocPagesInsert200ResponseMetaCacheDelta(UniversalBaseModel):
    ...
    pages: typing.List[DocPagesInsert200ResponseMetaCacheDeltaPagesItem]
