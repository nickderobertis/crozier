...
class ListDistributionsByWebAclIdResultDistributionListItemsItemDefaultCacheBehaviorViewerProtocolPolicy(enum.StrEnum):
    """
    ...
    def visit(
        ...
        if (
            self
            is ListDistributionsByWebAclIdResultDistributionListItemsItemDefaultCacheBehaviorViewerProtocolPolicy.ALLOW_ALL
        ):
            return allow_all()
        if (
            self
            is ListDistributionsByWebAclIdResultDistributionListItemsItemDefaultCacheBehaviorViewerProtocolPolicy.HTTPS_ONLY
        ):
            return https_only()
        if (
            self
            is ListDistributionsByWebAclIdResultDistributionListItemsItemDefaultCacheBehaviorViewerProtocolPolicy.REDIRECT_TO_HTTPS
        ):
