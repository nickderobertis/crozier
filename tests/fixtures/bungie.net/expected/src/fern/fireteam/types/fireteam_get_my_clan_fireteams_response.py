...
from ...types.search_result_of_fireteam_response import SearchResultOfFireteamResponse


class FireteamGetMyClanFireteamsResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[SearchResultOfFireteamResponse], FieldMetadata(alias="Response")
    ] = None
