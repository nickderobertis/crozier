...
class ListDistributionsByWebAclIdResultDistributionListItemsItemCacheBehaviors(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[typing.List[ListDistributionsByWebAclIdResultDistributionListItemsItemCacheBehaviorsItemsItem]],
