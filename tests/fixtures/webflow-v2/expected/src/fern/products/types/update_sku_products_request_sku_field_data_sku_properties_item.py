...
class UpdateSkuProductsRequestSkuFieldDataSkuPropertiesItem(UniversalBaseModel):
    """
    ...
    enum: typing.List[UpdateSkuProductsRequestSkuFieldDataSkuPropertiesItemEnumItem] = pydantic.Field()
    """
