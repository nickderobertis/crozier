...
class ChannelOptionsViberWithButtonViberServiceCategory(enum.StrEnum):
    """
    ...
    def visit(self, transaction: typing.Callable[[], T_Result], promotion: typing.Callable[[], T_Result]) -> T_Result:
        if self is ChannelOptionsViberWithButtonViberServiceCategory.TRANSACTION:
            return transaction()
        if self is ChannelOptionsViberWithButtonViberServiceCategory.PROMOTION:
            return promotion()
