...
class RawAppPkgmNotificationsClient:
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                "_links": convert_and_respect_annotation_metadata(
                    object_=links, annotation=AppPkgNotificationLinks, direction="write"
                ),
                "appDId": app_d_id,
                "appPkgId": app_pkg_id,
                "id": id,
                ...
                "timeStamp": convert_and_respect_annotation_metadata(
                    object_=time_stamp, annotation=TimeStamp, direction="write"
                ),
            },
            headers={
...
class AsyncRawAppPkgmNotificationsClient:
