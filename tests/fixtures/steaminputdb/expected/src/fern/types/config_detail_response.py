...
class ConfigDetailResponse(UniversalBaseModel):
    ...
    playtime_seconds: typing.Optional[int] = pydantic.Field(default=None)
    """
    Total playtime in seconds with the specified time period
    """

    playtime_sessions: typing.Optional[int] = pydantic.Field(default=None)
    """
    Total number of playtime sessions within the specified time period
    """
    ...
    votes: typing.Optional[ConfigDetailResponseVotesStruct] = None
