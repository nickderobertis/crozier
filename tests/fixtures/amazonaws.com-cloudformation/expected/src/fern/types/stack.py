...
class Stack(UniversalBaseModel):
    ...
    change_set_id: typing_extensions.Annotated[
        ...
        pydantic.Field(alias="ChangeSetId", description="The unique ID of the change set."),
    ] = None
    """
    ...
    description: typing_extensions.Annotated[
        ...
        pydantic.Field(alias="Description", description="A user-defined description associated with the stack."),
    ] = None
    """
    ...
    parameters: typing_extensions.Annotated[
        ...
        pydantic.Field(alias="Parameters", description="A list of <code>Parameter</code> structures."),
    ] = None
    """
    ...
    creation_time: typing_extensions.Annotated[
        ...
        pydantic.Field(alias="CreationTime", description="The time at which the stack was created."),
    ]
    """
    ...
    rollback_configuration: typing_extensions.Annotated[
        typing.Optional[StackRollbackConfiguration],
    ...
    stack_status: typing_extensions.Annotated[
        ...
        pydantic.Field(alias="StackStatus", description="Current status of the stack."),
    ]
    """
    ...
    disable_rollback: typing_extensions.Annotated[
        ...
        pydantic.Field(
            ...
            description="<p>Boolean to enable or disable rollback on stack creation failures:</p> <ul> <li> <p> <code>true</code>: disable rollback.</p> </li> <li> <p> <code>false</code>: enable rollback.</p> </li> </ul>",
        ),
    ] = None
    """
    ...
    timeout_in_minutes: typing_extensions.Annotated[
        ...
        pydantic.Field(
            alias="TimeoutInMinutes", description="The amount of time within which stack creation should complete."
        ),
    ] = None
    """
    ...
    capabilities: typing_extensions.Annotated[
        ...
        pydantic.Field(alias="Capabilities", description="The capabilities allowed in the stack."),
    ] = None
    """
    The capabilities allowed in the stack.
    """

    outputs: typing_extensions.Annotated[
        typing.Optional[typing.List[Output]],
        FieldMetadata(alias="Outputs"),
        pydantic.Field(alias="Outputs", description="A list of output structures."),
    ] = None
    """
    ...
    tags: typing_extensions.Annotated[
        ...
        pydantic.Field(
            alias="Tags", description="A list of <code>Tag</code>s that specify information about the stack."
        ),
    ] = None
    """
