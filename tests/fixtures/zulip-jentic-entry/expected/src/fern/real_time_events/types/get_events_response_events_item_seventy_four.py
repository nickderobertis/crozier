...
class GetEventsResponseEventsItemSeventyFour(UniversalBaseModel):
    """
    ...
    **Changes**: New in Zulip 11.0 (feature level 390).
    ...
    type: typing.Optional[GetEventsResponseEventsItemSeventyFourType] = pydantic.Field(default=None)
    """
    The event's type, relevant both for client-side dispatch and server-side
    filtering by event type in [POST /register](/api/register-queue).
    """

    op: typing.Optional[GetEventsResponseEventsItemSeventyFourOp] = None
