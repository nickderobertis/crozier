...
class DestinyResponsesDestinyProfileResponse(UniversalBaseModel):
    ...
    platform_silver: typing_extensions.Annotated[
        typing.Optional[SingleComponentResponseOfDestinyPlatformSilverComponent], FieldMetadata(alias="platformSilver")
    ] = pydantic.Field(default=None)
    """
    ...
    profile_currencies: typing_extensions.Annotated[
        typing.Optional[SingleComponentResponseOfDestinyInventoryComponent], FieldMetadata(alias="profileCurrencies")
    ] = pydantic.Field(default=None)
    """
    ...
    profile_inventory: typing_extensions.Annotated[
        typing.Optional[SingleComponentResponseOfDestinyInventoryComponent], FieldMetadata(alias="profileInventory")
    ] = pydantic.Field(default=None)
    """
    ...
    profile_kiosks: typing_extensions.Annotated[
        typing.Optional[SingleComponentResponseOfDestinyKiosksComponent], FieldMetadata(alias="profileKiosks")
    ] = pydantic.Field(default=None)
    """
    ...
    profile_plug_sets: typing_extensions.Annotated[
        typing.Optional[SingleComponentResponseOfDestinyPlugSetsComponent], FieldMetadata(alias="profilePlugSets")
    ] = pydantic.Field(default=None)
    """
    ...
    profile_records: typing_extensions.Annotated[
        typing.Optional[SingleComponentResponseOfDestinyProfileRecordsComponent], FieldMetadata(alias="profileRecords")
    ] = pydantic.Field(default=None)
    """
    COMPONENT TYPE: Records
    """
    ...
    response_minted_timestamp: typing_extensions.Annotated[
        typing.Optional[dt.datetime], FieldMetadata(alias="responseMintedTimestamp")
    ] = pydantic.Field(default=None)
    """
    ...
    secondary_components_minted_timestamp: typing_extensions.Annotated[
        typing.Optional[dt.datetime], FieldMetadata(alias="secondaryComponentsMintedTimestamp")
    ] = pydantic.Field(default=None)
    """
    ...
    vendor_receipts: typing_extensions.Annotated[
        typing.Optional[SingleComponentResponseOfDestinyVendorReceiptsComponent], FieldMetadata(alias="vendorReceipts")
    ] = pydantic.Field(default=None)
    """
