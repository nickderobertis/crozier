...
class SocialFriendsBungieFriend(UniversalBaseModel):
    ...
    last_seen_as_bungie_membership_type: typing_extensions.Annotated[
        typing.Optional[int], FieldMetadata(alias="lastSeenAsBungieMembershipType")
    ] = None
    last_seen_as_membership_id: typing_extensions.Annotated[
        typing.Optional[int], FieldMetadata(alias="lastSeenAsMembershipId")
    ] = None
    online_status: typing_extensions.Annotated[typing.Optional[int], FieldMetadata(alias="onlineStatus")] = None
    online_title: typing_extensions.Annotated[typing.Optional[int], FieldMetadata(alias="onlineTitle")] = None
