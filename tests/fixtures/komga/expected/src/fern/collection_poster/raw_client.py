...
class RawCollectionPosterClient:
    ...
    def get_collection_thumbnail(
        ...
        with self._client_wrapper.httpx_client.stream(
            f"api/v1/collections/{encode_path_param(id)}/thumbnail",
            method="GET",
    ...
    def get_collection_thumbnails(
        self, id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> HttpResponse[typing.List[ThumbnailSeriesCollectionDto]]:
        """
        Parameters
        ----------
        id : str
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"api/v1/collections/{encode_path_param(id)}/thumbnails",
            method="GET",
            request_options=request_options,
        )
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=typing.List[ThumbnailSeriesCollectionDto],
                        object_=_response.json(),
                    ),
                )
    ...
    ) -> HttpResponse[ThumbnailSeriesCollectionDto]:
        """
        Required role: **ADMIN**
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=ThumbnailSeriesCollectionDto,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def get_collection_thumbnail_by_id(
        ...
        """
        with self._client_wrapper.httpx_client.stream(
            f"api/v1/collections/{encode_path_param(id)}/thumbnails/{encode_path_param(thumbnail_id)}",
            method="GET",
            request_options=request_options,
        ) as _response:
    ...
    def mark_collection_thumbnail_selected(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"api/v1/collections/{encode_path_param(id)}/thumbnails/{encode_path_param(thumbnail_id)}/selected",
            method="PUT",
            request_options=request_options,
        )
        try:
...
class AsyncRawCollectionPosterClient:
    ...
    async def get_collection_thumbnails(
        self, id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[typing.List[ThumbnailSeriesCollectionDto]]:
        """
        Parameters
        ----------
        id : str
    ...
    async def add_user_uploaded_collection_thumbnail(
        ...
        *,
        ...
        selected: typing.Optional[bool] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[ThumbnailSeriesCollectionDto]:
        """
        Required role: **ADMIN**
