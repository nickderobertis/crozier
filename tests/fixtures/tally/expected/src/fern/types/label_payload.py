...
class LabelPayload(UniversalBaseModel):
    """
    ...
    is_folded: typing_extensions.Annotated[
        typing.Optional[IsFolded], FieldMetadata(alias="isFolded"), pydantic.Field(alias="isFolded")
    ] = None
