...
class StackResourceDetailDriftInformationStackResourceDriftStatus(str, enum.Enum):
    """
    ...
    def visit(
        ...
        if self is StackResourceDetailDriftInformationStackResourceDriftStatus.IN_SYNC:
            return in_sync()
        if self is StackResourceDetailDriftInformationStackResourceDriftStatus.MODIFIED:
            return modified()
        if self is StackResourceDetailDriftInformationStackResourceDriftStatus.DELETED:
            return deleted()
        if self is StackResourceDetailDriftInformationStackResourceDriftStatus.NOT_CHECKED:
            return not_checked()
