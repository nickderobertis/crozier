...
class TypeConfigurationDetails(UniversalBaseModel):
    ...
    alias: typing_extensions.Annotated[
        typing.Optional[str],
    ...
    configuration: typing_extensions.Annotated[
        ...
        pydantic.Field(
            alias="Configuration",
            description="<p>A JSON string specifying the configuration data for the extension, in this account and region.</p> <p>If a configuration hasn't been set for a specified extension, CloudFormation returns <code>{}</code>.</p>",
        ),
    ] = None
    """
    ...
    last_updated: typing_extensions.Annotated[
        ...
        pydantic.Field(
            alias="LastUpdated",
            description="<p>When the configuration data was last updated for this extension.</p> <p>If a configuration hasn't been set for a specified extension, CloudFormation returns <code>null</code>.</p>",
        ),
    ] = None
    """
    ...
    is_default_configuration: typing_extensions.Annotated[
        ...
        FieldMetadata(alias="IsDefaultConfiguration"),
        pydantic.Field(
            alias="IsDefaultConfiguration",
            description="Whether this configuration data is the default configuration for the extension.",
        ),
    ] = None
    """
