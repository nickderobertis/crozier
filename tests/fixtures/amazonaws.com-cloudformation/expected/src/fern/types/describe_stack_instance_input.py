...
class DescribeStackInstanceInput(UniversalBaseModel):
    ...
    stack_instance_account: typing_extensions.Annotated[str, FieldMetadata(alias="StackInstanceAccount")] = (
        pydantic.Field()
    )
    """
    ...
    stack_instance_region: typing_extensions.Annotated[str, FieldMetadata(alias="StackInstanceRegion")] = (
        pydantic.Field()
    )
    """
    ...
    call_as: typing_extensions.Annotated[
        typing.Optional[DescribeStackInstanceInputCallAs], FieldMetadata(alias="CallAs")
