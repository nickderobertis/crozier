...
class RawScriptsClient:
    ...
    def list(
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"sites/{encode_path_param(site_id)}/registered_scripts",
    ...
    def register_hosted(
        ...
        *,
    ...
    ) -> HttpResponse[RegisterHostedScriptsResponse]:
        """
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"sites/{encode_path_param(site_id)}/registered_scripts/hosted",
            base_url=self._client_wrapper.get_environment().base,
            method="POST",
            json={
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=RegisterHostedScriptsResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def register_inline(
        ...
        *,
        ...
        can_copy: typing.Optional[bool] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[RegisterInlineScriptsResponse]:
        """
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"sites/{encode_path_param(site_id)}/registered_scripts/inline",
            base_url=self._client_wrapper.get_environment().base,
            method="POST",
            json={
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=RegisterInlineScriptsResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawScriptsClient:
    ...
    async def register_hosted(
        ...
        *,
        ...
        can_copy: typing.Optional[bool] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[RegisterHostedScriptsResponse]:
        """
        Register a hosted script to a site.
    ...
    async def register_inline(
        ...
        *,
        ...
        can_copy: typing.Optional[bool] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[RegisterInlineScriptsResponse]:
        """
        Register an inline script to a site. Inline scripts are limited to 2000 characters.
