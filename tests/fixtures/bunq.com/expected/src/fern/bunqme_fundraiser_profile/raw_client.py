...
class RawBunqmeFundraiserProfileClient:
    ...
    ) -> HttpResponse[typing.List[BunqMeFundraiserProfileUserListing]]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=typing.List[BunqMeFundraiserProfileUserListing],
    ...
    ) -> HttpResponse[BunqMeFundraiserProfileUserRead]:
        """
        bunq.me public profile of the user.
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=BunqMeFundraiserProfileUserRead,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawBunqmeFundraiserProfileClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._client_wrapper = client_wrapper

    async def list_all_bunqme_fundraiser_profile_for_user(
        self, user_id: int, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[typing.List[BunqMeFundraiserProfileUserListing]]:
        """
        bunq.me public profile of the user.
    ...
    async def read_bunqme_fundraiser_profile_for_user(
        self, user_id: int, item_id: int, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[BunqMeFundraiserProfileUserRead]:
        """
        bunq.me public profile of the user.
