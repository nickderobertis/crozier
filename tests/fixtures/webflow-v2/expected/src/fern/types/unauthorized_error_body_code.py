...
class UnauthorizedErrorBodyCode(enum.StrEnum):
    ...
    def visit(
        ...
        if self is UnauthorizedErrorBodyCode.ANALYZE_FILTER_CONFLICT:
            return analyze_filter_conflict()
        if self is UnauthorizedErrorBodyCode.ANALYZE_INPUT_VALIDATION:
            return analyze_input_validation()
        if self is UnauthorizedErrorBodyCode.ANALYZE_UNSUPPORTED_FILTER:
            return analyze_unsupported_filter()
        if self is UnauthorizedErrorBodyCode.BAD_REQUEST:
            return bad_request()
        if self is UnauthorizedErrorBodyCode.BEFORE_HISTORICAL_FLOOR:
            return before_historical_floor()
        if self is UnauthorizedErrorBodyCode.COLLECTION_NOT_FOUND:
            return collection_not_found()
        if self is UnauthorizedErrorBodyCode.CONFLICT:
            return conflict()
        if self is UnauthorizedErrorBodyCode.DUPLICATE_COLLECTION:
            return duplicate_collection()
        if self is UnauthorizedErrorBodyCode.DUPLICATE_USER_EMAIL:
            return duplicate_user_email()
        if self is UnauthorizedErrorBodyCode.ECOMMERCE_NOT_ENABLED:
            return ecommerce_not_enabled()
        if self is UnauthorizedErrorBodyCode.FORBIDDEN:
            return forbidden()
        if self is UnauthorizedErrorBodyCode.FORMS_REQUIRE_REPUBLISH:
            return forms_require_republish()
        if self is UnauthorizedErrorBodyCode.INCOMPATIBLE_WEBHOOK_FILTER:
            return incompatible_webhook_filter()
        if self is UnauthorizedErrorBodyCode.INTERNAL_ERROR:
            return internal_error()
        if self is UnauthorizedErrorBodyCode.INVALID_AUTH_VERSION:
            return invalid_auth_version()
        if self is UnauthorizedErrorBodyCode.INVALID_CREDENTIALS:
            return invalid_credentials()
        if self is UnauthorizedErrorBodyCode.INVALID_DOMAIN:
            return invalid_domain()
        if self is UnauthorizedErrorBodyCode.INVALID_TIME_RANGE:
            return invalid_time_range()
        if self is UnauthorizedErrorBodyCode.INVALID_USER_EMAIL:
            return invalid_user_email()
        if self is UnauthorizedErrorBodyCode.ITEM_NOT_FOUND:
            return item_not_found()
        if self is UnauthorizedErrorBodyCode.MISSING_SCOPES:
            return missing_scopes()
        if self is UnauthorizedErrorBodyCode.NO_DOMAINS:
            return no_domains()
        if self is UnauthorizedErrorBodyCode.NOT_AUTHORIZED:
            return not_authorized()
        if self is UnauthorizedErrorBodyCode.NOT_ENTERPRISE_PLAN_SITE:
            return not_enterprise_plan_site()
        if self is UnauthorizedErrorBodyCode.NOT_ENTERPRISE_PLAN_WORKSPACE:
            return not_enterprise_plan_workspace()
        if self is UnauthorizedErrorBodyCode.ORDER_NOT_FOUND:
            return order_not_found()
        if self is UnauthorizedErrorBodyCode.RESOURCE_NOT_FOUND:
            return resource_not_found()
        if self is UnauthorizedErrorBodyCode.SERVICE_UNAVAILABLE:
            return service_unavailable()
        if self is UnauthorizedErrorBodyCode.TIME_RANGE_TOO_WIDE:
            return time_range_too_wide()
        if self is UnauthorizedErrorBodyCode.TOO_MANY_REQUESTS:
            return too_many_requests()
        if self is UnauthorizedErrorBodyCode.UNSUPPORTED_VERSION:
            return unsupported_version()
        if self is UnauthorizedErrorBodyCode.UNSUPPORTED_WEBHOOK_TRIGGER_TYPE:
            return unsupported_webhook_trigger_type()
        if self is UnauthorizedErrorBodyCode.USER_LIMIT_REACHED:
            return user_limit_reached()
        if self is UnauthorizedErrorBodyCode.USER_NOT_FOUND:
            return user_not_found()
        if self is UnauthorizedErrorBodyCode.USERS_NOT_ENABLED:
            return users_not_enabled()
        if self is UnauthorizedErrorBodyCode.VALIDATION_ERROR:
