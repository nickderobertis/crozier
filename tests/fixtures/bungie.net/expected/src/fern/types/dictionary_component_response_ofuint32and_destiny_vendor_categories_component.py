...
class DictionaryComponentResponseOfuint32AndDestinyVendorCategoriesComponent(UniversalBaseModel):
    data: typing.Optional[typing.Dict[str, DestinyEntitiesVendorsDestinyVendorCategoriesComponent]] = None
