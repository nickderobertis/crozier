...
class GetEventsResponseEventsItemSeventyNine(UniversalBaseModel):
    """
    ...
    **Changes**: New in Zulip 10.0 (feature level 368).
    ...
    type: typing.Optional[GetEventsResponseEventsItemSeventyNineType] = pydantic.Field(default=None)
    """
    The event's type, relevant both for client-side dispatch and server-side
    filtering by event type in [POST /register](/api/register-queue).
    """

    op: typing.Optional[GetEventsResponseEventsItemSeventyNineOp] = None
