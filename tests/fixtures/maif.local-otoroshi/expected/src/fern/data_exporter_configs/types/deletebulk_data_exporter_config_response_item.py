...
class DeletebulkDataExporterConfigResponseItem(UniversalBaseModel):
    """
    The bulk response
    """
    ...
    status: typing.Optional[DeletebulkDataExporterConfigResponseItemStatus] = pydantic.Field(default=None)
    """
    Status
    """
