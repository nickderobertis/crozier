...
class DistributionListItemsItemCacheBehaviorsItemsItemLambdaFunctionAssociationsItemsItem(UniversalBaseModel):
    """
    ...
    event_type: typing_extensions.Annotated[
        typing.Optional[DistributionListItemsItemCacheBehaviorsItemsItemLambdaFunctionAssociationsItemsItemEventType],
