...
client = FernApi(...)
response = client.prices_and_fixed_prices.with_raw_response.createorupdatefixedpricesonpricetableortradepolicy(...)
...
```python
client.prices_and_fixed_prices.createorupdatefixedpricesonpricetableortradepolicy(..., request_options={
    "max_retries": 1
})
```
