...
class UserStatusReactionType(enum.StrEnum):
    """
    ...
    **Changes**: New in Zulip 5.0 (feature level 86).
    ...
    def visit(
        ...
        if self is UserStatusReactionType.UNICODE_EMOJI:
            return unicode_emoji()
        if self is UserStatusReactionType.REALM_EMOJI:
            return realm_emoji()
        if self is UserStatusReactionType.ZULIP_EXTRA_EMOJI:
