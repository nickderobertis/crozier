    ...
    def ingest(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"project/{encode_path_param(proj_key)}/semantic/ingest",
            method="POST",
            json={
                "source": convert_and_respect_annotation_metadata(
                    object_=source, annotation=SemanticIngestRequestSource, direction="write"
                ),
                "parameters": convert_and_respect_annotation_metadata(
                    object_=parameters, annotation=SemanticIngestReqParams, direction="write"
                ),
            },
            headers={
