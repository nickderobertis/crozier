...
class StackResourceDriftInformationSummary(UniversalBaseModel):
    """
    ...
    stack_resource_drift_status: typing_extensions.Annotated[
        StackResourceDriftInformationSummaryStackResourceDriftStatus, FieldMetadata(alias="StackResourceDriftStatus")
    ] = pydantic.Field()
    """
