...
class EcommOrderChangedPayloadPayloadPurchasedItemsItemVariantImageFile(UniversalBaseModel):
    ...
    variants: typing.Optional[
        typing.List[EcommOrderChangedPayloadPayloadPurchasedItemsItemVariantImageFileVariantsItem]
