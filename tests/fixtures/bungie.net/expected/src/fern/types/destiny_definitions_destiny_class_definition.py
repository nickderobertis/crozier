...
class DestinyDefinitionsDestinyClassDefinition(UniversalBaseModel):
    ...
    gendered_class_names: typing_extensions.Annotated[
        typing.Optional[typing.Dict[str, str]], FieldMetadata(alias="genderedClassNames")
    ...
    gendered_class_names_by_gender_hash: typing_extensions.Annotated[
        typing.Optional[typing.Dict[str, str]], FieldMetadata(alias="genderedClassNamesByGenderHash")
    ] = None
    ...
    mentor_vendor_hash: typing_extensions.Annotated[typing.Optional[int], FieldMetadata(alias="mentorVendorHash")] = (
        pydantic.Field(default=None)
    )
    """
