...
class ResourceTargetDefinition(UniversalBaseModel):
    ...
    attribute: typing_extensions.Annotated[
        typing.Optional[ResourceTargetDefinitionAttribute], FieldMetadata(alias="Attribute")
    ...
    requires_recreation: typing_extensions.Annotated[
        typing.Optional[ResourceTargetDefinitionRequiresRecreation], FieldMetadata(alias="RequiresRecreation")
    ] = pydantic.Field(default=None)
    """
