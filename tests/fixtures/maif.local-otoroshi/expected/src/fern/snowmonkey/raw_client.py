...
class RawSnowmonkeyClient:
    ...
    def start_snow_monkey(self, *, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[Done]:
        """
    ...
    def stop_snow_monkey(self, *, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[Done]:
        """
    ...
    def get_snow_monkey_outages(
        self, *, request_options: typing.Optional[RequestOptions] = None
    ) -> HttpResponse[typing.List[Outage]]:
        """
    ...
    def reset_snow_monkey(self, *, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[Done]:
        """
...
class AsyncRawSnowmonkeyClient:
    ...
    async def get_snow_monkey_config(
        self, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[SnowMonkeyConfig]:
        """
        Get current Snow Monkey config
    ...
    async def get_snow_monkey_outages(
        self, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[typing.List[Outage]]:
        """
        Get all current Snow Monkey ourages
