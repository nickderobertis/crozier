...
class RawAuditLogsClient:
    ...
    def get_workspace_audit_logs(
        ...
        *,
    ...
    ) -> HttpResponse[GetWorkspaceAuditLogsAuditLogsResponse]:
        """
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"workspaces/{encode_path_param(workspace_id_or_slug)}/audit_logs",
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=GetWorkspaceAuditLogsAuditLogsResponse,
...
class AsyncRawAuditLogsClient:
    ...
    async def get_workspace_audit_logs(
        ...
        *,
        ...
        to: typing.Optional[dt.datetime] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[GetWorkspaceAuditLogsAuditLogsResponse]:
        """
        Get audit logs for a workspace.
