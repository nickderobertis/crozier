...
class GetDistributionConfigResultDistributionConfigOriginsItemsItem(UniversalBaseModel):
    """
    ...
    custom_headers: typing_extensions.Annotated[
        typing.Optional[GetDistributionConfigResultDistributionConfigOriginsItemsItemCustomHeaders],
    ...
    s3origin_config: typing_extensions.Annotated[
        typing.Optional[GetDistributionConfigResultDistributionConfigOriginsItemsItemS3OriginConfig],
    ...
    custom_origin_config: typing_extensions.Annotated[
        typing.Optional[GetDistributionConfigResultDistributionConfigOriginsItemsItemCustomOriginConfig],
