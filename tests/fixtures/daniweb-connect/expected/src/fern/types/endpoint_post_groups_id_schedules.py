...
class EndpointPostGroupsIdSchedules(UniversalBaseModel):
    data: typing.Optional[typing.List[EndpointPostGroupsIdSchedulesDataItem]] = None
...
update_forward_refs(EndpointPostGroupsIdSchedules)
