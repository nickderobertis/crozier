...
class UpdateProductsRequestSkuFieldDataEcSkuBillingMethod(enum.StrEnum):
    """
    ...
    def visit(self, one_time: typing.Callable[[], T_Result], subscription: typing.Callable[[], T_Result]) -> T_Result:
        if self is UpdateProductsRequestSkuFieldDataEcSkuBillingMethod.ONE_TIME:
            return one_time()
        if self is UpdateProductsRequestSkuFieldDataEcSkuBillingMethod.SUBSCRIPTION:
            return subscription()
