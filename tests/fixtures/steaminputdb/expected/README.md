...
client = FernApi(...)
response = client.search.with_raw_response.search_steam_games_and_configurations_all_at_once(...)
...
```python
client.search.search_steam_games_and_configurations_all_at_once(..., request_options={
    "max_retries": 1
})
```
