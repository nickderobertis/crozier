...
class GetApiDomainsResponseItem(UniversalBaseModel):
    ...
    state: GetApiDomainsResponseItemState
    ...
    link_type: typing_extensions.Annotated[
        GetApiDomainsResponseItemLinkType, FieldMetadata(alias="linkType"), pydantic.Field(alias="linkType")
    ]
    ...
    https_level: typing_extensions.Annotated[
        GetApiDomainsResponseItemHttpsLevel, FieldMetadata(alias="httpsLevel"), pydantic.Field(alias="httpsLevel")
    ]
    ...
    robots: GetApiDomainsResponseItemRobots
    ...
    is_favorite: typing_extensions.Annotated[
        bool, FieldMetadata(alias="isFavorite"), pydantic.Field(alias="isFavorite")
    ]
