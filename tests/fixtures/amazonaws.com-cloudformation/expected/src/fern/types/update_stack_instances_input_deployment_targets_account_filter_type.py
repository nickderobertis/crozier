...
class UpdateStackInstancesInputDeploymentTargetsAccountFilterType(str, enum.Enum):
    """
    ...
    def visit(
        ...
        if self is UpdateStackInstancesInputDeploymentTargetsAccountFilterType.NONE:
            return none()
        if self is UpdateStackInstancesInputDeploymentTargetsAccountFilterType.INTERSECTION:
            return intersection()
        if self is UpdateStackInstancesInputDeploymentTargetsAccountFilterType.DIFFERENCE:
            return difference()
        if self is UpdateStackInstancesInputDeploymentTargetsAccountFilterType.UNION:
            return union()
