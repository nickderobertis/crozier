...
class DistributionListItemsItemDefaultCacheBehaviorForwardedValues(UniversalBaseModel):
    """
    ...
    headers: typing_extensions.Annotated[
        typing.Optional[DistributionListItemsItemDefaultCacheBehaviorForwardedValuesHeaders],
    ...
    query_string_cache_keys: typing_extensions.Annotated[
        typing.Optional[DistributionListItemsItemDefaultCacheBehaviorForwardedValuesQueryStringCacheKeys],
