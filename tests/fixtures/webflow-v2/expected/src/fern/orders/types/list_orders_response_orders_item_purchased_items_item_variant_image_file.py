...
class ListOrdersResponseOrdersItemPurchasedItemsItemVariantImageFile(UniversalBaseModel):
    ...
    variants: typing.Optional[
        typing.List[ListOrdersResponseOrdersItemPurchasedItemsItemVariantImageFileVariantsItem]
