...
class EcommNewOrderPayloadPayload(UniversalBaseModel):
    ...
    status: typing.Optional[EcommNewOrderPayloadPayloadStatus] = pydantic.Field(default=None)
    """
    ...
    dispute_last_status: typing_extensions.Annotated[
        typing.Optional[EcommNewOrderPayloadPayloadDisputeLastStatus],
    ...
    customer_paid: typing_extensions.Annotated[
        typing.Optional[EcommNewOrderPayloadPayloadCustomerPaid],
    ...
    net_amount: typing_extensions.Annotated[
        typing.Optional[EcommNewOrderPayloadPayloadNetAmount],
    ...
    application_fee: typing_extensions.Annotated[
        typing.Optional[EcommNewOrderPayloadPayloadApplicationFee],
    ...
    all_addresses: typing_extensions.Annotated[
        typing.Optional[typing.List[EcommNewOrderPayloadPayloadAllAddressesItem]],
    ...
    shipping_address: typing_extensions.Annotated[
        typing.Optional[EcommNewOrderPayloadPayloadShippingAddress],
    ...
    billing_address: typing_extensions.Annotated[
        typing.Optional[EcommNewOrderPayloadPayloadBillingAddress],
    ...
    customer_info: typing_extensions.Annotated[
        typing.Optional[EcommNewOrderPayloadPayloadCustomerInfo],
    ...
    purchased_items: typing_extensions.Annotated[
        typing.Optional[typing.List[EcommNewOrderPayloadPayloadPurchasedItemsItem]],
    ...
    stripe_details: typing_extensions.Annotated[
        typing.Optional[EcommNewOrderPayloadPayloadStripeDetails],
    ...
    stripe_card: typing_extensions.Annotated[
        typing.Optional[EcommNewOrderPayloadPayloadStripeCard],
    ...
    paypal_details: typing_extensions.Annotated[
        typing.Optional[EcommNewOrderPayloadPayloadPaypalDetails],
    ...
    metadata: typing.Optional[EcommNewOrderPayloadPayloadMetadata] = None
    ...
    totals: typing.Optional[EcommNewOrderPayloadPayloadTotals] = pydantic.Field(default=None)
    """
    An object describing various pricing totals
    """

    download_files: typing_extensions.Annotated[
        typing.Optional[typing.List[EcommNewOrderPayloadPayloadDownloadFilesItem]],
