...
class GetProductsResponseSkusItemFieldDataEcSkuSubscriptionPlan(UniversalBaseModel):
    """
    ...
    interval: typing.Optional[GetProductsResponseSkusItemFieldDataEcSkuSubscriptionPlanInterval] = pydantic.Field(
        default=None
    )
    """
    ...
    plans: typing.Optional[typing.List[GetProductsResponseSkusItemFieldDataEcSkuSubscriptionPlanPlansItem]] = None
