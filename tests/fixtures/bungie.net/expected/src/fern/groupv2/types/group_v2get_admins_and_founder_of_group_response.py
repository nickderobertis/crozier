...
from ...types.search_result_of_group_member import SearchResultOfGroupMember


class GroupV2GetAdminsAndFounderOfGroupResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[SearchResultOfGroupMember], FieldMetadata(alias="Response"), pydantic.Field(alias="Response")
    ] = None
