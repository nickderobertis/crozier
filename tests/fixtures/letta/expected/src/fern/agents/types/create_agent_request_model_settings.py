...
class CreateAgentRequestModelSettings_Anthropic(UniversalBaseModel):
...
class CreateAgentRequestModelSettings_Azure(UniversalBaseModel):
...
class CreateAgentRequestModelSettings_Bedrock(UniversalBaseModel):
...
class CreateAgentRequestModelSettings_ChatgptOauth(UniversalBaseModel):
...
class CreateAgentRequestModelSettings_Deepseek(UniversalBaseModel):
...
class CreateAgentRequestModelSettings_GoogleAi(UniversalBaseModel):
...
class CreateAgentRequestModelSettings_GoogleVertex(UniversalBaseModel):
...
class CreateAgentRequestModelSettings_Groq(UniversalBaseModel):
...
class CreateAgentRequestModelSettings_Openai(UniversalBaseModel):
...
class CreateAgentRequestModelSettings_Together(UniversalBaseModel):
...
class CreateAgentRequestModelSettings_Xai(UniversalBaseModel):
...
class CreateAgentRequestModelSettings_Zai(UniversalBaseModel):
...
CreateAgentRequestModelSettings = typing_extensions.Annotated[
    typing.Union[
