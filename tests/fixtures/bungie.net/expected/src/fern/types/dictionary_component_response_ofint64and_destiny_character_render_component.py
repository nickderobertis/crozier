...
class DictionaryComponentResponseOfint64AndDestinyCharacterRenderComponent(UniversalBaseModel):
    data: typing.Optional[typing.Dict[str, DestinyEntitiesCharactersDestinyCharacterRenderComponent]] = None
