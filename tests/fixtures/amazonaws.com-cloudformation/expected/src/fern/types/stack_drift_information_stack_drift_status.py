...
class StackDriftInformationStackDriftStatus(str, enum.Enum):
    """
    ...
    def visit(
        ...
        if self is StackDriftInformationStackDriftStatus.DRIFTED:
            return drifted()
        if self is StackDriftInformationStackDriftStatus.IN_SYNC:
            return in_sync()
        if self is StackDriftInformationStackDriftStatus.UNKNOWN:
            return unknown()
        if self is StackDriftInformationStackDriftStatus.NOT_CHECKED:
            return not_checked()
