...
class EcommNewOrderPayloadPayloadShippingAddress(UniversalBaseModel):
    """
    The shipping address
    """

    type: typing.Optional[EcommNewOrderPayloadPayloadShippingAddressType] = pydantic.Field(default=None)
    """
    The type of the order address (billing or shipping)
    """

    japan_type: typing_extensions.Annotated[
        typing.Optional[EcommNewOrderPayloadPayloadShippingAddressJapanType],
