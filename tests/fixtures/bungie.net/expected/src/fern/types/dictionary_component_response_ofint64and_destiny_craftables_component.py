...
class DictionaryComponentResponseOfint64AndDestinyCraftablesComponent(UniversalBaseModel):
    data: typing.Optional[typing.Dict[str, DestinyComponentsCraftablesDestinyCraftablesComponent]] = None
