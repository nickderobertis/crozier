...
class DocAnnotationsList200ResponseAnnotationsItemPolylineMeasureRlXItem(UniversalBaseModel):
    unit: str
    conversion: typing.Optional[float] = None
    fraction: typing.Optional[DocAnnotationsList200ResponseAnnotationsItemPolylineMeasureRlXItemFraction] = None
    ...
    label_position: typing_extensions.Annotated[
        typing.Optional[DocAnnotationsList200ResponseAnnotationsItemPolylineMeasureRlXItemLabelPosition],
