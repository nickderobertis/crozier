...
class Destiny2ReportOffensivePostGameCarnageReportPlayerResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[typing.Optional[int], FieldMetadata(alias="Response")] = None
