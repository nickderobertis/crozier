...
class UpdateOrdersResponseBillingAddress(UniversalBaseModel):
    """
    The billing address
    """

    type: typing.Optional[UpdateOrdersResponseBillingAddressType] = pydantic.Field(default=None)
    """
    The type of the order address (billing or shipping)
    """

    japan_type: typing_extensions.Annotated[
        typing.Optional[UpdateOrdersResponseBillingAddressJapanType],
