...
from ...types.tags_models_contracts_tag_response import TagsModelsContractsTagResponse


class ForumGetForumTagSuggestionsResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[typing.List[TagsModelsContractsTagResponse]], FieldMetadata(alias="Response")
    ] = None
