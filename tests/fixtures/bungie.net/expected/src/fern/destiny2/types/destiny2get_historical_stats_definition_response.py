...
from ...types.destiny_historical_stats_definitions_destiny_historical_stats_definition import (
    DestinyHistoricalStatsDefinitionsDestinyHistoricalStatsDefinition,
)


class Destiny2GetHistoricalStatsDefinitionResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[typing.Dict[str, DestinyHistoricalStatsDefinitionsDestinyHistoricalStatsDefinition]],
