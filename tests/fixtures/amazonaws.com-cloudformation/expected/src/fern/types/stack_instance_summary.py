...
class StackInstanceSummary(UniversalBaseModel):
    ...
    status: typing_extensions.Annotated[
        typing.Optional[StackInstanceSummaryStatus],
    ...
    status_reason: typing_extensions.Annotated[
        ...
        pydantic.Field(
            alias="StatusReason",
            description="The explanation for the specific status code assigned to this stack instance.",
        ),
    ] = None
    """
    ...
    stack_instance_status: typing_extensions.Annotated[
        typing.Optional[StackInstanceSummaryStackInstanceStatus],
    ...
    drift_status: typing_extensions.Annotated[
        typing.Optional[StackInstanceSummaryDriftStatus],
