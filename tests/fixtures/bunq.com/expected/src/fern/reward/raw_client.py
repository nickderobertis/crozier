...
class RawRewardClient:
    ...
    def list_all_reward_for_user(
    ...
    ) -> HttpResponse[typing.List[RewardListing]]:
        """
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"user/{encode_path_param(user_id)}/reward",
            method="GET",
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=typing.List[RewardListing],
    ...
    def read_reward_for_user(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"user/{encode_path_param(user_id)}/reward/{encode_path_param(item_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
...
class AsyncRawRewardClient:
    ...
    async def list_all_reward_for_user(
        self, user_id: int, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[typing.List[RewardListing]]:
        """
        Used to view Rewards.
