...
from ...types.groups_v2group_response import GroupsV2GroupResponse


class GroupV2GetGroupByNameV2Response(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[typing.Optional[GroupsV2GroupResponse], FieldMetadata(alias="Response")] = (
        None
    )
