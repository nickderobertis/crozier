...
class DistributionListItemsItemCacheBehaviorsItemsItemLambdaFunctionAssociations(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[
            typing.List[DistributionListItemsItemCacheBehaviorsItemsItemLambdaFunctionAssociationsItemsItem]
        ],
