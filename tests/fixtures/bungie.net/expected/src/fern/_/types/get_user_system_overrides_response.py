...
from ...types.common_models_core_system import CommonModelsCoreSystem


class GetUserSystemOverridesResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[typing.Dict[str, CommonModelsCoreSystem]], FieldMetadata(alias="Response")
    ] = None
