...
class GetrulesforapricetableResponseRulesItemContext(UniversalBaseModel):
    """
    ...
    date_range: typing_extensions.Annotated[
        typing.Optional[GetrulesforapricetableResponseRulesItemContextDateRange],
    ...
    markup_range: typing_extensions.Annotated[
        typing.Optional[GetrulesforapricetableResponseRulesItemContextMarkupRange],
