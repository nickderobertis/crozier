...
class SetTypeConfigurationInput(UniversalBaseModel):
    ...
    configuration: typing_extensions.Annotated[str, FieldMetadata(alias="Configuration")] = pydantic.Field()
    """
    ...
    configuration_alias: typing_extensions.Annotated[
        typing.Optional[str], FieldMetadata(alias="ConfigurationAlias")
    ...
    type: typing_extensions.Annotated[typing.Optional[SetTypeConfigurationInputType], FieldMetadata(alias="Type")] = (
        pydantic.Field(default=None)
    )
    """
