...
class RawServiceOfferingNodeClient:
    ...
    def show_service_offering_node(
    ...
    ) -> HttpResponse[ServiceOfferingNode]:
        """
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"service_offering_nodes/{encode_path_param(id)}",
            method="GET",
            request_options=request_options,
        )
        try:
...
class AsyncRawServiceOfferingNodeClient:
    ...
    async def show_service_offering_node(
        self, id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[ServiceOfferingNode]:
        """
        Returns a ServiceOfferingNode object
