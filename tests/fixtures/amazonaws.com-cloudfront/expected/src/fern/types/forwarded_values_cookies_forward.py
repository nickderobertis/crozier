...
class ForwardedValuesCookiesForward(enum.StrEnum):
    """
    ...
    def visit(
        ...
        if self is ForwardedValuesCookiesForward.NONE:
            return none()
        if self is ForwardedValuesCookiesForward.WHITELIST:
            return whitelist()
        if self is ForwardedValuesCookiesForward.ALL:
            return all_()
