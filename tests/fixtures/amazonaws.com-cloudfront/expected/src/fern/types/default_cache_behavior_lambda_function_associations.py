...
class DefaultCacheBehaviorLambdaFunctionAssociations(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[typing.List[DefaultCacheBehaviorLambdaFunctionAssociationsItemsItem]],
