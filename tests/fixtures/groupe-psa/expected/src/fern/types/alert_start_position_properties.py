...
class AlertStartPositionProperties(CreatedAtField):
    ...
    type: typing.Optional[AlertStartPositionPropertiesType] = None
    fix_status: typing_extensions.Annotated[
        typing.Optional[AlertStartPositionPropertiesFixStatus],
