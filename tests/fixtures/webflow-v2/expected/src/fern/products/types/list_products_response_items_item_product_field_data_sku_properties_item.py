...
class ListProductsResponseItemsItemProductFieldDataSkuPropertiesItem(UniversalBaseModel):
    """
    ...
    enum: typing.List[ListProductsResponseItemsItemProductFieldDataSkuPropertiesItemEnumItem] = pydantic.Field()
    """
