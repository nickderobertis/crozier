...
class UpdateSkuProductsRequestSkuFieldData(UniversalBaseModel):
    """
    ...
    price: UpdateSkuProductsRequestSkuFieldDataPrice = pydantic.Field()
    """
    price of SKU
    """

    compare_at_price: typing_extensions.Annotated[
        typing.Optional[UpdateSkuProductsRequestSkuFieldDataCompareAtPrice],
    ...
    ec_sku_billing_method: typing_extensions.Annotated[
        typing.Optional[UpdateSkuProductsRequestSkuFieldDataEcSkuBillingMethod],
    ...
    ec_sku_subscription_plan: typing_extensions.Annotated[
        typing.Optional[UpdateSkuProductsRequestSkuFieldDataEcSkuSubscriptionPlan],
    ...
    sku_properties: typing_extensions.Annotated[
        typing.Optional[typing.List[UpdateSkuProductsRequestSkuFieldDataSkuPropertiesItem]],
