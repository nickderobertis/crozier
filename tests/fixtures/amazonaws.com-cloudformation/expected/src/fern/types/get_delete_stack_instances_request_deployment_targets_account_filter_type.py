...
class GetDeleteStackInstancesRequestDeploymentTargetsAccountFilterType(str, enum.Enum):
    """
    ...
    def visit(
        ...
        if self is GetDeleteStackInstancesRequestDeploymentTargetsAccountFilterType.NONE:
            return none()
        if self is GetDeleteStackInstancesRequestDeploymentTargetsAccountFilterType.INTERSECTION:
            return intersection()
        if self is GetDeleteStackInstancesRequestDeploymentTargetsAccountFilterType.DIFFERENCE:
            return difference()
        if self is GetDeleteStackInstancesRequestDeploymentTargetsAccountFilterType.UNION:
            return union()
