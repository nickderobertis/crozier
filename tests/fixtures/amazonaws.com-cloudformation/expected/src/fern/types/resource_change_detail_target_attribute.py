...
class ResourceChangeDetailTargetAttribute(str, enum.Enum):
    """
    ...
    def visit(
        ...
        if self is ResourceChangeDetailTargetAttribute.PROPERTIES:
            return properties()
        if self is ResourceChangeDetailTargetAttribute.METADATA:
            return metadata()
        if self is ResourceChangeDetailTargetAttribute.CREATION_POLICY:
            return creation_policy()
        if self is ResourceChangeDetailTargetAttribute.UPDATE_POLICY:
            return update_policy()
        if self is ResourceChangeDetailTargetAttribute.DELETION_POLICY:
            return deletion_policy()
        if self is ResourceChangeDetailTargetAttribute.TAGS:
            return tags()
