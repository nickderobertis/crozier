...
class DistributionDistributionConfigCustomErrorResponses(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[typing.List[DistributionDistributionConfigCustomErrorResponsesItemsItem]],
