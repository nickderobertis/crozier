...
from ...types.destiny_destiny_equip_item_results import DestinyDestinyEquipItemResults


class Destiny2EquipItemsResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[DestinyDestinyEquipItemResults], FieldMetadata(alias="Response")
    ] = None
