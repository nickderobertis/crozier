...
class UpdateProductsRequestProductFieldDataSkuPropertiesItem(UniversalBaseModel):
    """
    ...
    enum: typing.List[UpdateProductsRequestProductFieldDataSkuPropertiesItemEnumItem] = pydantic.Field()
    """
