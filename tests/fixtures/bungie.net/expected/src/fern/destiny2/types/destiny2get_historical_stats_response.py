...
from ...types.destiny_historical_stats_destiny_historical_stats_by_period import (
    DestinyHistoricalStatsDestinyHistoricalStatsByPeriod,
)


class Destiny2GetHistoricalStatsResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[typing.Dict[str, DestinyHistoricalStatsDestinyHistoricalStatsByPeriod]],
