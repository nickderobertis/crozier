...
from ...types.forum_post_search_response import ForumPostSearchResponse


class ForumGetPostAndParentAwaitingApprovalResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[typing.Optional[ForumPostSearchResponse], FieldMetadata(alias="Response")] = (
        None
    )
