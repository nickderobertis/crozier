...
class ListTypeVersionsInput(UniversalBaseModel):
    type: typing_extensions.Annotated[typing.Optional[ListTypeVersionsInputType], FieldMetadata(alias="Type")] = (
    ...
    deprecated_status: typing_extensions.Annotated[
        typing.Optional[ListTypeVersionsInputDeprecatedStatus], FieldMetadata(alias="DeprecatedStatus")
    ] = pydantic.Field(default=None)
    """
