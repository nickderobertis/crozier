...
class CreateDistributionWithTagsRequestDistributionConfigWithTagsTags(UniversalBaseModel):
    """
    A complex type that contains zero or more <code>Tag</code> elements.
    """

    items: typing_extensions.Annotated[
        typing.Optional[typing.List[CreateDistributionWithTagsRequestDistributionConfigWithTagsTagsItemsItem]],
