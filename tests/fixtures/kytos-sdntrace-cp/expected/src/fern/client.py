...
class FernApi:
    ...
    def trace_a_path(
        ...
        *,
        ...
        client.trace_a_path()
        """
        _response = self._raw_client.trace_a_path(trace=trace, request_options=request_options)
    ...
    def trace_paths_given_switches(
        ...
        *,
        ...
        client.trace_paths_given_switches(
            request=[PutV1TracesRequestItem()],
        )
        """
        _response = self._raw_client.trace_paths_given_switches(request=request, request_options=request_options)
        return _response.data
...
class AsyncFernApi:
    ...
    async def trace_a_path(
        ...
        *,
        ...
        async def main() -> None:
            await client.trace_a_path()


        asyncio.run(main())
        """
        _response = await self._raw_client.trace_a_path(trace=trace, request_options=request_options)
        return _response.data
    ...
    async def trace_paths_given_switches(
        ...
        *,
        ...
        from fern import AsyncFernApi, PutV1TracesRequestItem

        client = AsyncFernApi()


        async def main() -> None:
            await client.trace_paths_given_switches(
                request=[PutV1TracesRequestItem()],
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.trace_paths_given_switches(request=request, request_options=request_options)
        return _response.data
