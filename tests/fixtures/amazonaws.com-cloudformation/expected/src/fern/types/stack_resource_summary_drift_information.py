...
class StackResourceSummaryDriftInformation(UniversalBaseModel):
    """
    ...
    stack_resource_drift_status: typing_extensions.Annotated[
        StackResourceSummaryDriftInformationStackResourceDriftStatus, FieldMetadata(alias="StackResourceDriftStatus")
    ] = pydantic.Field()
    """
