...
class RawDocClient:
    ...
    def head(
        ...
        *,
    ...
    ) -> HttpResponse[DocHead200Response]:
        """
        Parameters
        ----------
        doc_id : str
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"v1/docs/{encode_path_param(doc_id)}/head",
            method="GET",
            headers={
    ...
    def download(
        ...
        *,
        ...
        with self._client_wrapper.httpx_client.stream(
            f"v1/docs/{encode_path_param(doc_id)}/layers/{encode_path_param(layer_name)}/download",
            method="GET",
            headers={
                "X-Document-Password": str(document_password) if document_password is not None else None,
            },
    ...
    def manifest(
        ...
        *,
        document_password: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[DocManifest200Response]:
        """
        Parameters
        ----------
        doc_id : str
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/docs/{encode_path_param(doc_id)}/layers/{encode_path_param(layer_name)}/manifest",
            method="GET",
            headers={
                "X-Document-Password": str(document_password) if document_password is not None else None,
            },
    ...
    def render(
        ...
        *,
        ...
        """
        with self._client_wrapper.httpx_client.stream(
            f"v1/docs/{encode_path_param(doc_id)}/layers/{encode_path_param(layer_name)}/render/pages/{encode_path_param(page_key)}/data",
            method="GET",
            headers={
                "X-Document-Password": str(document_password) if document_password is not None else None,
            },
    ...
    def text(
        ...
        *,
        document_password: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[DocText200Response]:
        """
        Parameters
        ----------
        doc_id : str
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/docs/{encode_path_param(doc_id)}/layers/{encode_path_param(layer_name)}/text/pages/{encode_path_param(page_key)}/data",
            method="GET",
            headers={
                "X-Document-Password": str(document_password) if document_password is not None else None,
            },
...
class AsyncRawDocClient:
    ...
    async def head(
        ...
        *,
        document_password: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[DocHead200Response]:
        """
        Parameters
        ----------
        doc_id : str
    ...
    async def manifest(
        ...
        *,
        document_password: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[DocManifest200Response]:
        """
        Parameters
        ----------
        doc_id : str
    ...
    async def text(
        ...
        *,
        document_password: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[DocText200Response]:
        """
        Parameters
        ----------
        doc_id : str
