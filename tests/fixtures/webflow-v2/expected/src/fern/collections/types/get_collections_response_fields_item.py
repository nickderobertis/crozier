...
class GetCollectionsResponseFieldsItem(UniversalBaseModel):
    """
    ...
    type: GetCollectionsResponseFieldsItemType = pydantic.Field()
    """
    ...
    validations: typing.Optional[GetCollectionsResponseFieldsItemValidations] = pydantic.Field(default=None)
    """
