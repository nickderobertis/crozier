...
class DistributionSummaryListItemDefaultCacheBehaviorViewerProtocolPolicy(enum.StrEnum):
    """
    ...
    def visit(
        ...
        if self is DistributionSummaryListItemDefaultCacheBehaviorViewerProtocolPolicy.ALLOW_ALL:
            return allow_all()
        if self is DistributionSummaryListItemDefaultCacheBehaviorViewerProtocolPolicy.HTTPS_ONLY:
            return https_only()
        if self is DistributionSummaryListItemDefaultCacheBehaviorViewerProtocolPolicy.REDIRECT_TO_HTTPS:
