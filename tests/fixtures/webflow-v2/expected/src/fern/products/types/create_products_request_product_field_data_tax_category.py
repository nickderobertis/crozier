...
class CreateProductsRequestProductFieldDataTaxCategory(enum.StrEnum):
    """
    Product tax class
    """
    ...
    def visit(
        ...
        if self is CreateProductsRequestProductFieldDataTaxCategory.STANDARD_TAXABLE:
            return standard_taxable()
        if self is CreateProductsRequestProductFieldDataTaxCategory.STANDARD_EXEMPT:
            return standard_exempt()
        if self is CreateProductsRequestProductFieldDataTaxCategory.BOOKS_RELIGIOUS:
            return books_religious()
        if self is CreateProductsRequestProductFieldDataTaxCategory.BOOKS_TEXTBOOK:
            return books_textbook()
        if self is CreateProductsRequestProductFieldDataTaxCategory.CLOTHING:
            return clothing()
        if self is CreateProductsRequestProductFieldDataTaxCategory.CLOTHING_SWIMWEAR:
            return clothing_swimwear()
        if self is CreateProductsRequestProductFieldDataTaxCategory.DIGITAL_GOODS:
            return digital_goods()
        if self is CreateProductsRequestProductFieldDataTaxCategory.DIGITAL_SERVICE:
            return digital_service()
        if self is CreateProductsRequestProductFieldDataTaxCategory.DRUGS_NON_PRESCRIPTION:
            return drugs_non_prescription()
        if self is CreateProductsRequestProductFieldDataTaxCategory.DRUGS_PRESCRIPTION:
            return drugs_prescription()
        if self is CreateProductsRequestProductFieldDataTaxCategory.FOOD_BOTTLED_WATER:
            return food_bottled_water()
        if self is CreateProductsRequestProductFieldDataTaxCategory.FOOD_CANDY:
            return food_candy()
        if self is CreateProductsRequestProductFieldDataTaxCategory.FOOD_GROCERIES:
            return food_groceries()
        if self is CreateProductsRequestProductFieldDataTaxCategory.FOOD_PREPARED:
            return food_prepared()
        if self is CreateProductsRequestProductFieldDataTaxCategory.FOOD_SODA:
            return food_soda()
        if self is CreateProductsRequestProductFieldDataTaxCategory.FOOD_SUPPLEMENTS:
            return food_supplements()
        if self is CreateProductsRequestProductFieldDataTaxCategory.MAGAZINE_INDIVIDUAL:
            return magazine_individual()
        if self is CreateProductsRequestProductFieldDataTaxCategory.MAGAZINE_SUBSCRIPTION:
            return magazine_subscription()
        if self is CreateProductsRequestProductFieldDataTaxCategory.SERVICE_ADMISSION:
            return service_admission()
        if self is CreateProductsRequestProductFieldDataTaxCategory.SERVICE_ADVERTISING:
            return service_advertising()
        if self is CreateProductsRequestProductFieldDataTaxCategory.SERVICE_DRY_CLEANING:
            return service_dry_cleaning()
        if self is CreateProductsRequestProductFieldDataTaxCategory.SERVICE_HAIRDRESSING:
            return service_hairdressing()
        if self is CreateProductsRequestProductFieldDataTaxCategory.SERVICE_INSTALLATION:
            return service_installation()
        if self is CreateProductsRequestProductFieldDataTaxCategory.SERVICE_MISCELLANEOUS:
            return service_miscellaneous()
        if self is CreateProductsRequestProductFieldDataTaxCategory.SERVICE_PARKING:
            return service_parking()
        if self is CreateProductsRequestProductFieldDataTaxCategory.SERVICE_PRINTING:
            return service_printing()
        if self is CreateProductsRequestProductFieldDataTaxCategory.SERVICE_PROFESSIONAL:
            return service_professional()
        if self is CreateProductsRequestProductFieldDataTaxCategory.SERVICE_REPAIR:
            return service_repair()
        if self is CreateProductsRequestProductFieldDataTaxCategory.SERVICE_TRAINING:
