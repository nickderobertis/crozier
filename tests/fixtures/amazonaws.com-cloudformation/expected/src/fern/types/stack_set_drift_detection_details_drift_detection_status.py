...
class StackSetDriftDetectionDetailsDriftDetectionStatus(str, enum.Enum):
    """
    ...
    def visit(
        ...
        if self is StackSetDriftDetectionDetailsDriftDetectionStatus.COMPLETED:
            return completed()
        if self is StackSetDriftDetectionDetailsDriftDetectionStatus.FAILED:
            return failed()
        if self is StackSetDriftDetectionDetailsDriftDetectionStatus.PARTIAL_SUCCESS:
            return partial_success()
        if self is StackSetDriftDetectionDetailsDriftDetectionStatus.IN_PROGRESS:
            return in_progress()
        if self is StackSetDriftDetectionDetailsDriftDetectionStatus.STOPPED:
            return stopped()
