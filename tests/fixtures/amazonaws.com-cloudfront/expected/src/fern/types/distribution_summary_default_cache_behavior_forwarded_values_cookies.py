...
class DistributionSummaryDefaultCacheBehaviorForwardedValuesCookies(UniversalBaseModel):
    """
    ...
    whitelisted_names: typing_extensions.Annotated[
        typing.Optional[DistributionSummaryDefaultCacheBehaviorForwardedValuesCookiesWhitelistedNames],
