...
class UpdateStackSetInput(UniversalBaseModel):
    ...
    operation_preferences: typing_extensions.Annotated[
        typing.Optional[UpdateStackSetInputOperationPreferences], FieldMetadata(alias="OperationPreferences")
    ] = pydantic.Field(default=None)
    """
    ...
    deployment_targets: typing_extensions.Annotated[
        typing.Optional[UpdateStackSetInputDeploymentTargets], FieldMetadata(alias="DeploymentTargets")
    ] = pydantic.Field(default=None)
    """
    ...
    permission_model: typing_extensions.Annotated[
        typing.Optional[UpdateStackSetInputPermissionModel], FieldMetadata(alias="PermissionModel")
    ] = pydantic.Field(default=None)
    """
    ...
    auto_deployment: typing_extensions.Annotated[
        typing.Optional[UpdateStackSetInputAutoDeployment], FieldMetadata(alias="AutoDeployment")
    ] = pydantic.Field(default=None)
    """
    ...
    regions: typing_extensions.Annotated[typing.Optional[typing.List[Region]], FieldMetadata(alias="Regions")] = (
        pydantic.Field(default=None)
    )
    """
    ...
    call_as: typing_extensions.Annotated[typing.Optional[UpdateStackSetInputCallAs], FieldMetadata(alias="CallAs")] = (
        pydantic.Field(default=None)
    )
    """
    ...
    managed_execution: typing_extensions.Annotated[
        typing.Optional[UpdateStackSetInputManagedExecution], FieldMetadata(alias="ManagedExecution")
    ] = pydantic.Field(default=None)
    """
