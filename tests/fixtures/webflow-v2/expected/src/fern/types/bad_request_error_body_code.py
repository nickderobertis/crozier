...
class BadRequestErrorBodyCode(enum.StrEnum):
    ...
    def visit(
        ...
        if self is BadRequestErrorBodyCode.ANALYZE_FILTER_CONFLICT:
            return analyze_filter_conflict()
        if self is BadRequestErrorBodyCode.ANALYZE_INPUT_VALIDATION:
            return analyze_input_validation()
        if self is BadRequestErrorBodyCode.ANALYZE_UNSUPPORTED_FILTER:
            return analyze_unsupported_filter()
        if self is BadRequestErrorBodyCode.BAD_REQUEST:
            return bad_request()
        if self is BadRequestErrorBodyCode.BEFORE_HISTORICAL_FLOOR:
            return before_historical_floor()
        if self is BadRequestErrorBodyCode.COLLECTION_NOT_FOUND:
            return collection_not_found()
        if self is BadRequestErrorBodyCode.CONFLICT:
            return conflict()
        if self is BadRequestErrorBodyCode.DUPLICATE_COLLECTION:
            return duplicate_collection()
        if self is BadRequestErrorBodyCode.DUPLICATE_USER_EMAIL:
            return duplicate_user_email()
        if self is BadRequestErrorBodyCode.ECOMMERCE_NOT_ENABLED:
            return ecommerce_not_enabled()
        if self is BadRequestErrorBodyCode.FORBIDDEN:
            return forbidden()
        if self is BadRequestErrorBodyCode.FORMS_REQUIRE_REPUBLISH:
            return forms_require_republish()
        if self is BadRequestErrorBodyCode.INCOMPATIBLE_WEBHOOK_FILTER:
            return incompatible_webhook_filter()
        if self is BadRequestErrorBodyCode.INTERNAL_ERROR:
            return internal_error()
        if self is BadRequestErrorBodyCode.INVALID_AUTH_VERSION:
            return invalid_auth_version()
        if self is BadRequestErrorBodyCode.INVALID_CREDENTIALS:
            return invalid_credentials()
        if self is BadRequestErrorBodyCode.INVALID_DOMAIN:
            return invalid_domain()
        if self is BadRequestErrorBodyCode.INVALID_TIME_RANGE:
            return invalid_time_range()
        if self is BadRequestErrorBodyCode.INVALID_USER_EMAIL:
            return invalid_user_email()
        if self is BadRequestErrorBodyCode.ITEM_NOT_FOUND:
            return item_not_found()
        if self is BadRequestErrorBodyCode.MISSING_SCOPES:
            return missing_scopes()
        if self is BadRequestErrorBodyCode.NO_DOMAINS:
            return no_domains()
        if self is BadRequestErrorBodyCode.NOT_AUTHORIZED:
            return not_authorized()
        if self is BadRequestErrorBodyCode.NOT_ENTERPRISE_PLAN_SITE:
            return not_enterprise_plan_site()
        if self is BadRequestErrorBodyCode.NOT_ENTERPRISE_PLAN_WORKSPACE:
            return not_enterprise_plan_workspace()
        if self is BadRequestErrorBodyCode.ORDER_NOT_FOUND:
            return order_not_found()
        if self is BadRequestErrorBodyCode.RESOURCE_NOT_FOUND:
            return resource_not_found()
        if self is BadRequestErrorBodyCode.SERVICE_UNAVAILABLE:
            return service_unavailable()
        if self is BadRequestErrorBodyCode.TIME_RANGE_TOO_WIDE:
            return time_range_too_wide()
        if self is BadRequestErrorBodyCode.TOO_MANY_REQUESTS:
            return too_many_requests()
        if self is BadRequestErrorBodyCode.UNSUPPORTED_VERSION:
            return unsupported_version()
        if self is BadRequestErrorBodyCode.UNSUPPORTED_WEBHOOK_TRIGGER_TYPE:
            return unsupported_webhook_trigger_type()
        if self is BadRequestErrorBodyCode.USER_LIMIT_REACHED:
            return user_limit_reached()
        if self is BadRequestErrorBodyCode.USER_NOT_FOUND:
            return user_not_found()
        if self is BadRequestErrorBodyCode.USERS_NOT_ENABLED:
