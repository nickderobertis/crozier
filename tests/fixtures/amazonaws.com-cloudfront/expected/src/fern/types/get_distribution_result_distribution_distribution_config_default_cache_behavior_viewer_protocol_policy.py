...
class GetDistributionResultDistributionDistributionConfigDefaultCacheBehaviorViewerProtocolPolicy(enum.StrEnum):
    """
    ...
    def visit(
        ...
        if (
            self
            is GetDistributionResultDistributionDistributionConfigDefaultCacheBehaviorViewerProtocolPolicy.ALLOW_ALL
        ):
            return allow_all()
        if (
            self
            is GetDistributionResultDistributionDistributionConfigDefaultCacheBehaviorViewerProtocolPolicy.HTTPS_ONLY
        ):
            return https_only()
        if (
            self
            is GetDistributionResultDistributionDistributionConfigDefaultCacheBehaviorViewerProtocolPolicy.REDIRECT_TO_HTTPS
        ):
