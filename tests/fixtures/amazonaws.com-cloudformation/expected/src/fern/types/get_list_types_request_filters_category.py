...
class GetListTypesRequestFiltersCategory(str, enum.Enum):
    """
    ...
    def visit(
        ...
        if self is GetListTypesRequestFiltersCategory.REGISTERED:
            return registered()
        if self is GetListTypesRequestFiltersCategory.ACTIVATED:
            return activated()
        if self is GetListTypesRequestFiltersCategory.THIRD_PARTY:
            return third_party()
        if self is GetListTypesRequestFiltersCategory.AWS_TYPES:
            return aws_types()
