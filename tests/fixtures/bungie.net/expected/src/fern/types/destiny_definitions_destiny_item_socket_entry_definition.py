...
class DestinyDefinitionsDestinyItemSocketEntryDefinition(UniversalBaseModel):
    ...
    hide_perks_in_item_tooltip: typing_extensions.Annotated[
        typing.Optional[bool],
        FieldMetadata(alias="hidePerksInItemTooltip"),
        pydantic.Field(
            alias="hidePerksInItemTooltip",
    ...
    plug_sources: typing_extensions.Annotated[
        typing.Optional[int],
        FieldMetadata(alias="plugSources"),
        pydantic.Field(
            alias="plugSources",
    ...
    prevent_initialization_on_vendor_purchase: typing_extensions.Annotated[
        typing.Optional[bool],
        FieldMetadata(alias="preventInitializationOnVendorPurchase"),
        pydantic.Field(
            alias="preventInitializationOnVendorPurchase",
    ...
    randomized_plug_set_hash: typing_extensions.Annotated[
        typing.Optional[int],
        FieldMetadata(alias="randomizedPlugSetHash"),
        pydantic.Field(
            alias="randomizedPlugSetHash",
    ...
    reusable_plug_set_hash: typing_extensions.Annotated[
        typing.Optional[int],
        FieldMetadata(alias="reusablePlugSetHash"),
        pydantic.Field(
            alias="reusablePlugSetHash",
    ...
    single_initial_item_hash: typing_extensions.Annotated[
        typing.Optional[int],
        FieldMetadata(alias="singleInitialItemHash"),
        pydantic.Field(
            alias="singleInitialItemHash",
