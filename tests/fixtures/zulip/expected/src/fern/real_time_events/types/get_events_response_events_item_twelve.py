...
class GetEventsResponseEventsItemTwelve(UniversalBaseModel):
    """
    ...
    **Changes**: Before Zulip 8.0 (feature level 232), the
    ...
    type: typing.Optional[GetEventsResponseEventsItemTwelveType] = pydantic.Field(default=None)
    """
    The event's type, relevant both for client-side dispatch and server-side
    filtering by event type in [POST /register](/api/register-queue).
    """

    op: typing.Optional[GetEventsResponseEventsItemTwelveOp] = None
