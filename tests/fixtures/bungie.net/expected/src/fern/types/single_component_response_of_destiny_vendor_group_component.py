...
class SingleComponentResponseOfDestinyVendorGroupComponent(UniversalBaseModel):
    data: typing.Optional[DestinyComponentsVendorsDestinyVendorGroupComponent] = None
