...
class PowerPortTemplateTypeLabel(str, enum.Enum):
    C6 = "C6"
    C8 = "C8"
    C14 = "C14"
    C16 = "C16"
    ...
    def visit(
        ...
        if self is PowerPortTemplateTypeLabel.C6:
            return c6()
        if self is PowerPortTemplateTypeLabel.C8:
            return c8()
        if self is PowerPortTemplateTypeLabel.C14:
            return c14()
        if self is PowerPortTemplateTypeLabel.C16:
            return c16()
        if self is PowerPortTemplateTypeLabel.C20:
            return c20()
        if self is PowerPortTemplateTypeLabel.C22:
            return c22()
        if self is PowerPortTemplateTypeLabel.PNE4H:
            return pne4h()
        if self is PowerPortTemplateTypeLabel.PNE6H:
            return pne6h()
        if self is PowerPortTemplateTypeLabel.PNE9H:
            return pne9h()
        if self is PowerPortTemplateTypeLabel.TWO_PE4H:
            return two_pe4h()
        if self is PowerPortTemplateTypeLabel.TWO_PE6H:
            return two_pe6h()
        if self is PowerPortTemplateTypeLabel.TWO_PE9H:
            return two_pe9h()
        if self is PowerPortTemplateTypeLabel.THREE_PE4H:
            return three_pe4h()
        if self is PowerPortTemplateTypeLabel.THREE_PE6H:
            return three_pe6h()
        if self is PowerPortTemplateTypeLabel.THREE_PE9H:
            return three_pe9h()
        if self is PowerPortTemplateTypeLabel.THREE_PNE4H:
            return three_pne4h()
        if self is PowerPortTemplateTypeLabel.THREE_PNE6H:
            return three_pne6h()
        if self is PowerPortTemplateTypeLabel.THREE_PNE9H:
            return three_pne9h()
        if self is PowerPortTemplateTypeLabel.NEMA115P:
            return nema115p()
        if self is PowerPortTemplateTypeLabel.NEMA515P:
            return nema515p()
        if self is PowerPortTemplateTypeLabel.NEMA520P:
            return nema520p()
        if self is PowerPortTemplateTypeLabel.NEMA530P:
            return nema530p()
        if self is PowerPortTemplateTypeLabel.NEMA550P:
            return nema550p()
        if self is PowerPortTemplateTypeLabel.NEMA615P:
            return nema615p()
        if self is PowerPortTemplateTypeLabel.NEMA620P:
            return nema620p()
        if self is PowerPortTemplateTypeLabel.NEMA630P:
            return nema630p()
        if self is PowerPortTemplateTypeLabel.NEMA650P:
            return nema650p()
        if self is PowerPortTemplateTypeLabel.NEMA1030P:
            return nema1030p()
        if self is PowerPortTemplateTypeLabel.NEMA1050P:
            return nema1050p()
        if self is PowerPortTemplateTypeLabel.NEMA1420P:
            return nema1420p()
        if self is PowerPortTemplateTypeLabel.NEMA1430P:
            return nema1430p()
        if self is PowerPortTemplateTypeLabel.NEMA1450P:
            return nema1450p()
        if self is PowerPortTemplateTypeLabel.NEMA1460P:
            return nema1460p()
        if self is PowerPortTemplateTypeLabel.NEMA1515P:
            return nema1515p()
        if self is PowerPortTemplateTypeLabel.NEMA1520P:
            return nema1520p()
        if self is PowerPortTemplateTypeLabel.NEMA1530P:
            return nema1530p()
        if self is PowerPortTemplateTypeLabel.NEMA1550P:
            return nema1550p()
        if self is PowerPortTemplateTypeLabel.NEMA1560P:
            return nema1560p()
        if self is PowerPortTemplateTypeLabel.NEMA_L115P:
            return nema_l115p()
        if self is PowerPortTemplateTypeLabel.NEMA_L515P:
            return nema_l515p()
        if self is PowerPortTemplateTypeLabel.NEMA_L520P:
            return nema_l520p()
        if self is PowerPortTemplateTypeLabel.NEMA_L530P:
            return nema_l530p()
        if self is PowerPortTemplateTypeLabel.NEMA_L550P:
            return nema_l550p()
        if self is PowerPortTemplateTypeLabel.NEMA_L615P:
            return nema_l615p()
        if self is PowerPortTemplateTypeLabel.NEMA_L620P:
            return nema_l620p()
        if self is PowerPortTemplateTypeLabel.NEMA_L630P:
            return nema_l630p()
        if self is PowerPortTemplateTypeLabel.NEMA_L650P:
            return nema_l650p()
        if self is PowerPortTemplateTypeLabel.NEMA_L1030P:
            return nema_l1030p()
        if self is PowerPortTemplateTypeLabel.NEMA_L1420P:
            return nema_l1420p()
        if self is PowerPortTemplateTypeLabel.NEMA_L1430P:
            return nema_l1430p()
        if self is PowerPortTemplateTypeLabel.NEMA_L1450P:
            return nema_l1450p()
        if self is PowerPortTemplateTypeLabel.NEMA_L1460P:
            return nema_l1460p()
        if self is PowerPortTemplateTypeLabel.NEMA_L1520P:
            return nema_l1520p()
        if self is PowerPortTemplateTypeLabel.NEMA_L1530P:
            return nema_l1530p()
        if self is PowerPortTemplateTypeLabel.NEMA_L1550P:
            return nema_l1550p()
        if self is PowerPortTemplateTypeLabel.NEMA_L1560P:
            return nema_l1560p()
        if self is PowerPortTemplateTypeLabel.NEMA_L2120P:
            return nema_l2120p()
        if self is PowerPortTemplateTypeLabel.NEMA_L2130P:
            return nema_l2130p()
        if self is PowerPortTemplateTypeLabel.NEMA_L2230P:
            return nema_l2230p()
        if self is PowerPortTemplateTypeLabel.CS6361C:
            return cs6361c()
        if self is PowerPortTemplateTypeLabel.CS6365C:
            return cs6365c()
        if self is PowerPortTemplateTypeLabel.CS8165C:
            return cs8165c()
        if self is PowerPortTemplateTypeLabel.CS8265C:
            return cs8265c()
        if self is PowerPortTemplateTypeLabel.CS8365C:
            return cs8365c()
        if self is PowerPortTemplateTypeLabel.CS8465C:
            return cs8465c()
        if self is PowerPortTemplateTypeLabel.ITA_TYPE_C_CEE716:
            return ita_type_c_cee716()
        if self is PowerPortTemplateTypeLabel.ITA_TYPE_E_CEE76:
            return ita_type_e_cee76()
        if self is PowerPortTemplateTypeLabel.ITA_TYPE_F_CEE74:
            return ita_type_f_cee74()
        if self is PowerPortTemplateTypeLabel.ITA_TYPE_EF_CEE77:
            return ita_type_ef_cee77()
        if self is PowerPortTemplateTypeLabel.ITA_TYPE_G_BS1363:
            return ita_type_g_bs1363()
        if self is PowerPortTemplateTypeLabel.ITA_TYPE_H:
            return ita_type_h()
        if self is PowerPortTemplateTypeLabel.ITA_TYPE_I:
            return ita_type_i()
        if self is PowerPortTemplateTypeLabel.ITA_TYPE_J:
            return ita_type_j()
        if self is PowerPortTemplateTypeLabel.ITA_TYPE_K:
            return ita_type_k()
        if self is PowerPortTemplateTypeLabel.ITA_TYPE_L_CEI2350:
            return ita_type_l_cei2350()
        if self is PowerPortTemplateTypeLabel.ITA_TYPE_M_BS546:
            return ita_type_m_bs546()
        if self is PowerPortTemplateTypeLabel.ITA_TYPE_N:
            return ita_type_n()
        if self is PowerPortTemplateTypeLabel.ITA_TYPE_O:
            return ita_type_o()
        if self is PowerPortTemplateTypeLabel.USB_TYPE_A:
            return usb_type_a()
        if self is PowerPortTemplateTypeLabel.USB_TYPE_B:
            return usb_type_b()
        if self is PowerPortTemplateTypeLabel.USB_TYPE_C:
            return usb_type_c()
        if self is PowerPortTemplateTypeLabel.USB_MINI_A:
            return usb_mini_a()
        if self is PowerPortTemplateTypeLabel.USB_MINI_B:
            return usb_mini_b()
        if self is PowerPortTemplateTypeLabel.USB_MICRO_A:
            return usb_micro_a()
        if self is PowerPortTemplateTypeLabel.USB_MICRO_B:
            return usb_micro_b()
        if self is PowerPortTemplateTypeLabel.USB_MICRO_AB:
            return usb_micro_ab()
        if self is PowerPortTemplateTypeLabel.USB30TYPE_B:
            return usb30type_b()
        if self is PowerPortTemplateTypeLabel.USB30MICRO_B:
            return usb30micro_b()
        if self is PowerPortTemplateTypeLabel.DC_TERMINAL:
            return dc_terminal()
        if self is PowerPortTemplateTypeLabel.SAF_D_GRID:
            return saf_d_grid()
        if self is PowerPortTemplateTypeLabel.NEUTRIK_POWER_CON20A:
            return neutrik_power_con20a()
        if self is PowerPortTemplateTypeLabel.NEUTRIK_POWER_CON32A:
            return neutrik_power_con32a()
        if self is PowerPortTemplateTypeLabel.NEUTRIK_POWER_CON_TRUE1:
            return neutrik_power_con_true1()
        if self is PowerPortTemplateTypeLabel.NEUTRIK_POWER_CON_TRUE1TOP:
            return neutrik_power_con_true1top()
        if self is PowerPortTemplateTypeLabel.UBIQUITI_SMART_POWER:
            return ubiquiti_smart_power()
        if self is PowerPortTemplateTypeLabel.HARDWIRED:
            return hardwired()
        if self is PowerPortTemplateTypeLabel.OTHER:
            return other()
