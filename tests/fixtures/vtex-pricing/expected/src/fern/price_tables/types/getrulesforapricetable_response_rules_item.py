...
class GetrulesforapricetableResponseRulesItem(UniversalBaseModel):
    """
    Object containing a price table rule.
    """

    context: typing.Optional[GetrulesforapricetableResponseRulesItemContext] = pydantic.Field(default=None)
    """
