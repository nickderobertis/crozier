...
from .post_oauth_client_request_request_auth_context_refs_item import PostOauthClientRequestRequestAuthContextRefsItem
...
class PostOauthClientRequestRequest(UniversalBaseModel):
    ...
    auth_context_refs: typing_extensions.Annotated[
        typing.List[PostOauthClientRequestRequestAuthContextRefsItem],
    ...
    user_claims: typing_extensions.Annotated[
        typing.List[PostOauthClientRequestRequestUserClaimsItem],
    ...
    grant_types: typing_extensions.Annotated[
        typing.List[PostOauthClientRequestRequestGrantTypesItem],
    ...
    client_auth_methods: typing_extensions.Annotated[
        typing.List[PostOauthClientRequestRequestClientAuthMethodsItem],
