...
from ..types.get_hris_job_response import GetHrisJobResponse
from ..types.get_hris_jobs_response import GetHrisJobsResponse
...
class RawJobsClient:
    ...
    ) -> HttpResponse[GetHrisJobsResponse]:
        """
    ...
    def one(
        ...
        *,
        ...
        fields: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[GetHrisJobResponse]:
        """
        A Job for employee.
...
class AsyncRawJobsClient:
    ...
    async def all_(
        ...
        *,
        ...
        fields: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[GetHrisJobsResponse]:
        """
        List Jobs for employee.
    ...
    async def one(
        ...
        *,
        ...
        fields: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[GetHrisJobResponse]:
        """
        A Job for employee.
