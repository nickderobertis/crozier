...
class StackSetDriftDetectionDetailsDriftStatus(str, enum.Enum):
    """
    ...
    def visit(
        ...
        if self is StackSetDriftDetectionDetailsDriftStatus.DRIFTED:
            return drifted()
        if self is StackSetDriftDetectionDetailsDriftStatus.IN_SYNC:
            return in_sync()
        if self is StackSetDriftDetectionDetailsDriftStatus.NOT_CHECKED:
            return not_checked()
