...
class CreateDistributionRequestDistributionConfigOriginsItemsItemCustomHeaders(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[typing.List[CreateDistributionRequestDistributionConfigOriginsItemsItemCustomHeadersItemsItem]],
