...
class DestinyEntitiesItemsDestinyItemInstanceComponent(UniversalBaseModel):
    ...
    can_equip: typing_extensions.Annotated[
        typing.Optional[bool],
        FieldMetadata(alias="canEquip"),
        pydantic.Field(
            alias="canEquip",
    ...
    cannot_equip_reason: typing_extensions.Annotated[
        typing.Optional[int],
        FieldMetadata(alias="cannotEquipReason"),
        pydantic.Field(
            alias="cannotEquipReason",
    ...
    damage_type: typing_extensions.Annotated[
        ...
        pydantic.Field(
            alias="damageType", description="If the item has a damage type, this is the item's current damage type."
        ),
    ] = None
    """
    ...
    equip_required_level: typing_extensions.Annotated[
        typing.Optional[int],
        FieldMetadata(alias="equipRequiredLevel"),
        pydantic.Field(
            alias="equipRequiredLevel",
    ...
    is_equipped: typing_extensions.Annotated[
        typing.Optional[bool],
        FieldMetadata(alias="isEquipped"),
        pydantic.Field(alias="isEquipped", description="Is the item currently equipped on the given character?"),
    ] = None
    """
    Is the item currently equipped on the given character?
    """

    item_level: typing_extensions.Annotated[
        typing.Optional[int],
        FieldMetadata(alias="itemLevel"),
        pydantic.Field(
            alias="itemLevel",
    ...
    primary_stat: typing_extensions.Annotated[
        typing.Optional[DestinyDestinyStat],
        FieldMetadata(alias="primaryStat"),
        pydantic.Field(
            alias="primaryStat",
    ...
    unlock_hashes_required_to_equip: typing_extensions.Annotated[
        ...
        FieldMetadata(alias="unlockHashesRequiredToEquip"),
        pydantic.Field(
            alias="unlockHashesRequiredToEquip",
