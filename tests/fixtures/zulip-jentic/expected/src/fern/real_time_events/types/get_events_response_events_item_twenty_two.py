...
class GetEventsResponseEventsItemTwentyTwo(UniversalBaseModel):
    """
    Event sent to a user's clients when they [register a device](/api/register-client-device).
    ...
    **Changes**: New in Zulip 12.0 (feature level 468).
    ...
    type: typing.Optional[GetEventsResponseEventsItemTwentyTwoType] = pydantic.Field(default=None)
    """
    The event's type, relevant both for client-side dispatch and server-side
    filtering by event type in [POST /register](/api/register-queue).
    """

    op: typing.Optional[GetEventsResponseEventsItemTwentyTwoOp] = None
