...
_dynamic_imports: typing.Dict[str, str] = {
    "CreateWebhookRequestHttpHeadersItem": ".types",
    "CreateWebhookResponse": ".types",
    "ListWebhookEventsResponse": ".types",
    "ListWebhookEventsResponseEventsItem": ".types",
    "ListWebhookEventsResponseEventsItemDeliveryStatus": ".types",
    "ListWebhookEventsResponseEventsItemEventType": ".types",
    "ListWebhooksResponse": ".types",
    "ListWebhooksResponseWebhooksItem": ".types",
    "ListWebhooksResponseWebhooksItemHttpHeadersItem": ".types",
    "UpdateWebhookRequestHttpHeadersItem": ".types",
}
