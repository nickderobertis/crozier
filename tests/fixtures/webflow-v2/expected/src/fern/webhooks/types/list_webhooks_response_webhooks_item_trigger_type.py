...
class ListWebhooksResponseWebhooksItemTriggerType(enum.StrEnum):
    """
    ...
    def visit(
        ...
        if self is ListWebhooksResponseWebhooksItemTriggerType.FORM_SUBMISSION:
            return form_submission()
        if self is ListWebhooksResponseWebhooksItemTriggerType.SITE_PUBLISH:
            return site_publish()
        if self is ListWebhooksResponseWebhooksItemTriggerType.PAGE_CREATED:
            return page_created()
        if self is ListWebhooksResponseWebhooksItemTriggerType.PAGE_METADATA_UPDATED:
            return page_metadata_updated()
        if self is ListWebhooksResponseWebhooksItemTriggerType.PAGE_DELETED:
            return page_deleted()
        if self is ListWebhooksResponseWebhooksItemTriggerType.ECOMM_NEW_ORDER:
            return ecomm_new_order()
        if self is ListWebhooksResponseWebhooksItemTriggerType.ECOMM_ORDER_CHANGED:
            return ecomm_order_changed()
        if self is ListWebhooksResponseWebhooksItemTriggerType.ECOMM_INVENTORY_CHANGED:
            return ecomm_inventory_changed()
        if self is ListWebhooksResponseWebhooksItemTriggerType.COLLECTION_ITEM_CREATED:
            return collection_item_created()
        if self is ListWebhooksResponseWebhooksItemTriggerType.COLLECTION_ITEM_CHANGED:
            return collection_item_changed()
        if self is ListWebhooksResponseWebhooksItemTriggerType.COLLECTION_ITEM_DELETED:
            return collection_item_deleted()
        if self is ListWebhooksResponseWebhooksItemTriggerType.COLLECTION_ITEM_PUBLISHED:
            return collection_item_published()
        if self is ListWebhooksResponseWebhooksItemTriggerType.COLLECTION_ITEM_UNPUBLISHED:
            return collection_item_unpublished()
        if self is ListWebhooksResponseWebhooksItemTriggerType.COMMENT_CREATED:
