...
class EcommNewOrderPayloadPayloadPurchasedItemsItem(UniversalBaseModel):
    """
    ...
    row_total: typing_extensions.Annotated[
        typing.Optional[EcommNewOrderPayloadPayloadPurchasedItemsItemRowTotal],
    ...
    variant_image: typing_extensions.Annotated[
        typing.Optional[EcommNewOrderPayloadPayloadPurchasedItemsItemVariantImage],
        FieldMetadata(alias="variantImage"),
        pydantic.Field(alias="variantImage"),
    ] = None
    variant_price: typing_extensions.Annotated[
        typing.Optional[EcommNewOrderPayloadPayloadPurchasedItemsItemVariantPrice],
