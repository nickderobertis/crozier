...
class GetFormsResponse(UniversalBaseModel):
    """
    A Webflow form
    """
    ...
    fields: typing.Optional[typing.Dict[str, GetFormsResponseFieldsValue]] = pydantic.Field(default=None)
    """
    A collection of form field objects
    """

    response_settings: typing_extensions.Annotated[
        typing.Optional[GetFormsResponseResponseSettings],
