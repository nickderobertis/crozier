...
class DestinyDefinitionsEnergyTypesDestinyEnergyTypeDefinition(UniversalBaseModel):
    ...
    capacity_stat_hash: typing_extensions.Annotated[
        typing.Optional[int],
        FieldMetadata(alias="capacityStatHash"),
        pydantic.Field(
            alias="capacityStatHash",
    ...
    cost_stat_hash: typing_extensions.Annotated[
        typing.Optional[int],
        FieldMetadata(alias="costStatHash"),
        pydantic.Field(
            alias="costStatHash",
    ...
    display_properties: typing_extensions.Annotated[
        ...
        pydantic.Field(alias="displayProperties", description="The description of the energy type, icon etc..."),
    ] = None
    """
