...
class DictionaryComponentResponseOfint64AndDestinyCharacterProgressionComponent(UniversalBaseModel):
    data: typing.Optional[typing.Dict[str, DestinyEntitiesCharactersDestinyCharacterProgressionComponent]] = None
