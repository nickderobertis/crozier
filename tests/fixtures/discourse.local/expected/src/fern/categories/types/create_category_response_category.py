...
from .create_category_response_category_group_permissions_item import CreateCategoryResponseCategoryGroupPermissionsItem
...
class CreateCategoryResponseCategory(UniversalBaseModel):
    ...
    can_edit: bool
    color: str
    custom_fields: CreateCategoryResponseCategoryCustomFields
    ...
    group_permissions: typing.List[CreateCategoryResponseCategoryGroupPermissionsItem]
    ...
    required_tag_groups: typing.List[CreateCategoryResponseCategoryRequiredTagGroupsItem]
    search_priority: int
