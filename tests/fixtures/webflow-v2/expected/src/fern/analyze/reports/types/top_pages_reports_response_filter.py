...
from .top_pages_reports_response_filter_previous_collection_id import TopPagesReportsResponseFilterPreviousCollectionId
...
class TopPagesReportsResponseFilter(UniversalBaseModel):
    """
    ...
    audience_ids: typing_extensions.Annotated[
        typing.Optional[TopPagesReportsResponseFilterAudienceIds],
    ...
    browser: typing.Optional[TopPagesReportsResponseFilterBrowser] = pydantic.Field(default=None)
    """
    Operators for filtering a single dimension. Specify at least one of `eq`, `in`, `ne`, or `nin`.
    """

    collection_id: typing_extensions.Annotated[
        typing.Optional[TopPagesReportsResponseFilterCollectionId],
    ...
    country: typing.Optional[TopPagesReportsResponseFilterCountry] = pydantic.Field(default=None)
    """
    Operators for filtering a single dimension. Specify at least one of `eq`, `in`, `ne`, or `nin`.
    """

    day_of_week: typing_extensions.Annotated[
        typing.Optional[TopPagesReportsResponseFilterDayOfWeek],
    ...
    device_brand: typing_extensions.Annotated[
        typing.Optional[TopPagesReportsResponseFilterDeviceBrand],
    ...
    device_type: typing_extensions.Annotated[
        typing.Optional[TopPagesReportsResponseFilterDeviceType],
    ...
    domain: typing.Optional[TopPagesReportsResponseFilterDomain] = pydantic.Field(default=None)
    """
    Operators for filtering a single dimension. Specify at least one of `eq`, `in`, `ne`, or `nin`.
    """

    item_slug: typing_extensions.Annotated[
        typing.Optional[TopPagesReportsResponseFilterItemSlug],
    ...
    language: typing.Optional[TopPagesReportsResponseFilterLanguage] = pydantic.Field(default=None)
    """
    Operators for filtering a single dimension. Specify at least one of `eq`, `in`, `ne`, or `nin`.
    """

    locale: typing.Optional[TopPagesReportsResponseFilterLocale] = pydantic.Field(default=None)
    """
    Operators for filtering a single dimension. Specify at least one of `eq`, `in`, `ne`, or `nin`.
    """

    next_collection_id: typing_extensions.Annotated[
        typing.Optional[TopPagesReportsResponseFilterNextCollectionId],
    ...
    next_item_slug: typing_extensions.Annotated[
        typing.Optional[TopPagesReportsResponseFilterNextItemSlug],
    ...
    next_page_id: typing_extensions.Annotated[
        typing.Optional[TopPagesReportsResponseFilterNextPageId],
    ...
    os: typing.Optional[TopPagesReportsResponseFilterOs] = pydantic.Field(default=None)
    """
    Operators for filtering a single dimension. Specify at least one of `eq`, `in`, `ne`, or `nin`.
    """

    page_id: typing_extensions.Annotated[
        typing.Optional[TopPagesReportsResponseFilterPageId],
    ...
    page_path: typing_extensions.Annotated[
        typing.Optional[TopPagesReportsResponseFilterPagePath],
    ...
    previous_collection_id: typing_extensions.Annotated[
        typing.Optional[TopPagesReportsResponseFilterPreviousCollectionId],
    ...
    previous_item_slug: typing_extensions.Annotated[
        typing.Optional[TopPagesReportsResponseFilterPreviousItemSlug],
    ...
    previous_page_id: typing_extensions.Annotated[
        typing.Optional[TopPagesReportsResponseFilterPreviousPageId],
    ...
    referrer: typing.Optional[TopPagesReportsResponseFilterReferrer] = pydantic.Field(default=None)
    """
    Operators for filtering a single dimension. Specify at least one of `eq`, `in`, `ne`, or `nin`.
    """

    region: typing.Optional[TopPagesReportsResponseFilterRegion] = pydantic.Field(default=None)
    """
    Operators for filtering a single dimension. Specify at least one of `eq`, `in`, `ne`, or `nin`.
    """

    time_of_day: typing_extensions.Annotated[
        typing.Optional[TopPagesReportsResponseFilterTimeOfDay],
    ...
    timezone: typing.Optional[TopPagesReportsResponseFilterTimezone] = pydantic.Field(default=None)
    """
    Operators for filtering a single dimension. Specify at least one of `eq`, `in`, `ne`, or `nin`.
    """

    traffic_source: typing_extensions.Annotated[
        typing.Optional[TopPagesReportsResponseFilterTrafficSource],
    ...
    utm_campaign: typing_extensions.Annotated[
        typing.Optional[TopPagesReportsResponseFilterUtmCampaign],
    ...
    utm_content: typing_extensions.Annotated[
        typing.Optional[TopPagesReportsResponseFilterUtmContent],
    ...
    utm_medium: typing_extensions.Annotated[
        typing.Optional[TopPagesReportsResponseFilterUtmMedium],
    ...
    utm_source: typing_extensions.Annotated[
        typing.Optional[TopPagesReportsResponseFilterUtmSource],
    ...
    utm_term: typing_extensions.Annotated[
        typing.Optional[TopPagesReportsResponseFilterUtmTerm],
    ...
    visit_status: typing_extensions.Annotated[
        typing.Optional[TopPagesReportsResponseFilterVisitStatus],
