...
class DefaultCacheBehaviorLambdaFunctionAssociationsItemsItemEventType(enum.StrEnum):
    """
    ...
    def visit(
        ...
        if self is DefaultCacheBehaviorLambdaFunctionAssociationsItemsItemEventType.VIEWER_REQUEST:
            return viewer_request()
        if self is DefaultCacheBehaviorLambdaFunctionAssociationsItemsItemEventType.VIEWER_RESPONSE:
            return viewer_response()
        if self is DefaultCacheBehaviorLambdaFunctionAssociationsItemsItemEventType.ORIGIN_REQUEST:
            return origin_request()
        if self is DefaultCacheBehaviorLambdaFunctionAssociationsItemsItemEventType.ORIGIN_RESPONSE:
