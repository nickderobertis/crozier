...
class PolicyRiskScoreModel(UniversalBaseModel):
    """
    Model for Policy Risk Score
    """

    cloud_type: typing_extensions.Annotated[
        typing.Optional[PolicyRiskScoreModelCloudType],
    ...
    points: typing.Optional[str] = pydantic.Field(default=None)
    """
    Points
    """
    ...
    policy_sub_types: typing_extensions.Annotated[
        typing.Optional[typing.List[PolicyRiskScoreModelPolicySubTypesItem]],
    ...
    remediation: typing.Optional[PolicyRiskScoreModelRemediation] = pydantic.Field(default=None)
    """
    ...
    rule: PolicyRiskScoreModelRule = pydantic.Field()
    """
    ...
    severity: PolicyRiskScoreModelSeverity = pydantic.Field()
    """
    Severity
    """
