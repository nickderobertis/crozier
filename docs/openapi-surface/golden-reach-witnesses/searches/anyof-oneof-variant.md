# Arm search: `anyof-oneof-variant`

The unreached handling site(s) searched for: `src/ir.rs::InlineHoister::hoist_union_variant[if let Some\(members\) = variant\.one_of\.as_ref\(\)\.or\(variant\.any_of\.as_ref\(\)\) \{]`.
Read with: `schema.anyOf>schema.oneOf`.
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `apis.guru` | 1 | 0 | 1 | 0 | 0 | 0 | 0 | 0 | 0 |
| `jentic` | 45 | 0 | 45 | 0 | 4 | 5 | 6 | 6 | 4 |
| `github-code-search` | 26 | 14 | 26 | 0 | 0 | 1 | 0 | 0 | 14 |
| `github-publisher-trees` | 25 | 8 | 0 | 25 | 0 | 0 | 0 | 0 | 33 |
| `sourcegraph` | 20 | 2 | 20 | 0 | 0 | 0 | 0 | 0 | 2 |
| `vendor-portals` | 132 | 58 | 0 | 132 | 0 | 0 | 0 | 0 | 190 |
