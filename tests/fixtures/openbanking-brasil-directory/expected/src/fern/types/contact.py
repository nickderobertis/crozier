...
class Contact(UniversalBaseModel):
    ...
    contact_id: typing_extensions.Annotated[
        ...
        pydantic.Field(alias="ContactId", description="Unique contact ID for the row."),
    ] = None
    """
    ...
    contact_type: typing_extensions.Annotated[
        typing.Optional[ContactContactType], FieldMetadata(alias="ContactType"), pydantic.Field(alias="ContactType")
    ] = None
