...
class RawAccountsClient:
    ...
    def get_accounts(self, *, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[ObReadAccount6]:
        """
        Parameters
        ----------
    ...
    def get_accounts_account_id(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"accounts/{encode_path_param(account_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
...
class AsyncRawAccountsClient:
    ...
    ) -> AsyncHttpResponse[ObReadAccount6]:
        """
        Parameters
        ----------
        request_options : typing.Optional[RequestOptions]
