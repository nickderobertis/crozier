...
class GetEventsResponseEventsItemThirtyNineRecipient(UniversalBaseModel):
    """
    Object containing details about recipients of message edit typing notification.
    """

    type: typing.Optional[GetEventsResponseEventsItemThirtyNineRecipientType] = pydantic.Field(default=None)
    """
