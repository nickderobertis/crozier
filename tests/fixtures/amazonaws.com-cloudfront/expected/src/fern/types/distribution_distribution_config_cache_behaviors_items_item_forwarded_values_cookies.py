...
class DistributionDistributionConfigCacheBehaviorsItemsItemForwardedValuesCookies(UniversalBaseModel):
    """
    ...
    whitelisted_names: typing_extensions.Annotated[
        typing.Optional[DistributionDistributionConfigCacheBehaviorsItemsItemForwardedValuesCookiesWhitelistedNames],
