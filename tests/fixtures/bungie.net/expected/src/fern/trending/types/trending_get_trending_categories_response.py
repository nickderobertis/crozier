...
from ...types.trending_trending_categories import TrendingTrendingCategories


class TrendingGetTrendingCategoriesResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[TrendingTrendingCategories], FieldMetadata(alias="Response"), pydantic.Field(alias="Response")
    ] = None
...
update_forward_refs(TrendingGetTrendingCategoriesResponse)
