...
class RawTemplatesClient:
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                "data": convert_and_respect_annotation_metadata(
                    object_=data, annotation=TemplateCreateRequestData, direction="write"
                ),
            },
            headers={
    ...
    def get_template(self, id: int, *, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[None]:
        """
        Parameters
        ----------
        id : int
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"templates/{encode_path_param(id)}",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def update_template(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                "data": convert_and_respect_annotation_metadata(
                    object_=data, annotation=TemplateUpdateRequestData, direction="write"
                ),
            },
            headers={
                "content-type": "application/vnd.api+json",
