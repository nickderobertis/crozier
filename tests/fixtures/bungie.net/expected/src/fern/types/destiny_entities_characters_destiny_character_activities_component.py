...
class DestinyEntitiesCharactersDestinyCharacterActivitiesComponent(UniversalBaseModel):
    ...
    available_activities: typing_extensions.Annotated[
        typing.Optional[typing.List[DestinyDestinyActivity]], FieldMetadata(alias="availableActivities")
    ...
    current_activity_hash: typing_extensions.Annotated[
        typing.Optional[int], FieldMetadata(alias="currentActivityHash")
    ] = pydantic.Field(default=None)
    """
    ...
    current_activity_mode_hash: typing_extensions.Annotated[
        typing.Optional[int], FieldMetadata(alias="currentActivityModeHash")
    ] = pydantic.Field(default=None)
    """
    ...
    current_activity_mode_hashes: typing_extensions.Annotated[
        typing.Optional[typing.List[int]], FieldMetadata(alias="currentActivityModeHashes")
    ] = pydantic.Field(default=None)
    """
    ...
    current_activity_mode_type: typing_extensions.Annotated[
        typing.Optional[int], FieldMetadata(alias="currentActivityModeType")
    ] = pydantic.Field(default=None)
    """
    ...
    current_activity_mode_types: typing_extensions.Annotated[
        typing.Optional[typing.List[int]], FieldMetadata(alias="currentActivityModeTypes")
    ] = pydantic.Field(default=None)
    """
    ...
    current_playlist_activity_hash: typing_extensions.Annotated[
        typing.Optional[int], FieldMetadata(alias="currentPlaylistActivityHash")
    ] = pydantic.Field(default=None)
    """
    ...
    date_activity_started: typing_extensions.Annotated[
        typing.Optional[dt.datetime], FieldMetadata(alias="dateActivityStarted")
    ] = pydantic.Field(default=None)
    """
    ...
    last_completed_story_hash: typing_extensions.Annotated[
        typing.Optional[int], FieldMetadata(alias="lastCompletedStoryHash")
    ] = pydantic.Field(default=None)
    """
