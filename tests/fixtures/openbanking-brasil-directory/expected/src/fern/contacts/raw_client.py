...
class RawContactsClient:
    ...
    def get_the_contacts_for_the_given_organisation(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"organisations/{encode_path_param(organisation_id)}/contacts",
            method="GET",
            params={
                "page": page,
                "size": size,
    ...
    def get_a_contact_by_id(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"organisations/{encode_path_param(organisation_id)}/contacts/{encode_path_param(contact_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
...
class AsyncRawContactsClient:
    ...
    async def get_the_contacts_for_the_given_organisation(
        ...
        *,
        ...
        sort: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[ContactsPage]:
        """
        Parameters
        ----------
        organisation_id : OrganisationId
