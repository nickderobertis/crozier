...
class TrendingTrendingEntry(UniversalBaseModel):
    ...
    entity_type: typing_extensions.Annotated[typing.Optional[int], FieldMetadata(alias="entityType")] = pydantic.Field(
        default=None
    )
    """
    ...
    feature_image: typing_extensions.Annotated[typing.Optional[str], FieldMetadata(alias="featureImage")] = (
        pydantic.Field(default=None)
    )
    """
    ...
    is_featured: typing_extensions.Annotated[typing.Optional[bool], FieldMetadata(alias="isFeatured")] = None
    ...
    mp4video: typing_extensions.Annotated[typing.Optional[str], FieldMetadata(alias="mp4Video")] = pydantic.Field(
        default=None
    )
    """
    ...
    webm_video: typing_extensions.Annotated[typing.Optional[str], FieldMetadata(alias="webmVideo")] = pydantic.Field(
        default=None
    )
    """
