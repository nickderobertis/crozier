...
class StackSetOperationStackSetDriftDetectionDetailsDriftStatus(str, enum.Enum):
    """
    ...
    def visit(
        ...
        if self is StackSetOperationStackSetDriftDetectionDetailsDriftStatus.DRIFTED:
            return drifted()
        if self is StackSetOperationStackSetDriftDetectionDetailsDriftStatus.IN_SYNC:
            return in_sync()
        if self is StackSetOperationStackSetDriftDetectionDetailsDriftStatus.NOT_CHECKED:
            return not_checked()
