...
class UpdateSkuProductsRequestSkuFieldDataEcSkuSubscriptionPlan(UniversalBaseModel):
    """
    ...
    interval: typing.Optional[UpdateSkuProductsRequestSkuFieldDataEcSkuSubscriptionPlanInterval] = pydantic.Field(
        default=None
    )
    """
    ...
    plans: typing.Optional[typing.List[UpdateSkuProductsRequestSkuFieldDataEcSkuSubscriptionPlanPlansItem]] = None
