...
class ObbcaData1OtherFeesChargesItemFeeChargeCapItem(UniversalBaseModel):
    """
    Details about any caps (maximum charges) that apply to a particular or group of fee/charge
    """

    capping_period: typing_extensions.Annotated[
        typing.Optional[ObbcaData1OtherFeesChargesItemFeeChargeCapItemCappingPeriod],
    ...
    fee_type: typing_extensions.Annotated[
        typing.List[ObbcaData1OtherFeesChargesItemFeeChargeCapItemFeeTypeItem], FieldMetadata(alias="FeeType")
    ] = pydantic.Field()
    """
    ...
    min_max_type: typing_extensions.Annotated[
        ObbcaData1OtherFeesChargesItemFeeChargeCapItemMinMaxType, FieldMetadata(alias="MinMaxType")
    ] = pydantic.Field()
    """
    Min Max type
    """
    ...
    other_fee_type: typing_extensions.Annotated[
        typing.Optional[typing.List[ObbcaData1OtherFeesChargesItemFeeChargeCapItemOtherFeeTypeItem]],
