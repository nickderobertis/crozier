...
from ...types.destiny_historical_stats_destiny_post_game_carnage_report_data import (
    DestinyHistoricalStatsDestinyPostGameCarnageReportData,
)


class Destiny2GetPostGameCarnageReportResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[DestinyHistoricalStatsDestinyPostGameCarnageReportData], FieldMetadata(alias="Response")
    ] = None
