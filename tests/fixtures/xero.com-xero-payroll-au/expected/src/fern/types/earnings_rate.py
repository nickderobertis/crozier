...
class EarningsRate(UniversalBaseModel):
    ...
    accrue_leave: typing_extensions.Annotated[
        typing.Optional[bool],
        FieldMetadata(alias="AccrueLeave"),
        pydantic.Field(
            alias="AccrueLeave",
    ...
    allowance_type: typing_extensions.Annotated[
        typing.Optional[AllowanceType], FieldMetadata(alias="AllowanceType"), pydantic.Field(alias="AllowanceType")
    ] = None
    amount: typing_extensions.Annotated[
        typing.Optional[float],
        FieldMetadata(alias="Amount"),
        pydantic.Field(alias="Amount", description="Optional Amount for FIXEDAMOUNT RateType EarningsRate"),
    ] = None
    """
    ...
    earnings_type: typing_extensions.Annotated[
        typing.Optional[EarningsType], FieldMetadata(alias="EarningsType"), pydantic.Field(alias="EarningsType")
    ] = None
    ...
    is_exempt_from_super: typing_extensions.Annotated[
        typing.Optional[bool],
        FieldMetadata(alias="IsExemptFromSuper"),
        pydantic.Field(
    ...
    is_exempt_from_tax: typing_extensions.Annotated[
        typing.Optional[bool],
        FieldMetadata(alias="IsExemptFromTax"),
        pydantic.Field(
    ...
    is_reportable_as_w1: typing_extensions.Annotated[
        typing.Optional[bool],
        FieldMetadata(alias="IsReportableAsW1"),
        pydantic.Field(
    ...
    multiplier: typing_extensions.Annotated[
        typing.Optional[float],
        FieldMetadata(alias="Multiplier"),
        pydantic.Field(
            alias="Multiplier",
    ...
    rate_type: typing_extensions.Annotated[
        typing.Optional[RateType], FieldMetadata(alias="RateType"), pydantic.Field(alias="RateType")
    ] = None
