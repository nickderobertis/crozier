...
class ListTypesInput(UniversalBaseModel):
    visibility: typing_extensions.Annotated[
        typing.Optional[ListTypesInputVisibility],
    ...
    provisioning_type: typing_extensions.Annotated[
        typing.Optional[ListTypesInputProvisioningType],
    ...
    deprecated_status: typing_extensions.Annotated[
        typing.Optional[ListTypesInputDeprecatedStatus],
    ...
    type: typing_extensions.Annotated[
        typing.Optional[ListTypesInputType],
    ...
    filters: typing_extensions.Annotated[
        typing.Optional[ListTypesInputFilters],
