...
from .stack_set_drift_detection_details_drift_detection_status import StackSetDriftDetectionDetailsDriftDetectionStatus
from .stack_set_drift_detection_details_drift_status import StackSetDriftDetectionDetailsDriftStatus


class StackSetDriftDetectionDetails(UniversalBaseModel):
    """
    ...
    drift_status: typing_extensions.Annotated[
        typing.Optional[StackSetDriftDetectionDetailsDriftStatus],
    ...
    drift_detection_status: typing_extensions.Annotated[
        typing.Optional[StackSetDriftDetectionDetailsDriftDetectionStatus],
