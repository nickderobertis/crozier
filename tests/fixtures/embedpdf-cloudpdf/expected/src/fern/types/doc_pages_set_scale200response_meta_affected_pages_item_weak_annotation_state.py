...
class DocPagesSetScale200ResponseMetaAffectedPagesItemWeakAnnotationState_Unknown(UniversalBaseModel):
...
class DocPagesSetScale200ResponseMetaAffectedPagesItemWeakAnnotationState_Known(UniversalBaseModel):
...
DocPagesSetScale200ResponseMetaAffectedPagesItemWeakAnnotationState = typing_extensions.Annotated[
    typing.Union[
