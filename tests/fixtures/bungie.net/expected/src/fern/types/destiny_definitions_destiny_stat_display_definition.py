...
class DestinyDefinitionsDestinyStatDisplayDefinition(UniversalBaseModel):
    ...
    display_as_numeric: typing_extensions.Annotated[
        typing.Optional[bool],
        FieldMetadata(alias="displayAsNumeric"),
        pydantic.Field(
            alias="displayAsNumeric",
    ...
    display_interpolation: typing_extensions.Annotated[
        typing.Optional[typing.List[InterpolationInterpolationPoint]],
        FieldMetadata(alias="displayInterpolation"),
        pydantic.Field(
            alias="displayInterpolation",
