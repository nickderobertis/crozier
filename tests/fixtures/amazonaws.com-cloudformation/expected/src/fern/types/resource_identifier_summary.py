...
class ResourceIdentifierSummary(UniversalBaseModel):
    ...
    logical_resource_ids: typing_extensions.Annotated[
        typing.Optional[typing.List[LogicalResourceId]], FieldMetadata(alias="LogicalResourceIds")
    ] = pydantic.Field(default=None)
    """
    ...
    resource_identifiers: typing_extensions.Annotated[
        typing.Optional[typing.List[ResourceIdentifierPropertyKey]], FieldMetadata(alias="ResourceIdentifiers")
    ] = pydantic.Field(default=None)
    """
