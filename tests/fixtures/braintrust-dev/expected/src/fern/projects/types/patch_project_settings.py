...
from ...types.nullable_saved_function_id import NullableSavedFunctionId
...
class PatchProjectSettings(UniversalBaseModel):
    """
    ...
    span_field_order: typing_extensions.Annotated[
        typing.Optional[typing.List[PatchProjectSettingsSpanFieldOrderItem]],
    ...
    remote_eval_sources: typing.Optional[typing.List[PatchProjectSettingsRemoteEvalSourcesItem]] = pydantic.Field(
        default=None
    )
    """
