...
class DocAnnotationsListAll200ResponsePagesItemAnnotationsItemPolylineMeasureRlYItem(UniversalBaseModel):
    unit: str
    ...
    label_position: typing_extensions.Annotated[
        typing.Optional[DocAnnotationsListAll200ResponsePagesItemAnnotationsItemPolylineMeasureRlYItemLabelPosition],
