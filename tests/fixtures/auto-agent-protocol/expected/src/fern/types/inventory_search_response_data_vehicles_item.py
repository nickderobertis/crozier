...
class InventorySearchResponseDataVehiclesItem(UniversalBaseModel):
    condition: typing.Optional[InventorySearchResponseDataVehiclesItemCondition] = pydantic.Field(default=None)
    """
