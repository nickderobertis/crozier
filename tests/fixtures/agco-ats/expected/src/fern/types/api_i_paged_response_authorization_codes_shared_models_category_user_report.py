...
class ApiIPagedResponseAuthorizationCodesSharedModelsCategoryUserReport(UniversalBaseModel):
    entities: typing_extensions.Annotated[
        typing.Optional[typing.List[AuthorizationCodesSharedModelsCategoryUserReport]],
