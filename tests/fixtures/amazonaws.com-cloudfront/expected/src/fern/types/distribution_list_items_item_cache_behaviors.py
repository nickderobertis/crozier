...
from .distribution_list_items_item_cache_behaviors_items_item import DistributionListItemsItemCacheBehaviorsItemsItem


class DistributionListItemsItemCacheBehaviors(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[typing.List[DistributionListItemsItemCacheBehaviorsItemsItem]],
