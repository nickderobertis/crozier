...
if typing.TYPE_CHECKING:
    ...
    from .slurm.client import AsyncSlurmClient, SlurmClient
...
class FernApi:
    ...
    def __init__(
        ...
        *,
        ...
        self._slurm: typing.Optional[SlurmClient] = None
    ...
    def slurm(self):
        if self._slurm is None:
            ...
            self._slurm = SlurmClient(client_wrapper=self._client_wrapper)
        return self._slurm
...
class AsyncFernApi:
    ...
    def __init__(
        ...
        *,
        ...
        self._slurm: typing.Optional[AsyncSlurmClient] = None
        self._openapi: typing.Optional[AsyncOpenapiClient] = None

    @property
    def slurm(self):
        if self._slurm is None:
            from .slurm.client import AsyncSlurmClient

            self._slurm = AsyncSlurmClient(client_wrapper=self._client_wrapper)
        return self._slurm
