...
class UpdateUnfulfillOrdersResponsePurchasedItemsItem(UniversalBaseModel):
    """
    ...
    row_total: typing_extensions.Annotated[
        typing.Optional[UpdateUnfulfillOrdersResponsePurchasedItemsItemRowTotal],
    ...
    variant_image: typing_extensions.Annotated[
        typing.Optional[UpdateUnfulfillOrdersResponsePurchasedItemsItemVariantImage],
        FieldMetadata(alias="variantImage"),
        pydantic.Field(alias="variantImage"),
    ] = None
    variant_price: typing_extensions.Annotated[
        typing.Optional[UpdateUnfulfillOrdersResponsePurchasedItemsItemVariantPrice],
