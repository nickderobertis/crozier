...
class RawNotificationFilterPushClient:
    def __init__(self, *, client_wrapper: SyncClientWrapper):
        self._client_wrapper = client_wrapper

    def list_all_notification_filter_push_for_user(
        self, user_id: int, *, request_options: typing.Optional[RequestOptions] = None
    ) -> HttpResponse[typing.List[NotificationFilterPushListing]]:
        """
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"user/{encode_path_param(user_id)}/notification-filter-push",
            method="GET",
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=typing.List[NotificationFilterPushListing],
    ...
    ) -> HttpResponse[NotificationFilterPushCreate]:
        """
        Manage the push notification filters for a user.
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                "notification_filters": convert_and_respect_annotation_metadata(
                    object_=notification_filters, annotation=typing.Sequence[NotificationFilterPush], direction="write"
                ),
            },
            headers={
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=NotificationFilterPushCreate,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawNotificationFilterPushClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._client_wrapper = client_wrapper

    async def list_all_notification_filter_push_for_user(
        self, user_id: int, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[typing.List[NotificationFilterPushListing]]:
        """
        Manage the push notification filters for a user.
    ...
    async def create_notification_filter_push_for_user(
        ...
        *,
        notification_filters: typing.Optional[typing.Sequence[NotificationFilterPush]] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[NotificationFilterPushCreate]:
        """
        Manage the push notification filters for a user.
