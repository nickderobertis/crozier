...
class CreateChangeSetInput(UniversalBaseModel):
    ...
    rollback_configuration: typing_extensions.Annotated[
        typing.Optional[CreateChangeSetInputRollbackConfiguration],
    ...
    client_token: typing_extensions.Annotated[
        typing.Optional[str],
        FieldMetadata(alias="ClientToken"),
        pydantic.Field(
            alias="ClientToken",
    ...
    description: typing_extensions.Annotated[
        ...
        pydantic.Field(alias="Description", description="A description to help you identify this change set."),
    ] = None
    """
    ...
    change_set_type: typing_extensions.Annotated[
        typing.Optional[CreateChangeSetInputChangeSetType],
        FieldMetadata(alias="ChangeSetType"),
        pydantic.Field(
            alias="ChangeSetType",
    ...
    resources_to_import: typing_extensions.Annotated[
        typing.Optional[typing.List[ResourceToImport]],
        FieldMetadata(alias="ResourcesToImport"),
        pydantic.Field(alias="ResourcesToImport", description="The resources to import into your stack."),
    ] = None
    """
