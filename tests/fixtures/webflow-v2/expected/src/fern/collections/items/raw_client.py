...
class RawItemsClient:
    ...
    def list_items(
        ...
        *,
    ...
    ) -> HttpResponse[ListItemsItemsResponse]:
        """
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"collections/{encode_path_param(collection_id)}/items",
            ...
            params={
                ...
                "createdOn": convert_and_respect_annotation_metadata(
                    object_=created_on, annotation=ListItemsItemsRequestCreatedOn, direction="write"
                ),
                "lastPublished": convert_and_respect_annotation_metadata(
                    object_=last_published, annotation=ListItemsItemsRequestLastPublished, direction="write"
                ),
                "lastUpdated": convert_and_respect_annotation_metadata(
                    object_=last_updated, annotation=ListItemsItemsRequestLastUpdated, direction="write"
                ),
                "filter": convert_and_respect_annotation_metadata(
                    object_=filter, annotation=typing.Dict[str, ListItemsItemsRequestFilterValue], direction="write"
                ),
                "sortBy": sort_by,
    ...
    def create_item(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[CreateItemItemsResponse]:
        """
        <Tip title="Components in Rich Text">
          Rich Text field values may contain Webflow component instances as `<wf-component>` markup. On read they appear inline in the field's HTML; on write, the same markup creates or updates the instance.
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json=convert_and_respect_annotation_metadata(
                object_=request, annotation=CreateItemItemsRequestBody, direction="write"
            ),
            headers={
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                "items": convert_and_respect_annotation_metadata(
                    object_=items, annotation=typing.Sequence[DeleteItemsItemsRequestItemsItem], direction="write"
                ),
            },
            headers={
                "content-type": "application/json",
    ...
    def update_items(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[UpdateItemsItemsResponse]:
        """
        <Tip title="Components in Rich Text">
          Rich Text field values may contain Webflow component instances as `<wf-component>` markup. On read they appear inline in the field's HTML; on write, the same markup creates or updates the instance.
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                "items": convert_and_respect_annotation_metadata(
                    object_=items, annotation=typing.Sequence[UpdateItemsItemsRequestItemsItem], direction="write"
                ),
            },
            headers={
                "content-type": "application/json",
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=UpdateItemsItemsResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def list_items_live(
        ...
        *,
        ...
        translatable: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[ListItemsLiveItemsResponse]:
        """
        <Tip title="Components in Rich Text">
          Rich Text field values may contain Webflow component instances as `<wf-component>` markup. On read they appear inline in the field's HTML; on write, the same markup creates or updates the instance.
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"collections/{encode_path_param(collection_id)}/items/live",
            base_url=self._client_wrapper.get_environment().base,
            method="GET",
            params={
                "cmsLocaleId": cms_locale_id,
                ...
                "slug": slug,
                "createdOn": convert_and_respect_annotation_metadata(
                    object_=created_on, annotation=ListItemsLiveItemsRequestCreatedOn, direction="write"
                ),
                "lastPublished": convert_and_respect_annotation_metadata(
                    object_=last_published, annotation=ListItemsLiveItemsRequestLastPublished, direction="write"
                ),
                "lastUpdated": convert_and_respect_annotation_metadata(
                    object_=last_updated, annotation=ListItemsLiveItemsRequestLastUpdated, direction="write"
                ),
                "filter": convert_and_respect_annotation_metadata(
                    object_=filter, annotation=typing.Dict[str, ListItemsLiveItemsRequestFilterValue], direction="write"
                ),
                "sortBy": sort_by,
                "sortOrder": sort_order,
                "sort": sort,
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=ListItemsLiveItemsResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def create_item_live(
        ...
        *,
        ...
        skip_invalid_files: typing.Optional[bool] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[CreateItemLiveItemsResponse]:
        """
        <Tip title="Components in Rich Text">
          Rich Text field values may contain Webflow component instances as `<wf-component>` markup. On read they appear inline in the field's HTML; on write, the same markup creates or updates the instance.
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json=convert_and_respect_annotation_metadata(
                object_=request, annotation=CreateItemLiveItemsRequestBody, direction="write"
            ),
            headers={
                "content-type": "application/json",
            },
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=CreateItemLiveItemsResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def delete_items_live(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                "items": convert_and_respect_annotation_metadata(
                    object_=items, annotation=typing.Sequence[DeleteItemsLiveItemsRequestItemsItem], direction="write"
                ),
            },
            headers={
                "content-type": "application/json",
    ...
    def update_items_live(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[UpdateItemsLiveItemsResponse]:
        """
        <Tip title="Components in Rich Text">
          Rich Text field values may contain Webflow component instances as `<wf-component>` markup. On read they appear inline in the field's HTML; on write, the same markup creates or updates the instance.
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                "items": convert_and_respect_annotation_metadata(
                    object_=items, annotation=typing.Sequence[UpdateItemsLiveItemsRequestItemsItem], direction="write"
                ),
            },
            headers={
                "content-type": "application/json",
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=UpdateItemsLiveItemsResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def create_items(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[CreateItemsItemsResponse]:
        """
        <Tip title="Components in Rich Text">
          Rich Text field values may contain Webflow component instances as `<wf-component>` markup. On read they appear inline in the field's HTML; on write, the same markup creates or updates the instance.
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"collections/{encode_path_param(collection_id)}/items/bulk",
            base_url=self._client_wrapper.get_environment().base,
            method="POST",
            params={
                "skipInvalidFiles": skip_invalid_files,
            ...
            json={
                ...
                "fieldData": convert_and_respect_annotation_metadata(
                    object_=field_data, annotation=CreateItemsItemsRequestFieldData, direction="write"
                ),
            },
            headers={
                "content-type": "application/json",
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=CreateItemsItemsResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def get_item(
        ...
        *,
        ...
        translatable: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[GetItemItemsResponse]:
        """
        <Tip title="Components in Rich Text">
          Rich Text field values may contain Webflow component instances as `<wf-component>` markup. On read they appear inline in the field's HTML; on write, the same markup creates or updates the instance.
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"collections/{encode_path_param(collection_id)}/items/{encode_path_param(item_id)}",
            base_url=self._client_wrapper.get_environment().base,
            method="GET",
            params={
                "cmsLocaleId": cms_locale_id,
    ...
    def update_item(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[UpdateItemItemsResponse]:
        """
        <Tip title="Components in Rich Text">
          Rich Text field values may contain Webflow component instances as `<wf-component>` markup. On read they appear inline in the field's HTML; on write, the same markup creates or updates the instance.
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                ...
                "isDraft": is_draft,
                "fieldData": convert_and_respect_annotation_metadata(
                    object_=field_data, annotation=UpdateItemItemsRequestFieldData, direction="write"
                ),
            },
            headers={
                "content-type": "application/json",
    ...
    def get_item_live(
        ...
        *,
        ...
        translatable: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[GetItemLiveItemsResponse]:
        """
        <Tip title="Components in Rich Text">
          Rich Text field values may contain Webflow component instances as `<wf-component>` markup. On read they appear inline in the field's HTML; on write, the same markup creates or updates the instance.
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"collections/{encode_path_param(collection_id)}/items/{encode_path_param(item_id)}/live",
            base_url=self._client_wrapper.get_environment().base,
            method="GET",
            params={
                "cmsLocaleId": cms_locale_id,
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=GetItemLiveItemsResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def update_item_live(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[UpdateItemLiveItemsResponse]:
        """
        <Tip title="Components in Rich Text">
          Rich Text field values may contain Webflow component instances as `<wf-component>` markup. On read they appear inline in the field's HTML; on write, the same markup creates or updates the instance.
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                ...
                "isDraft": is_draft,
                "fieldData": convert_and_respect_annotation_metadata(
                    object_=field_data, annotation=UpdateItemLiveItemsRequestFieldData, direction="write"
                ),
            },
            headers={
                "content-type": "application/json",
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=UpdateItemLiveItemsResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def publish_item(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[PublishItemItemsResponse]:
        """
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"collections/{encode_path_param(collection_id)}/items/publish",
            base_url=self._client_wrapper.get_environment().base,
            method="POST",
            json=convert_and_respect_annotation_metadata(
                object_=request, annotation=PublishItemItemsRequestBody, direction="write"
            ),
            headers={
                "content-type": "application/json",
            },
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=PublishItemItemsResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawItemsClient:
    ...
    async def list_items(
        ...
        *,
        ...
        translatable: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[ListItemsItemsResponse]:
        """
        <Tip title="Components in Rich Text">
          Rich Text field values may contain Webflow component instances as `<wf-component>` markup. On read they appear inline in the field's HTML; on write, the same markup creates or updates the instance.
    ...
    async def create_item(
        ...
        *,
        ...
        skip_invalid_files: typing.Optional[bool] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[CreateItemItemsResponse]:
        """
        <Tip title="Components in Rich Text">
          Rich Text field values may contain Webflow component instances as `<wf-component>` markup. On read they appear inline in the field's HTML; on write, the same markup creates or updates the instance.
    ...
    async def update_items(
        ...
        *,
        ...
        items: typing.Optional[typing.Sequence[UpdateItemsItemsRequestItemsItem]] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[UpdateItemsItemsResponse]:
        """
        <Tip title="Components in Rich Text">
          Rich Text field values may contain Webflow component instances as `<wf-component>` markup. On read they appear inline in the field's HTML; on write, the same markup creates or updates the instance.
    ...
    async def list_items_live(
        ...
        *,
        ...
        translatable: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[ListItemsLiveItemsResponse]:
        """
        <Tip title="Components in Rich Text">
          Rich Text field values may contain Webflow component instances as `<wf-component>` markup. On read they appear inline in the field's HTML; on write, the same markup creates or updates the instance.
    ...
    async def create_item_live(
        ...
        *,
        ...
        skip_invalid_files: typing.Optional[bool] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[CreateItemLiveItemsResponse]:
        """
        <Tip title="Components in Rich Text">
          Rich Text field values may contain Webflow component instances as `<wf-component>` markup. On read they appear inline in the field's HTML; on write, the same markup creates or updates the instance.
    ...
    async def update_items_live(
        ...
        *,
        ...
        items: typing.Optional[typing.Sequence[UpdateItemsLiveItemsRequestItemsItem]] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[UpdateItemsLiveItemsResponse]:
        """
        <Tip title="Components in Rich Text">
          Rich Text field values may contain Webflow component instances as `<wf-component>` markup. On read they appear inline in the field's HTML; on write, the same markup creates or updates the instance.
    ...
    async def create_items(
        ...
        *,
        ...
        is_draft: typing.Optional[bool] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[CreateItemsItemsResponse]:
        """
        <Tip title="Components in Rich Text">
          Rich Text field values may contain Webflow component instances as `<wf-component>` markup. On read they appear inline in the field's HTML; on write, the same markup creates or updates the instance.
    ...
    async def get_item(
        ...
        *,
        ...
        translatable: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[GetItemItemsResponse]:
        """
        <Tip title="Components in Rich Text">
          Rich Text field values may contain Webflow component instances as `<wf-component>` markup. On read they appear inline in the field's HTML; on write, the same markup creates or updates the instance.
    ...
    async def update_item(
        ...
        *,
        ...
        field_data: typing.Optional[UpdateItemItemsRequestFieldData] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[UpdateItemItemsResponse]:
        """
        <Tip title="Components in Rich Text">
          Rich Text field values may contain Webflow component instances as `<wf-component>` markup. On read they appear inline in the field's HTML; on write, the same markup creates or updates the instance.
    ...
    async def get_item_live(
        ...
        *,
        ...
        translatable: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[GetItemLiveItemsResponse]:
        """
        <Tip title="Components in Rich Text">
          Rich Text field values may contain Webflow component instances as `<wf-component>` markup. On read they appear inline in the field's HTML; on write, the same markup creates or updates the instance.
    ...
    async def update_item_live(
        ...
        *,
        ...
        field_data: typing.Optional[UpdateItemLiveItemsRequestFieldData] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[UpdateItemLiveItemsResponse]:
        """
        <Tip title="Components in Rich Text">
          Rich Text field values may contain Webflow component instances as `<wf-component>` markup. On read they appear inline in the field's HTML; on write, the same markup creates or updates the instance.
    ...
    async def publish_item(
        ...
        *,
        request: PublishItemItemsRequestBody,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[PublishItemItemsResponse]:
        """
        Publish an item or multiple items.
