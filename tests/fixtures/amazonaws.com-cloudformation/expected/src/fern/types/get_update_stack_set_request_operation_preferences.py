...
class GetUpdateStackSetRequestOperationPreferences(UniversalBaseModel):
    """
    ...
    region_concurrency_type: typing_extensions.Annotated[
        typing.Optional[GetUpdateStackSetRequestOperationPreferencesRegionConcurrencyType],
