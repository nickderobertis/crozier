...
class ListLatestTopicsResponseTopicListTopicsItem(UniversalBaseModel):
    ...
    posters: typing.Optional[typing.List[ListLatestTopicsResponseTopicListTopicsItemPostersItem]] = None
