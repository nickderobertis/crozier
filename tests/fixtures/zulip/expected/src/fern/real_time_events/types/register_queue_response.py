...
class RegisterQueueResponse(UniversalBaseModel):
    ...
    idle_queue_timeout_secs: typing.Optional[int] = pydantic.Field(default=None)
    """
    The effective idle queue timeout for the allocated queue,
    ...
    **Changes**: New in Zulip 6.0 (feature level 134), deprecating and
    ...
    has_webex_token: typing.Optional[bool] = pydantic.Field(default=None)
    """
    Present if `video_calls` is present in `fetch_event_types`.
    ...
    **Changes**: New in Zulip 12.0 (feature level 442).
    ...
    klipy_api_key: typing.Optional[str] = pydantic.Field(default=None)
    """
    Present if `klipy` is present in `fetch_event_types`.
