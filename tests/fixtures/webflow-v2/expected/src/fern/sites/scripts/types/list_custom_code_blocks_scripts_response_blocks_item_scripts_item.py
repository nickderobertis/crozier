...
class ListCustomCodeBlocksScriptsResponseBlocksItemScriptsItem(UniversalBaseModel):
    id: str = pydantic.Field()
    """
    ID of the registered custom code script
    """

    location: ListCustomCodeBlocksScriptsResponseBlocksItemScriptsItemLocation = pydantic.Field()
    """
