...
class SingleComponentResponseOfDestinyCurrenciesComponent(UniversalBaseModel):
    data: typing.Optional[DestinyComponentsInventoryDestinyCurrenciesComponent] = None
