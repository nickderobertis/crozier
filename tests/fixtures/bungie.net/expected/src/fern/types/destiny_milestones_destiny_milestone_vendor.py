...
class DestinyMilestonesDestinyMilestoneVendor(UniversalBaseModel):
    """
    ...
    preview_item_hash: typing_extensions.Annotated[typing.Optional[int], FieldMetadata(alias="previewItemHash")] = (
