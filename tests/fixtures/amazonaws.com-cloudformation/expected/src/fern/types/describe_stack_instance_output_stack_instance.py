...
class DescribeStackInstanceOutputStackInstance(UniversalBaseModel):
    ...
    status: typing_extensions.Annotated[
        typing.Optional[DescribeStackInstanceOutputStackInstanceStatus], FieldMetadata(alias="Status")
    ] = pydantic.Field(default=None)
    """
    ...
    drift_status: typing_extensions.Annotated[
        typing.Optional[DescribeStackInstanceOutputStackInstanceDriftStatus], FieldMetadata(alias="DriftStatus")
    ] = pydantic.Field(default=None)
    """
