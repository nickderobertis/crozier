...
class ListCommentThreadsCommentsResponseCommentsItem(UniversalBaseModel):
    """
    ...
    author: ListCommentThreadsCommentsResponseCommentsItemAuthor
    mentioned_users: typing_extensions.Annotated[
        typing.List[ListCommentThreadsCommentsResponseCommentsItemMentionedUsersItem],
