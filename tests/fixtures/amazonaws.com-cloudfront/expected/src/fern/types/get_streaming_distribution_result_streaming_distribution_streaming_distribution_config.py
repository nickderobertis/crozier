...
class GetStreamingDistributionResultStreamingDistributionStreamingDistributionConfig(UniversalBaseModel):
    """
    ...
    aliases: typing_extensions.Annotated[
        typing.Optional[GetStreamingDistributionResultStreamingDistributionStreamingDistributionConfigAliases],
    ...
    logging: typing_extensions.Annotated[
        typing.Optional[GetStreamingDistributionResultStreamingDistributionStreamingDistributionConfigLogging],
    ...
    price_class: typing_extensions.Annotated[
        typing.Optional[GetStreamingDistributionResultStreamingDistributionStreamingDistributionConfigPriceClass],
