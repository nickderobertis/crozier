...
client = FernApi(...)
response = client.individual_ue_context_document.with_raw_response.release_ue_context(...)
...
```python
client.individual_ue_context_document.release_ue_context(..., request_options={
    "max_retries": 1
})
```
