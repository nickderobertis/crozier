...
class DocumentsInit200ResponseCreatedDocument(UniversalBaseModel):
    id: str
    tenant_id: typing_extensions.Annotated[str, FieldMetadata(alias="tenantId"), pydantic.Field(alias="tenantId")]
    state: DocumentsInit200ResponseCreatedDocumentState
    ...
    thumbnail_state: typing_extensions.Annotated[
        typing.Optional[DocumentsInit200ResponseCreatedDocumentThumbnailState],
