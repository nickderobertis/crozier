...
class CacheBehaviorListItemForwardedValues(UniversalBaseModel):
    """
    ...
    headers: typing_extensions.Annotated[
        typing.Optional[CacheBehaviorListItemForwardedValuesHeaders],
    ...
    query_string_cache_keys: typing_extensions.Annotated[
        typing.Optional[CacheBehaviorListItemForwardedValuesQueryStringCacheKeys],
