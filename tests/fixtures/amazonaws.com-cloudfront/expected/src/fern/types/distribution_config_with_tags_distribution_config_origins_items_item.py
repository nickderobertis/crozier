...
class DistributionConfigWithTagsDistributionConfigOriginsItemsItem(UniversalBaseModel):
    """
    ...
    custom_headers: typing_extensions.Annotated[
        typing.Optional[DistributionConfigWithTagsDistributionConfigOriginsItemsItemCustomHeaders],
    ...
    s3origin_config: typing_extensions.Annotated[
        typing.Optional[DistributionConfigWithTagsDistributionConfigOriginsItemsItemS3OriginConfig],
    ...
    custom_origin_config: typing_extensions.Annotated[
        typing.Optional[DistributionConfigWithTagsDistributionConfigOriginsItemsItemCustomOriginConfig],
