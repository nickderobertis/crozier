...
class DistributionDistributionConfigDefaultCacheBehaviorLambdaFunctionAssociations(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[
            typing.List[DistributionDistributionConfigDefaultCacheBehaviorLambdaFunctionAssociationsItemsItem]
        ],
