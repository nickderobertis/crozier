...
class UpdateUserGroupRequestCanLeaveGroup(UniversalBaseModel):
    """
    ...
    **Changes**: New in Zulip 10.0 (feature level 308).
    ...
    new: UpdateUserGroupRequestCanLeaveGroupNew = pydantic.Field()
    """
    The new [group-setting value](/api/group-setting-values) for who would
    have this permission.
    """

    old: typing.Optional[UpdateUserGroupRequestCanLeaveGroupOld] = pydantic.Field(default=None)
    """
