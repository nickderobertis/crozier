...
class OriginsItemsItem(UniversalBaseModel):
    """
    ...
    custom_headers: typing_extensions.Annotated[
        typing.Optional[OriginsItemsItemCustomHeaders],
    ...
    s3origin_config: typing_extensions.Annotated[
        typing.Optional[OriginsItemsItemS3OriginConfig],
    ...
    custom_origin_config: typing_extensions.Annotated[
        typing.Optional[OriginsItemsItemCustomOriginConfig],
