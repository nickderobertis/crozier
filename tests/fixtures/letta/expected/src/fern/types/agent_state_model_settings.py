...
class AgentStateModelSettings_Anthropic(UniversalBaseModel):
...
class AgentStateModelSettings_Azure(UniversalBaseModel):
...
class AgentStateModelSettings_Bedrock(UniversalBaseModel):
...
class AgentStateModelSettings_ChatgptOauth(UniversalBaseModel):
...
class AgentStateModelSettings_Deepseek(UniversalBaseModel):
...
class AgentStateModelSettings_GoogleAi(UniversalBaseModel):
...
class AgentStateModelSettings_GoogleVertex(UniversalBaseModel):
...
class AgentStateModelSettings_Groq(UniversalBaseModel):
...
class AgentStateModelSettings_Openai(UniversalBaseModel):
...
class AgentStateModelSettings_Together(UniversalBaseModel):
...
class AgentStateModelSettings_Xai(UniversalBaseModel):
...
class AgentStateModelSettings_Zai(UniversalBaseModel):
...
AgentStateModelSettings = typing_extensions.Annotated[
    typing.Union[
