...
class CacheBehaviorListItemLambdaFunctionAssociations(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[typing.List[CacheBehaviorListItemLambdaFunctionAssociationsItemsItem]],
