...
class ListItemsItemsResponseItemsItem(UniversalBaseModel):
    """
    ...
    field_data: typing_extensions.Annotated[
        ListItemsItemsResponseItemsItemFieldData, FieldMetadata(alias="fieldData"), pydantic.Field(alias="fieldData")
    ]
