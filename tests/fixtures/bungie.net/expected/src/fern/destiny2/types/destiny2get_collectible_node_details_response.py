...
from ...types.destiny_responses_destiny_collectible_node_detail_response import (
    DestinyResponsesDestinyCollectibleNodeDetailResponse,
)


class Destiny2GetCollectibleNodeDetailsResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[DestinyResponsesDestinyCollectibleNodeDetailResponse], FieldMetadata(alias="Response")
    ] = None
