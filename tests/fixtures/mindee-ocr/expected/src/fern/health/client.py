...
class HealthClient:
    ...
    def check(self, *, request_options: typing.Optional[RequestOptions] = None) -> HealthResponse:
        """
        Health check
...
class AsyncHealthClient:
    ...
    async def check(self, *, request_options: typing.Optional[RequestOptions] = None) -> HealthResponse:
        """
        Health check
