...
class InsertProjectLogsEvent(UniversalBaseModel):
    """
    ...
    metadata: typing.Optional[InsertProjectLogsEventMetadata] = pydantic.Field(default=None)
    """
    ...
    metrics: typing.Optional[InsertProjectLogsEventMetrics] = pydantic.Field(default=None)
    """
    ...
    context: typing.Optional[InsertProjectLogsEventContext] = pydantic.Field(default=None)
    """
    ...
    array_delete: typing_extensions.Annotated[
        typing.Optional[typing.List[InsertProjectLogsEventArrayDeleteItem]],
