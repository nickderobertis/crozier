...
class NormalizationDestinationDefinitionConfig(UniversalBaseModel):
    ...
    normalization_integration_type: typing_extensions.Annotated[
        typing.Optional[str], FieldMetadata(alias="normalizationIntegrationType")
    ...
    normalization_repository: typing_extensions.Annotated[
        typing.Optional[str], FieldMetadata(alias="normalizationRepository")
    ] = pydantic.Field(default=None)
    """
    ...
    normalization_tag: typing_extensions.Annotated[typing.Optional[str], FieldMetadata(alias="normalizationTag")] = (
        pydantic.Field(default=None)
    )
    """
