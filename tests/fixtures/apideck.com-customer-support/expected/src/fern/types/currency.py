...
class Currency(str, enum.Enum):
    ...
    def visit(
        self,
        unknown_currency: typing.Callable[[], T_Result],
        ...
        if self is Currency.UNKNOWN_CURRENCY:
        ...
        if self is Currency.ZAR:
            return zar()
        if self is Currency.ZMK:
            return zmk()
        if self is Currency.ZMW:
            return zmw()
        if self is Currency.BTC:
            return btc()
        if self is Currency.ETH:
            return eth()
