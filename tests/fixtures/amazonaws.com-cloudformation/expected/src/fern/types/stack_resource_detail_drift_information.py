...
class StackResourceDetailDriftInformation(UniversalBaseModel):
    """
    ...
    stack_resource_drift_status: typing_extensions.Annotated[
        StackResourceDetailDriftInformationStackResourceDriftStatus, FieldMetadata(alias="StackResourceDriftStatus")
    ] = pydantic.Field()
    """
