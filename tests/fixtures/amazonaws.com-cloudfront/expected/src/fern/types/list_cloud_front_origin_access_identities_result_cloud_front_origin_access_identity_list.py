...
class ListCloudFrontOriginAccessIdentitiesResultCloudFrontOriginAccessIdentityList(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[
            typing.List[ListCloudFrontOriginAccessIdentitiesResultCloudFrontOriginAccessIdentityListItemsItem]
        ],
