...
class DictionaryComponentResponseOfint64AndDestinyPresentationNodesComponent(UniversalBaseModel):
    data: typing.Optional[typing.Dict[str, DestinyComponentsPresentationDestinyPresentationNodesComponent]] = None
