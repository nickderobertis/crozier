...
class RawSoftwareStatementCertificatesClient:
    ...
    def get_certificates_for_the_given_software_statement(
        ...
        *,
    ...
    ) -> HttpResponse[CertificatesOrKeys]:
        """
        Parameters
        ----------
        organisation_id : OrganisationId
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"organisations/{encode_path_param(organisation_id)}/softwarestatements/{encode_path_param(software_statement_id)}/certificates",
            method="GET",
    ...
    def get_the_certificate_of_the_given_type_and_id_for_the_given_software_statement(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"organisations/{encode_path_param(organisation_id)}/softwarestatements/{encode_path_param(software_statement_id)}/certificates/{encode_path_param(software_statement_certificate_or_key_type)}/{encode_path_param(certificate_or_key_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
...
class AsyncRawSoftwareStatementCertificatesClient:
    ...
    async def get_certificates_for_the_given_software_statement(
        ...
        *,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[CertificatesOrKeys]:
        """
        Parameters
        ----------
        organisation_id : OrganisationId
    ...
    async def get_the_certificate_of_the_given_type_and_id_for_the_given_software_statement(
        ...
        *,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[CertificateOrKey]:
        """
        Parameters
        ----------
        organisation_id : OrganisationId
