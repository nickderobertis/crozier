...
class ObStatement2(UniversalBaseModel):
    ...
    statement_fee: typing_extensions.Annotated[
        typing.Optional[typing.List[ObStatement2StatementFeeItem]],
    ...
    statement_interest: typing_extensions.Annotated[
        typing.Optional[typing.List[ObStatement2StatementInterestItem]],
        FieldMetadata(alias="StatementInterest"),
        pydantic.Field(alias="StatementInterest"),
    ] = None
    statement_rate: typing_extensions.Annotated[
        typing.Optional[typing.List[ObStatement2StatementRateItem]],
    ...
    statement_value: typing_extensions.Annotated[
        typing.Optional[typing.List[ObStatement2StatementValueItem]],
