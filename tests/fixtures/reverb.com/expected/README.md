...
client = FernApi(...)
response = client.conversations.with_raw_response.make_an_offer_to_the_other_participant_in_the_conversation(...)
...
```python
client.conversations.make_an_offer_to_the_other_participant_in_the_conversation(..., request_options={
    "max_retries": 1
})
```
