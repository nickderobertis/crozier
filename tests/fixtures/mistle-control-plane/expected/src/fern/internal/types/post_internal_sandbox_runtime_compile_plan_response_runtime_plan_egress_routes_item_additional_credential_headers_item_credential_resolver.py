...
class PostInternalSandboxRuntimeCompilePlanResponseRuntimePlanEgressRoutesItemAdditionalCredentialHeadersItemCredentialResolver_IntegrationConnection(
    UniversalBaseModel
):
...
class PostInternalSandboxRuntimeCompilePlanResponseRuntimePlanEgressRoutesItemAdditionalCredentialHeadersItemCredentialResolver_LinkedPrincipal(
    UniversalBaseModel
):
...
class PostInternalSandboxRuntimeCompilePlanResponseRuntimePlanEgressRoutesItemAdditionalCredentialHeadersItemCredentialResolver_MistleMcpToken(
    UniversalBaseModel
):
...
class PostInternalSandboxRuntimeCompilePlanResponseRuntimePlanEgressRoutesItemAdditionalCredentialHeadersItemCredentialResolver_MistleMcpSetupAssistantToken(
    UniversalBaseModel
):
...
class PostInternalSandboxRuntimeCompilePlanResponseRuntimePlanEgressRoutesItemAdditionalCredentialHeadersItemCredentialResolver_MistleMcpDesignerToken(
    UniversalBaseModel
):
...
class PostInternalSandboxRuntimeCompilePlanResponseRuntimePlanEgressRoutesItemAdditionalCredentialHeadersItemCredentialResolver_PlatformOpenaiApiKey(
    UniversalBaseModel
):
...
class PostInternalSandboxRuntimeCompilePlanResponseRuntimePlanEgressRoutesItemAdditionalCredentialHeadersItemCredentialResolver_PlatformLangfuseSecretKey(
    UniversalBaseModel
):
...
PostInternalSandboxRuntimeCompilePlanResponseRuntimePlanEgressRoutesItemAdditionalCredentialHeadersItemCredentialResolver = typing_extensions.Annotated[
    typing.Union[
