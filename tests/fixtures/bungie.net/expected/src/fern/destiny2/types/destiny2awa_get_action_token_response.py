...
from ...types.destiny_advanced_awa_authorization_result import DestinyAdvancedAwaAuthorizationResult


class Destiny2AwaGetActionTokenResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[DestinyAdvancedAwaAuthorizationResult], FieldMetadata(alias="Response")
    ] = None
