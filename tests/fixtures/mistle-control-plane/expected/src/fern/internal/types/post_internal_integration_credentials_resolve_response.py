...
class PostInternalIntegrationCredentialsResolveResponse_Value(UniversalBaseModel):
...
class PostInternalIntegrationCredentialsResolveResponse_AwsSession(UniversalBaseModel):
...
PostInternalIntegrationCredentialsResolveResponse = typing_extensions.Annotated[
    typing.Union[
