...
class SingleComponentResponseOfDestinyItemPlugObjectivesComponent(UniversalBaseModel):
    data: typing.Optional[DestinyComponentsItemsDestinyItemPlugObjectivesComponent] = None
