...
class ObReadProduct2DataProductItemOtherProductTypeCreditInterestTierBandSetItemTierBandMethod(str, enum.Enum):
    """
    ...
    def visit(
        ...
        if self is ObReadProduct2DataProductItemOtherProductTypeCreditInterestTierBandSetItemTierBandMethod.INBA:
            return inba()
        if self is ObReadProduct2DataProductItemOtherProductTypeCreditInterestTierBandSetItemTierBandMethod.INTI:
            return inti()
        if self is ObReadProduct2DataProductItemOtherProductTypeCreditInterestTierBandSetItemTierBandMethod.INWH:
            return inwh()
