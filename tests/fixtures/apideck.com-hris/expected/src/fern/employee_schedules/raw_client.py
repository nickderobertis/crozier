...
class RawEmployeeSchedulesClient:
    ...
    def all_(
        ...
        *,
    ...
    ) -> HttpResponse[GetEmployeeSchedulesResponse]:
        """
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"hris/schedules/employees/{encode_path_param(employee_id)}",
            method="GET",
            params={
                "raw": raw,
                "fields": fields,
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=GetEmployeeSchedulesResponse,
...
class AsyncRawEmployeeSchedulesClient:
    ...
    async def all_(
        ...
        *,
        ...
        fields: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[GetEmployeeSchedulesResponse]:
        """
        List schedules for employee, a schedule is a work pattern, not the actual worked hours, for an employee.
