...
class RawEventManagerClient:
    ...
    ) -> HttpResponse[typing.List[BaseEventAction]]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=typing.List[BaseEventAction],
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                ...
                "options": convert_and_respect_annotation_metadata(
                    object_=options, annotation=BaseEventActionOptions, direction="write"
                ),
                "rules": rules,
            },
            headers={
    ...
    def get_event_action_by_name(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"eventactions/{encode_path_param(name)}",
            method="GET",
            params={
                "confidential_data": confidential_data,
            },
    ...
    def update_event_action(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"eventactions/{encode_path_param(name_)}",
            method="PUT",
            json={
                "id": id,
                "name": name,
    ...
    def get_event_rules(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[typing.List[EventRule]]:
        """
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                "actions": convert_and_respect_annotation_metadata(
                    object_=actions, annotation=typing.Sequence[EventActionMinimal], direction="write"
                ),
                "id": id,
                "name": name,
                "status": status,
                ...
                "conditions": convert_and_respect_annotation_metadata(
                    object_=conditions, annotation=EventConditions, direction="write"
                ),
            },
            headers={
                "content-type": "application/json",
    ...
    def get_event_rile_by_name(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"eventrules/{encode_path_param(name)}",
            method="GET",
            params={
                "confidential_data": confidential_data,
            },
    ...
    def update_event_rule(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"eventrules/{encode_path_param(name_)}",
            method="PUT",
            json={
                "actions": convert_and_respect_annotation_metadata(
                    object_=actions, annotation=typing.Sequence[EventActionMinimal], direction="write"
    ...
    def run_event_rule(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"eventrules/run/{encode_path_param(name)}",
            method="POST",
            request_options=request_options,
        )
        try:
...
class AsyncRawEventManagerClient:
    ...
    async def get_event_actons(
        ...
        *,
        ...
        order: typing.Optional[GetEventActonsRequestOrder] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[typing.List[BaseEventAction]]:
        """
        Returns an array with one or more event actions
    ...
    async def add_event_action(
        ...
        *,
        ...
        rules: typing.Optional[typing.Sequence[str]] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[BaseEventAction]:
        """
        Adds a new event actions
    ...
    async def get_event_rules(
        ...
        *,
        ...
        order: typing.Optional[GetEventRulesRequestOrder] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[typing.List[EventRule]]:
        """
        Returns an array with one or more event rules
