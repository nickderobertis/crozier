...
class StackResourceSummaryDriftInformationStackResourceDriftStatus(str, enum.Enum):
    """
    ...
    def visit(
        ...
        if self is StackResourceSummaryDriftInformationStackResourceDriftStatus.IN_SYNC:
            return in_sync()
        if self is StackResourceSummaryDriftInformationStackResourceDriftStatus.MODIFIED:
            return modified()
        if self is StackResourceSummaryDriftInformationStackResourceDriftStatus.DELETED:
            return deleted()
        if self is StackResourceSummaryDriftInformationStackResourceDriftStatus.NOT_CHECKED:
            return not_checked()
