...
class DocAnnotationsList200ResponseAnnotationsItemLineMeasureRlYItem(UniversalBaseModel):
    unit: str
    conversion: typing.Optional[float] = None
    fraction: typing.Optional[DocAnnotationsList200ResponseAnnotationsItemLineMeasureRlYItemFraction] = None
    ...
    label_position: typing_extensions.Annotated[
        typing.Optional[DocAnnotationsList200ResponseAnnotationsItemLineMeasureRlYItemLabelPosition],
