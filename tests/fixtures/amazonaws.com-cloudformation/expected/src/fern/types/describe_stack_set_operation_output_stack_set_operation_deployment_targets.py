...
class DescribeStackSetOperationOutputStackSetOperationDeploymentTargets(UniversalBaseModel):
    """
    ...
    account_filter_type: typing_extensions.Annotated[
        typing.Optional[DescribeStackSetOperationOutputStackSetOperationDeploymentTargetsAccountFilterType],
