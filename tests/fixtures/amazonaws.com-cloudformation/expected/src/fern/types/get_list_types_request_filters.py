...
class GetListTypesRequestFilters(UniversalBaseModel):
    """
    Filter criteria to use in determining which extensions to return.
    """

    category: typing_extensions.Annotated[
        typing.Optional[GetListTypesRequestFiltersCategory], FieldMetadata(alias="Category")
    ...
    type_name_prefix: typing_extensions.Annotated[typing.Optional[str], FieldMetadata(alias="TypeNamePrefix")] = (
        pydantic.Field(default=None)
    )
    """
