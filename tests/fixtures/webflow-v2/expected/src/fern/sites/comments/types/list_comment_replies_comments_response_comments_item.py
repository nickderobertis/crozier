...
class ListCommentRepliesCommentsResponseCommentsItem(UniversalBaseModel):
    """
    ...
    author: ListCommentRepliesCommentsResponseCommentsItemAuthor
    mentioned_users: typing_extensions.Annotated[
        typing.Optional[typing.List[ListCommentRepliesCommentsResponseCommentsItemMentionedUsersItem]],
