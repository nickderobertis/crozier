...
from .create_products_request_product_field_data_tax_category import CreateProductsRequestProductFieldDataTaxCategory


class CreateProductsRequestProductFieldData(UniversalBaseModel):
    """
    ...
    sku_properties: typing_extensions.Annotated[
        typing.Optional[typing.List[CreateProductsRequestProductFieldDataSkuPropertiesItem]],
    ...
    tax_category: typing_extensions.Annotated[
        typing.Optional[CreateProductsRequestProductFieldDataTaxCategory],
    ...
    ec_product_type: typing_extensions.Annotated[
        typing.Optional[CreateProductsRequestProductFieldDataEcProductType],
