...
class UpdateStreamRequestCanDeleteAnyMessageGroup(UniversalBaseModel):
    """
    ...
    **Changes**: New in Zulip 11.0 (feature level 407). Prior to this
    ...
    new: UpdateStreamRequestCanDeleteAnyMessageGroupNew = pydantic.Field()
    """
    The new [group-setting value](/api/group-setting-values) for who would
    have this permission.
    """

    old: typing.Optional[UpdateStreamRequestCanDeleteAnyMessageGroupOld] = pydantic.Field(default=None)
    """
