...
class DocAnnotationsList200ResponseAnnotationsItemLineMeasureRlDistanceItem(UniversalBaseModel):
    unit: str
    conversion: typing.Optional[float] = None
    fraction: typing.Optional[DocAnnotationsList200ResponseAnnotationsItemLineMeasureRlDistanceItemFraction] = None
    ...
    label_position: typing_extensions.Annotated[
        typing.Optional[DocAnnotationsList200ResponseAnnotationsItemLineMeasureRlDistanceItemLabelPosition],
