...
class ListTypeRegistrationsInput(UniversalBaseModel):
    type: typing_extensions.Annotated[
        typing.Optional[ListTypeRegistrationsInputType],
    ...
    registration_status_filter: typing_extensions.Annotated[
        ...
        pydantic.Field(
            alias="RegistrationStatusFilter",
            description="<p>The current status of the extension registration request.</p> <p>The default is <code>IN_PROGRESS</code>.</p>",
        ),
    ] = None
    """
