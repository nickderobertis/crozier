...
if typing.TYPE_CHECKING:
    from .acks.client import AcksClient, AsyncAcksClient
...
class FernApi:
    ...
    def __init__(
        ...
        *,
        ...
        self._acks: typing.Optional[AcksClient] = None
    ...
    def healthcheck_get(self, *, request_options: typing.Optional[RequestOptions] = None) -> str:
        """
        Parameters
        ----------
        ...
        """
        _response = self._raw_client.healthcheck_get(request_options=request_options)
    ...
    def acks(self):
        if self._acks is None:
            from .acks.client import AcksClient

            self._acks = AcksClient(client_wrapper=self._client_wrapper)
        return self._acks
...
class AsyncFernApi:
    ...
    def __init__(
        ...
        *,
        ...
        self._acks: typing.Optional[AsyncAcksClient] = None
    ...
    async def healthcheck_get(self, *, request_options: typing.Optional[RequestOptions] = None) -> str:
        """
        Parameters
        ----------
        request_options : typing.Optional[RequestOptions]
        ...
        async def main() -> None:
            await client.healthcheck_get()


        asyncio.run(main())
        """
        _response = await self._raw_client.healthcheck_get(request_options=request_options)
        return _response.data
    ...
    def acks(self):
        if self._acks is None:
            from .acks.client import AsyncAcksClient

            self._acks = AsyncAcksClient(client_wrapper=self._client_wrapper)
        return self._acks
