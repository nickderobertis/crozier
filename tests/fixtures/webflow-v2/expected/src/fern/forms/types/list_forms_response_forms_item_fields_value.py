...
class ListFormsResponseFormsItemFieldsValue(UniversalBaseModel):
    """
    ...
    type: typing.Optional[ListFormsResponseFormsItemFieldsValueType] = pydantic.Field(default=None)
    """
    The field type
    """
