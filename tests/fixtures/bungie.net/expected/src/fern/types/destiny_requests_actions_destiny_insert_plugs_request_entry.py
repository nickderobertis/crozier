...
class DestinyRequestsActionsDestinyInsertPlugsRequestEntry(UniversalBaseModel):
    ...
    socket_array_type: typing_extensions.Annotated[typing.Optional[int], FieldMetadata(alias="socketArrayType")] = (
        pydantic.Field(default=None)
    )
    """
    ...
    socket_index: typing_extensions.Annotated[typing.Optional[int], FieldMetadata(alias="socketIndex")] = (
        pydantic.Field(default=None)
    )
    """
