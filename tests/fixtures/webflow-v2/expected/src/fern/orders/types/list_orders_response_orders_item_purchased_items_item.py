...
class ListOrdersResponseOrdersItemPurchasedItemsItem(UniversalBaseModel):
    """
    ...
    row_total: typing_extensions.Annotated[
        typing.Optional[ListOrdersResponseOrdersItemPurchasedItemsItemRowTotal],
    ...
    variant_image: typing_extensions.Annotated[
        typing.Optional[ListOrdersResponseOrdersItemPurchasedItemsItemVariantImage],
        FieldMetadata(alias="variantImage"),
        pydantic.Field(alias="variantImage"),
    ] = None
    variant_price: typing_extensions.Annotated[
        typing.Optional[ListOrdersResponseOrdersItemPurchasedItemsItemVariantPrice],
