...
if typing.TYPE_CHECKING:
    ...
    from .alias_name import AliasName
    ...
    from .get_stats_req import GetStatsReq
    from .has import Has
    from .has_data import HasData
    from .has_req import HasReq
    ...
    from .httpapi_generic_resp_customer_drop_collection_resp_data import (
    ...
    from .privileges_data_item import PrivilegesDataItem
...
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "CollectionSchemaFieldsItem": ".collection_schema_fields_item",
    "CollectionSchemaFieldsItemElementTypeParams": ".collection_schema_fields_item_element_type_params",
    ...
    "GetStatsReq": ".get_stats_req",
    "Has": ".has",
    "HasData": ".has_data",
    "HasReq": ".has_req",
    "HttpReturnCode": ".http_return_code",
    "HttpapiGenericRespCustomerCreateIndexResp": ".httpapi_generic_resp_customer_create_index_resp",
    "HttpapiGenericRespCustomerCreateIndexRespData": ".httpapi_generic_resp_customer_create_index_resp_data",
    "HttpapiGenericRespCustomerDeleteResp": ".httpapi_generic_resp_customer_delete_resp",
    "HttpapiGenericRespCustomerDeleteRespData": ".httpapi_generic_resp_customer_delete_resp_data",
    "HttpapiGenericRespCustomerDropCollectionResp": ".httpapi_generic_resp_customer_drop_collection_resp",
    "HttpapiGenericRespCustomerDropCollectionRespData": ".httpapi_generic_resp_customer_drop_collection_resp_data",
    "HttpapiGenericRespCustomerInsertResp": ".httpapi_generic_resp_customer_insert_resp",
    "HttpapiGenericRespCustomerInsertRespData": ".httpapi_generic_resp_customer_insert_resp_data",
    ...
    "IndexParamIndexConfig": ".index_param_index_config",
    ...
    "PrivilegesDataItem": ".privileges_data_item",
    "RoleName": ".role_name",
    "RoleUser": ".role_user",
