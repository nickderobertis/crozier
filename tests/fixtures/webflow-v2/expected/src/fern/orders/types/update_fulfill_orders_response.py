...
class UpdateFulfillOrdersResponse(UniversalBaseModel):
    ...
    status: typing.Optional[UpdateFulfillOrdersResponseStatus] = pydantic.Field(default=None)
    """
    ...
    dispute_last_status: typing_extensions.Annotated[
        typing.Optional[UpdateFulfillOrdersResponseDisputeLastStatus],
    ...
    customer_paid: typing_extensions.Annotated[
        typing.Optional[UpdateFulfillOrdersResponseCustomerPaid],
    ...
    net_amount: typing_extensions.Annotated[
        typing.Optional[UpdateFulfillOrdersResponseNetAmount],
    ...
    application_fee: typing_extensions.Annotated[
        typing.Optional[UpdateFulfillOrdersResponseApplicationFee],
    ...
    all_addresses: typing_extensions.Annotated[
        typing.Optional[typing.List[UpdateFulfillOrdersResponseAllAddressesItem]],
    ...
    shipping_address: typing_extensions.Annotated[
        typing.Optional[UpdateFulfillOrdersResponseShippingAddress],
    ...
    billing_address: typing_extensions.Annotated[
        typing.Optional[UpdateFulfillOrdersResponseBillingAddress],
    ...
    customer_info: typing_extensions.Annotated[
        typing.Optional[UpdateFulfillOrdersResponseCustomerInfo],
    ...
    purchased_items: typing_extensions.Annotated[
        typing.Optional[typing.List[UpdateFulfillOrdersResponsePurchasedItemsItem]],
    ...
    stripe_details: typing_extensions.Annotated[
        typing.Optional[UpdateFulfillOrdersResponseStripeDetails],
    ...
    stripe_card: typing_extensions.Annotated[
        typing.Optional[UpdateFulfillOrdersResponseStripeCard],
    ...
    paypal_details: typing_extensions.Annotated[
        typing.Optional[UpdateFulfillOrdersResponsePaypalDetails],
    ...
    metadata: typing.Optional[UpdateFulfillOrdersResponseMetadata] = None
    ...
    totals: typing.Optional[UpdateFulfillOrdersResponseTotals] = pydantic.Field(default=None)
    """
    An object describing various pricing totals
    """

    download_files: typing_extensions.Annotated[
        typing.Optional[typing.List[UpdateFulfillOrdersResponseDownloadFilesItem]],
