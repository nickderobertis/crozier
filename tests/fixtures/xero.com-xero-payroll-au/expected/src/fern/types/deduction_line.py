...
class DeductionLine(UniversalBaseModel):
    ...
    calculation_type: typing_extensions.Annotated[DeductionTypeCalculationType, FieldMetadata(alias="CalculationType")]
    deduction_type_id: typing_extensions.Annotated[str, FieldMetadata(alias="DeductionTypeID")] = pydantic.Field()
    """
