...
class RawStatementClient:
    ...
    def create_statement_for_user_monetary_account_event(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"user/{encode_path_param(user_id)}/monetary-account/{encode_path_param(monetary_account_id)}/event/{encode_path_param(event_id)}/statement",
            method="POST",
            json=request,
            headers={
    ...
    def read_statement_for_user_monetary_account_event(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"user/{encode_path_param(user_id)}/monetary-account/{encode_path_param(monetary_account_id)}/event/{encode_path_param(event_id)}/statement/{encode_path_param(item_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
