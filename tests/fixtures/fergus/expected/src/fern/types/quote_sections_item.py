...
class QuoteSectionsItem(UniversalBaseModel):
    ...
    selection_mode: typing_extensions.Annotated[
        QuoteSectionsItemSelectionMode, FieldMetadata(alias="selectionMode"), pydantic.Field(alias="selectionMode")
    ]
    section_config: typing_extensions.Annotated[
        typing.Optional[QuoteSectionsItemSectionConfig],
        FieldMetadata(alias="sectionConfig"),
        pydantic.Field(alias="sectionConfig"),
    ] = None
    line_items: typing_extensions.Annotated[
        typing.Optional[typing.List[QuoteSectionsItemLineItemsItem]],
...
update_forward_refs(QuoteSectionsItem, QuoteSection=QuoteSection)
