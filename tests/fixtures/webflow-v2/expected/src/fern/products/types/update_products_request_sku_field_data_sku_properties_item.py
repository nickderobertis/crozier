...
class UpdateProductsRequestSkuFieldDataSkuPropertiesItem(UniversalBaseModel):
    """
    ...
    enum: typing.List[UpdateProductsRequestSkuFieldDataSkuPropertiesItemEnumItem] = pydantic.Field()
    """
