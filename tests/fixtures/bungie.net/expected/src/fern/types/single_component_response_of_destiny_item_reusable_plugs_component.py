...
class SingleComponentResponseOfDestinyItemReusablePlugsComponent(UniversalBaseModel):
    data: typing.Optional[DestinyComponentsItemsDestinyItemReusablePlugsComponent] = None
