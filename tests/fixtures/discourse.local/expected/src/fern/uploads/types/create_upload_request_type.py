...
class CreateUploadRequestType(str, enum.Enum):
    ...
    def visit(
        ...
        if self is CreateUploadRequestType.AVATAR:
            return avatar()
        if self is CreateUploadRequestType.PROFILE_BACKGROUND:
            return profile_background()
        if self is CreateUploadRequestType.CARD_BACKGROUND:
            return card_background()
        if self is CreateUploadRequestType.CUSTOM_EMOJI:
            return custom_emoji()
        if self is CreateUploadRequestType.COMPOSER:
            return composer()
