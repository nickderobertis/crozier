...
class GetDistributionResultDistributionDistributionConfig(UniversalBaseModel):
    """
    ...
    aliases: typing_extensions.Annotated[
        typing.Optional[GetDistributionResultDistributionDistributionConfigAliases],
    ...
    cache_behaviors: typing_extensions.Annotated[
        typing.Optional[GetDistributionResultDistributionDistributionConfigCacheBehaviors],
    ...
    custom_error_responses: typing_extensions.Annotated[
        typing.Optional[GetDistributionResultDistributionDistributionConfigCustomErrorResponses],
    ...
    logging: typing_extensions.Annotated[
        typing.Optional[GetDistributionResultDistributionDistributionConfigLogging],
    ...
    price_class: typing_extensions.Annotated[
        typing.Optional[GetDistributionResultDistributionDistributionConfigPriceClass],
    ...
    http_version: typing_extensions.Annotated[
        typing.Optional[GetDistributionResultDistributionDistributionConfigHttpVersion],
