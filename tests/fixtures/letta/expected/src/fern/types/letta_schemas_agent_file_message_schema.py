...
class LettaSchemasAgentFileMessageSchema(UniversalBaseModel):
    """
    Message with human-readable ID for agent file
    """

    type: typing.Optional[LettaSchemasAgentFileMessageSchemaType] = pydantic.Field(default=None)
    """
    ...
    tool_returns: typing.Optional[typing.List[LettaSchemasMessageToolReturnInput]] = pydantic.Field(default=None)
    """
