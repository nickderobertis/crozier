...
class TaxDeclaration(UniversalBaseModel):
    approved_withholding_variation_percentage: typing_extensions.Annotated[
        typing.Optional[float], FieldMetadata(alias="ApprovedWithholdingVariationPercentage")
    ...
    australian_resident_for_tax_purposes: typing_extensions.Annotated[
        typing.Optional[bool], FieldMetadata(alias="AustralianResidentForTaxPurposes")
    ] = pydantic.Field(default=None)
    """
    ...
    eligible_to_receive_leave_loading: typing_extensions.Annotated[
        typing.Optional[bool], FieldMetadata(alias="EligibleToReceiveLeaveLoading")
    ] = pydantic.Field(default=None)
    """
    ...
    employment_basis: typing_extensions.Annotated[
        typing.Optional[EmploymentBasis], FieldMetadata(alias="EmploymentBasis")
    ] = None
    has_help_debt: typing_extensions.Annotated[typing.Optional[bool], FieldMetadata(alias="HasHELPDebt")] = (
        pydantic.Field(default=None)
    )
    """
    ...
    has_sfss_debt: typing_extensions.Annotated[typing.Optional[bool], FieldMetadata(alias="HasSFSSDebt")] = (
        pydantic.Field(default=None)
    )
    """
    ...
    has_student_startup_loan: typing_extensions.Annotated[
        typing.Optional[bool], FieldMetadata(alias="HasStudentStartupLoan")
    ] = pydantic.Field(default=None)
    """
    ...
    has_trade_support_loan_debt: typing_extensions.Annotated[
        typing.Optional[bool], FieldMetadata(alias="HasTradeSupportLoanDebt")
    ] = pydantic.Field(default=None)
    """
    ...
    residency_status: typing_extensions.Annotated[
        typing.Optional[ResidencyStatus], FieldMetadata(alias="ResidencyStatus")
    ] = None
    tfn_exemption_type: typing_extensions.Annotated[
        typing.Optional[TfnExemptionType], FieldMetadata(alias="TFNExemptionType")
    ] = None
    tax_file_number: typing_extensions.Annotated[typing.Optional[str], FieldMetadata(alias="TaxFileNumber")] = (
        pydantic.Field(default=None)
    )
    """
    ...
    tax_free_threshold_claimed: typing_extensions.Annotated[
        typing.Optional[bool], FieldMetadata(alias="TaxFreeThresholdClaimed")
    ] = pydantic.Field(default=None)
    """
    ...
    tax_offset_estimated_amount: typing_extensions.Annotated[
        typing.Optional[float], FieldMetadata(alias="TaxOffsetEstimatedAmount")
    ] = pydantic.Field(default=None)
    """
    ...
    upward_variation_tax_withholding_amount: typing_extensions.Annotated[
        typing.Optional[float], FieldMetadata(alias="UpwardVariationTaxWithholdingAmount")
    ] = pydantic.Field(default=None)
    """
