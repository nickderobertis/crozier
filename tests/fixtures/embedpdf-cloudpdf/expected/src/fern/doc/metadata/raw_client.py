...
class RawMetadataClient:
    ...
    def get(
        ...
        *,
    ...
    ) -> HttpResponse[DocMetadataGet200Response]:
        """
        Parameters
        ----------
        doc_id : str
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"v1/docs/{encode_path_param(doc_id)}/layers/{encode_path_param(layer_name)}/metadata",
            method="GET",
            headers={
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=DocMetadataGet200Response,
...
class AsyncRawMetadataClient:
    ...
    async def get(
        ...
        *,
        document_password: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[DocMetadataGet200Response]:
        """
        Parameters
        ----------
        doc_id : str
