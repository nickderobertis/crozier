...
class CreateDistributionRequestDistributionConfigDefaultCacheBehaviorViewerProtocolPolicy(enum.StrEnum):
    """
    ...
    def visit(
        ...
        if self is CreateDistributionRequestDistributionConfigDefaultCacheBehaviorViewerProtocolPolicy.ALLOW_ALL:
            return allow_all()
        if self is CreateDistributionRequestDistributionConfigDefaultCacheBehaviorViewerProtocolPolicy.HTTPS_ONLY:
            return https_only()
        if (
            self
            is CreateDistributionRequestDistributionConfigDefaultCacheBehaviorViewerProtocolPolicy.REDIRECT_TO_HTTPS
        ):
