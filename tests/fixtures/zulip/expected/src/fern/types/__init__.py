...
if typing.TYPE_CHECKING:
    ...
    from .custom_profile_field_data_schema import CustomProfileFieldDataSchema
    from .custom_profile_field_display_in_profile_summary_schema import CustomProfileFieldDisplayInProfileSummarySchema
    from .custom_profile_field_editable_by_user_schema import CustomProfileFieldEditableByUserSchema
    from .custom_profile_field_hint_schema import CustomProfileFieldHintSchema
    from .custom_profile_field_required_schema import CustomProfileFieldRequiredSchema
    from .custom_profile_field_use_for_user_matching_schema import CustomProfileFieldUseForUserMatchingSchema
    ...
    from .profile_data_update import ProfileDataUpdate
...
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "CustomProfileFieldDataSchema": ".custom_profile_field_data_schema",
    "CustomProfileFieldDisplayInProfileSummarySchema": ".custom_profile_field_display_in_profile_summary_schema",
    "CustomProfileFieldEditableByUserSchema": ".custom_profile_field_editable_by_user_schema",
    "CustomProfileFieldHintSchema": ".custom_profile_field_hint_schema",
    "CustomProfileFieldRequiredSchema": ".custom_profile_field_required_schema",
    "CustomProfileFieldUseForUserMatchingSchema": ".custom_profile_field_use_for_user_matching_schema",
    "DefaultChannelGroup": ".default_channel_group",
    "DefaultPushNotifications": ".default_push_notifications",
    "Draft": ".draft",
    ...
    "ProfileDataUpdate": ".profile_data_update",
    "ProfileDataUpdateValue": ".profile_data_update_value",
