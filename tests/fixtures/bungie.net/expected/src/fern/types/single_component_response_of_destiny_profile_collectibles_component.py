...
class SingleComponentResponseOfDestinyProfileCollectiblesComponent(UniversalBaseModel):
    data: typing.Optional[DestinyComponentsCollectiblesDestinyProfileCollectiblesComponent] = None
