...
class DestinyDefinitionsMilestonesDestinyMilestoneDefinition(UniversalBaseModel):
    """
    ...
    activities: typing.Optional[
        typing.List[DestinyDefinitionsMilestonesDestinyMilestoneChallengeActivityDefinition]
    ...
    quests: typing.Optional[typing.Dict[str, DestinyDefinitionsMilestonesDestinyMilestoneQuestDefinition]] = (
        pydantic.Field(default=None)
    )
    """
    ...
    recruitable: typing.Optional[bool] = pydantic.Field(default=None)
    """
    ...
    rewards: typing.Optional[typing.Dict[str, DestinyDefinitionsMilestonesDestinyMilestoneRewardCategoryDefinition]] = (
        pydantic.Field(default=None)
    )
    """
    ...
    values: typing.Optional[typing.Dict[str, DestinyDefinitionsMilestonesDestinyMilestoneValueDefinition]] = (
        pydantic.Field(default=None)
    )
    """
    ...
    vendors: typing.Optional[typing.List[DestinyDefinitionsMilestonesDestinyMilestoneVendorDefinition]] = (
        pydantic.Field(default=None)
    )
    """
