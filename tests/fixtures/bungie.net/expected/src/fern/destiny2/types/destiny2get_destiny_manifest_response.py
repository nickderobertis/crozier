...
from ...types.destiny_config_destiny_manifest import DestinyConfigDestinyManifest


class Destiny2GetDestinyManifestResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[DestinyConfigDestinyManifest], FieldMetadata(alias="Response"), pydantic.Field(alias="Response")
    ] = None
