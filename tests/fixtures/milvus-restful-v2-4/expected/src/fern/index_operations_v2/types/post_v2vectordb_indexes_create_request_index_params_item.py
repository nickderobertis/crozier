...
class PostV2VectordbIndexesCreateRequestIndexParamsItem(UniversalBaseModel):
    ...
    index_config: typing_extensions.Annotated[
        typing.Optional[PostV2VectordbIndexesCreateRequestIndexParamsItemIndexConfig],
