...
class RawOrdersClient:
    ...
    def list(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"sites/{encode_path_param(site_id)}/orders",
    ...
    def get(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"sites/{encode_path_param(site_id)}/orders/{encode_path_param(order_id)}",
            base_url=self._client_wrapper.get_environment().base,
            method="GET",
            request_options=request_options,
        )
    ...
    def update(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[UpdateOrdersResponse]:
        """
    ...
    def update_fulfill(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[UpdateFulfillOrdersResponse]:
        """
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"sites/{encode_path_param(site_id)}/orders/{encode_path_param(order_id)}/fulfill",
            base_url=self._client_wrapper.get_environment().base,
            method="POST",
            json={
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=UpdateFulfillOrdersResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def update_unfulfill(
        self, site_id: str, order_id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> HttpResponse[UpdateUnfulfillOrdersResponse]:
        """
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"sites/{encode_path_param(site_id)}/orders/{encode_path_param(order_id)}/unfulfill",
            base_url=self._client_wrapper.get_environment().base,
            method="POST",
            request_options=request_options,
        )
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=UpdateUnfulfillOrdersResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def refund(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[RefundOrdersResponse]:
        """
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"sites/{encode_path_param(site_id)}/orders/{encode_path_param(order_id)}/refund",
            base_url=self._client_wrapper.get_environment().base,
            method="POST",
            json={
                "reason": reason,
...
class AsyncRawOrdersClient:
    ...
    async def update(
        ...
        *,
        ...
        shipping_tracking_url: typing.Optional[str] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[UpdateOrdersResponse]:
        """
        This API lets you update the fields, `comment`, `shippingProvider`,
        and/or `shippingTracking` for a given order. All three fields can be
        updated simultaneously or independently.
    ...
    async def update_fulfill(
        ...
        *,
        send_order_fulfilled_email: typing.Optional[bool] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[UpdateFulfillOrdersResponse]:
        """
        Updates an order's status to fulfilled
    ...
    async def update_unfulfill(
        self, site_id: str, order_id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[UpdateUnfulfillOrdersResponse]:
        """
        Updates an order's status to unfulfilled
    ...
    async def refund(
        ...
        *,
        reason: typing.Optional[RefundOrdersRequestReason] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[RefundOrdersResponse]:
        """
        This API will reverse a Stripe charge and refund an order back to a
        customer. It will also set the order's status to `refunded`.
