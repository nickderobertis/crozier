...
class DistributionSummaryCacheBehaviorsItemsItemForwardedValuesCookies(UniversalBaseModel):
    """
    ...
    whitelisted_names: typing_extensions.Annotated[
        typing.Optional[DistributionSummaryCacheBehaviorsItemsItemForwardedValuesCookiesWhitelistedNames],
