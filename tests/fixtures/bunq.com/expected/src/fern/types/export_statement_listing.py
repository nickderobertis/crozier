...
class ExportStatementListing(UniversalBaseModel):
    ...
    statement_format: typing.Optional[str] = pydantic.Field(default=None)
    """
    The format of statement.
    """

    statement_number: typing.Optional[int] = pydantic.Field(default=None)
    """
