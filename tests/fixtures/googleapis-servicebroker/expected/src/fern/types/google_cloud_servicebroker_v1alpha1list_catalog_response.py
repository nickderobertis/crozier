...
class GoogleCloudServicebrokerV1Alpha1ListCatalogResponse(UniversalBaseModel):
    """
    ...
    services: typing.Optional[typing.List[GoogleCloudServicebrokerV1Alpha1Service]] = pydantic.Field(default=None)
    """
