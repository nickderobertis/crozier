...
class CreateSkuProductsResponseSkusItemFieldData(UniversalBaseModel):
    """
    ...
    price: CreateSkuProductsResponseSkusItemFieldDataPrice = pydantic.Field()
    """
    price of SKU
    """

    compare_at_price: typing_extensions.Annotated[
        typing.Optional[CreateSkuProductsResponseSkusItemFieldDataCompareAtPrice],
    ...
    ec_sku_billing_method: typing_extensions.Annotated[
        typing.Optional[CreateSkuProductsResponseSkusItemFieldDataEcSkuBillingMethod],
    ...
    ec_sku_subscription_plan: typing_extensions.Annotated[
        typing.Optional[CreateSkuProductsResponseSkusItemFieldDataEcSkuSubscriptionPlan],
    ...
    sku_properties: typing_extensions.Annotated[
        typing.Optional[typing.List[CreateSkuProductsResponseSkusItemFieldDataSkuPropertiesItem]],
