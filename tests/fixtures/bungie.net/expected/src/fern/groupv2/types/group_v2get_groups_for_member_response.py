...
from ...types.groups_v2get_groups_for_member_response import GroupsV2GetGroupsForMemberResponse


class GroupV2GetGroupsForMemberResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[GroupsV2GetGroupsForMemberResponse], FieldMetadata(alias="Response")
    ] = None
