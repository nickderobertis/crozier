...
class UpdateStackSetInputPermissionModel(str, enum.Enum):
    """
    ...
    def visit(
        ...
        if self is UpdateStackSetInputPermissionModel.SERVICE_MANAGED:
            return service_managed()
        if self is UpdateStackSetInputPermissionModel.SELF_MANAGED:
            return self_managed()
