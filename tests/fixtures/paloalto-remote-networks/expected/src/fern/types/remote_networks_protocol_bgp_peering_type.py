...
class RemoteNetworksProtocolBgpPeeringType(enum.StrEnum):
    """
    ...
    def visit(
        ...
        if self is RemoteNetworksProtocolBgpPeeringType.EXCHANGE_V4OVER_V4:
            return exchange_v4over_v4()
        if self is RemoteNetworksProtocolBgpPeeringType.EXCHANGE_V4V6OVER_V4:
            return exchange_v4v6over_v4()
        if self is RemoteNetworksProtocolBgpPeeringType.EXCHANGE_V4OVER_V4V6OVER_V6:
            return exchange_v4over_v4v6over_v6()
        if self is RemoteNetworksProtocolBgpPeeringType.EXCHANGE_V6OVER_V6:
