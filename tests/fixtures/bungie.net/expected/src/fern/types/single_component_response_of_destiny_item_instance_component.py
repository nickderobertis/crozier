...
class SingleComponentResponseOfDestinyItemInstanceComponent(UniversalBaseModel):
    data: typing.Optional[DestinyEntitiesItemsDestinyItemInstanceComponent] = None
