...
class EmojiReactionReactionType(enum.StrEnum):
    """
    ...
    def visit(
        ...
        if self is EmojiReactionReactionType.UNICODE_EMOJI:
            return unicode_emoji()
        if self is EmojiReactionReactionType.REALM_EMOJI:
            return realm_emoji()
        if self is EmojiReactionReactionType.ZULIP_EXTRA_EMOJI:
