...
class TypeSummary(UniversalBaseModel):
    ...
    type: typing_extensions.Annotated[typing.Optional[TypeSummaryType], FieldMetadata(alias="Type")] = pydantic.Field(
        default=None
    )
    """
    ...
    publisher_identity: typing_extensions.Annotated[
        typing.Optional[TypeSummaryPublisherIdentity], FieldMetadata(alias="PublisherIdentity")
    ] = pydantic.Field(default=None)
    """
    ...
    publisher_name: typing_extensions.Annotated[typing.Optional[str], FieldMetadata(alias="PublisherName")] = (
        pydantic.Field(default=None)
    )
    """
