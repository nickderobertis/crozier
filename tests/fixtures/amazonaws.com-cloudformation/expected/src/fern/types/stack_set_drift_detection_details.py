...
class StackSetDriftDetectionDetails(UniversalBaseModel):
    ...
    drift_status: typing_extensions.Annotated[
        typing.Optional[StackSetDriftDetectionDetailsDriftStatus], FieldMetadata(alias="DriftStatus")
    ...
    drift_detection_status: typing_extensions.Annotated[
        typing.Optional[StackSetDriftDetectionDetailsDriftDetectionStatus], FieldMetadata(alias="DriftDetectionStatus")
    ] = pydantic.Field(default=None)
    """
