...
class DistributionSummaryListItemDefaultCacheBehaviorLambdaFunctionAssociationsItemsItem(UniversalBaseModel):
    """
    ...
    event_type: typing_extensions.Annotated[
        typing.Optional[DistributionSummaryListItemDefaultCacheBehaviorLambdaFunctionAssociationsItemsItemEventType],
