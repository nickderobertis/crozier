...
class DestinyDefinitionsDestinyVendorInventoryFlyoutDefinition(UniversalBaseModel):
    ...
    equipment_slot_hash: typing_extensions.Annotated[typing.Optional[int], FieldMetadata(alias="equipmentSlotHash")] = (
        pydantic.Field(default=None)
    )
    """
    ...
    flyout_id: typing_extensions.Annotated[typing.Optional[int], FieldMetadata(alias="flyoutId")] = pydantic.Field(
        default=None
    )
    """
    ...
    locked_description: typing_extensions.Annotated[typing.Optional[str], FieldMetadata(alias="lockedDescription")] = (
        pydantic.Field(default=None)
    )
    """
    ...
    suppress_newness: typing_extensions.Annotated[typing.Optional[bool], FieldMetadata(alias="suppressNewness")] = (
        pydantic.Field(default=None)
    )
    """
