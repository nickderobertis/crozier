...
class GetDistributionResultDistributionDistributionConfigCacheBehaviors(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[typing.List[GetDistributionResultDistributionDistributionConfigCacheBehaviorsItemsItem]],
