...
class UpdateProductsResponseFieldDataEcProductType(enum.StrEnum):
    """
    ...
    def visit(
        ...
        if self is UpdateProductsResponseFieldDataEcProductType.FF42FEE0113744F693A764E3431A9CC2:
            return ff42fee0113744f693a764e3431a9cc2()
        if self is UpdateProductsResponseFieldDataEcProductType.F22027DB68002190AEF89A4A2B7AC8A1:
            return f22027db68002190aef89a4a2b7ac8a1()
        if self is UpdateProductsResponseFieldDataEcProductType.C599E43B1A1C34D5A323AEDF75D3ADF6:
            return c599e43b1a1c34d5a323aedf75d3adf6()
        if self is UpdateProductsResponseFieldDataEcProductType.B6CCC1830DB4B1BABEB06A9AC5F6DD76:
