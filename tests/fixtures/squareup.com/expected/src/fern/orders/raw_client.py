...
class RawOrdersClient:
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                ...
                "order": convert_and_respect_annotation_metadata(object_=order, annotation=Order, direction="write"),
            },
    ...
    def batch_retrieve_orders(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[BatchRetrieveOrdersResponse]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=BatchRetrieveOrdersResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                ...
                "proposed_rewards": convert_and_respect_annotation_metadata(
                    object_=proposed_rewards, annotation=typing.Sequence[OrderReward], direction="write"
                ),
            },
            headers={
                "content-type": "application/json",
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                ...
                "query": convert_and_respect_annotation_metadata(
                    object_=query, annotation=SearchOrdersQuery, direction="write"
                ),
    ...
    def retrieve_order(
    ...
    ) -> HttpResponse[RetrieveOrderResponse]:
        """
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v2/orders/{encode_path_param(order_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def pay_order(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v2/orders/{encode_path_param(order_id)}/pay",
            method="POST",
            json={
                "idempotency_key": idempotency_key,
...
class AsyncRawOrdersClient:
    ...
    async def batch_retrieve_orders(
        ...
        *,
        ...
        location_id: typing.Optional[str] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[BatchRetrieveOrdersResponse]:
        """
        Retrieves a set of [orders](https://developer.squareup.com/reference/square_2021-08-18/objects/Order) by their IDs.
    ...
    async def retrieve_order(
        self, order_id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[RetrieveOrderResponse]:
        """
        Retrieves an [Order](https://developer.squareup.com/reference/square_2021-08-18/objects/Order) by ID.
