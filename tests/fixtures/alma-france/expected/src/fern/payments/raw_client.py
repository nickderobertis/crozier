...
class RawPaymentsClient:
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                "payment": convert_and_respect_annotation_metadata(
                    object_=payment, annotation=CreatePaymentRequestPayment, direction="write"
                ),
    ...
    def getpayment(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[Payment]:
        """
        Parameters
        ----------
        id : str
    ...
    def sendpaymentsms(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"payments/{encode_path_param(id)}/sms",
            method="POST",
            json={
                "phone": phone,
            },
    ...
    def sendpaymentemail(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"payments/{encode_path_param(id)}/email",
            method="POST",
            json={
                "email": email,
            },
    ...
    def cancel_payment(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"payments/{encode_path_param(id)}/cancel",
            method="PUT",
            request_options=request_options,
        )
        try:
    ...
    def update_payment(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"payments/{encode_path_param(id)}/update",
            method="POST",
            json=request,
            headers={
                "content-type": "application/json",
