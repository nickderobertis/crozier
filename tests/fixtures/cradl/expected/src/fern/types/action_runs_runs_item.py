...
class ActionRunsRunsItem(UniversalBaseModel):
    ...
    no_agent_run_update: typing_extensions.Annotated[
        typing.Optional[bool], FieldMetadata(alias="noAgentRunUpdate"), pydantic.Field(alias="noAgentRunUpdate")
    ] = None
    ...
    status: typing.Optional[ActionRunsRunsItemStatus] = None
