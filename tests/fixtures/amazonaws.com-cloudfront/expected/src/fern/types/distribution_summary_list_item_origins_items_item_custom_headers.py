...
class DistributionSummaryListItemOriginsItemsItemCustomHeaders(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[typing.List[DistributionSummaryListItemOriginsItemsItemCustomHeadersItemsItem]],
