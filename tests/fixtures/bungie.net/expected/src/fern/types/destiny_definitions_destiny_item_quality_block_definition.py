...
class DestinyDefinitionsDestinyItemQualityBlockDefinition(UniversalBaseModel):
    ...
    current_version: typing_extensions.Annotated[
        typing.Optional[int],
        FieldMetadata(alias="currentVersion"),
        pydantic.Field(alias="currentVersion", description="The latest version available for this item."),
    ] = None
    """
    ...
    display_version_watermark_icons: typing_extensions.Annotated[
        ...
        FieldMetadata(alias="displayVersionWatermarkIcons"),
        pydantic.Field(
            alias="displayVersionWatermarkIcons",
    ...
    infusion_category_hash: typing_extensions.Annotated[
        typing.Optional[int],
        FieldMetadata(alias="infusionCategoryHash"),
        pydantic.Field(
            alias="infusionCategoryHash",
    ...
    infusion_category_hashes: typing_extensions.Annotated[
        ...
        FieldMetadata(alias="infusionCategoryHashes"),
        pydantic.Field(
            alias="infusionCategoryHashes",
    ...
    infusion_category_name: typing_extensions.Annotated[
        typing.Optional[str],
        FieldMetadata(alias="infusionCategoryName"),
        pydantic.Field(
            alias="infusionCategoryName",
    ...
    item_levels: typing_extensions.Annotated[
        typing.Optional[typing.List[int]],
        FieldMetadata(alias="itemLevels"),
        pydantic.Field(
            alias="itemLevels",
    ...
    progression_level_requirement_hash: typing_extensions.Annotated[
        typing.Optional[int],
        FieldMetadata(alias="progressionLevelRequirementHash"),
        pydantic.Field(
            alias="progressionLevelRequirementHash",
    ...
    quality_level: typing_extensions.Annotated[
        typing.Optional[int],
        FieldMetadata(alias="qualityLevel"),
        pydantic.Field(
            alias="qualityLevel",
