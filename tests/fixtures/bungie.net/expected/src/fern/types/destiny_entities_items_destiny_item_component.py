...
class DestinyEntitiesItemsDestinyItemComponent(UniversalBaseModel):
    ...
    bind_status: typing_extensions.Annotated[typing.Optional[int], FieldMetadata(alias="bindStatus")] = pydantic.Field(
        default=None
    )
    """
    ...
    bucket_hash: typing_extensions.Annotated[typing.Optional[int], FieldMetadata(alias="bucketHash")] = pydantic.Field(
        default=None
    )
    """
    ...
    metric_hash: typing_extensions.Annotated[typing.Optional[int], FieldMetadata(alias="metricHash")] = pydantic.Field(
        default=None
    )
    """
    ...
    metric_objective: typing_extensions.Annotated[
        typing.Optional[DestinyQuestsDestinyObjectiveProgress], FieldMetadata(alias="metricObjective")
    ] = pydantic.Field(default=None)
    """
    ...
    tooltip_notification_indexes: typing_extensions.Annotated[
        typing.Optional[typing.List[int]], FieldMetadata(alias="tooltipNotificationIndexes")
    ] = pydantic.Field(default=None)
    """
    ...
    version_number: typing_extensions.Annotated[typing.Optional[int], FieldMetadata(alias="versionNumber")] = (
        pydantic.Field(default=None)
    )
    """
