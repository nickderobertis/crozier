...
from ...types.groups_v2group_member_leave_result import GroupsV2GroupMemberLeaveResult


class GroupV2KickMemberResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[GroupsV2GroupMemberLeaveResult], FieldMetadata(alias="Response")
    ] = None
