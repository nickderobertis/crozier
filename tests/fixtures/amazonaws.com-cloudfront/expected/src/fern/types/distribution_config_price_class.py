...
class DistributionConfigPriceClass(enum.StrEnum):
    """
    ...
    def visit(
        ...
        if self is DistributionConfigPriceClass.PRICE_CLASS100:
            return price_class100()
        if self is DistributionConfigPriceClass.PRICE_CLASS200:
            return price_class200()
        if self is DistributionConfigPriceClass.PRICE_CLASS_ALL:
