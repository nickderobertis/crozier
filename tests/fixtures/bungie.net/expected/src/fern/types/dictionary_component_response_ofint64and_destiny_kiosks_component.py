...
class DictionaryComponentResponseOfint64AndDestinyKiosksComponent(UniversalBaseModel):
    data: typing.Optional[typing.Dict[str, DestinyComponentsKiosksDestinyKiosksComponent]] = None
