...
class GetMetadataPagesResponse(UniversalBaseModel):
    """
    The Page object
    """
    ...
    seo: typing.Optional[GetMetadataPagesResponseSeo] = pydantic.Field(default=None)
    """
    SEO-related fields for the Page
    """

    open_graph: typing_extensions.Annotated[
        typing.Optional[GetMetadataPagesResponseOpenGraph],
