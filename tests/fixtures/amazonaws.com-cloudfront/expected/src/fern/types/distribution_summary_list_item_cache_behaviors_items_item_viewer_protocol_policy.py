...
class DistributionSummaryListItemCacheBehaviorsItemsItemViewerProtocolPolicy(enum.StrEnum):
    """
    ...
    def visit(
        ...
        if self is DistributionSummaryListItemCacheBehaviorsItemsItemViewerProtocolPolicy.ALLOW_ALL:
            return allow_all()
        if self is DistributionSummaryListItemCacheBehaviorsItemsItemViewerProtocolPolicy.HTTPS_ONLY:
            return https_only()
        if self is DistributionSummaryListItemCacheBehaviorsItemsItemViewerProtocolPolicy.REDIRECT_TO_HTTPS:
