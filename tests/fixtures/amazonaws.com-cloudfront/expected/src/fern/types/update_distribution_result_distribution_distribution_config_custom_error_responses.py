...
class UpdateDistributionResultDistributionDistributionConfigCustomErrorResponses(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[
            typing.List[UpdateDistributionResultDistributionDistributionConfigCustomErrorResponsesItemsItem]
        ],
