...
class CreateDistributionWithTagsResultDistributionDistributionConfigCacheBehaviors(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[
            typing.List[CreateDistributionWithTagsResultDistributionDistributionConfigCacheBehaviorsItemsItem]
        ],
