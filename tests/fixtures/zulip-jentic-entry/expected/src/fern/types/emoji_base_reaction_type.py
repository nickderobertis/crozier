...
class EmojiBaseReactionType(enum.StrEnum):
    """
    ...
    def visit(
        ...
        if self is EmojiBaseReactionType.UNICODE_EMOJI:
            return unicode_emoji()
        if self is EmojiBaseReactionType.REALM_EMOJI:
            return realm_emoji()
        if self is EmojiBaseReactionType.ZULIP_EXTRA_EMOJI:
