...
class GetMessagesResponseMessagesItem(UniversalBaseModel):
    ...
    **Changes**: Before Zulip 7.0 (feature level 163), access to a
    ...
    display_recipient: typing.Optional[GetMessagesResponseMessagesItemDisplayRecipient] = pydantic.Field(default=None)
    """
    ...
    edit_history: typing.Optional[typing.List[GetMessagesResponseMessagesItemEditHistoryItem]] = pydantic.Field(
        default=None
    )
    """
    ...
    **Changes**: Before Zulip 10.0 (feature level 334), `empty_topic_name`
    ...
    submessages: typing.Optional[typing.List[GetMessagesResponseMessagesItemSubmessagesItem]] = pydantic.Field(
        default=None
    )
    """
    ...
    topic_links: typing.Optional[typing.List[GetMessagesResponseMessagesItemTopicLinksItem]] = pydantic.Field(
        default=None
    )
    """
