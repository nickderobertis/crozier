# Arm search: `format-uri-template`

The unreached handling site(s) searched for: `src/ir.rs::scalar_body[=^ {12}_ => return None]`.
Read with: `schema.format=uri-template`.
