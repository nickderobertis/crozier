...
class V1ProjectsCreateProjectBudgetRecurrenceItem(UniversalBaseModel):
    recur: V1ProjectsCreateProjectBudgetRecurrenceItemRecur = pydantic.Field()
    """
    ...
    recur_until: V1ProjectsCreateProjectBudgetRecurrenceItemRecurUntil = pydantic.Field()
    """
