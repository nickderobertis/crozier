...
class PowerOutletTemplateTypeValue(str, enum.Enum):
    ...
    def visit(
        ...
        if self is PowerOutletTemplateTypeValue.IEC60320C5:
            return iec60320c5()
        if self is PowerOutletTemplateTypeValue.IEC60320C7:
            return iec60320c7()
        if self is PowerOutletTemplateTypeValue.IEC60320C13:
            return iec60320c13()
        if self is PowerOutletTemplateTypeValue.IEC60320C15:
            return iec60320c15()
        if self is PowerOutletTemplateTypeValue.IEC60320C19:
            return iec60320c19()
        if self is PowerOutletTemplateTypeValue.IEC60320C21:
            return iec60320c21()
        if self is PowerOutletTemplateTypeValue.IEC60309PNE4H:
            return iec60309pne4h()
        if self is PowerOutletTemplateTypeValue.IEC60309PNE6H:
            return iec60309pne6h()
        if self is PowerOutletTemplateTypeValue.IEC60309PNE9H:
            return iec60309pne9h()
        if self is PowerOutletTemplateTypeValue.IEC603092PE4H:
            return iec603092pe4h()
        if self is PowerOutletTemplateTypeValue.IEC603092PE6H:
            return iec603092pe6h()
        if self is PowerOutletTemplateTypeValue.IEC603092PE9H:
            return iec603092pe9h()
        if self is PowerOutletTemplateTypeValue.IEC603093PE4H:
            return iec603093pe4h()
        if self is PowerOutletTemplateTypeValue.IEC603093PE6H:
            return iec603093pe6h()
        if self is PowerOutletTemplateTypeValue.IEC603093PE9H:
            return iec603093pe9h()
        if self is PowerOutletTemplateTypeValue.IEC603093PNE4H:
            return iec603093pne4h()
        if self is PowerOutletTemplateTypeValue.IEC603093PNE6H:
            return iec603093pne6h()
        if self is PowerOutletTemplateTypeValue.IEC603093PNE9H:
            return iec603093pne9h()
        if self is PowerOutletTemplateTypeValue.NEMA115R:
            return nema115r()
        if self is PowerOutletTemplateTypeValue.NEMA515R:
            return nema515r()
        if self is PowerOutletTemplateTypeValue.NEMA520R:
            return nema520r()
        if self is PowerOutletTemplateTypeValue.NEMA530R:
            return nema530r()
        if self is PowerOutletTemplateTypeValue.NEMA550R:
            return nema550r()
        if self is PowerOutletTemplateTypeValue.NEMA615R:
            return nema615r()
        if self is PowerOutletTemplateTypeValue.NEMA620R:
            return nema620r()
        if self is PowerOutletTemplateTypeValue.NEMA630R:
            return nema630r()
        if self is PowerOutletTemplateTypeValue.NEMA650R:
            return nema650r()
        if self is PowerOutletTemplateTypeValue.NEMA1030R:
            return nema1030r()
        if self is PowerOutletTemplateTypeValue.NEMA1050R:
            return nema1050r()
        if self is PowerOutletTemplateTypeValue.NEMA1420R:
            return nema1420r()
        if self is PowerOutletTemplateTypeValue.NEMA1430R:
            return nema1430r()
        if self is PowerOutletTemplateTypeValue.NEMA1450R:
            return nema1450r()
        if self is PowerOutletTemplateTypeValue.NEMA1460R:
            return nema1460r()
        if self is PowerOutletTemplateTypeValue.NEMA1515R:
            return nema1515r()
        if self is PowerOutletTemplateTypeValue.NEMA1520R:
            return nema1520r()
        if self is PowerOutletTemplateTypeValue.NEMA1530R:
            return nema1530r()
        if self is PowerOutletTemplateTypeValue.NEMA1550R:
            return nema1550r()
        if self is PowerOutletTemplateTypeValue.NEMA1560R:
            return nema1560r()
        if self is PowerOutletTemplateTypeValue.NEMA_L115R:
            return nema_l115r()
        if self is PowerOutletTemplateTypeValue.NEMA_L515R:
            return nema_l515r()
        if self is PowerOutletTemplateTypeValue.NEMA_L520R:
            return nema_l520r()
        if self is PowerOutletTemplateTypeValue.NEMA_L530R:
            return nema_l530r()
        if self is PowerOutletTemplateTypeValue.NEMA_L550R:
            return nema_l550r()
        if self is PowerOutletTemplateTypeValue.NEMA_L615R:
            return nema_l615r()
        if self is PowerOutletTemplateTypeValue.NEMA_L620R:
            return nema_l620r()
        if self is PowerOutletTemplateTypeValue.NEMA_L630R:
            return nema_l630r()
        if self is PowerOutletTemplateTypeValue.NEMA_L650R:
            return nema_l650r()
        if self is PowerOutletTemplateTypeValue.NEMA_L1030R:
            return nema_l1030r()
        if self is PowerOutletTemplateTypeValue.NEMA_L1420R:
            return nema_l1420r()
        if self is PowerOutletTemplateTypeValue.NEMA_L1430R:
            return nema_l1430r()
        if self is PowerOutletTemplateTypeValue.NEMA_L1450R:
            return nema_l1450r()
        if self is PowerOutletTemplateTypeValue.NEMA_L1460R:
            return nema_l1460r()
        if self is PowerOutletTemplateTypeValue.NEMA_L1520R:
            return nema_l1520r()
        if self is PowerOutletTemplateTypeValue.NEMA_L1530R:
            return nema_l1530r()
        if self is PowerOutletTemplateTypeValue.NEMA_L1550R:
            return nema_l1550r()
        if self is PowerOutletTemplateTypeValue.NEMA_L1560R:
            return nema_l1560r()
        if self is PowerOutletTemplateTypeValue.NEMA_L2120R:
            return nema_l2120r()
        if self is PowerOutletTemplateTypeValue.NEMA_L2130R:
            return nema_l2130r()
        if self is PowerOutletTemplateTypeValue.NEMA_L2230R:
            return nema_l2230r()
        if self is PowerOutletTemplateTypeValue.CS6360C:
            return cs6360c()
        if self is PowerOutletTemplateTypeValue.CS6364C:
            return cs6364c()
        if self is PowerOutletTemplateTypeValue.CS8164C:
            return cs8164c()
        if self is PowerOutletTemplateTypeValue.CS8264C:
            return cs8264c()
        if self is PowerOutletTemplateTypeValue.CS8364C:
            return cs8364c()
        if self is PowerOutletTemplateTypeValue.CS8464C:
            return cs8464c()
        if self is PowerOutletTemplateTypeValue.ITA_E:
            return ita_e()
        if self is PowerOutletTemplateTypeValue.ITA_F:
            return ita_f()
        if self is PowerOutletTemplateTypeValue.ITA_G:
            return ita_g()
        if self is PowerOutletTemplateTypeValue.ITA_H:
            return ita_h()
        if self is PowerOutletTemplateTypeValue.ITA_I:
            return ita_i()
        if self is PowerOutletTemplateTypeValue.ITA_J:
            return ita_j()
        if self is PowerOutletTemplateTypeValue.ITA_K:
            return ita_k()
        if self is PowerOutletTemplateTypeValue.ITA_L:
            return ita_l()
        if self is PowerOutletTemplateTypeValue.ITA_M:
            return ita_m()
        if self is PowerOutletTemplateTypeValue.ITA_N:
            return ita_n()
        if self is PowerOutletTemplateTypeValue.ITA_O:
            return ita_o()
        if self is PowerOutletTemplateTypeValue.ITA_MULTISTANDARD:
            return ita_multistandard()
        if self is PowerOutletTemplateTypeValue.USB_A:
            return usb_a()
        if self is PowerOutletTemplateTypeValue.USB_MICRO_B:
            return usb_micro_b()
        if self is PowerOutletTemplateTypeValue.USB_C:
            return usb_c()
        if self is PowerOutletTemplateTypeValue.DC_TERMINAL:
            return dc_terminal()
        if self is PowerOutletTemplateTypeValue.HDOT_CX:
            return hdot_cx()
        if self is PowerOutletTemplateTypeValue.SAF_D_GRID:
            return saf_d_grid()
        if self is PowerOutletTemplateTypeValue.NEUTRIK_POWERCON20A:
            return neutrik_powercon20a()
        if self is PowerOutletTemplateTypeValue.NEUTRIK_POWERCON32A:
            return neutrik_powercon32a()
        if self is PowerOutletTemplateTypeValue.NEUTRIK_POWERCON_TRUE1:
            return neutrik_powercon_true1()
        if self is PowerOutletTemplateTypeValue.NEUTRIK_POWERCON_TRUE1TOP:
            return neutrik_powercon_true1top()
        if self is PowerOutletTemplateTypeValue.UBIQUITI_SMARTPOWER:
            return ubiquiti_smartpower()
        if self is PowerOutletTemplateTypeValue.HARDWIRED:
            return hardwired()
        if self is PowerOutletTemplateTypeValue.OTHER:
            return other()
