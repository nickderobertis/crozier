...
| xml-request | both | Request Body Object.content `application/xml` key | limitations | Census map-key walk: zero declarations across every registered source. Ledger `xml-request`: `discards`. **Committed Fern measurement:** [`xml-request`](probe-expected/xml-request/) |  |  |  |
| xml-response | both | Response Object.content `application/xml` key | limitations | Census map-key walk: zero declarations across every registered source. Ledger `xml-response`: `discards`. **Committed Fern measurement:** [`xml-response`](probe-expected/xml-response/) |  |  |  |
...
| encoding-explode | both | Encoding Object.explode | limitations | Census `mediaType.encoding.explode`: zero declarations across every registered source. Ledger `encoding-explode-or-allowReserved`: `refuses (multipart object `explode`) / ignores (list `explode`, `allowReserved`)`. The separate non-list multipart `explode` refusal was observed in the earlier round but has no distinct region key and no Contract A artifact; that case remains unproven by the gate. **Committed Fern measurement:** [`encoding-explode`](probe-expected/encoding-explode/); control [`encoding-explode-control`](probe-expected/encoding-explode-control/) |  |  |  |
| encoding-allow-reserved | both | Encoding Object.allowReserved | limitations | Census `mediaType.encoding.allowReserved`: zero declarations across every registered source. Ledger `encoding-explode-or-allowReserved`: `refuses (multipart object `explode`) / ignores (list `explode`, `allowReserved`)`. **Committed Fern measurement:** [`encoding-allow-reserved`](probe-expected/encoding-allow-reserved/); control [`encoding-allow-reserved-control`](probe-expected/encoding-allow-reserved-control/) |  |  |  |
...
| range-1XX | both | Responses Object `1XX` key | limitations | Census map-key walk: zero declarations across every registered source. Ledger `range-1XX`: `discards + supply`. **Committed Fern measurement:** [`range-1XX`](probe-expected/range-1XX/) |  |  |  |
| range-2XX | both | Responses Object `2XX` key | golden | Census map-key walk: eight declarations, all in `sigstore-rekor`. | | | |
| range-3XX | both | Responses Object `3XX` key | limitations | Census map-key walk: zero declarations across every registered source. Ledger `range-3XX`: `discards`. **Committed Fern measurement:** [`range-3XX`](probe-expected/range-3XX/) |  |  |  |
| range-4XX | both | Responses Object `4XX` key | limitations | Census map-key walk: zero declarations across every registered source. Ledger `range-4XX`: `discards`. **Committed Fern measurement:** [`range-4XX`](probe-expected/range-4XX/) |  |  |  |
| range-5XX | both | Responses Object `5XX` key | limitations | Census map-key walk: zero declarations across every registered source. Ledger `range-5XX`: `discards`. **Committed Fern measurement:** [`range-5XX`](probe-expected/range-5XX/) |  |  |  |
...
| link-requestBody | both | Link Object.requestBody | limitations | Census `link.requestBody`: zero declarations across every registered source. Ledger `link-requestBody`: `discards + supply`. **Committed Fern measurement:** [`link-requestBody`](probe-expected/link-requestBody/) |  |  |  |
| link-description | both | Link Object.description | limitations | Census `link.description`: zero declarations across every registered source. Ledger `link-description`: `discards`. **Committed Fern measurement:** [`link-description`](probe-expected/link-description/) |  |  |  |
| link-server | both | Link Object.server | limitations | Census `link.server`: zero declarations across every registered source. Ledger `link-server`: `discards + supply`. **Committed Fern measurement:** [`link-server`](probe-expected/link-server/) |  |  |  |
