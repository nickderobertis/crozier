...
class ResourceChange(UniversalBaseModel):
    """
    ...
    action: typing_extensions.Annotated[typing.Optional[ResourceChangeAction], FieldMetadata(alias="Action")] = (
    ...
    replacement: typing_extensions.Annotated[
        typing.Optional[ResourceChangeReplacement], FieldMetadata(alias="Replacement")
    ] = pydantic.Field(default=None)
    """
    ...
    module_info: typing_extensions.Annotated[
        typing.Optional[ResourceChangeModuleInfo], FieldMetadata(alias="ModuleInfo")
    ] = pydantic.Field(default=None)
    """
