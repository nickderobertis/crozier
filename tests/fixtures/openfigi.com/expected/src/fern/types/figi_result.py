...
class FigiResult(UniversalBaseModel):
    composite_figi: typing_extensions.Annotated[typing.Optional[str], FieldMetadata(alias="compositeFIGI")] = None
    exch_code: typing_extensions.Annotated[typing.Optional[str], FieldMetadata(alias="exchCode")] = None
    figi: typing.Optional[str] = None
    market_sector: typing_extensions.Annotated[typing.Optional[str], FieldMetadata(alias="marketSector")] = None
    ...
    security_description: typing_extensions.Annotated[
        typing.Optional[str], FieldMetadata(alias="securityDescription")
    ] = None
    ...
    share_class_figi: typing_extensions.Annotated[typing.Optional[str], FieldMetadata(alias="shareClassFIGI")] = None
