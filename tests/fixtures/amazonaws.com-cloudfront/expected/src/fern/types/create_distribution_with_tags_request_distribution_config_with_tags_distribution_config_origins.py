...
class CreateDistributionWithTagsRequestDistributionConfigWithTagsDistributionConfigOrigins(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[
            typing.List[CreateDistributionWithTagsRequestDistributionConfigWithTagsDistributionConfigOriginsItemsItem]
        ],
