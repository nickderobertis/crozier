...
class DocPagesViewports200ResponseItemMeasureRlXItem(UniversalBaseModel):
    unit: str
    conversion: typing.Optional[float] = None
    fraction: typing.Optional[DocPagesViewports200ResponseItemMeasureRlXItemFraction] = None
    ...
    label_position: typing_extensions.Annotated[
        typing.Optional[DocPagesViewports200ResponseItemMeasureRlXItemLabelPosition],
