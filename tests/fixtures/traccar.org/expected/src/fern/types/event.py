...
class Event(UniversalBaseModel):
    ...
    geofence_id: typing_extensions.Annotated[typing.Optional[int], FieldMetadata(alias="geofenceId")] = None
    id: typing.Optional[int] = None
    maintenance_id: typing_extensions.Annotated[typing.Optional[int], FieldMetadata(alias="maintenanceId")] = None
