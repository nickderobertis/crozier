...
class GetLinksLinkIdResponse(UniversalBaseModel):
    ...
    expires_at: typing_extensions.Annotated[
        typing.Optional[GetLinksLinkIdResponseExpiresAt],
    ...
    ttl: typing.Optional[GetLinksLinkIdResponseTtl] = pydantic.Field(default=None)
    """
    ...
    split_urlv2: typing_extensions.Annotated[
        typing.Optional[typing.List[GetLinksLinkIdResponseSplitUrlv2Item]],
    ...
    redirect_type: typing_extensions.Annotated[
        typing.Optional[GetLinksLinkIdResponseRedirectType],
    ...
    source: typing.Optional[GetLinksLinkIdResponseSource] = pydantic.Field(default=None)
    """
    Link source
    """

    user: typing_extensions.Annotated[
        typing.Optional[GetLinksLinkIdResponseUser], FieldMetadata(alias="User"), pydantic.Field(alias="User")
    ] = None
