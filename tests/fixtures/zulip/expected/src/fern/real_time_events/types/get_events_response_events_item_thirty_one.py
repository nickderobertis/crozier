...
class GetEventsResponseEventsItemThirtyOne(UniversalBaseModel):
    """
    ...
    **Changes**: Before Zulip 12.0 (feature level 457), an
    ...
    type: typing.Optional[GetEventsResponseEventsItemThirtyOneType] = pydantic.Field(default=None)
    """
    ...
    **Changes**: Before Zulip 11.0 (feature level 393), this list was
    ...
    message_type: typing.Optional[GetEventsResponseEventsItemThirtyOneMessageType] = pydantic.Field(default=None)
    """
