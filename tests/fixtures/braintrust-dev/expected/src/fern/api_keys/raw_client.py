...
class RawApiKeysClient:
    ...
    def post_api_key(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[CreateApiKeyOutput]:
        """
    ...
    def get_api_key_id(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/api_key/{encode_path_param(api_key_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
...
class AsyncRawApiKeysClient:
    ...
    async def post_api_key(
        ...
        *,
        ...
        org_name: typing.Optional[str] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[CreateApiKeyOutput]:
        """
        Create a new api_key. It is possible to have multiple API keys with the same name. There is no de-duplication
