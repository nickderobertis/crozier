...
from ...types.content_content_item_public_contract import ContentContentItemPublicContract


class ContentGetContentByTagAndTypeResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[ContentContentItemPublicContract], FieldMetadata(alias="Response")
    ] = None
