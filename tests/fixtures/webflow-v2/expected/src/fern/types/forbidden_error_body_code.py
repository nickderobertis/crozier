...
class ForbiddenErrorBodyCode(enum.StrEnum):
    """
    Error code
    """
    ...
    def visit(
        ...
        if self is ForbiddenErrorBodyCode.ANALYZE_FILTER_CONFLICT:
            return analyze_filter_conflict()
        if self is ForbiddenErrorBodyCode.ANALYZE_INPUT_VALIDATION:
            return analyze_input_validation()
        if self is ForbiddenErrorBodyCode.ANALYZE_UNSUPPORTED_FILTER:
            return analyze_unsupported_filter()
        if self is ForbiddenErrorBodyCode.BAD_REQUEST:
            return bad_request()
        if self is ForbiddenErrorBodyCode.BEFORE_HISTORICAL_FLOOR:
            return before_historical_floor()
        if self is ForbiddenErrorBodyCode.COLLECTION_NOT_FOUND:
            return collection_not_found()
        if self is ForbiddenErrorBodyCode.CONFLICT:
            return conflict()
        if self is ForbiddenErrorBodyCode.DUPLICATE_COLLECTION:
            return duplicate_collection()
        if self is ForbiddenErrorBodyCode.DUPLICATE_USER_EMAIL:
            return duplicate_user_email()
        if self is ForbiddenErrorBodyCode.ECOMMERCE_NOT_ENABLED:
            return ecommerce_not_enabled()
        if self is ForbiddenErrorBodyCode.FORBIDDEN:
            return forbidden()
        if self is ForbiddenErrorBodyCode.FORMS_REQUIRE_REPUBLISH:
            return forms_require_republish()
        if self is ForbiddenErrorBodyCode.INCOMPATIBLE_WEBHOOK_FILTER:
            return incompatible_webhook_filter()
        if self is ForbiddenErrorBodyCode.INTERNAL_ERROR:
            return internal_error()
        if self is ForbiddenErrorBodyCode.INVALID_AUTH_VERSION:
            return invalid_auth_version()
        if self is ForbiddenErrorBodyCode.INVALID_CREDENTIALS:
            return invalid_credentials()
        if self is ForbiddenErrorBodyCode.INVALID_DOMAIN:
            return invalid_domain()
        if self is ForbiddenErrorBodyCode.INVALID_TIME_RANGE:
            return invalid_time_range()
        if self is ForbiddenErrorBodyCode.INVALID_USER_EMAIL:
            return invalid_user_email()
        if self is ForbiddenErrorBodyCode.ITEM_NOT_FOUND:
            return item_not_found()
        if self is ForbiddenErrorBodyCode.MISSING_SCOPES:
            return missing_scopes()
        if self is ForbiddenErrorBodyCode.NO_DOMAINS:
            return no_domains()
        if self is ForbiddenErrorBodyCode.NOT_AUTHORIZED:
            return not_authorized()
        if self is ForbiddenErrorBodyCode.NOT_ENTERPRISE_PLAN_SITE:
            return not_enterprise_plan_site()
        if self is ForbiddenErrorBodyCode.NOT_ENTERPRISE_PLAN_WORKSPACE:
            return not_enterprise_plan_workspace()
        if self is ForbiddenErrorBodyCode.ORDER_NOT_FOUND:
            return order_not_found()
        if self is ForbiddenErrorBodyCode.RESOURCE_NOT_FOUND:
            return resource_not_found()
        if self is ForbiddenErrorBodyCode.SERVICE_UNAVAILABLE:
            return service_unavailable()
        if self is ForbiddenErrorBodyCode.TIME_RANGE_TOO_WIDE:
            return time_range_too_wide()
        if self is ForbiddenErrorBodyCode.TOO_MANY_REQUESTS:
            return too_many_requests()
        if self is ForbiddenErrorBodyCode.UNSUPPORTED_VERSION:
            return unsupported_version()
        if self is ForbiddenErrorBodyCode.UNSUPPORTED_WEBHOOK_TRIGGER_TYPE:
            return unsupported_webhook_trigger_type()
        if self is ForbiddenErrorBodyCode.USER_LIMIT_REACHED:
            return user_limit_reached()
        if self is ForbiddenErrorBodyCode.USER_NOT_FOUND:
            return user_not_found()
        if self is ForbiddenErrorBodyCode.USERS_NOT_ENABLED:
            return users_not_enabled()
        if self is ForbiddenErrorBodyCode.VALIDATION_ERROR:
