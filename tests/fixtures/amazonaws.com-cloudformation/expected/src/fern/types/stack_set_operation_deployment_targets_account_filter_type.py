...
class StackSetOperationDeploymentTargetsAccountFilterType(str, enum.Enum):
    """
    ...
    def visit(
        ...
        if self is StackSetOperationDeploymentTargetsAccountFilterType.NONE:
            return none()
        if self is StackSetOperationDeploymentTargetsAccountFilterType.INTERSECTION:
            return intersection()
        if self is StackSetOperationDeploymentTargetsAccountFilterType.DIFFERENCE:
            return difference()
        if self is StackSetOperationDeploymentTargetsAccountFilterType.UNION:
            return union()
