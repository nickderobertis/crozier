...
class TokensApplyMissingPartnerOffersWithoutClaimResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[typing.Optional[bool], FieldMetadata(alias="Response")] = None
