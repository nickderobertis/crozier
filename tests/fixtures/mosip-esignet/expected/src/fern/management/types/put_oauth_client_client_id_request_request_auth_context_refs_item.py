...
class PutOauthClientClientIdRequestRequestAuthContextRefsItem(enum.StrEnum):
    ...
    def visit(
        ...
        if self is PutOauthClientClientIdRequestRequestAuthContextRefsItem.MOSIP_IDP_ACR_STATIC_CODE:
            return mosip_idp_acr_static_code()
        if self is PutOauthClientClientIdRequestRequestAuthContextRefsItem.MOSIP_IDP_ACR_GENERATED_CODE:
            return mosip_idp_acr_generated_code()
        if self is PutOauthClientClientIdRequestRequestAuthContextRefsItem.MOSIP_IDP_ACR_LINKED_WALLET:
            return mosip_idp_acr_linked_wallet()
        if self is PutOauthClientClientIdRequestRequestAuthContextRefsItem.MOSIP_IDP_ACR_BIOMETRICS:
            return mosip_idp_acr_biometrics()
        if self is PutOauthClientClientIdRequestRequestAuthContextRefsItem.MOSIP_IDP_ACR_ID_TOKEN:
            return mosip_idp_acr_id_token()
        if self is PutOauthClientClientIdRequestRequestAuthContextRefsItem.MOSIP_IDP_ACR_PASSWORD:
            return mosip_idp_acr_password()
        if self is PutOauthClientClientIdRequestRequestAuthContextRefsItem.MOSIP_IDP_ACR_KNOWLEDGE:
