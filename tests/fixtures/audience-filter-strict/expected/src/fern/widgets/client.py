...
class WidgetsClient:
    ...
    def list_widgets(self, *, request_options: typing.Optional[RequestOptions] = None) -> typing.List[Widget]:
        """
        Parameters
        ----------
...
class AsyncWidgetsClient:
    ...
    async def list_widgets(self, *, request_options: typing.Optional[RequestOptions] = None) -> typing.List[Widget]:
        """
        Parameters
        ----------
        request_options : typing.Optional[RequestOptions]
