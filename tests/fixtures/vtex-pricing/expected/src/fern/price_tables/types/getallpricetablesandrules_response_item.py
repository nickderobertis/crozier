...
class GetallpricetablesandrulesResponseItem(UniversalBaseModel):
    ...
    rules: typing.Optional[typing.List[GetallpricetablesandrulesResponseItemRulesItem]] = pydantic.Field(default=None)
    """
