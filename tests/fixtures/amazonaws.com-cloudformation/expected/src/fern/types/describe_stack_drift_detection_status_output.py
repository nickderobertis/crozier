...
class DescribeStackDriftDetectionStatusOutput(UniversalBaseModel):
    ...
    stack_drift_detection_id: typing_extensions.Annotated[
        ...
        pydantic.Field(
            ...
            description="<p>The ID of the drift detection results of this operation.</p> <p>CloudFormation generates new results, with a new drift detection ID, each time this operation is run. However, the number of reports CloudFormation retains for any given stack, and for how long, may vary.</p>",
        ),
    ]
    """
    ...
    detection_status_reason: typing_extensions.Annotated[
        typing.Optional[str],
        FieldMetadata(alias="DetectionStatusReason"),
        pydantic.Field(
            alias="DetectionStatusReason",
            description="The reason the stack drift detection operation has its current status.",
        ),
    ] = None
    """
    ...
    drifted_stack_resource_count: typing_extensions.Annotated[
        typing.Optional[int],
        FieldMetadata(alias="DriftedStackResourceCount"),
        pydantic.Field(
            alias="DriftedStackResourceCount",
            description="Total number of stack resources that have drifted. This is NULL until the drift detection operation reaches a status of <code>DETECTION_COMPLETE</code>. This value will be 0 for stacks whose drift status is <code>IN_SYNC</code>.",
        ),
    ] = None
    """
    ...
    timestamp: typing_extensions.Annotated[
        ...
        pydantic.Field(
            alias="Timestamp", description="Time at which the stack drift detection operation was initiated."
        ),
    ]
    """
