...
from .prediction_postprocess_config import PredictionPostprocessConfig
...
class Prediction(UniversalBaseModel):
    ...
    postprocess_config: typing_extensions.Annotated[
        typing.Optional[PredictionPostprocessConfig],
    ...
    preprocess_config: typing_extensions.Annotated[
        typing.Optional[PredictionPreprocessConfig],
    ...
    status: typing.Optional[PredictionStatus] = None
