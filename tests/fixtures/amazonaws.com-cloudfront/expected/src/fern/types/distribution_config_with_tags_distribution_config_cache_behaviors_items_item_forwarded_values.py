...
class DistributionConfigWithTagsDistributionConfigCacheBehaviorsItemsItemForwardedValues(UniversalBaseModel):
    """
    ...
    headers: typing_extensions.Annotated[
        typing.Optional[DistributionConfigWithTagsDistributionConfigCacheBehaviorsItemsItemForwardedValuesHeaders],
