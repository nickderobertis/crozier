...
class ObReadProduct2DataProductItemOtherProductTypeProductDetails(UniversalBaseModel):
    fee_free_length: typing_extensions.Annotated[typing.Optional[int], FieldMetadata(alias="FeeFreeLength")] = (
    ...
    other_segment: typing_extensions.Annotated[
        typing.Optional[ObOtherCodeType10], FieldMetadata(alias="OtherSegment")
    ] = None
