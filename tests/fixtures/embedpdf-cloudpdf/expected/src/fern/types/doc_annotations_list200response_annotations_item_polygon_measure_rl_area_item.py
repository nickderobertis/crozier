...
class DocAnnotationsList200ResponseAnnotationsItemPolygonMeasureRlAreaItem(UniversalBaseModel):
    unit: str
    conversion: typing.Optional[float] = None
    fraction: typing.Optional[DocAnnotationsList200ResponseAnnotationsItemPolygonMeasureRlAreaItemFraction] = None
    ...
    label_position: typing_extensions.Annotated[
        typing.Optional[DocAnnotationsList200ResponseAnnotationsItemPolygonMeasureRlAreaItemLabelPosition],
