...
from .list_orders_response_orders_item_all_addresses_item_type import ListOrdersResponseOrdersItemAllAddressesItemType


class ListOrdersResponseOrdersItemAllAddressesItem(UniversalBaseModel):
    """
    A customer address
    """

    type: typing.Optional[ListOrdersResponseOrdersItemAllAddressesItemType] = pydantic.Field(default=None)
    """
    The type of the order address (billing or shipping)
    """

    japan_type: typing_extensions.Annotated[
        typing.Optional[ListOrdersResponseOrdersItemAllAddressesItemJapanType],
