...
from .llm_config_response_format import LlmConfigResponseFormat
...
class LlmConfig(UniversalBaseModel):
    ...
    effort: typing.Optional[LlmConfigEffort] = pydantic.Field(default=None)
    """
    ...
    response_format: typing.Optional[LlmConfigResponseFormat] = pydantic.Field(default=None)
    """
