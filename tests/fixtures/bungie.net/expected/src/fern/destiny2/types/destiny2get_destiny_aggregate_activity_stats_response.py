...
from ...types.destiny_historical_stats_destiny_aggregate_activity_results import (
    DestinyHistoricalStatsDestinyAggregateActivityResults,
)


class Destiny2GetDestinyAggregateActivityStatsResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[DestinyHistoricalStatsDestinyAggregateActivityResults], FieldMetadata(alias="Response")
    ] = None
