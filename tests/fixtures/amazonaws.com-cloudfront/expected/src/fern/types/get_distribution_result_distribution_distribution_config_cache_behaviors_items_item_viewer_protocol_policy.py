...
class GetDistributionResultDistributionDistributionConfigCacheBehaviorsItemsItemViewerProtocolPolicy(enum.StrEnum):
    """
    ...
    def visit(
        ...
        if (
            self
            is GetDistributionResultDistributionDistributionConfigCacheBehaviorsItemsItemViewerProtocolPolicy.ALLOW_ALL
        ):
            return allow_all()
        if (
            self
            is GetDistributionResultDistributionDistributionConfigCacheBehaviorsItemsItemViewerProtocolPolicy.HTTPS_ONLY
        ):
            return https_only()
        if (
            self
            is GetDistributionResultDistributionDistributionConfigCacheBehaviorsItemsItemViewerProtocolPolicy.REDIRECT_TO_HTTPS
        ):
