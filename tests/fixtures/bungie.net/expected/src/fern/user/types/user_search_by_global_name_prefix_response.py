...
from ...types.user_user_search_response import UserUserSearchResponse


class UserSearchByGlobalNamePrefixResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[typing.Optional[UserUserSearchResponse], FieldMetadata(alias="Response")] = (
        None
    )
