...
class AddQuoteResponseData(UniversalBaseModel):
    id: float
    ...
    sections: typing.Optional[typing.List[AddQuoteResponseDataSectionsItem]] = None
    deposit: typing.Optional[AddQuoteResponseDataDeposit] = None
    links: typing.Optional[typing.List[AddQuoteResponseDataLinksItem]] = None
...
update_forward_refs(AddQuoteResponseData)
