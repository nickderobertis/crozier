...
class SessionPromptAsyncRequestPartsItem_Text(UniversalBaseModel):
...
class SessionPromptAsyncRequestPartsItem_File(UniversalBaseModel):
...
class SessionPromptAsyncRequestPartsItem_Agent(UniversalBaseModel):
...
class SessionPromptAsyncRequestPartsItem_Subtask(UniversalBaseModel):
...
SessionPromptAsyncRequestPartsItem = typing_extensions.Annotated[
    typing.Union[
