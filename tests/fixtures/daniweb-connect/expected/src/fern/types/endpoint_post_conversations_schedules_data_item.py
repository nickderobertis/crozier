...
class EndpointPostConversationsSchedulesDataItem(UniversalBaseModel):
    ...
    navigation: typing.Optional[EndpointPostConversationsSchedulesDataItemNavigation] = None
...
update_forward_refs(EndpointPostConversationsSchedulesDataItem, Conversation=Conversation, Message=Message)
