...
from .detailed_customer_invoice_sections_item_line_items_item import DetailedCustomerInvoiceSectionsItemLineItemsItem


class DetailedCustomerInvoiceSectionsItem(UniversalBaseModel):
    ...
    line_items: typing_extensions.Annotated[
        typing.Optional[typing.List[DetailedCustomerInvoiceSectionsItemLineItemsItem]],
...
update_forward_refs(DetailedCustomerInvoiceSectionsItem, InvoiceSection=InvoiceSection)
