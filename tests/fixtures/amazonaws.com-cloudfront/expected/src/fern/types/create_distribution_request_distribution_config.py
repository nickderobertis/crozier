...
from .create_distribution_request_distribution_config_aliases import CreateDistributionRequestDistributionConfigAliases
...
from .create_distribution_request_distribution_config_logging import CreateDistributionRequestDistributionConfigLogging
from .create_distribution_request_distribution_config_origins import CreateDistributionRequestDistributionConfigOrigins
...
class CreateDistributionRequestDistributionConfig(UniversalBaseModel):
    """
    ...
    aliases: typing_extensions.Annotated[
        typing.Optional[CreateDistributionRequestDistributionConfigAliases],
    ...
    cache_behaviors: typing_extensions.Annotated[
        typing.Optional[CreateDistributionRequestDistributionConfigCacheBehaviors],
    ...
    custom_error_responses: typing_extensions.Annotated[
        typing.Optional[CreateDistributionRequestDistributionConfigCustomErrorResponses],
    ...
    logging: typing_extensions.Annotated[
        typing.Optional[CreateDistributionRequestDistributionConfigLogging],
    ...
    price_class: typing_extensions.Annotated[
        typing.Optional[CreateDistributionRequestDistributionConfigPriceClass],
    ...
    http_version: typing_extensions.Annotated[
        typing.Optional[CreateDistributionRequestDistributionConfigHttpVersion],
