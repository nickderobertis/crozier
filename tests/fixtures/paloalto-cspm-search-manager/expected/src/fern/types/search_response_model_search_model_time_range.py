...
class SearchResponseModelSearchModelTimeRange_Absolute(UniversalBaseModel):
    """
    Time Range
    """
...
class SearchResponseModelSearchModelTimeRange_Relative(UniversalBaseModel):
    """
    Time Range
    """
...
class SearchResponseModelSearchModelTimeRange_ToNow(UniversalBaseModel):
    """
    Time Range
    """
...
SearchResponseModelSearchModelTimeRange = typing_extensions.Annotated[
    typing.Union[
