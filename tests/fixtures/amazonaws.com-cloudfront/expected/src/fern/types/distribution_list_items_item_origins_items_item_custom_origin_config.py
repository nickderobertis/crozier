...
class DistributionListItemsItemOriginsItemsItemCustomOriginConfig(UniversalBaseModel):
    """
    ...
    origin_ssl_protocols: typing_extensions.Annotated[
        typing.Optional[DistributionListItemsItemOriginsItemsItemCustomOriginConfigOriginSslProtocols],
