...
class ObReadConsent1DataPermissionsItem(str, enum.Enum):
    """
    ...
    def visit(
        ...
        if self is ObReadConsent1DataPermissionsItem.READ_ACCOUNTS_BASIC:
            return read_accounts_basic()
        if self is ObReadConsent1DataPermissionsItem.READ_ACCOUNTS_DETAIL:
            return read_accounts_detail()
        if self is ObReadConsent1DataPermissionsItem.READ_BALANCES:
            return read_balances()
        if self is ObReadConsent1DataPermissionsItem.READ_BENEFICIARIES_BASIC:
            return read_beneficiaries_basic()
        if self is ObReadConsent1DataPermissionsItem.READ_BENEFICIARIES_DETAIL:
            return read_beneficiaries_detail()
        if self is ObReadConsent1DataPermissionsItem.READ_DIRECT_DEBITS:
            return read_direct_debits()
        if self is ObReadConsent1DataPermissionsItem.READ_OFFERS:
            return read_offers()
        if self is ObReadConsent1DataPermissionsItem.READ_PAN:
            return read_pan()
        if self is ObReadConsent1DataPermissionsItem.READ_PARTY:
            return read_party()
        if self is ObReadConsent1DataPermissionsItem.READ_PARTY_PSU:
            return read_party_psu()
        if self is ObReadConsent1DataPermissionsItem.READ_PRODUCTS:
            return read_products()
        if self is ObReadConsent1DataPermissionsItem.READ_SCHEDULED_PAYMENTS_BASIC:
            return read_scheduled_payments_basic()
        if self is ObReadConsent1DataPermissionsItem.READ_SCHEDULED_PAYMENTS_DETAIL:
            return read_scheduled_payments_detail()
        if self is ObReadConsent1DataPermissionsItem.READ_STANDING_ORDERS_BASIC:
            return read_standing_orders_basic()
        if self is ObReadConsent1DataPermissionsItem.READ_STANDING_ORDERS_DETAIL:
            return read_standing_orders_detail()
        if self is ObReadConsent1DataPermissionsItem.READ_STATEMENTS_BASIC:
            return read_statements_basic()
        if self is ObReadConsent1DataPermissionsItem.READ_STATEMENTS_DETAIL:
            return read_statements_detail()
        if self is ObReadConsent1DataPermissionsItem.READ_TRANSACTIONS_BASIC:
            return read_transactions_basic()
        if self is ObReadConsent1DataPermissionsItem.READ_TRANSACTIONS_CREDITS:
            return read_transactions_credits()
        if self is ObReadConsent1DataPermissionsItem.READ_TRANSACTIONS_DEBITS:
            return read_transactions_debits()
        if self is ObReadConsent1DataPermissionsItem.READ_TRANSACTIONS_DETAIL:
