...
class AlertEndPositionPropertiesFixStatus(enum.StrEnum):
    """
    ...
    def visit(self, two_d: typing.Callable[[], T_Result], three_d: typing.Callable[[], T_Result]) -> T_Result:
        if self is AlertEndPositionPropertiesFixStatus.TWO_D:
            return two_d()
        if self is AlertEndPositionPropertiesFixStatus.THREE_D:
            return three_d()
