...
from ...types.groups_v2group_potential_membership_search_response import GroupsV2GroupPotentialMembershipSearchResponse


class GroupV2GetPotentialGroupsForMemberResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[GroupsV2GroupPotentialMembershipSearchResponse], FieldMetadata(alias="Response")
    ] = None
