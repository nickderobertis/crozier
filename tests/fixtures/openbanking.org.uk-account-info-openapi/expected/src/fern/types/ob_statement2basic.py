...
class ObStatement2Basic(UniversalBaseModel):
    ...
    statement_benefit: typing_extensions.Annotated[
        typing.Optional[typing.List[ObStatement2BasicStatementBenefitItem]],
        FieldMetadata(alias="StatementBenefit"),
        pydantic.Field(alias="StatementBenefit"),
    ] = None
    statement_date_time: typing_extensions.Annotated[
        typing.Optional[typing.List[ObStatement2BasicStatementDateTimeItem]],
    ...
    statement_fee: typing_extensions.Annotated[
        typing.Optional[typing.List[ObStatement2BasicStatementFeeItem]],
    ...
    statement_interest: typing_extensions.Annotated[
        typing.Optional[typing.List[ObStatement2BasicStatementInterestItem]],
        FieldMetadata(alias="StatementInterest"),
        pydantic.Field(alias="StatementInterest"),
    ] = None
    statement_rate: typing_extensions.Annotated[
        typing.Optional[typing.List[ObStatement2BasicStatementRateItem]],
    ...
    statement_value: typing_extensions.Annotated[
        typing.Optional[typing.List[ObStatement2BasicStatementValueItem]],
