...
class SingleComponentResponseOfDestinyCharacterRenderComponent(UniversalBaseModel):
    data: typing.Optional[DestinyEntitiesCharactersDestinyCharacterRenderComponent] = None
