...
class CreateCollectionsResponse(UniversalBaseModel):
    """
    A collection object
    """
    ...
    fields: typing.List[CreateCollectionsResponseFieldsItem] = pydantic.Field()
    """
    The list of fields in the Collection
    """

    field_groups: typing_extensions.Annotated[
        typing.Optional[typing.List[CreateCollectionsResponseFieldGroupsItem]],
