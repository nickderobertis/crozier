...
class DistributionSummaryListItemCacheBehaviorsItemsItemForwardedValues(UniversalBaseModel):
    """
    ...
    headers: typing_extensions.Annotated[
        typing.Optional[DistributionSummaryListItemCacheBehaviorsItemsItemForwardedValuesHeaders],
    ...
    query_string_cache_keys: typing_extensions.Annotated[
        typing.Optional[DistributionSummaryListItemCacheBehaviorsItemsItemForwardedValuesQueryStringCacheKeys],
