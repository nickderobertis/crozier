...
class ListOrdersResponseOrdersItem(UniversalBaseModel):
    ...
    status: typing.Optional[ListOrdersResponseOrdersItemStatus] = pydantic.Field(default=None)
    """
    ...
    dispute_last_status: typing_extensions.Annotated[
        typing.Optional[ListOrdersResponseOrdersItemDisputeLastStatus],
    ...
    customer_paid: typing_extensions.Annotated[
        typing.Optional[ListOrdersResponseOrdersItemCustomerPaid],
    ...
    net_amount: typing_extensions.Annotated[
        typing.Optional[ListOrdersResponseOrdersItemNetAmount],
    ...
    application_fee: typing_extensions.Annotated[
        typing.Optional[ListOrdersResponseOrdersItemApplicationFee],
    ...
    all_addresses: typing_extensions.Annotated[
        typing.Optional[typing.List[ListOrdersResponseOrdersItemAllAddressesItem]],
    ...
    shipping_address: typing_extensions.Annotated[
        typing.Optional[ListOrdersResponseOrdersItemShippingAddress],
    ...
    billing_address: typing_extensions.Annotated[
        typing.Optional[ListOrdersResponseOrdersItemBillingAddress],
    ...
    customer_info: typing_extensions.Annotated[
        typing.Optional[ListOrdersResponseOrdersItemCustomerInfo],
    ...
    purchased_items: typing_extensions.Annotated[
        typing.Optional[typing.List[ListOrdersResponseOrdersItemPurchasedItemsItem]],
    ...
    stripe_details: typing_extensions.Annotated[
        typing.Optional[ListOrdersResponseOrdersItemStripeDetails],
    ...
    stripe_card: typing_extensions.Annotated[
        typing.Optional[ListOrdersResponseOrdersItemStripeCard],
    ...
    paypal_details: typing_extensions.Annotated[
        typing.Optional[ListOrdersResponseOrdersItemPaypalDetails],
    ...
    metadata: typing.Optional[ListOrdersResponseOrdersItemMetadata] = None
    ...
    totals: typing.Optional[ListOrdersResponseOrdersItemTotals] = pydantic.Field(default=None)
    """
    An object describing various pricing totals
    """

    download_files: typing_extensions.Annotated[
        typing.Optional[typing.List[ListOrdersResponseOrdersItemDownloadFilesItem]],
