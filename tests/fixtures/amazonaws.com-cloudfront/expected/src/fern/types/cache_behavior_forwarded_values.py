...
from .cache_behavior_forwarded_values_query_string_cache_keys import CacheBehaviorForwardedValuesQueryStringCacheKeys


class CacheBehaviorForwardedValues(UniversalBaseModel):
    """
    ...
    headers: typing_extensions.Annotated[
        typing.Optional[CacheBehaviorForwardedValuesHeaders],
    ...
    query_string_cache_keys: typing_extensions.Annotated[
        typing.Optional[CacheBehaviorForwardedValuesQueryStringCacheKeys],
