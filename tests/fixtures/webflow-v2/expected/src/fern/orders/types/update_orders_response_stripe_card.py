...
class UpdateOrdersResponseStripeCard(UniversalBaseModel):
    """
    ...
    brand: typing.Optional[UpdateOrdersResponseStripeCardBrand] = pydantic.Field(default=None)
    """
    ...
    expires: typing.Optional[UpdateOrdersResponseStripeCardExpires] = pydantic.Field(default=None)
    """
