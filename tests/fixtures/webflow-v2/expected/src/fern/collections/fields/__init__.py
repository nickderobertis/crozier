...
_dynamic_imports: typing.Dict[str, str] = {
    "CreateFieldsRequestBody": ".types",
    "CreateFieldsResponse": ".types",
    "OptionField": ".types",
    "OptionFieldMetadata": ".types",
    "OptionFieldMetadataOptionsItem": ".types",
    "OptionFieldType": ".types",
    "ReferenceField": ".types",
    "ReferenceFieldMetadata": ".types",
    "ReferenceFieldType": ".types",
    "StaticField": ".types",
    "StaticFieldType": ".types",
    "UpdateFieldsResponse": ".types",
    "UpdateFieldsResponseType": ".types",
    "UpdateFieldsResponseValidations": ".types",
    "UpdateFieldsResponseValidationsAdditionalProperties": ".types",
}
