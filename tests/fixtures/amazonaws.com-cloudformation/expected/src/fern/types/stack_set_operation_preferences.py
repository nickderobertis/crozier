...
from .stack_set_operation_preferences_region_concurrency_type import StackSetOperationPreferencesRegionConcurrencyType


class StackSetOperationPreferences(UniversalBaseModel):
    """
    ...
    region_concurrency_type: typing_extensions.Annotated[
        typing.Optional[StackSetOperationPreferencesRegionConcurrencyType], FieldMetadata(alias="RegionConcurrencyType")
