...
class GetDistributionConfigResultDistributionConfig(UniversalBaseModel):
    """
    ...
    aliases: typing_extensions.Annotated[
        typing.Optional[GetDistributionConfigResultDistributionConfigAliases],
    ...
    cache_behaviors: typing_extensions.Annotated[
        typing.Optional[GetDistributionConfigResultDistributionConfigCacheBehaviors],
    ...
    custom_error_responses: typing_extensions.Annotated[
        typing.Optional[GetDistributionConfigResultDistributionConfigCustomErrorResponses],
    ...
    logging: typing_extensions.Annotated[
        typing.Optional[GetDistributionConfigResultDistributionConfigLogging],
    ...
    price_class: typing_extensions.Annotated[
        typing.Optional[GetDistributionConfigResultDistributionConfigPriceClass],
    ...
    http_version: typing_extensions.Annotated[
        typing.Optional[GetDistributionConfigResultDistributionConfigHttpVersion],
