...
class DistributionConfigWithTagsDistributionConfigOrigins(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[typing.List[DistributionConfigWithTagsDistributionConfigOriginsItemsItem]],
