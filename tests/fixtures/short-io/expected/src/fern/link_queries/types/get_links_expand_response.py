...
class GetLinksExpandResponse(UniversalBaseModel):
    ...
    expires_at: typing_extensions.Annotated[
        typing.Optional[GetLinksExpandResponseExpiresAt],
    ...
    ttl: typing.Optional[GetLinksExpandResponseTtl] = pydantic.Field(default=None)
    """
    ...
    split_urlv2: typing_extensions.Annotated[
        typing.Optional[typing.List[GetLinksExpandResponseSplitUrlv2Item]],
    ...
    redirect_type: typing_extensions.Annotated[
        typing.Optional[GetLinksExpandResponseRedirectType],
    ...
    source: typing.Optional[GetLinksExpandResponseSource] = pydantic.Field(default=None)
    """
    Link source
    """

    user: typing_extensions.Annotated[
        typing.Optional[GetLinksExpandResponseUser], FieldMetadata(alias="User"), pydantic.Field(alias="User")
    ] = None
