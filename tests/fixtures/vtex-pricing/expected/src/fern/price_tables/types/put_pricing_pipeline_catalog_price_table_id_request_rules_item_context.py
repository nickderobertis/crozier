...
class PutPricingPipelineCatalogPriceTableIdRequestRulesItemContext(UniversalBaseModel):
    """
    ...
    markup_range: typing_extensions.Annotated[
        typing.Optional[PutPricingPipelineCatalogPriceTableIdRequestRulesItemContextMarkupRange],
