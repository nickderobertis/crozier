...
class JobsClient:
    ...
    def one(
        ...
        *,
        ...
        """
        _response = self._raw_client.one(employee_id, job_id, raw=raw, fields=fields, request_options=request_options)
        return _response.data
    ...
    async def one(
        ...
        *,
        ...
        _response = await self._raw_client.one(
            employee_id, job_id, raw=raw, fields=fields, request_options=request_options
        )
        return _response.data
