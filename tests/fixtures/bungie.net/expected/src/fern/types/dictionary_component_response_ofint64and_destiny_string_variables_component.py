...
class DictionaryComponentResponseOfint64AndDestinyStringVariablesComponent(UniversalBaseModel):
    data: typing.Optional[typing.Dict[str, DestinyComponentsStringVariablesDestinyStringVariablesComponent]] = None
