...
class PatchPositionsIdRequestOrganizationSize(enum.StrEnum):
    ...
    def visit(
        ...
        if self is PatchPositionsIdRequestOrganizationSize.SELF_EMPLOYED:
            return self_employed()
        if self is PatchPositionsIdRequestOrganizationSize.TWO9EMPLOYEES:
            return two9employees()
        if self is PatchPositionsIdRequestOrganizationSize.TEN49EMPLOYEES:
            return ten49employees()
        if self is PatchPositionsIdRequestOrganizationSize.FIFTY99EMPLOYEES:
            return fifty99employees()
        if self is PatchPositionsIdRequestOrganizationSize.ONE_HUNDRED499EMPLOYEES:
            return one_hundred499employees()
        if self is PatchPositionsIdRequestOrganizationSize.FIVE_HUNDRED999EMPLOYEES:
            return five_hundred999employees()
        if self is PatchPositionsIdRequestOrganizationSize.ONE_THOUSAND4999EMPLOYEES:
            return one_thousand4999employees()
        if self is PatchPositionsIdRequestOrganizationSize.FIVE_THOUSAND_EMPLOYEES:
            return five_thousand_employees()
        if self is PatchPositionsIdRequestOrganizationSize.DONT_KNOW:
            return dont_know()
