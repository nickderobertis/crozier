...
class McpRetrieveMcpServerResponse_Stdio(UniversalBaseModel):
...
class McpRetrieveMcpServerResponse_Sse(UniversalBaseModel):
...
class McpRetrieveMcpServerResponse_StreamableHttp(UniversalBaseModel):
...
McpRetrieveMcpServerResponse = typing_extensions.Annotated[
    typing.Union[
