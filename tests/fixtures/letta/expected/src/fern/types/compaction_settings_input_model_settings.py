...
class CompactionSettingsInputModelSettings_Anthropic(UniversalBaseModel):
...
class CompactionSettingsInputModelSettings_Azure(UniversalBaseModel):
...
class CompactionSettingsInputModelSettings_Bedrock(UniversalBaseModel):
...
class CompactionSettingsInputModelSettings_ChatgptOauth(UniversalBaseModel):
...
class CompactionSettingsInputModelSettings_Deepseek(UniversalBaseModel):
...
class CompactionSettingsInputModelSettings_GoogleAi(UniversalBaseModel):
...
class CompactionSettingsInputModelSettings_GoogleVertex(UniversalBaseModel):
...
class CompactionSettingsInputModelSettings_Groq(UniversalBaseModel):
...
class CompactionSettingsInputModelSettings_Openai(UniversalBaseModel):
...
class CompactionSettingsInputModelSettings_Together(UniversalBaseModel):
...
class CompactionSettingsInputModelSettings_Xai(UniversalBaseModel):
...
class CompactionSettingsInputModelSettings_Zai(UniversalBaseModel):
...
CompactionSettingsInputModelSettings = typing_extensions.Annotated[
    typing.Union[
