...
class DictionaryComponentResponseOfuint32AndDestinyVendorComponent(UniversalBaseModel):
    data: typing.Optional[typing.Dict[str, DestinyEntitiesVendorsDestinyVendorComponent]] = None
