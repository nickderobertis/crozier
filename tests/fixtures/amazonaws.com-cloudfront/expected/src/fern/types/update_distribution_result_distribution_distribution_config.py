...
class UpdateDistributionResultDistributionDistributionConfig(UniversalBaseModel):
    """
    ...
    aliases: typing_extensions.Annotated[
        typing.Optional[UpdateDistributionResultDistributionDistributionConfigAliases],
    ...
    cache_behaviors: typing_extensions.Annotated[
        typing.Optional[UpdateDistributionResultDistributionDistributionConfigCacheBehaviors],
    ...
    custom_error_responses: typing_extensions.Annotated[
        typing.Optional[UpdateDistributionResultDistributionDistributionConfigCustomErrorResponses],
    ...
    logging: typing_extensions.Annotated[
        typing.Optional[UpdateDistributionResultDistributionDistributionConfigLogging],
    ...
    price_class: typing_extensions.Annotated[
        typing.Optional[UpdateDistributionResultDistributionDistributionConfigPriceClass],
    ...
    http_version: typing_extensions.Annotated[
        typing.Optional[UpdateDistributionResultDistributionDistributionConfigHttpVersion],
