...
class CacheBehaviorsItemsItemLambdaFunctionAssociationsItemsItem(UniversalBaseModel):
    """
    ...
    event_type: typing_extensions.Annotated[
        typing.Optional[CacheBehaviorsItemsItemLambdaFunctionAssociationsItemsItemEventType],
