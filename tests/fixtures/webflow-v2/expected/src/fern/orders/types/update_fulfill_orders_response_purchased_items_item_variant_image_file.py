...
class UpdateFulfillOrdersResponsePurchasedItemsItemVariantImageFile(UniversalBaseModel):
    ...
    variants: typing.Optional[
        typing.List[UpdateFulfillOrdersResponsePurchasedItemsItemVariantImageFileVariantsItem]
