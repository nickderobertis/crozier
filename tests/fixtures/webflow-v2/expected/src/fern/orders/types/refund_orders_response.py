...
class RefundOrdersResponse(UniversalBaseModel):
    ...
    status: typing.Optional[RefundOrdersResponseStatus] = pydantic.Field(default=None)
    """
    ...
    dispute_last_status: typing_extensions.Annotated[
        typing.Optional[RefundOrdersResponseDisputeLastStatus],
    ...
    customer_paid: typing_extensions.Annotated[
        typing.Optional[RefundOrdersResponseCustomerPaid],
    ...
    net_amount: typing_extensions.Annotated[
        typing.Optional[RefundOrdersResponseNetAmount],
    ...
    application_fee: typing_extensions.Annotated[
        typing.Optional[RefundOrdersResponseApplicationFee],
    ...
    all_addresses: typing_extensions.Annotated[
        typing.Optional[typing.List[RefundOrdersResponseAllAddressesItem]],
    ...
    shipping_address: typing_extensions.Annotated[
        typing.Optional[RefundOrdersResponseShippingAddress],
    ...
    billing_address: typing_extensions.Annotated[
        typing.Optional[RefundOrdersResponseBillingAddress],
    ...
    customer_info: typing_extensions.Annotated[
        typing.Optional[RefundOrdersResponseCustomerInfo],
    ...
    purchased_items: typing_extensions.Annotated[
        typing.Optional[typing.List[RefundOrdersResponsePurchasedItemsItem]],
    ...
    stripe_details: typing_extensions.Annotated[
        typing.Optional[RefundOrdersResponseStripeDetails],
    ...
    stripe_card: typing_extensions.Annotated[
        typing.Optional[RefundOrdersResponseStripeCard],
    ...
    paypal_details: typing_extensions.Annotated[
        typing.Optional[RefundOrdersResponsePaypalDetails],
    ...
    metadata: typing.Optional[RefundOrdersResponseMetadata] = None
    ...
    totals: typing.Optional[RefundOrdersResponseTotals] = pydantic.Field(default=None)
    """
    An object describing various pricing totals
    """

    download_files: typing_extensions.Annotated[
        typing.Optional[typing.List[RefundOrdersResponseDownloadFilesItem]],
