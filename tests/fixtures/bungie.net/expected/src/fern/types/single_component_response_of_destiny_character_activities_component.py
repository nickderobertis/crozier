...
class SingleComponentResponseOfDestinyCharacterActivitiesComponent(UniversalBaseModel):
    data: typing.Optional[DestinyEntitiesCharactersDestinyCharacterActivitiesComponent] = None
