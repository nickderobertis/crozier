...
class DistributionSummaryDefaultCacheBehaviorForwardedValues(UniversalBaseModel):
    """
    ...
    headers: typing_extensions.Annotated[
        typing.Optional[DistributionSummaryDefaultCacheBehaviorForwardedValuesHeaders],
    ...
    query_string_cache_keys: typing_extensions.Annotated[
        typing.Optional[DistributionSummaryDefaultCacheBehaviorForwardedValuesQueryStringCacheKeys],
