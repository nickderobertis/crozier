...
class DistributionSummaryListItemDefaultCacheBehaviorForwardedValuesCookies(UniversalBaseModel):
    """
    ...
    whitelisted_names: typing_extensions.Annotated[
        typing.Optional[DistributionSummaryListItemDefaultCacheBehaviorForwardedValuesCookiesWhitelistedNames],
