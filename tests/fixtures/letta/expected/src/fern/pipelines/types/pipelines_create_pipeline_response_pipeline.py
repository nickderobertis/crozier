...
class PipelinesCreatePipelineResponsePipeline(UniversalBaseModel):
    id: str
    name: str
    organization_id: str
    project_id: str
    integration_id: str
    integration_type: PipelinesCreatePipelineResponsePipelineIntegrationType
    feed_id: str
    config: PipelinesCreatePipelineResponsePipelineConfig
