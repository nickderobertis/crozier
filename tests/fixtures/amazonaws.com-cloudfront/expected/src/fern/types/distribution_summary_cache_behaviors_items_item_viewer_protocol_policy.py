...
class DistributionSummaryCacheBehaviorsItemsItemViewerProtocolPolicy(enum.StrEnum):
    """
    ...
    def visit(
        ...
        if self is DistributionSummaryCacheBehaviorsItemsItemViewerProtocolPolicy.ALLOW_ALL:
            return allow_all()
        if self is DistributionSummaryCacheBehaviorsItemsItemViewerProtocolPolicy.HTTPS_ONLY:
            return https_only()
        if self is DistributionSummaryCacheBehaviorsItemsItemViewerProtocolPolicy.REDIRECT_TO_HTTPS:
