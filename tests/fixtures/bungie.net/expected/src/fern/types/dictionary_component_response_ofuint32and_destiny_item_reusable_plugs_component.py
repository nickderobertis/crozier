...
class DictionaryComponentResponseOfuint32AndDestinyItemReusablePlugsComponent(UniversalBaseModel):
    data: typing.Optional[typing.Dict[str, DestinyComponentsItemsDestinyItemReusablePlugsComponent]] = None
