...
class PutOauthClientClientIdResponse(UniversalBaseModel):
    ...
    response: typing.Optional[PutOauthClientClientIdResponseResponse] = None
    errors: typing.Optional[typing.List[PutOauthClientClientIdResponseErrorsItem]] = pydantic.Field(default=None)
    """
