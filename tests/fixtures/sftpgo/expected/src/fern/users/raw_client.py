...
class RawUsersClient:
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                ...
                "filters": convert_and_respect_annotation_metadata(
                    object_=filters, annotation=UserFilters, direction="write"
                ),
                ...
                "groups": convert_and_respect_annotation_metadata(
                    object_=groups, annotation=typing.Sequence[GroupMapping], direction="write"
                ),
    ...
    def disable_user2fa(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"users/{encode_path_param(username)}/2fa/disable",
            method="PUT",
            request_options=request_options,
        )
        try:
    ...
    def user_forgot_password(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"users/{encode_path_param(username)}/forgot-password",
            method="POST",
            request_options=request_options,
        )
        try:
    ...
    def user_reset_password(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"users/{encode_path_param(username)}/reset-password",
            method="POST",
            json={
                "code": code,
                "password": password,
