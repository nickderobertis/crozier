...
class StopStackSetOperationInput(UniversalBaseModel):
    ...
    operation_id: typing_extensions.Annotated[
        ...
        pydantic.Field(alias="OperationId", description="The ID of the stack operation."),
    ]
    """
    ...
    call_as: typing_extensions.Annotated[
        typing.Optional[StopStackSetOperationInputCallAs],
