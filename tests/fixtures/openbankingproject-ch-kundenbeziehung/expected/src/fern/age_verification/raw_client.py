...
class RawAgeVerificationClient:
        ...
        *,
    ...
    ) -> HttpResponse[AgeVerificationResponse]:
        """
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                ...
                "dataMinimization": data_minimization,
                "existingVerificationId": existing_verification_id,
            },
            headers={
...
class AsyncRawAgeVerificationClient:
    ...
    async def verify_age(
        ...
        *,
        ...
        existing_verification_id: typing.Optional[str] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[AgeVerificationResponse]:
        """
        Privacy-preserving Altersverifikation ohne vollständige Identitätspreisgabe
