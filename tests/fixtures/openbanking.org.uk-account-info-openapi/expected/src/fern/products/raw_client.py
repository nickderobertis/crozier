...
class RawProductsClient:
    ...
    def get_accounts_account_id_product(
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"accounts/{encode_path_param(account_id)}/product",
            method="GET",
    ...
    def get_products(self, *, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[ObReadProduct2]:
        """
        Parameters
        ----------
        request_options : typing.Optional[RequestOptions]
...
class AsyncRawProductsClient:
    ...
    async def get_accounts_account_id_product(
        self, account_id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[ObReadProduct2]:
        """
        Parameters
        ----------
        account_id : str
