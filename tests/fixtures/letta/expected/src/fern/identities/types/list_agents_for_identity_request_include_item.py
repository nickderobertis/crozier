...
class ListAgentsForIdentityRequestIncludeItem(enum.StrEnum):
    ...
    def visit(
        ...
        if self is ListAgentsForIdentityRequestIncludeItem.AGENT_BLOCKS:
            return agent_blocks()
        if self is ListAgentsForIdentityRequestIncludeItem.AGENT_IDENTITIES:
            return agent_identities()
        if self is ListAgentsForIdentityRequestIncludeItem.AGENT_MANAGED_GROUP:
            return agent_managed_group()
        if self is ListAgentsForIdentityRequestIncludeItem.AGENT_PENDING_APPROVAL:
            return agent_pending_approval()
        if self is ListAgentsForIdentityRequestIncludeItem.AGENT_SECRETS:
            return agent_secrets()
        if self is ListAgentsForIdentityRequestIncludeItem.AGENT_SOURCES:
            return agent_sources()
        if self is ListAgentsForIdentityRequestIncludeItem.AGENT_TAGS:
            return agent_tags()
        if self is ListAgentsForIdentityRequestIncludeItem.AGENT_TOOLS:
            return agent_tools()
