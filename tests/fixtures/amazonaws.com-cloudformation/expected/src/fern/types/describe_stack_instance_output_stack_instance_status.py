...
class DescribeStackInstanceOutputStackInstanceStatus(str, enum.Enum):
    """
    ...
    def visit(
        ...
        if self is DescribeStackInstanceOutputStackInstanceStatus.CURRENT:
            return current()
        if self is DescribeStackInstanceOutputStackInstanceStatus.OUTDATED:
            return outdated()
        if self is DescribeStackInstanceOutputStackInstanceStatus.INOPERABLE:
            return inoperable()
