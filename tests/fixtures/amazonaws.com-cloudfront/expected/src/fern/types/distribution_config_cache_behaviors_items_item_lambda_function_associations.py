...
class DistributionConfigCacheBehaviorsItemsItemLambdaFunctionAssociations(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[typing.List[DistributionConfigCacheBehaviorsItemsItemLambdaFunctionAssociationsItemsItem]],
