...
class RawAuthorisationServerCertificationsClient:
    ...
    def get_all_certifications_for_given_authorisation_server(
        ...
        *,
    ...
    ) -> HttpResponse[AuthorisationServerCertifications]:
        """
        Parameters
        ----------
        organisation_id : OrganisationId
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"organisations/{encode_path_param(organisation_id)}/authorisationservers/{encode_path_param(authorisation_server_id)}/certifications",
            method="GET",
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=AuthorisationServerCertifications,
    ...
    def get_a_certification_by_id(
        ...
        *,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[AuthorisationServerCertification]:
        """
        Parameters
        ----------
        organisation_id : OrganisationId
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"organisations/{encode_path_param(organisation_id)}/authorisationservers/{encode_path_param(authorisation_server_id)}/certifications/{encode_path_param(authorisation_server_certification_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=AuthorisationServerCertification,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawAuthorisationServerCertificationsClient:
    ...
    async def get_all_certifications_for_given_authorisation_server(
        ...
        *,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[AuthorisationServerCertifications]:
        """
        Parameters
        ----------
        organisation_id : OrganisationId
    ...
    async def get_a_certification_by_id(
        ...
        *,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[AuthorisationServerCertification]:
        """
        Parameters
        ----------
        organisation_id : OrganisationId
