...
if typing.TYPE_CHECKING:
    ...
    from .ui.client import AsyncUiClient, UiClient
    from .wallet.client import AsyncWalletClient, WalletClient
    from .wallet_backend.client import AsyncWalletBackendClient, WalletBackendClient
...
class FernApi:
    ...
    def __init__(
        ...
        *,
        ...
        self._ui: typing.Optional[UiClient] = None
        self._wallet: typing.Optional[WalletClient] = None
        self._wallet_backend: typing.Optional[WalletBackendClient] = None
    ...
    def ui(self):
        if self._ui is None:
            ...
            self._ui = UiClient(client_wrapper=self._client_wrapper)
        return self._ui
    ...
    def wallet_backend(self):
        if self._wallet_backend is None:
            from .wallet_backend.client import WalletBackendClient

            self._wallet_backend = WalletBackendClient(client_wrapper=self._client_wrapper)
        return self._wallet_backend
...
class AsyncFernApi:
    ...
    def __init__(
        ...
        *,
        ...
        self._ui: typing.Optional[AsyncUiClient] = None
        self._wallet: typing.Optional[AsyncWalletClient] = None
        self._wallet_backend: typing.Optional[AsyncWalletBackendClient] = None
    ...
    def ui(self):
        if self._ui is None:
            from .ui.client import AsyncUiClient

            self._ui = AsyncUiClient(client_wrapper=self._client_wrapper)
        return self._ui
    ...
    def wallet_backend(self):
        if self._wallet_backend is None:
            from .wallet_backend.client import AsyncWalletBackendClient

            self._wallet_backend = AsyncWalletBackendClient(client_wrapper=self._client_wrapper)
        return self._wallet_backend
