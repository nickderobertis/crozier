...
class GetEventsResponseEventsItemFortyTwo(UniversalBaseModel):
    """
    ...
    type: typing.Optional[GetEventsResponseEventsItemFortyTwoType] = pydantic.Field(default=None)
    """
    The event's type, relevant both for client-side dispatch and server-side
    filtering by event type in [POST /register](/api/register-queue).
    """

    op: typing.Optional[GetEventsResponseEventsItemFortyTwoOp] = None
    operation: typing.Optional[GetEventsResponseEventsItemFortyTwoOperation] = pydantic.Field(default=None)
    """
