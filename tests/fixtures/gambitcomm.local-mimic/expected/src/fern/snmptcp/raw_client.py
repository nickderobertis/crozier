...
class RawSnmptcpClient:
    ...
    def protocol_snmptcp_get_args(
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"mimic/agent/{encode_path_param(agent_num)}/protocol/msg/snmptcp/get/args",
            method="GET",
    ...
    def protocol_snmptcp_get_config(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"mimic/agent/{encode_path_param(agent_num)}/protocol/msg/snmptcp/get/config",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def protocol_snmptcp_get_statistics(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"mimic/agent/{encode_path_param(agent_num)}/protocol/msg/snmptcp/get/statistics",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def protocol_snmptcp_get_trace(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"mimic/agent/{encode_path_param(agent_num)}/protocol/msg/snmptcp/get/trace",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def protocol_snmptcp_ipalias_disable(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"mimic/agent/{encode_path_param(agent_num)}/protocol/msg/snmptcp/ipalias/disable/{encode_path_param(ipaddress)}/{encode_path_param(port)}",
            method="PUT",
            request_options=request_options,
        )
        try:
    ...
    def protocol_snmptcp_ipalias_enable(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"mimic/agent/{encode_path_param(agent_num)}/protocol/msg/snmptcp/ipalias/enable/{encode_path_param(ipaddress)}/{encode_path_param(port)}",
            method="PUT",
            request_options=request_options,
        )
        try:
    ...
    def protocol_snmptcp_ipalias_isenabled(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"mimic/agent/{encode_path_param(agent_num)}/protocol/msg/snmptcp/ipalias/isenabled/{encode_path_param(ipaddress)}/{encode_path_param(port)}",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def protocol_snmptcp_ipalias_list(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"mimic/agent/{encode_path_param(agent_num)}/protocol/msg/snmptcp/ipalias/list",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def protocol_snmptcp_set_config(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"mimic/agent/{encode_path_param(agent_num)}/protocol/msg/snmptcp/set/config/{encode_path_param(argument)}/{encode_path_param(value)}",
            method="PUT",
            request_options=request_options,
        )
        try:
    ...
    def protocol_snmptcp_set_trace(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"mimic/agent/{encode_path_param(agent_num)}/protocol/msg/snmptcp/set/trace/{encode_path_param(enable_or_not)}",
            method="PUT",
            request_options=request_options,
        )
        try:
...
class AsyncRawSnmptcpClient:
    ...
    async def protocol_snmptcp_get_config(
        self, agent_num: int, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[ConfigSnmptcp]:
        """
        Agent's SNMPTCP configuration with port,rule,prompt,paging_prompt,userdb,keymap
