...
from ...types.applications_api_usage import ApplicationsApiUsage


class AppGetApplicationApiUsageResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[typing.Optional[ApplicationsApiUsage], FieldMetadata(alias="Response")] = None
