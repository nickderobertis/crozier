...
class StackSetOperation(UniversalBaseModel):
    ...
    action: typing_extensions.Annotated[
        typing.Optional[StackSetOperationAction],
    ...
    status: typing_extensions.Annotated[
        typing.Optional[StackSetOperationStatus],
    ...
    operation_preferences: typing_extensions.Annotated[
        typing.Optional[StackSetOperationOperationPreferences],
    ...
    deployment_targets: typing_extensions.Annotated[
        typing.Optional[StackSetOperationDeploymentTargets],
    ...
    status_details: typing_extensions.Annotated[
        typing.Optional[StackSetOperationStatusDetails],
