...
class CreateStackInput(UniversalBaseModel):
    ...
    stack_name: typing_extensions.Annotated[
        ...
        pydantic.Field(
            alias="StackName",
            description="<p>The name that's associated with the stack. The name must be unique in the Region in which you are creating the stack.</p> <note> <p>A stack name can contain only alphanumeric characters (case sensitive) and hyphens. It must start with an alphabetical character and can't be longer than 128 characters.</p> </note>",
        ),
    ]
    """
    ...
    parameters: typing_extensions.Annotated[
        ...
        pydantic.Field(
            alias="Parameters",
            description='A list of <code>Parameter</code> structures that specify input parameters for the stack. For more information, see the <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/APIReference/API_Parameter.html">Parameter</a> data type.',
        ),
    ] = None
    """
    ...
    rollback_configuration: typing_extensions.Annotated[
        typing.Optional[CreateStackInputRollbackConfiguration],
    ...
    timeout_in_minutes: typing_extensions.Annotated[
        typing.Optional[int],
        FieldMetadata(alias="TimeoutInMinutes"),
        pydantic.Field(
    ...
    resource_types: typing_extensions.Annotated[
        typing.Optional[typing.List[ResourceType]],
        FieldMetadata(alias="ResourceTypes"),
        pydantic.Field(
            alias="ResourceTypes",
    ...
    role_arn: typing_extensions.Annotated[
        ...
        pydantic.Field(
            alias="RoleARN",
            description="<p>The Amazon Resource Name (ARN) of an Identity and Access Management (IAM) role that CloudFormation assumes to create the stack. CloudFormation uses the role's credentials to make calls on your behalf. CloudFormation always uses this role for all future operations on the stack. Provided that users have permission to operate on the stack, CloudFormation uses this role even if the users don't have permission to pass it. Ensure that the role grants least privilege.</p> <p>If you don't specify a value, CloudFormation uses the role that was previously associated with the stack. If no role is available, CloudFormation uses a temporary session that's generated from your user credentials.</p>",
        ),
    ] = None
    """
    ...
    on_failure: typing_extensions.Annotated[
        typing.Optional[CreateStackInputOnFailure],
        FieldMetadata(alias="OnFailure"),
        pydantic.Field(
            alias="OnFailure",
            description="<p>Determines what action will be taken if stack creation fails. This must be one of: <code>DO_NOTHING</code>, <code>ROLLBACK</code>, or <code>DELETE</code>. You can specify either <code>OnFailure</code> or <code>DisableRollback</code>, but not both.</p> <p>Default: <code>ROLLBACK</code> </p>",
        ),
    ] = None
    """
