...
class Ok81(UniversalBaseModel):
    ...
    cdc_ethnicity_code: typing_extensions.Annotated[
        str, FieldMetadata(alias="cdcEthnicityCode"), pydantic.Field(alias="cdcEthnicityCode")
    ]
