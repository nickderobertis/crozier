...
class GetSitesResponse(UniversalBaseModel):
    ...
    custom_domains: typing_extensions.Annotated[
        typing.Optional[typing.List[GetSitesResponseCustomDomainsItem]],
        FieldMetadata(alias="customDomains"),
        pydantic.Field(alias="customDomains"),
    ] = None
    locales: typing.Optional[GetSitesResponseLocales] = None
    ...
    data_collection_type: typing_extensions.Annotated[
        typing.Optional[GetSitesResponseDataCollectionType],
