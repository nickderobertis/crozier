...
class GetCustomFontsResponseCustomFont(UniversalBaseModel):
    """
    ...
    format: typing.Optional[GetCustomFontsResponseCustomFontFormat] = pydantic.Field(default=None)
    """
    ...
    axes: typing.List[GetCustomFontsResponseCustomFontAxesItem] = pydantic.Field()
    """
