...
class DistributionListItemsItemCacheBehaviorsItemsItemForwardedValuesCookies(UniversalBaseModel):
    """
    ...
    whitelisted_names: typing_extensions.Annotated[
        typing.Optional[DistributionListItemsItemCacheBehaviorsItemsItemForwardedValuesCookiesWhitelistedNames],
