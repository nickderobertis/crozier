...
from ...types.destiny_historical_stats_destiny_activity_history_results import (
    DestinyHistoricalStatsDestinyActivityHistoryResults,
)


class Destiny2GetActivityHistoryResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[DestinyHistoricalStatsDestinyActivityHistoryResults], FieldMetadata(alias="Response")
    ] = None
