...
class CreateStackInstancesInputOperationPreferencesRegionConcurrencyType(enum.StrEnum):
    ...
    def visit(self, sequential: typing.Callable[[], T_Result], parallel: typing.Callable[[], T_Result]) -> T_Result:
        if self is CreateStackInstancesInputOperationPreferencesRegionConcurrencyType.SEQUENTIAL:
            return sequential()
        if self is CreateStackInstancesInputOperationPreferencesRegionConcurrencyType.PARALLEL:
            return parallel()
