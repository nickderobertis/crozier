...
class DescribeStackSetOutputStackSetPermissionModel(str, enum.Enum):
    """
    ...
    def visit(
        ...
        if self is DescribeStackSetOutputStackSetPermissionModel.SERVICE_MANAGED:
            return service_managed()
        if self is DescribeStackSetOutputStackSetPermissionModel.SELF_MANAGED:
            return self_managed()
