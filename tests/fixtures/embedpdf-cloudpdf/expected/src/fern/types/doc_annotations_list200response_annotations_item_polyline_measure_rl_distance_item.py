...
class DocAnnotationsList200ResponseAnnotationsItemPolylineMeasureRlDistanceItem(UniversalBaseModel):
    unit: str
    conversion: typing.Optional[float] = None
    fraction: typing.Optional[DocAnnotationsList200ResponseAnnotationsItemPolylineMeasureRlDistanceItemFraction] = None
    ...
    label_position: typing_extensions.Annotated[
        typing.Optional[DocAnnotationsList200ResponseAnnotationsItemPolylineMeasureRlDistanceItemLabelPosition],
