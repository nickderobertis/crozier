...
client = FernApi(...)
response = client.dynamic_offers.with_raw_response.post_dynamic_offers_id_calculate(...)
...
```python
client.dynamic_offers.post_dynamic_offers_id_calculate(..., request_options={
    "max_retries": 1
})
```
