...
class InterfaceDescriptor(UniversalBaseModel):
    dst_ip_address: typing_extensions.Annotated[
        typing.Optional[str],
        FieldMetadata(alias="dstIPAddress"),
        pydantic.Field(
            alias="dstIPAddress",
    ...
    dst_mac_address: typing_extensions.Annotated[
        typing.Optional[str],
        FieldMetadata(alias="dstMACAddress"),
        pydantic.Field(
            alias="dstMACAddress",
    ...
    interface_type: typing_extensions.Annotated[
        InterfaceType, FieldMetadata(alias="interfaceType"), pydantic.Field(alias="interfaceType")
    ]
    src_mac_address: typing_extensions.Annotated[
        typing.Optional[str],
        FieldMetadata(alias="srcMACAddress"),
        pydantic.Field(
            alias="srcMACAddress",
    ...
    tunnel_info: typing_extensions.Annotated[
        typing.Optional[TunnelInfo], FieldMetadata(alias="tunnelInfo"), pydantic.Field(alias="tunnelInfo")
    ] = None
