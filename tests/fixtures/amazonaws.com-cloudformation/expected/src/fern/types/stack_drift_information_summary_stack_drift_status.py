...
class StackDriftInformationSummaryStackDriftStatus(str, enum.Enum):
    """
    ...
    def visit(
        ...
        if self is StackDriftInformationSummaryStackDriftStatus.DRIFTED:
            return drifted()
        if self is StackDriftInformationSummaryStackDriftStatus.IN_SYNC:
            return in_sync()
        if self is StackDriftInformationSummaryStackDriftStatus.UNKNOWN:
            return unknown()
        if self is StackDriftInformationSummaryStackDriftStatus.NOT_CHECKED:
            return not_checked()
