...
class GetDistributionConfigResultDistributionConfigOriginsItemsItemCustomHeaders(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[
            typing.List[GetDistributionConfigResultDistributionConfigOriginsItemsItemCustomHeadersItemsItem]
        ],
