...
class RawCurrencyConversionClient:
    ...
    def list_all_currency_conversion_for_user_monetary_account(
    ...
    ) -> HttpResponse[typing.List[CurrencyConversionListing]]:
        """
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"user/{encode_path_param(user_id)}/monetary-account/{encode_path_param(monetary_account_id)}/currency-conversion",
            method="GET",
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=typing.List[CurrencyConversionListing],
    ...
    def read_currency_conversion_for_user_monetary_account(
        ...
        *,
    ...
    ) -> HttpResponse[CurrencyConversionRead]:
        """
        Endpoint for managing currency conversions.
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"user/{encode_path_param(user_id)}/monetary-account/{encode_path_param(monetary_account_id)}/currency-conversion/{encode_path_param(item_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
...
class AsyncRawCurrencyConversionClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._client_wrapper = client_wrapper

    async def list_all_currency_conversion_for_user_monetary_account(
        self, user_id: int, monetary_account_id: int, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[typing.List[CurrencyConversionListing]]:
        """
        Endpoint for managing currency conversions.
    ...
    async def read_currency_conversion_for_user_monetary_account(
        ...
        *,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[CurrencyConversionRead]:
        """
        Endpoint for managing currency conversions.
