...
class RawReferencesAuthorityClient:
    ...
    def get_a_reference_authority_by_id(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"references/authorities/{encode_path_param(authority_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
...
class AsyncRawReferencesAuthorityClient:
