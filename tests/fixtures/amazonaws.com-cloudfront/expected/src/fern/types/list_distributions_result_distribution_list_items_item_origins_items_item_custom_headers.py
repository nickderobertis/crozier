...
class ListDistributionsResultDistributionListItemsItemOriginsItemsItemCustomHeaders(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[
            typing.List[ListDistributionsResultDistributionListItemsItemOriginsItemsItemCustomHeadersItemsItem]
        ],
