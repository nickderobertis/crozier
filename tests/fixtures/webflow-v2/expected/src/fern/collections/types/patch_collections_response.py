...
class PatchCollectionsResponse(UniversalBaseModel):
    """
    A collection object
    """
    ...
    fields: typing.List[PatchCollectionsResponseFieldsItem] = pydantic.Field()
    """
    The list of fields in the Collection
    """

    field_groups: typing_extensions.Annotated[
        typing.Optional[typing.List[PatchCollectionsResponseFieldGroupsItem]],
