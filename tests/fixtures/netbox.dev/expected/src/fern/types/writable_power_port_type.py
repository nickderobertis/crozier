...
class WritablePowerPortType(str, enum.Enum):
    """
    Physical port type
    """
    ...
    def visit(
        ...
        if self is WritablePowerPortType.IEC60320C6:
            return iec60320c6()
        if self is WritablePowerPortType.IEC60320C8:
            return iec60320c8()
        if self is WritablePowerPortType.IEC60320C14:
            return iec60320c14()
        if self is WritablePowerPortType.IEC60320C16:
            return iec60320c16()
        if self is WritablePowerPortType.IEC60320C20:
            return iec60320c20()
        if self is WritablePowerPortType.IEC60320C22:
            return iec60320c22()
        if self is WritablePowerPortType.IEC60309PNE4H:
            return iec60309pne4h()
        if self is WritablePowerPortType.IEC60309PNE6H:
            return iec60309pne6h()
        if self is WritablePowerPortType.IEC60309PNE9H:
            return iec60309pne9h()
        if self is WritablePowerPortType.IEC603092PE4H:
            return iec603092pe4h()
        if self is WritablePowerPortType.IEC603092PE6H:
            return iec603092pe6h()
        if self is WritablePowerPortType.IEC603092PE9H:
            return iec603092pe9h()
        if self is WritablePowerPortType.IEC603093PE4H:
            return iec603093pe4h()
        if self is WritablePowerPortType.IEC603093PE6H:
            return iec603093pe6h()
        if self is WritablePowerPortType.IEC603093PE9H:
            return iec603093pe9h()
        if self is WritablePowerPortType.IEC603093PNE4H:
            return iec603093pne4h()
        if self is WritablePowerPortType.IEC603093PNE6H:
            return iec603093pne6h()
        if self is WritablePowerPortType.IEC603093PNE9H:
            return iec603093pne9h()
        if self is WritablePowerPortType.NEMA115P:
            return nema115p()
        if self is WritablePowerPortType.NEMA515P:
            return nema515p()
        if self is WritablePowerPortType.NEMA520P:
            return nema520p()
        if self is WritablePowerPortType.NEMA530P:
            return nema530p()
        if self is WritablePowerPortType.NEMA550P:
            return nema550p()
        if self is WritablePowerPortType.NEMA615P:
            return nema615p()
        if self is WritablePowerPortType.NEMA620P:
            return nema620p()
        if self is WritablePowerPortType.NEMA630P:
            return nema630p()
        if self is WritablePowerPortType.NEMA650P:
            return nema650p()
        if self is WritablePowerPortType.NEMA1030P:
            return nema1030p()
        if self is WritablePowerPortType.NEMA1050P:
            return nema1050p()
        if self is WritablePowerPortType.NEMA1420P:
            return nema1420p()
        if self is WritablePowerPortType.NEMA1430P:
            return nema1430p()
        if self is WritablePowerPortType.NEMA1450P:
            return nema1450p()
        if self is WritablePowerPortType.NEMA1460P:
            return nema1460p()
        if self is WritablePowerPortType.NEMA1515P:
            return nema1515p()
        if self is WritablePowerPortType.NEMA1520P:
            return nema1520p()
        if self is WritablePowerPortType.NEMA1530P:
            return nema1530p()
        if self is WritablePowerPortType.NEMA1550P:
            return nema1550p()
        if self is WritablePowerPortType.NEMA1560P:
            return nema1560p()
        if self is WritablePowerPortType.NEMA_L115P:
            return nema_l115p()
        if self is WritablePowerPortType.NEMA_L515P:
            return nema_l515p()
        if self is WritablePowerPortType.NEMA_L520P:
            return nema_l520p()
        if self is WritablePowerPortType.NEMA_L530P:
            return nema_l530p()
        if self is WritablePowerPortType.NEMA_L550P:
            return nema_l550p()
        if self is WritablePowerPortType.NEMA_L615P:
            return nema_l615p()
        if self is WritablePowerPortType.NEMA_L620P:
            return nema_l620p()
        if self is WritablePowerPortType.NEMA_L630P:
            return nema_l630p()
        if self is WritablePowerPortType.NEMA_L650P:
            return nema_l650p()
        if self is WritablePowerPortType.NEMA_L1030P:
            return nema_l1030p()
        if self is WritablePowerPortType.NEMA_L1420P:
            return nema_l1420p()
        if self is WritablePowerPortType.NEMA_L1430P:
            return nema_l1430p()
        if self is WritablePowerPortType.NEMA_L1450P:
            return nema_l1450p()
        if self is WritablePowerPortType.NEMA_L1460P:
            return nema_l1460p()
        if self is WritablePowerPortType.NEMA_L1520P:
            return nema_l1520p()
        if self is WritablePowerPortType.NEMA_L1530P:
            return nema_l1530p()
        if self is WritablePowerPortType.NEMA_L1550P:
            return nema_l1550p()
        if self is WritablePowerPortType.NEMA_L1560P:
            return nema_l1560p()
        if self is WritablePowerPortType.NEMA_L2120P:
            return nema_l2120p()
        if self is WritablePowerPortType.NEMA_L2130P:
            return nema_l2130p()
        if self is WritablePowerPortType.NEMA_L2230P:
            return nema_l2230p()
        if self is WritablePowerPortType.CS6361C:
            return cs6361c()
        if self is WritablePowerPortType.CS6365C:
            return cs6365c()
        if self is WritablePowerPortType.CS8165C:
            return cs8165c()
        if self is WritablePowerPortType.CS8265C:
            return cs8265c()
        if self is WritablePowerPortType.CS8365C:
            return cs8365c()
        if self is WritablePowerPortType.CS8465C:
            return cs8465c()
        if self is WritablePowerPortType.ITA_C:
            return ita_c()
        if self is WritablePowerPortType.ITA_E:
            return ita_e()
        if self is WritablePowerPortType.ITA_F:
            return ita_f()
        if self is WritablePowerPortType.ITA_EF:
            return ita_ef()
        if self is WritablePowerPortType.ITA_G:
            return ita_g()
        if self is WritablePowerPortType.ITA_H:
            return ita_h()
        if self is WritablePowerPortType.ITA_I:
            return ita_i()
        if self is WritablePowerPortType.ITA_J:
            return ita_j()
        if self is WritablePowerPortType.ITA_K:
            return ita_k()
        if self is WritablePowerPortType.ITA_L:
            return ita_l()
        if self is WritablePowerPortType.ITA_M:
            return ita_m()
        if self is WritablePowerPortType.ITA_N:
            return ita_n()
        if self is WritablePowerPortType.ITA_O:
            return ita_o()
        if self is WritablePowerPortType.USB_A:
            return usb_a()
        if self is WritablePowerPortType.USB_B:
            return usb_b()
        if self is WritablePowerPortType.USB_C:
            return usb_c()
        if self is WritablePowerPortType.USB_MINI_A:
            return usb_mini_a()
        if self is WritablePowerPortType.USB_MINI_B:
            return usb_mini_b()
        if self is WritablePowerPortType.USB_MICRO_A:
            return usb_micro_a()
        if self is WritablePowerPortType.USB_MICRO_B:
            return usb_micro_b()
        if self is WritablePowerPortType.USB_MICRO_AB:
            return usb_micro_ab()
        if self is WritablePowerPortType.USB3B:
            return usb3b()
        if self is WritablePowerPortType.USB3MICRO_B:
            return usb3micro_b()
        if self is WritablePowerPortType.DC_TERMINAL:
            return dc_terminal()
        if self is WritablePowerPortType.SAF_D_GRID:
            return saf_d_grid()
        if self is WritablePowerPortType.NEUTRIK_POWERCON20:
            return neutrik_powercon20()
        if self is WritablePowerPortType.NEUTRIK_POWERCON32:
            return neutrik_powercon32()
        if self is WritablePowerPortType.NEUTRIK_POWERCON_TRUE1:
            return neutrik_powercon_true1()
        if self is WritablePowerPortType.NEUTRIK_POWERCON_TRUE1TOP:
            return neutrik_powercon_true1top()
        if self is WritablePowerPortType.UBIQUITI_SMARTPOWER:
            return ubiquiti_smartpower()
        if self is WritablePowerPortType.HARDWIRED:
            return hardwired()
        if self is WritablePowerPortType.OTHER:
            return other()
