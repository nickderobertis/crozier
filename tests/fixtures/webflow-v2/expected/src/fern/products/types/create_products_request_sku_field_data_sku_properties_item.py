...
class CreateProductsRequestSkuFieldDataSkuPropertiesItem(UniversalBaseModel):
    """
    ...
    enum: typing.List[CreateProductsRequestSkuFieldDataSkuPropertiesItemEnumItem] = pydantic.Field()
    """
