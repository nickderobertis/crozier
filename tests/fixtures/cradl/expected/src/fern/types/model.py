...
from .model_postprocess_config import ModelPostprocessConfig
...
class Model(UniversalBaseModel):
    ...
    llm_version: typing_extensions.Annotated[
        typing.Optional[ModelLlmVersion], FieldMetadata(alias="llmVersion"), pydantic.Field(alias="llmVersion")
    ] = None
    ...
    postprocess_config: typing_extensions.Annotated[
        typing.Optional[ModelPostprocessConfig],
    ...
    confidence_version: typing_extensions.Annotated[
        typing.Optional[ModelConfidenceVersion],
        FieldMetadata(alias="confidenceVersion"),
        pydantic.Field(alias="confidenceVersion"),
    ] = None
    preprocess_config: typing_extensions.Annotated[
        ModelPreprocessConfig, FieldMetadata(alias="preprocessConfig"), pydantic.Field(alias="preprocessConfig")
    ]
