...
class ListPostsResponseLatestPostsItem(UniversalBaseModel):
    actions_summary: typing.Optional[typing.List[ListPostsResponseLatestPostsItemActionsSummaryItem]] = None
    ...
    topic_html_title: typing.Optional[str] = None
    topic_id: typing.Optional[int] = None
    topic_slug: typing.Optional[str] = None
    topic_title: typing.Optional[str] = None
