...
from ...types.destiny_milestones_destiny_public_milestone import DestinyMilestonesDestinyPublicMilestone


class Destiny2GetPublicMilestonesResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[typing.Dict[str, DestinyMilestonesDestinyPublicMilestone]], FieldMetadata(alias="Response")
    ] = None
