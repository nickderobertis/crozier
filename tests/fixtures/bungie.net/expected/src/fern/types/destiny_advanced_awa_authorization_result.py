...
class DestinyAdvancedAwaAuthorizationResult(UniversalBaseModel):
    action_token: typing_extensions.Annotated[typing.Optional[str], FieldMetadata(alias="actionToken")] = (
    ...
    developer_note: typing_extensions.Annotated[typing.Optional[str], FieldMetadata(alias="developerNote")] = (
        pydantic.Field(default=None)
    )
    """
    ...
    maximum_number_of_uses: typing_extensions.Annotated[
        typing.Optional[int], FieldMetadata(alias="maximumNumberOfUses")
    ] = pydantic.Field(default=None)
    """
    ...
    response_reason: typing_extensions.Annotated[typing.Optional[int], FieldMetadata(alias="responseReason")] = None
    type: typing.Optional[int] = pydantic.Field(default=None)
    """
    Advanced Write Action Type from the permission request.
    """

    user_selection: typing_extensions.Annotated[typing.Optional[int], FieldMetadata(alias="userSelection")] = (
        pydantic.Field(default=None)
    )
    """
    ...
    valid_until: typing_extensions.Annotated[typing.Optional[dt.datetime], FieldMetadata(alias="validUntil")] = (
        pydantic.Field(default=None)
    )
    """
