...
class PatchClientClientIdRequestRequestAdditionalConfig(UniversalBaseModel):
    """
    ...
    userinfo_response_type: typing.Optional[PatchClientClientIdRequestRequestAdditionalConfigUserinfoResponseType] = (
    ...
    """
    The number of minutes after which a user's given consent will expire.
    """
