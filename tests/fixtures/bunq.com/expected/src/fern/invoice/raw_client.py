...
class RawInvoiceClient:
    ...
    def list_all_invoice_for_user(
    ...
    ) -> HttpResponse[typing.List[InvoiceByUserListing]]:
        """
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"user/{encode_path_param(user_id)}/invoice",
            method="GET",
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=typing.List[InvoiceByUserListing],
    ...
    def read_invoice_for_user(
    ...
    ) -> HttpResponse[InvoiceByUserRead]:
        """
        Used to list bunq invoices by user.
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"user/{encode_path_param(user_id)}/invoice/{encode_path_param(item_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def list_all_invoice_for_user_monetary_account(
    ...
    ) -> HttpResponse[typing.List[InvoiceListing]]:
        """
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"user/{encode_path_param(user_id)}/monetary-account/{encode_path_param(monetary_account_id)}/invoice",
            method="GET",
            request_options=request_options,
        )
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=typing.List[InvoiceListing],
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def read_invoice_for_user_monetary_account(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"user/{encode_path_param(user_id)}/monetary-account/{encode_path_param(monetary_account_id)}/invoice/{encode_path_param(item_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
...
class AsyncRawInvoiceClient:
    ...
    async def list_all_invoice_for_user(
        self, user_id: int, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[typing.List[InvoiceByUserListing]]:
        """
        Used to list bunq invoices by user.
    ...
    async def read_invoice_for_user(
        self, user_id: int, item_id: int, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[InvoiceByUserRead]:
        """
        Used to list bunq invoices by user.
    ...
    async def list_all_invoice_for_user_monetary_account(
        self, user_id: int, monetary_account_id: int, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[typing.List[InvoiceListing]]:
        """
        Used to view a bunq invoice.
