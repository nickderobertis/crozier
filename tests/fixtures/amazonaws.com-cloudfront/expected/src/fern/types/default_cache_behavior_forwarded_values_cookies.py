...
from .default_cache_behavior_forwarded_values_cookies_forward import DefaultCacheBehaviorForwardedValuesCookiesForward
...
class DefaultCacheBehaviorForwardedValuesCookies(UniversalBaseModel):
    """
    ...
    whitelisted_names: typing_extensions.Annotated[
        typing.Optional[DefaultCacheBehaviorForwardedValuesCookiesWhitelistedNames],
