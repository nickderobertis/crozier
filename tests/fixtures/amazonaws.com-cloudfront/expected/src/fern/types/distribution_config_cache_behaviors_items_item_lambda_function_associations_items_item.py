...
class DistributionConfigCacheBehaviorsItemsItemLambdaFunctionAssociationsItemsItem(UniversalBaseModel):
    """
    ...
    event_type: typing_extensions.Annotated[
        typing.Optional[DistributionConfigCacheBehaviorsItemsItemLambdaFunctionAssociationsItemsItemEventType],
