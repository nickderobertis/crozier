...
class CreateAgentRequestToolRulesItem_Conditional(UniversalBaseModel):
...
class CreateAgentRequestToolRulesItem_ConstrainChildTools(UniversalBaseModel):
...
class CreateAgentRequestToolRulesItem_ContinueLoop(UniversalBaseModel):
...
class CreateAgentRequestToolRulesItem_ExitLoop(UniversalBaseModel):
...
class CreateAgentRequestToolRulesItem_MaxCountPerStep(UniversalBaseModel):
...
class CreateAgentRequestToolRulesItem_ParentLastTool(UniversalBaseModel):
...
class CreateAgentRequestToolRulesItem_RequiredBeforeExit(UniversalBaseModel):
...
class CreateAgentRequestToolRulesItem_RequiresApproval(UniversalBaseModel):
...
class CreateAgentRequestToolRulesItem_RunFirst(UniversalBaseModel):
...
CreateAgentRequestToolRulesItem = typing_extensions.Annotated[
    typing.Union[
