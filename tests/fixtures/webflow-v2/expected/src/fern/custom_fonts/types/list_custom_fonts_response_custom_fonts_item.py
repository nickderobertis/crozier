...
from .list_custom_fonts_response_custom_fonts_item_font_display import ListCustomFontsResponseCustomFontsItemFontDisplay
from .list_custom_fonts_response_custom_fonts_item_format import ListCustomFontsResponseCustomFontsItemFormat


class ListCustomFontsResponseCustomFontsItem(UniversalBaseModel):
    """
    ...
    format: typing.Optional[ListCustomFontsResponseCustomFontsItemFormat] = pydantic.Field(default=None)
    """
    ...
    axes: typing.List[ListCustomFontsResponseCustomFontsItemAxesItem] = pydantic.Field()
    """
