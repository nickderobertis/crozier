...
class DistributionDistributionConfigCacheBehaviorsItemsItemLambdaFunctionAssociations(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[
            typing.List[DistributionDistributionConfigCacheBehaviorsItemsItemLambdaFunctionAssociationsItemsItem]
        ],
