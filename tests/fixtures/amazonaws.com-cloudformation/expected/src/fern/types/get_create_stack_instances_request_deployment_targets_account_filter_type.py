...
class GetCreateStackInstancesRequestDeploymentTargetsAccountFilterType(str, enum.Enum):
    """
    ...
    def visit(
        ...
        if self is GetCreateStackInstancesRequestDeploymentTargetsAccountFilterType.NONE:
            return none()
        if self is GetCreateStackInstancesRequestDeploymentTargetsAccountFilterType.INTERSECTION:
            return intersection()
        if self is GetCreateStackInstancesRequestDeploymentTargetsAccountFilterType.DIFFERENCE:
            return difference()
        if self is GetCreateStackInstancesRequestDeploymentTargetsAccountFilterType.UNION:
            return union()
