...
class RawFilesClient:
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            params={
                ...
                "filter": convert_and_respect_annotation_metadata(
                    object_=filter, annotation=FilesFilter, direction="write"
                ),
                "sort": convert_and_respect_annotation_metadata(object_=sort, annotation=FilesSort, direction="write"),
    ...
    def upload(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json=request,
            headers={
                "x-apideck-metadata": str(apideck_metadata) if apideck_metadata is not None else None,
            },
            request_options=request_options,
            omit=OMIT,
        )
    ...
    def one(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"file-storage/files/{jsonable_encoder(id)}",
            method="GET",
            params={
                "raw": raw,
                "fields": fields,
    ...
    def update(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[UpdateFileResponse]:
        """
        Rename or move File
    ...
    def download(
        ...
        with self._client_wrapper.httpx_client.stream(
            f"file-storage/files/{jsonable_encoder(id)}/download",
            method="GET",
            params={
                "fields": fields,
            },
...
class AsyncRawFilesClient:
    ...
    async def update(
        ...
        *,
        ...
        parent_folder_id: typing.Optional[ParentFolderId] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[UpdateFileResponse]:
        """
        Rename or move File
