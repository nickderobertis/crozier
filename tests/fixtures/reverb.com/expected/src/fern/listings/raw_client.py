        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                "categories": convert_and_respect_annotation_metadata(
                    object_=categories, annotation=typing.Sequence[PostListingsRequestCategoriesItem], direction="write"
                ),
                "condition": convert_and_respect_annotation_metadata(
                    object_=condition, annotation=PostListingsRequestCondition, direction="write"
                ),
                ...
                "location": convert_and_respect_annotation_metadata(
                    object_=location, annotation=PostListingsRequestLocation, direction="write"
                ),
                "make": make,
                "model": model,
                ...
                "photos": photos,
                "preorder_info": convert_and_respect_annotation_metadata(
                    object_=preorder_info, annotation=PostListingsRequestPreorderInfo, direction="write"
                ),
                "price": convert_and_respect_annotation_metadata(
                    object_=price, annotation=PostListingsRequestPrice, direction="write"
                ),
                "prop_65_warning": prop65warning,
                "publish": publish,
                "seller": convert_and_respect_annotation_metadata(
                    object_=seller, annotation=PostListingsRequestSeller, direction="write"
                ),
                "seller_cost": seller_cost,
                "shipping": convert_and_respect_annotation_metadata(
                    object_=shipping, annotation=PostListingsRequestShipping, direction="write"
                ),
                ...
                "videos": convert_and_respect_annotation_metadata(
                    object_=videos, annotation=typing.Sequence[PostListingsRequestVideosItem], direction="write"
                ),
                "year": year,
            },
            headers={
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                "categories": convert_and_respect_annotation_metadata(
                    object_=categories,
                    annotation=typing.Sequence[PutListingsSlugRequestCategoriesItem],
                    direction="write",
                ),
                "condition": convert_and_respect_annotation_metadata(
                    object_=condition, annotation=PutListingsSlugRequestCondition, direction="write"
                ),
                "description": description,
                "exclusive_channel": exclusive_channel,
                "finish": finish,
                ...
                "inventory": inventory,
                "location": convert_and_respect_annotation_metadata(
                    object_=location, annotation=PutListingsSlugRequestLocation, direction="write"
                ),
                "make": make,
                "model": model,
                "multi_item": multi_item,
                ...
                "photos": photos,
                "preorder_info": convert_and_respect_annotation_metadata(
                    object_=preorder_info, annotation=PutListingsSlugRequestPreorderInfo, direction="write"
                ),
                "price": convert_and_respect_annotation_metadata(
                    object_=price, annotation=PutListingsSlugRequestPrice, direction="write"
                ),
                "prop_65_warning": prop65warning,
                "publish": publish,
                "seller": convert_and_respect_annotation_metadata(
                    object_=seller, annotation=PutListingsSlugRequestSeller, direction="write"
                ),
                "seller_cost": seller_cost,
                "shipping": convert_and_respect_annotation_metadata(
                    object_=shipping, annotation=PutListingsSlugRequestShipping, direction="write"
                ),
                "shipping_profile_id": shipping_profile_id,
                "shipping_profile_name": shipping_profile_name,
                "sku": sku,
                ...
                "upc_does_not_apply": upc_does_not_apply,
                "videos": convert_and_respect_annotation_metadata(
                    object_=videos, annotation=typing.Sequence[PutListingsSlugRequestVideosItem], direction="write"
                ),
                "year": year,
            },
            headers={
