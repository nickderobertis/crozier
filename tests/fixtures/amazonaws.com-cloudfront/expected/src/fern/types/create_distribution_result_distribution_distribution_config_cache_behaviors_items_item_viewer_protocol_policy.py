...
class CreateDistributionResultDistributionDistributionConfigCacheBehaviorsItemsItemViewerProtocolPolicy(enum.StrEnum):
    """
    ...
    def visit(
        ...
        if (
            self
            is CreateDistributionResultDistributionDistributionConfigCacheBehaviorsItemsItemViewerProtocolPolicy.ALLOW_ALL
        ):
            return allow_all()
        if (
            self
            is CreateDistributionResultDistributionDistributionConfigCacheBehaviorsItemsItemViewerProtocolPolicy.HTTPS_ONLY
        ):
            return https_only()
        if (
            self
            is CreateDistributionResultDistributionDistributionConfigCacheBehaviorsItemsItemViewerProtocolPolicy.REDIRECT_TO_HTTPS
        ):
