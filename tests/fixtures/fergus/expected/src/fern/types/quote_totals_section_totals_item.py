...
class QuoteTotalsSectionTotalsItem(UniversalBaseModel):
    section_id: typing_extensions.Annotated[int, FieldMetadata(alias="sectionId"), pydantic.Field(alias="sectionId")]
