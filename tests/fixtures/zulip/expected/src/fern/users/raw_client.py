...
class RawUsersClient:
    ...
    ) -> HttpResponse[GetAttachmentsResponse]:
        """
    ...
    def remove_attachment(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"attachments/{encode_path_param(attachment_id)}",
            method="DELETE",
            request_options=request_options,
        )
        try:
    ...
    def reactivate_user(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"users/{encode_path_param(user_id)}/reactivate",
            method="POST",
            request_options=request_options,
        )
        try:
    ...
    def get_user_status(
        self, user_id: int, *, request_options: typing.Optional[RequestOptions] = None
    ) -> HttpResponse[GetUserStatusResponse]:
        """
        ...
        **Changes**: New in Zulip 9.0 (feature level 262). Previously,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"users/{encode_path_param(user_id)}/status",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def get_user_presence(
    ...
    ) -> HttpResponse[GetUserPresenceResponse]:
        """
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"users/{encode_path_param(user_id_or_email)}/presence",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def get_own_user(
        self, *, request_options: typing.Optional[RequestOptions] = None
    ) -> HttpResponse[GetOwnUserResponse]:
        """
    ...
    def regenerate_api_key(
        self, *, request_options: typing.Optional[RequestOptions] = None
    ) -> HttpResponse[RegenerateApiKeyResponse]:
        """
        !!! warn ""
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=RegenerateApiKeyResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def get_alert_words(
        self, *, request_options: typing.Optional[RequestOptions] = None
    ) -> HttpResponse[GetAlertWordsResponse]:
        """
    ...
    ) -> HttpResponse[AddAlertWordsResponse]:
        """
    ...
    def remove_alert_words(
        self, *, alert_words: typing.Sequence[str], request_options: typing.Optional[RequestOptions] = None
    ) -> HttpResponse[RemoveAlertWordsResponse]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=RemoveAlertWordsResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def update_presence(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[UpdatePresenceResponse]:
        """
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            data={
                "data": convert_and_respect_annotation_metadata(
                    object_=data, annotation=typing.Sequence[ProfileDataUpdate], direction="write"
                ),
            },
            headers={
                "content-type": "application/x-www-form-urlencoded",
    ...
    def mute_user(
        ...
        **Changes**: New in Zulip 4.0 (feature level 48).
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"users/me/muted_users/{encode_path_param(muted_user_id)}",
            method="POST",
            request_options=request_options,
        )
        try:
    ...
    def delete_avatar(
        self, *, request_options: typing.Optional[RequestOptions] = None
    ) -> HttpResponse[DeleteAvatarResponse]:
        """
    ...
    def get_user_by_email(
        ...
        *,
        ...
        include_custom_profile_fields: typing.Optional[bool] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[GetUserByEmailResponse]:
        """
        ...
        **Changes**: In Zulip 12.0 (feature level 437), fixed a bug
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"users/{encode_path_param(email)}",
            method="GET",
            params={
                "client_gravatar": client_gravatar,
                "include_custom_profile_fields": include_custom_profile_fields,
        ...
        **Changes**: New in Zulip 10.0 (feature level 313).
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            data={
                "full_name": full_name,
                "role": role,
                "profile_data": convert_and_respect_annotation_metadata(
                    object_=profile_data, annotation=typing.Sequence[ProfileDataUpdate], direction="write"
                ),
                "new_email": new_email,
            },
            headers={
    ...
    def update_settings(
        ...
        **Changes**: Removed `dense_mode` setting in Zulip 10.0 (feature level 364)
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            method="PATCH",
            data={
                "target_users": convert_and_respect_annotation_metadata(
                    object_=target_users, annotation=UpdateSettingsRequestTargetUsers, direction="write"
                ),
                "full_name": full_name,
                "email": email,
    ...
    def set_typing_status_for_message_edit(
        ...
        **Changes**: Before Zulip 10.0 (feature level 361), the endpoint was
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"messages/{encode_path_param(message_id)}/typing",
            method="POST",
            data={
                "op": op,
            },
    ...
    def create_user_group(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[CreateUserGroupResponse]:
        """
        ...
        **Changes**: Prior to Zulip 12.0 (feature level 496), bot
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            data={
                ...
                "members": members,
                "subgroups": subgroups,
                "can_add_members_group": convert_and_respect_annotation_metadata(
                    object_=can_add_members_group,
                    annotation=CreateUserGroupRequestCanAddMembersGroup,
                    direction="write",
                ),
                "can_join_group": convert_and_respect_annotation_metadata(
                    object_=can_join_group, annotation=CreateUserGroupRequestCanJoinGroup, direction="write"
                ),
                "can_leave_group": convert_and_respect_annotation_metadata(
                    object_=can_leave_group, annotation=CreateUserGroupRequestCanLeaveGroup, direction="write"
                ),
                "can_manage_group": convert_and_respect_annotation_metadata(
                    object_=can_manage_group, annotation=CreateUserGroupRequestCanManageGroup, direction="write"
                ),
                "can_mention_group": convert_and_respect_annotation_metadata(
                    object_=can_mention_group, annotation=CreateUserGroupRequestCanMentionGroup, direction="write"
                ),
                "can_remove_members_group": convert_and_respect_annotation_metadata(
                    object_=can_remove_members_group,
                    annotation=CreateUserGroupRequestCanRemoveMembersGroup,
                    direction="write",
                ),
            },
            headers={
    ...
    def get_user_group_members(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[GetUserGroupMembersResponse]:
        """
        ...
        **Changes**: Prior to Zulip 12.0 (feature level 496), bot
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"user_groups/{encode_path_param(user_group_id)}/members",
            method="GET",
            params={
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=GetUserGroupMembersResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def update_user_group(
        ...
        **Changes**: Prior to Zulip 12.0 (feature level 496), bot
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"user_groups/{encode_path_param(user_group_id)}",
            method="PATCH",
            data={
                "name": name,
                "description": description,
                "can_add_members_group": convert_and_respect_annotation_metadata(
                    object_=can_add_members_group,
                    annotation=UpdateUserGroupRequestCanAddMembersGroup,
                    direction="write",
                ),
                "can_join_group": convert_and_respect_annotation_metadata(
                    object_=can_join_group, annotation=UpdateUserGroupRequestCanJoinGroup, direction="write"
                ),
                "can_leave_group": convert_and_respect_annotation_metadata(
                    object_=can_leave_group, annotation=UpdateUserGroupRequestCanLeaveGroup, direction="write"
                ),
                "can_manage_group": convert_and_respect_annotation_metadata(
                    object_=can_manage_group, annotation=UpdateUserGroupRequestCanManageGroup, direction="write"
                ),
                "can_mention_group": convert_and_respect_annotation_metadata(
                    object_=can_mention_group, annotation=UpdateUserGroupRequestCanMentionGroup, direction="write"
                ),
                "can_remove_members_group": convert_and_respect_annotation_metadata(
                    object_=can_remove_members_group,
                    annotation=UpdateUserGroupRequestCanRemoveMembersGroup,
                    direction="write",
                ),
    ...
    def get_user_groups(
        self, *, request_options: typing.Optional[RequestOptions] = None
    ) -> HttpResponse[GetUserGroupsResponse]:
        """
    ...
    def get_user_group_subgroups(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[GetUserGroupSubgroupsResponse]:
        """
        ...
        **Changes**: Prior to Zulip 12.0 (feature level 496), bot
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"user_groups/{encode_path_param(user_group_id)}/subgroups",
            method="GET",
            params={
                "direct_subgroup_only": direct_subgroup_only,
            },
            request_options=request_options,
        )
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=GetUserGroupSubgroupsResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def get_is_user_group_member(
        ...
        *,
        direct_member_only: typing.Optional[bool] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[GetIsUserGroupMemberResponse]:
        """
        ...
        **Changes**: Prior to Zulip 12.0 (feature level 496), bot
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"user_groups/{encode_path_param(user_group_id)}/members/{encode_path_param(user_id)}",
            method="GET",
            params={
                "direct_member_only": direct_member_only,
            },
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=GetIsUserGroupMemberResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def deactivate_user_group(
        ...
        **Changes**: New in Zulip 10.0 (feature level 290).
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"user_groups/{encode_path_param(user_group_id)}/deactivate",
            method="POST",
            request_options=request_options,
        )
        try:
    ...
    def get_bot_api_key(
    ...
    ) -> HttpResponse[GetBotApiKeyResponse]:
        """
        ...
        **Changes**: New in Zulip 12.0 (feature level 463).
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"bots/{encode_path_param(bot_id)}/api_key",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def regenerate_bot_api_key(
        self, bot_id: int, *, request_options: typing.Optional[RequestOptions] = None
    ) -> HttpResponse[RegenerateBotApiKeyResponse]:
        """
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"bots/{encode_path_param(bot_id)}/api_key/regenerate",
            method="POST",
            request_options=request_options,
        )
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=RegenerateBotApiKeyResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawUsersClient:
    ...
    async def get_attachments(
        self, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[GetAttachmentsResponse]:
        """
        Fetch metadata on files uploaded by the requesting user.
    ...
    async def get_user_status(
        self, user_id: int, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[GetUserStatusResponse]:
        """
        Get the [status](/help/status-and-availability) currently set by a
        user in the organization.
    ...
    async def get_user_presence(
        self, user_id_or_email: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[GetUserPresenceResponse]:
        """
        Get the presence status for a specific user.
    ...
    async def get_own_user(
        self, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[GetOwnUserResponse]:
        """
        Get basic data about the user/bot that requests this endpoint.
    ...
    async def regenerate_api_key(
        self, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[RegenerateApiKeyResponse]:
        """
        !!! warn ""
    ...
    async def get_alert_words(
        self, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[GetAlertWordsResponse]:
        """
        Get all of the user's configured [alert words][alert-words].
    ...
    async def add_alert_words(
        self, *, alert_words: typing.Sequence[str], request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[AddAlertWordsResponse]:
        """
        Add words (or phrases) to the user's set of configured [alert words][alert-words].
    ...
    async def remove_alert_words(
        self, *, alert_words: typing.Sequence[str], request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[RemoveAlertWordsResponse]:
        """
        Remove words (or phrases) from the user's set of configured [alert words][alert-words].
    ...
    async def update_presence(
        ...
        *,
        ...
        slim_presence: typing.Optional[bool] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[UpdatePresenceResponse]:
        """
        Update the current user's [presence][availability] and fetch presence data
        of other users in the organization.
    ...
    async def upload_avatar(
        self, *, file: core.File, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[UploadAvatarResponse]:
        """
        Upload a new [profile picture](/help/change-your-profile-picture)
        for the current user.
    ...
    async def delete_avatar(
        self, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[DeleteAvatarResponse]:
        """
        Delete the current user's uploaded [profile picture](/help/change-your-profile-picture),
        reverting to the organization's
        [default style for profile pictures](/help/configure-default-profile-pictures).
    ...
    async def get_user_by_email(
        ...
        *,
        ...
        include_custom_profile_fields: typing.Optional[bool] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[GetUserByEmailResponse]:
        """
        Fetch details for a single user in the organization given a Zulip
        API email address.
    ...
    async def create_user_group(
        ...
        *,
        ...
        can_remove_members_group: typing.Optional[CreateUserGroupRequestCanRemoveMembersGroup] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[CreateUserGroupResponse]:
        """
        Create a new [user group](/help/user-groups).
    ...
    async def get_user_group_members(
        ...
        *,
        direct_member_only: typing.Optional[bool] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[GetUserGroupMembersResponse]:
        """
        Get the members of a [user group](/help/user-groups).
    ...
    async def get_user_groups(
        self, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[GetUserGroupsResponse]:
        """
        Fetches all of the user groups in the organization.
    ...
    async def get_user_group_subgroups(
        ...
        *,
        direct_subgroup_only: typing.Optional[bool] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[GetUserGroupSubgroupsResponse]:
        """
        Get the subgroups of a [user group](/help/user-groups).
    ...
    async def get_is_user_group_member(
        ...
        *,
        direct_member_only: typing.Optional[bool] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[GetIsUserGroupMemberResponse]:
        """
        Check whether a user is member of user group.
    ...
    async def get_bot_api_key(
        self, bot_id: int, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[GetBotApiKeyResponse]:
        """
        Fetch the API key for a bot user. Only the bot's owner and
        organization administrators have access to a bot's API key.
    ...
    async def regenerate_bot_api_key(
        self, bot_id: int, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[RegenerateBotApiKeyResponse]:
        """
        Generate a new API key for a bot user. Only the bot's owner and
        organization administrators have access to a bot's API key.
