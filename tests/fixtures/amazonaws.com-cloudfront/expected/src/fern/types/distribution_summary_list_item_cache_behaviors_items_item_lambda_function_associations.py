...
class DistributionSummaryListItemCacheBehaviorsItemsItemLambdaFunctionAssociations(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[
            typing.List[DistributionSummaryListItemCacheBehaviorsItemsItemLambdaFunctionAssociationsItemsItem]
        ],
