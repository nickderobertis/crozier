...
from ...types.destiny_historical_stats_destiny_leaderboard import DestinyHistoricalStatsDestinyLeaderboard


class Destiny2GetLeaderboardsForCharacterResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[typing.Dict[str, typing.Dict[str, DestinyHistoricalStatsDestinyLeaderboard]]],
