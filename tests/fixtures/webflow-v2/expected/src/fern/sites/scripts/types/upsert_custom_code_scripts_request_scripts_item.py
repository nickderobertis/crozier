...
from .upsert_custom_code_scripts_request_scripts_item_location import UpsertCustomCodeScriptsRequestScriptsItemLocation


class UpsertCustomCodeScriptsRequestScriptsItem(UniversalBaseModel):
    id: str = pydantic.Field()
    """
    ID of the registered custom code script
    """

    location: UpsertCustomCodeScriptsRequestScriptsItemLocation = pydantic.Field()
    """
