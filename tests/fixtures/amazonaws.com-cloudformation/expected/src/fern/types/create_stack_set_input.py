...
class CreateStackSetInput(UniversalBaseModel):
    ...
    permission_model: typing_extensions.Annotated[
        typing.Optional[CreateStackSetInputPermissionModel], FieldMetadata(alias="PermissionModel")
    ] = pydantic.Field(default=None)
    """
    ...
    auto_deployment: typing_extensions.Annotated[
        typing.Optional[CreateStackSetInputAutoDeployment], FieldMetadata(alias="AutoDeployment")
    ] = pydantic.Field(default=None)
    """
    ...
    call_as: typing_extensions.Annotated[typing.Optional[CreateStackSetInputCallAs], FieldMetadata(alias="CallAs")] = (
        pydantic.Field(default=None)
    )
    """
    ...
    managed_execution: typing_extensions.Annotated[
        typing.Optional[CreateStackSetInputManagedExecution], FieldMetadata(alias="ManagedExecution")
    ] = pydantic.Field(default=None)
    """
