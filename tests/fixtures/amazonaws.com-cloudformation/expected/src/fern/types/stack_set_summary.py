...
class StackSetSummary(UniversalBaseModel):
    ...
    status: typing_extensions.Annotated[typing.Optional[StackSetSummaryStatus], FieldMetadata(alias="Status")] = (
        pydantic.Field(default=None)
    )
    """
    ...
    auto_deployment: typing_extensions.Annotated[
        typing.Optional[StackSetSummaryAutoDeployment], FieldMetadata(alias="AutoDeployment")
    ] = pydantic.Field(default=None)
    """
    ...
    permission_model: typing_extensions.Annotated[
        typing.Optional[StackSetSummaryPermissionModel], FieldMetadata(alias="PermissionModel")
    ] = pydantic.Field(default=None)
    """
    ...
    drift_status: typing_extensions.Annotated[
        typing.Optional[StackSetSummaryDriftStatus], FieldMetadata(alias="DriftStatus")
    ] = pydantic.Field(default=None)
    """
    ...
    managed_execution: typing_extensions.Annotated[
        typing.Optional[StackSetSummaryManagedExecution], FieldMetadata(alias="ManagedExecution")
    ] = pydantic.Field(default=None)
    """
