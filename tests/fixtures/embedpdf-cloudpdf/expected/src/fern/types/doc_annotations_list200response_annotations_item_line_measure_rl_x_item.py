...
class DocAnnotationsList200ResponseAnnotationsItemLineMeasureRlXItem(UniversalBaseModel):
    unit: str
    conversion: typing.Optional[float] = None
    fraction: typing.Optional[DocAnnotationsList200ResponseAnnotationsItemLineMeasureRlXItemFraction] = None
    ...
    label_position: typing_extensions.Annotated[
        typing.Optional[DocAnnotationsList200ResponseAnnotationsItemLineMeasureRlXItemLabelPosition],
