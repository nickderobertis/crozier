...
class DestinyDefinitionsDestinyItemCraftingBlockDefinition(UniversalBaseModel):
    ...
    base_material_requirements: typing_extensions.Annotated[
        typing.Optional[int], FieldMetadata(alias="baseMaterialRequirements")
    ...
    failed_requirement_strings: typing_extensions.Annotated[
        typing.Optional[typing.List[str]], FieldMetadata(alias="failedRequirementStrings")
    ] = None
    output_item_hash: typing_extensions.Annotated[typing.Optional[int], FieldMetadata(alias="outputItemHash")] = (
        pydantic.Field(default=None)
    )
    """
    ...
    required_socket_type_hashes: typing_extensions.Annotated[
        typing.Optional[typing.List[int]], FieldMetadata(alias="requiredSocketTypeHashes")
    ] = pydantic.Field(default=None)
    """
