...
class CreateSitesResponse(UniversalBaseModel):
    ...
    display_name: typing_extensions.Annotated[
        str, FieldMetadata(alias="displayName"), pydantic.Field(alias="displayName", description="Name given to Site")
    ]
    """
    Name given to Site
    """
    ...
    custom_domains: typing_extensions.Annotated[
        typing.Optional[typing.List[CreateSitesResponseCustomDomainsItem]],
        FieldMetadata(alias="customDomains"),
        pydantic.Field(alias="customDomains"),
    ] = None
    locales: typing.Optional[CreateSitesResponseLocales] = None
