...
class DestinyComponentsCollectiblesDestinyProfileCollectiblesComponent(UniversalBaseModel):
    ...
    newness_flagged_collectible_hashes: typing_extensions.Annotated[
        ...
        FieldMetadata(alias="newnessFlaggedCollectibleHashes"),
        pydantic.Field(
            alias="newnessFlaggedCollectibleHashes",
    ...
    recent_collectible_hashes: typing_extensions.Annotated[
        typing.Optional[typing.List[int]],
        FieldMetadata(alias="recentCollectibleHashes"),
        pydantic.Field(
            alias="recentCollectibleHashes",
            description='The list of collectibles determined by the game as having been "recently" acquired.',
        ),
    ] = None
    """
