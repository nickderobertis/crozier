...
class GetEventsResponseEventsItemThirtyFour(UniversalBaseModel):
    """
    ...
    type: typing.Optional[GetEventsResponseEventsItemThirtyFourType] = pydantic.Field(default=None)
    """
