...
class UpdateOrdersResponsePurchasedItemsItem(UniversalBaseModel):
    """
    ...
    row_total: typing_extensions.Annotated[
        typing.Optional[UpdateOrdersResponsePurchasedItemsItemRowTotal],
    ...
    variant_image: typing_extensions.Annotated[
        typing.Optional[UpdateOrdersResponsePurchasedItemsItemVariantImage],
        FieldMetadata(alias="variantImage"),
        pydantic.Field(alias="variantImage"),
    ] = None
    variant_price: typing_extensions.Annotated[
        typing.Optional[UpdateOrdersResponsePurchasedItemsItemVariantPrice],
