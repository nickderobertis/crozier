...
class UpdateStackSetInput(UniversalBaseModel):
    stack_set_name: typing_extensions.Annotated[
        str,
        FieldMetadata(alias="StackSetName"),
        pydantic.Field(
            alias="StackSetName", description="The name or unique ID of the stack set that you want to update."
        ),
    ]
    """
    ...
    description: typing_extensions.Annotated[
        ...
        pydantic.Field(alias="Description", description="A brief description of updates that you are making."),
    ] = None
    """
    ...
    use_previous_template: typing_extensions.Annotated[
        ...
        FieldMetadata(alias="UsePreviousTemplate"),
        pydantic.Field(
            alias="UsePreviousTemplate",
    ...
    parameters: typing_extensions.Annotated[
        ...
        pydantic.Field(alias="Parameters", description="A list of input parameters for the stack set template."),
    ] = None
    """
    ...
    operation_preferences: typing_extensions.Annotated[
        typing.Optional[UpdateStackSetInputOperationPreferences],
    ...
    permission_model: typing_extensions.Annotated[
        typing.Optional[UpdateStackSetInputPermissionModel],
    ...
    auto_deployment: typing_extensions.Annotated[
        typing.Optional[UpdateStackSetInputAutoDeployment],
        FieldMetadata(alias="AutoDeployment"),
        pydantic.Field(
            alias="AutoDeployment",
            description="<p>[Service-managed permissions] Describes whether StackSets automatically deploys to Organizations accounts that are added to a target organization or organizational unit (OU).</p> <p>If you specify <code>AutoDeployment</code>, don't specify <code>DeploymentTargets</code> or <code>Regions</code>.</p>",
        ),
    ] = None
    """
    ...
    call_as: typing_extensions.Annotated[
        typing.Optional[UpdateStackSetInputCallAs],
    ...
    managed_execution: typing_extensions.Annotated[
        typing.Optional[UpdateStackSetInputManagedExecution],
