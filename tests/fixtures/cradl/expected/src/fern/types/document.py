...
class Document(UniversalBaseModel):
    ...
    ground_truth: typing_extensions.Annotated[
        typing.Optional[typing.List[DocumentGroundTruthItem]],
    ...
    content_type: typing_extensions.Annotated[
        typing.Optional[DocumentContentType], FieldMetadata(alias="contentType"), pydantic.Field(alias="contentType")
    ] = None
