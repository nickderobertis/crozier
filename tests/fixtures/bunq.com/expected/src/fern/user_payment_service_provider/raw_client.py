...
class RawUserPaymentServiceProviderClient:
    ...
    def read_user_payment_service_provider(
    ...
    ) -> HttpResponse[UserPaymentServiceProviderRead]:
        """
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"user-payment-service-provider/{encode_path_param(item_id)}",
            method="GET",
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=UserPaymentServiceProviderRead,
...
class AsyncRawUserPaymentServiceProviderClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._client_wrapper = client_wrapper

    async def read_user_payment_service_provider(
        self, item_id: int, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[UserPaymentServiceProviderRead]:
        """
        Used to view UserPaymentServiceProvider for session creation.
