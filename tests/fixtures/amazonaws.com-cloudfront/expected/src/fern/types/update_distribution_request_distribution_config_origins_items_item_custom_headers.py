...
class UpdateDistributionRequestDistributionConfigOriginsItemsItemCustomHeaders(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[typing.List[UpdateDistributionRequestDistributionConfigOriginsItemsItemCustomHeadersItemsItem]],
