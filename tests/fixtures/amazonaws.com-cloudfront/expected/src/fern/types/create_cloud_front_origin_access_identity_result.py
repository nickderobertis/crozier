...
class CreateCloudFrontOriginAccessIdentityResult(UniversalBaseModel):
    """
    The returned result of the corresponding request.
    """

    cloud_front_origin_access_identity: typing_extensions.Annotated[
        typing.Optional[CreateCloudFrontOriginAccessIdentityResultCloudFrontOriginAccessIdentity],
