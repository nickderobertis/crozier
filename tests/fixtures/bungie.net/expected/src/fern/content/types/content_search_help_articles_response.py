...
class ContentSearchHelpArticlesResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[typing.Dict[str, typing.Any]], FieldMetadata(alias="Response"), pydantic.Field(alias="Response")
    ] = None
