...
from .cache_behaviors_items_item_lambda_function_associations import CacheBehaviorsItemsItemLambdaFunctionAssociations
...
class CacheBehaviorsItemsItem(UniversalBaseModel):
    """
    ...
    lambda_function_associations: typing_extensions.Annotated[
        typing.Optional[CacheBehaviorsItemsItemLambdaFunctionAssociations],
