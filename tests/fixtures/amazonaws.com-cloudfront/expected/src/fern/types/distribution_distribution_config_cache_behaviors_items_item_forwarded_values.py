...
class DistributionDistributionConfigCacheBehaviorsItemsItemForwardedValues(UniversalBaseModel):
    """
    ...
    headers: typing_extensions.Annotated[
        typing.Optional[DistributionDistributionConfigCacheBehaviorsItemsItemForwardedValuesHeaders],
    ...
    query_string_cache_keys: typing_extensions.Annotated[
        typing.Optional[DistributionDistributionConfigCacheBehaviorsItemsItemForwardedValuesQueryStringCacheKeys],
