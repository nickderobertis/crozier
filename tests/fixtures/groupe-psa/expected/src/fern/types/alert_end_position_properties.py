...
class AlertEndPositionProperties(CreatedAtField):
    ...
    type: typing.Optional[AlertEndPositionPropertiesType] = None
    fix_status: typing_extensions.Annotated[
        typing.Optional[AlertEndPositionPropertiesFixStatus],
