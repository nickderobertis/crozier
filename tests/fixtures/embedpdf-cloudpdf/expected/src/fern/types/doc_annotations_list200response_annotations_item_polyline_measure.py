...
class DocAnnotationsList200ResponseAnnotationsItemPolylineMeasure_Rl(UniversalBaseModel):
...
class DocAnnotationsList200ResponseAnnotationsItemPolylineMeasure_Geo(UniversalBaseModel):
...
class DocAnnotationsList200ResponseAnnotationsItemPolylineMeasure_Unknown(UniversalBaseModel):
...
DocAnnotationsList200ResponseAnnotationsItemPolylineMeasure = typing_extensions.Annotated[
    typing.Union[
