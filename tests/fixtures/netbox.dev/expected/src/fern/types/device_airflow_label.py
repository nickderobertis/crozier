...
class DeviceAirflowLabel(str, enum.Enum):
    ...
    def visit(
        ...
        if self is DeviceAirflowLabel.FRONT_TO_REAR:
            return front_to_rear()
        if self is DeviceAirflowLabel.REAR_TO_FRONT:
            return rear_to_front()
        if self is DeviceAirflowLabel.LEFT_TO_RIGHT:
            return left_to_right()
        if self is DeviceAirflowLabel.RIGHT_TO_LEFT:
            return right_to_left()
        if self is DeviceAirflowLabel.SIDE_TO_REAR:
            return side_to_rear()
        if self is DeviceAirflowLabel.PASSIVE:
            return passive()
        if self is DeviceAirflowLabel.MIXED:
            return mixed()
