...
from ...types.user_user_membership_data import UserUserMembershipData


class UserGetMembershipDataForCurrentUserResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[typing.Optional[UserUserMembershipData], FieldMetadata(alias="Response")] = (
        None
    )
