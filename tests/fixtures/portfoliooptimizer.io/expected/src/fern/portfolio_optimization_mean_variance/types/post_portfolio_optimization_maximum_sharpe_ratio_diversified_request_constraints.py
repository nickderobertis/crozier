...
class PostPortfolioOptimizationMaximumSharpeRatioDiversifiedRequestConstraints(UniversalBaseModel):
    ...
    delta_return: typing_extensions.Annotated[
        ...
        pydantic.Field(
            alias="deltaReturn", description="The relative tolerance over the maximum Sharpe ratio portfolio return"
        ),
    ] = None
    """
