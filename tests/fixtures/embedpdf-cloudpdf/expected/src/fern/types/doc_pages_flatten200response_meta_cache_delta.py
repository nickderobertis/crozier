...
from .doc_pages_flatten200response_meta_cache_delta_pages_item import DocPagesFlatten200ResponseMetaCacheDeltaPagesItem


class DocPagesFlatten200ResponseMetaCacheDelta(UniversalBaseModel):
    ...
    pages: typing.List[DocPagesFlatten200ResponseMetaCacheDeltaPagesItem]
