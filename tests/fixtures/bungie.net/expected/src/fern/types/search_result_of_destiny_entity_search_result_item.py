...
class SearchResultOfDestinyEntitySearchResultItem(UniversalBaseModel):
    ...
    results: typing.Optional[typing.List[DestinyDefinitionsDestinyEntitySearchResultItem]] = None
