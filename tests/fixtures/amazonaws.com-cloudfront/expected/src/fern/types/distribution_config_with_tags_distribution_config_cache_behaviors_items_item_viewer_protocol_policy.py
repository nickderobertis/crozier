...
class DistributionConfigWithTagsDistributionConfigCacheBehaviorsItemsItemViewerProtocolPolicy(enum.StrEnum):
    """
    ...
    def visit(
        ...
        if self is DistributionConfigWithTagsDistributionConfigCacheBehaviorsItemsItemViewerProtocolPolicy.ALLOW_ALL:
            return allow_all()
        if self is DistributionConfigWithTagsDistributionConfigCacheBehaviorsItemsItemViewerProtocolPolicy.HTTPS_ONLY:
            return https_only()
        if (
            self
            is DistributionConfigWithTagsDistributionConfigCacheBehaviorsItemsItemViewerProtocolPolicy.REDIRECT_TO_HTTPS
        ):
