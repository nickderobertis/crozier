...
client = FernApi(...)
response = client.bandwidth_allocations.with_raw_response.post_v1bandwidth_allocations(...)
...
```python
client.bandwidth_allocations.post_v1bandwidth_allocations(..., request_options={
    "max_retries": 1
})
```
