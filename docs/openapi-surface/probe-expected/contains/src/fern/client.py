...
class FernApi:
    ...
    def get_basket(self, *, request_options: typing.Optional[RequestOptions] = None) -> Basket:
        """
        Parameters
        ----------
        ...
        client.get_basket()
        """
        _response = self._raw_client.get_basket(request_options=request_options)
...
class AsyncFernApi:
    ...
    async def get_basket(self, *, request_options: typing.Optional[RequestOptions] = None) -> Basket:
        """
        Parameters
        ----------
        request_options : typing.Optional[RequestOptions]
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.get_basket(request_options=request_options)
        return _response.data
