...
class RawOrganisationsClient:
    ...
    ) -> HttpResponse[OrganisationsPage]:
        """
        Parameters
        ----------
    ...
    def get_the_given_organisations_details(
    ...
    ) -> HttpResponse[OrganisationWithTnc]:
        """
        Parameters
        ----------
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"organisations/{encode_path_param(organisation_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def get_all_tn_c_data_of_the_given_organisation(
        ...
        *,
        ...
        sort: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[OrgTermsAndConditionsPage]:
        """
        Parameters
        ----------
        organisation_id : OrganisationId
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"organisations/{encode_path_param(organisation_id)}/tnchistory",
            method="GET",
            params={
                "page": page,
                "size": size,
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=OrgTermsAndConditionsPage,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawOrganisationsClient:
    ...
    async def get_all_organisations_that_the_logged_in_user_is_authorised_to_retrieve_from_trusted_services(
        ...
        *,
        ...
        hide_inactive: typing.Optional[bool] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[OrganisationsPage]:
        """
        Parameters
        ----------
        page : typing.Optional[int]
    ...
    async def get_the_given_organisations_details(
        self, organisation_id: OrganisationId, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[OrganisationWithTnc]:
        """
        Parameters
        ----------
        organisation_id : OrganisationId
    ...
    async def get_all_tn_c_data_of_the_given_organisation(
        ...
        *,
        ...
        sort: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[OrgTermsAndConditionsPage]:
        """
        Parameters
        ----------
        organisation_id : OrganisationId
