...
class StackResourceDrift(UniversalBaseModel):
    ...
    stack_resource_drift_status: typing_extensions.Annotated[
        StackResourceDriftStackResourceDriftStatus, FieldMetadata(alias="StackResourceDriftStatus")
    ] = pydantic.Field()
    """
    ...
    module_info: typing_extensions.Annotated[
        typing.Optional[StackResourceDriftModuleInfo], FieldMetadata(alias="ModuleInfo")
    ] = pydantic.Field(default=None)
    """
