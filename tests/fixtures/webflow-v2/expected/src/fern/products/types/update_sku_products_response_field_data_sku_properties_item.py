...
class UpdateSkuProductsResponseFieldDataSkuPropertiesItem(UniversalBaseModel):
    """
    ...
    enum: typing.List[UpdateSkuProductsResponseFieldDataSkuPropertiesItemEnumItem] = pydantic.Field()
    """
