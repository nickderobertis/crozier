...
class UpdateUnfulfillOrdersResponsePurchasedItemsItemVariantImageFile(UniversalBaseModel):
    ...
    variants: typing.Optional[
        typing.List[UpdateUnfulfillOrdersResponsePurchasedItemsItemVariantImageFileVariantsItem]
