...
class DestinyDestinyUnlockStatus(UniversalBaseModel):
    ...
    is_set: typing_extensions.Annotated[typing.Optional[bool], FieldMetadata(alias="isSet")] = pydantic.Field(
        default=None
    )
    """
    ...
    unlock_hash: typing_extensions.Annotated[typing.Optional[int], FieldMetadata(alias="unlockHash")] = pydantic.Field(
        default=None
    )
    """
