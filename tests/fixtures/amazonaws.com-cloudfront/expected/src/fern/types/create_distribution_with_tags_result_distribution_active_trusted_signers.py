...
class CreateDistributionWithTagsResultDistributionActiveTrustedSigners(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[typing.List[CreateDistributionWithTagsResultDistributionActiveTrustedSignersItemsItem]],
