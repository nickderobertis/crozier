...
class ActivateTypeInput(UniversalBaseModel):
    type: typing_extensions.Annotated[typing.Optional[ActivateTypeInputType], FieldMetadata(alias="Type")] = (
    ...
    type_name_alias: typing_extensions.Annotated[typing.Optional[str], FieldMetadata(alias="TypeNameAlias")] = (
        pydantic.Field(default=None)
    )
    """
    ...
    logging_config: typing_extensions.Annotated[
        typing.Optional[LoggingConfig], FieldMetadata(alias="LoggingConfig")
    ] = None
    ...
    version_bump: typing_extensions.Annotated[
        typing.Optional[ActivateTypeInputVersionBump], FieldMetadata(alias="VersionBump")
    ] = pydantic.Field(default=None)
    """
    ...
    major_version: typing_extensions.Annotated[typing.Optional[int], FieldMetadata(alias="MajorVersion")] = (
        pydantic.Field(default=None)
    )
    """
