...
class InterfaceTemplateTypeValue(str, enum.Enum):
    VIRTUAL = "virtual"
    BRIDGE = "bridge"
    LAG = "lag"
    ...
    def visit(
        ...
        if self is InterfaceTemplateTypeValue.VIRTUAL:
            return virtual()
        if self is InterfaceTemplateTypeValue.BRIDGE:
            return bridge()
        if self is InterfaceTemplateTypeValue.LAG:
            return lag()
        if self is InterfaceTemplateTypeValue.ONE_HUNDRED_BASE_FX:
            return one_hundred_base_fx()
        if self is InterfaceTemplateTypeValue.ONE_HUNDRED_BASE_LFX:
            return one_hundred_base_lfx()
        if self is InterfaceTemplateTypeValue.ONE_HUNDRED_BASE_TX:
            return one_hundred_base_tx()
        if self is InterfaceTemplateTypeValue.ONE_HUNDRED_BASE_T1:
            return one_hundred_base_t1()
        if self is InterfaceTemplateTypeValue.ONE_THOUSAND_BASE_T:
            return one_thousand_base_t()
        if self is InterfaceTemplateTypeValue.TWO5GBASE_T:
            return two5gbase_t()
        if self is InterfaceTemplateTypeValue.FIVE_GBASE_T:
            return five_gbase_t()
        if self is InterfaceTemplateTypeValue.TEN_GBASE_T:
            return ten_gbase_t()
        if self is InterfaceTemplateTypeValue.TEN_GBASE_CX4:
            return ten_gbase_cx4()
        if self is InterfaceTemplateTypeValue.ONE_THOUSAND_BASE_X_GBIC:
            return one_thousand_base_x_gbic()
        if self is InterfaceTemplateTypeValue.ONE_THOUSAND_BASE_X_SFP:
            return one_thousand_base_x_sfp()
        if self is InterfaceTemplateTypeValue.TEN_GBASE_X_SFPP:
            return ten_gbase_x_sfpp()
        if self is InterfaceTemplateTypeValue.TEN_GBASE_X_XFP:
            return ten_gbase_x_xfp()
        if self is InterfaceTemplateTypeValue.TEN_GBASE_X_XENPAK:
            return ten_gbase_x_xenpak()
        if self is InterfaceTemplateTypeValue.TEN_GBASE_XX2:
            return ten_gbase_xx2()
        if self is InterfaceTemplateTypeValue.TWENTY_FIVE_GBASE_X_SFP28:
            return twenty_five_gbase_x_sfp28()
        if self is InterfaceTemplateTypeValue.FIFTY_GBASE_X_SFP56:
            return fifty_gbase_x_sfp56()
        if self is InterfaceTemplateTypeValue.FORTY_GBASE_X_QSFPP:
            return forty_gbase_x_qsfpp()
        if self is InterfaceTemplateTypeValue.FIFTY_GBASE_X_SFP28:
            return fifty_gbase_x_sfp28()
        if self is InterfaceTemplateTypeValue.ONE_HUNDRED_GBASE_X_CFP:
            return one_hundred_gbase_x_cfp()
        if self is InterfaceTemplateTypeValue.ONE_HUNDRED_GBASE_X_CFP2:
            return one_hundred_gbase_x_cfp2()
        if self is InterfaceTemplateTypeValue.TWO_HUNDRED_GBASE_X_CFP2:
            return two_hundred_gbase_x_cfp2()
        if self is InterfaceTemplateTypeValue.ONE_HUNDRED_GBASE_X_CFP4:
            return one_hundred_gbase_x_cfp4()
        if self is InterfaceTemplateTypeValue.ONE_HUNDRED_GBASE_X_CPAK:
            return one_hundred_gbase_x_cpak()
        if self is InterfaceTemplateTypeValue.ONE_HUNDRED_GBASE_X_QSFP28:
            return one_hundred_gbase_x_qsfp28()
        if self is InterfaceTemplateTypeValue.TWO_HUNDRED_GBASE_X_QSFP56:
            return two_hundred_gbase_x_qsfp56()
        if self is InterfaceTemplateTypeValue.FOUR_HUNDRED_GBASE_X_QSFPDD:
            return four_hundred_gbase_x_qsfpdd()
        if self is InterfaceTemplateTypeValue.FOUR_HUNDRED_GBASE_X_OSFP:
            return four_hundred_gbase_x_osfp()
        if self is InterfaceTemplateTypeValue.EIGHT_HUNDRED_GBASE_X_QSFPDD:
            return eight_hundred_gbase_x_qsfpdd()
        if self is InterfaceTemplateTypeValue.EIGHT_HUNDRED_GBASE_X_OSFP:
            return eight_hundred_gbase_x_osfp()
        if self is InterfaceTemplateTypeValue.ONE_THOUSAND_BASE_KX:
            return one_thousand_base_kx()
        if self is InterfaceTemplateTypeValue.TEN_GBASE_KR:
            return ten_gbase_kr()
        if self is InterfaceTemplateTypeValue.TEN_GBASE_KX4:
            return ten_gbase_kx4()
        if self is InterfaceTemplateTypeValue.TWENTY_FIVE_GBASE_KR:
            return twenty_five_gbase_kr()
        if self is InterfaceTemplateTypeValue.FORTY_GBASE_KR4:
            return forty_gbase_kr4()
        if self is InterfaceTemplateTypeValue.FIFTY_GBASE_KR:
            return fifty_gbase_kr()
        if self is InterfaceTemplateTypeValue.ONE_HUNDRED_GBASE_KP4:
            return one_hundred_gbase_kp4()
        if self is InterfaceTemplateTypeValue.ONE_HUNDRED_GBASE_KR2:
            return one_hundred_gbase_kr2()
        if self is InterfaceTemplateTypeValue.ONE_HUNDRED_GBASE_KR4:
            return one_hundred_gbase_kr4()
        if self is InterfaceTemplateTypeValue.IEEE80211A:
            return ieee80211a()
        if self is InterfaceTemplateTypeValue.IEEE80211G:
            return ieee80211g()
        if self is InterfaceTemplateTypeValue.IEEE80211N:
            return ieee80211n()
        if self is InterfaceTemplateTypeValue.IEEE80211AC:
            return ieee80211ac()
        if self is InterfaceTemplateTypeValue.IEEE80211AD:
            return ieee80211ad()
        if self is InterfaceTemplateTypeValue.IEEE80211AX:
            return ieee80211ax()
        if self is InterfaceTemplateTypeValue.IEEE80211AY:
            return ieee80211ay()
        if self is InterfaceTemplateTypeValue.IEEE802151:
            return ieee802151()
        if self is InterfaceTemplateTypeValue.OTHER_WIRELESS:
            return other_wireless()
        if self is InterfaceTemplateTypeValue.GSM:
            return gsm()
        if self is InterfaceTemplateTypeValue.CDMA:
            return cdma()
        if self is InterfaceTemplateTypeValue.LTE:
            return lte()
        if self is InterfaceTemplateTypeValue.SONET_OC3:
            return sonet_oc3()
        if self is InterfaceTemplateTypeValue.SONET_OC12:
            return sonet_oc12()
        if self is InterfaceTemplateTypeValue.SONET_OC48:
            return sonet_oc48()
        if self is InterfaceTemplateTypeValue.SONET_OC192:
            return sonet_oc192()
        if self is InterfaceTemplateTypeValue.SONET_OC768:
            return sonet_oc768()
        if self is InterfaceTemplateTypeValue.SONET_OC1920:
            return sonet_oc1920()
        if self is InterfaceTemplateTypeValue.SONET_OC3840:
            return sonet_oc3840()
        if self is InterfaceTemplateTypeValue.ONE_GFC_SFP:
            return one_gfc_sfp()
        if self is InterfaceTemplateTypeValue.TWO_GFC_SFP:
            return two_gfc_sfp()
        if self is InterfaceTemplateTypeValue.FOUR_GFC_SFP:
            return four_gfc_sfp()
        if self is InterfaceTemplateTypeValue.EIGHT_GFC_SFPP:
            return eight_gfc_sfpp()
        if self is InterfaceTemplateTypeValue.SIXTEEN_GFC_SFPP:
            return sixteen_gfc_sfpp()
        if self is InterfaceTemplateTypeValue.THIRTY_TWO_GFC_SFP28:
            return thirty_two_gfc_sfp28()
        if self is InterfaceTemplateTypeValue.SIXTY_FOUR_GFC_QSFPP:
            return sixty_four_gfc_qsfpp()
        if self is InterfaceTemplateTypeValue.ONE_HUNDRED_TWENTY_EIGHT_GFC_QSFP28:
            return one_hundred_twenty_eight_gfc_qsfp28()
        if self is InterfaceTemplateTypeValue.INFINIBAND_SDR:
            return infiniband_sdr()
        if self is InterfaceTemplateTypeValue.INFINIBAND_DDR:
            return infiniband_ddr()
        if self is InterfaceTemplateTypeValue.INFINIBAND_QDR:
            return infiniband_qdr()
        if self is InterfaceTemplateTypeValue.INFINIBAND_FDR10:
            return infiniband_fdr10()
        if self is InterfaceTemplateTypeValue.INFINIBAND_FDR:
            return infiniband_fdr()
        if self is InterfaceTemplateTypeValue.INFINIBAND_EDR:
            return infiniband_edr()
        if self is InterfaceTemplateTypeValue.INFINIBAND_HDR:
            return infiniband_hdr()
        if self is InterfaceTemplateTypeValue.INFINIBAND_NDR:
            return infiniband_ndr()
        if self is InterfaceTemplateTypeValue.INFINIBAND_XDR:
            return infiniband_xdr()
        if self is InterfaceTemplateTypeValue.T1:
            return t1()
        if self is InterfaceTemplateTypeValue.E1:
            return e1()
        if self is InterfaceTemplateTypeValue.T3:
            return t3()
        if self is InterfaceTemplateTypeValue.E3:
            return e3()
        if self is InterfaceTemplateTypeValue.XDSL:
            return xdsl()
        if self is InterfaceTemplateTypeValue.DOCSIS:
            return docsis()
        if self is InterfaceTemplateTypeValue.GPON:
            return gpon()
        if self is InterfaceTemplateTypeValue.XG_PON:
            return xg_pon()
        if self is InterfaceTemplateTypeValue.XGS_PON:
            return xgs_pon()
        if self is InterfaceTemplateTypeValue.NG_PON2:
            return ng_pon2()
        if self is InterfaceTemplateTypeValue.EPON:
            return epon()
        if self is InterfaceTemplateTypeValue.TEN_G_EPON:
            return ten_g_epon()
        if self is InterfaceTemplateTypeValue.CISCO_STACKWISE:
            return cisco_stackwise()
        if self is InterfaceTemplateTypeValue.CISCO_STACKWISE_PLUS:
            return cisco_stackwise_plus()
        if self is InterfaceTemplateTypeValue.CISCO_FLEXSTACK:
            return cisco_flexstack()
        if self is InterfaceTemplateTypeValue.CISCO_FLEXSTACK_PLUS:
            return cisco_flexstack_plus()
        if self is InterfaceTemplateTypeValue.CISCO_STACKWISE80:
            return cisco_stackwise80()
        if self is InterfaceTemplateTypeValue.CISCO_STACKWISE160:
            return cisco_stackwise160()
        if self is InterfaceTemplateTypeValue.CISCO_STACKWISE320:
            return cisco_stackwise320()
        if self is InterfaceTemplateTypeValue.CISCO_STACKWISE480:
            return cisco_stackwise480()
        if self is InterfaceTemplateTypeValue.CISCO_STACKWISE1T:
            return cisco_stackwise1t()
        if self is InterfaceTemplateTypeValue.JUNIPER_VCP:
            return juniper_vcp()
        if self is InterfaceTemplateTypeValue.EXTREME_SUMMITSTACK:
            return extreme_summitstack()
        if self is InterfaceTemplateTypeValue.EXTREME_SUMMITSTACK128:
            return extreme_summitstack128()
        if self is InterfaceTemplateTypeValue.EXTREME_SUMMITSTACK256:
            return extreme_summitstack256()
        if self is InterfaceTemplateTypeValue.EXTREME_SUMMITSTACK512:
            return extreme_summitstack512()
        if self is InterfaceTemplateTypeValue.OTHER:
            return other()
