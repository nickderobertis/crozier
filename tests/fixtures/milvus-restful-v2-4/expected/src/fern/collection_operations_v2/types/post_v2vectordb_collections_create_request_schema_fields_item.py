...
class PostV2VectordbCollectionsCreateRequestSchemaFieldsItem(UniversalBaseModel):
    """
    ...
    element_type_params: typing_extensions.Annotated[
        typing.Optional[PostV2VectordbCollectionsCreateRequestSchemaFieldsItemElementTypeParams],
