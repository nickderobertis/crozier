...
class DescribeChangeSetOutputExecutionStatus(str, enum.Enum):
    """
    ...
    def visit(
        ...
        if self is DescribeChangeSetOutputExecutionStatus.UNAVAILABLE:
            return unavailable()
        if self is DescribeChangeSetOutputExecutionStatus.AVAILABLE:
            return available()
        if self is DescribeChangeSetOutputExecutionStatus.EXECUTE_IN_PROGRESS:
            return execute_in_progress()
        if self is DescribeChangeSetOutputExecutionStatus.EXECUTE_COMPLETE:
            return execute_complete()
        if self is DescribeChangeSetOutputExecutionStatus.EXECUTE_FAILED:
            return execute_failed()
        if self is DescribeChangeSetOutputExecutionStatus.OBSOLETE:
            return obsolete()
