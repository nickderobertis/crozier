...
class GetSpecificPostsFromTopicResponsePostStreamPostsItem(UniversalBaseModel):
    actions_summary: typing.Optional[
        typing.List[GetSpecificPostsFromTopicResponsePostStreamPostsItemActionsSummaryItem]
    ] = None
    ...
    reviewable_id: typing.Optional[int] = None
