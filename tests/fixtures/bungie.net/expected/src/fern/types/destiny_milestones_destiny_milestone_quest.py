...
class DestinyMilestonesDestinyMilestoneQuest(UniversalBaseModel):
    """
    ...
    activity: typing.Optional[DestinyMilestonesDestinyMilestoneActivity] = pydantic.Field(default=None)
    """
    *IF* the Milestone has an active Activity that can give you greater details about what you need to do, it will be returned here. Remember to associate this with the DestinyMilestoneDefinition's activities to get details about the activity, including what specific quest it is related to if you have multiple quests to choose from.
    ...
    challenges: typing.Optional[typing.List[DestinyChallengesDestinyChallengeStatus]] = pydantic.Field(default=None)
    """
    ...
    status: typing.Optional[DestinyQuestsDestinyQuestStatus] = pydantic.Field(default=None)
    """
