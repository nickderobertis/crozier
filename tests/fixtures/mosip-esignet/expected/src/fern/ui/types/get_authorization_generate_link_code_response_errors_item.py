...
class GetAuthorizationGenerateLinkCodeResponseErrorsItem(UniversalBaseModel):
    error_code: typing_extensions.Annotated[
        typing.Optional[GetAuthorizationGenerateLinkCodeResponseErrorsItemErrorCode],
