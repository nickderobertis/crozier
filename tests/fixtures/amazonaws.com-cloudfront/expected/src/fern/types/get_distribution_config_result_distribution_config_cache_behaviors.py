...
class GetDistributionConfigResultDistributionConfigCacheBehaviors(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[typing.List[GetDistributionConfigResultDistributionConfigCacheBehaviorsItemsItem]],
