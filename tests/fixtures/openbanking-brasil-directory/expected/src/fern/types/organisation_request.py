...
class OrganisationRequest(UniversalBaseModel):
    address_line1: typing_extensions.Annotated[
        str, FieldMetadata(alias="AddressLine1"), pydantic.Field(alias="AddressLine1", description="Address line 1")
    ]
    """
    Address line 1
    """
    ...
    city: typing_extensions.Annotated[
        str, FieldMetadata(alias="City"), pydantic.Field(alias="City", description="City")
    ]
    """
    City
    """
    ...
    country: typing_extensions.Annotated[
        str, FieldMetadata(alias="Country"), pydantic.Field(alias="Country", description="Country")
    ]
    """
    Country
    """
    ...
    organisation_id: typing_extensions.Annotated[
        OrganisationId, FieldMetadata(alias="OrganisationId"), pydantic.Field(alias="OrganisationId")
    ]
    organisation_name: typing_extensions.Annotated[
        str, FieldMetadata(alias="OrganisationName"), pydantic.Field(alias="OrganisationName")
    ]
    ...
    postcode: typing_extensions.Annotated[
        str, FieldMetadata(alias="Postcode"), pydantic.Field(alias="Postcode", description="Postcode")
    ]
    """
    Postcode
    """
    ...
    registered_name: typing_extensions.Annotated[
        typing.Optional[str],
        FieldMetadata(alias="RegisteredName"),
        pydantic.Field(alias="RegisteredName", description="Registered legal name"),
    ] = None
    """
    ...
    status: typing_extensions.Annotated[
        typing.Optional[OrganisationRequestStatus],
