...
class ApiIPagedResponseGlobalResourcesSharedModelsTranslationRequest(UniversalBaseModel):
    entities: typing_extensions.Annotated[
        typing.Optional[typing.List[GlobalResourcesSharedModelsTranslationRequest]],
