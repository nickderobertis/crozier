...
class RawSystemClient:
    ...
    def reboot_system(self, *, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[None]:
        """
        Reboot the system.
    ...
    def stop_emergency(self, *, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[None]:
        """
