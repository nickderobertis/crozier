...
class PutOidcClientClientIdResponse(UniversalBaseModel):
    ...
    response: typing.Optional[PutOidcClientClientIdResponseResponse] = None
    errors: typing.Optional[typing.List[PutOidcClientClientIdResponseErrorsItem]] = pydantic.Field(default=None)
    """
