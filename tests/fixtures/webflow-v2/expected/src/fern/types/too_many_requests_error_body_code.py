...
class TooManyRequestsErrorBodyCode(enum.StrEnum):
    """
    Error code
    """
    ...
    def visit(
        ...
        if self is TooManyRequestsErrorBodyCode.ANALYZE_FILTER_CONFLICT:
            return analyze_filter_conflict()
        if self is TooManyRequestsErrorBodyCode.ANALYZE_INPUT_VALIDATION:
            return analyze_input_validation()
        if self is TooManyRequestsErrorBodyCode.ANALYZE_UNSUPPORTED_FILTER:
            return analyze_unsupported_filter()
        if self is TooManyRequestsErrorBodyCode.BAD_REQUEST:
            return bad_request()
        if self is TooManyRequestsErrorBodyCode.BEFORE_HISTORICAL_FLOOR:
            return before_historical_floor()
        if self is TooManyRequestsErrorBodyCode.COLLECTION_NOT_FOUND:
            return collection_not_found()
        if self is TooManyRequestsErrorBodyCode.CONFLICT:
            return conflict()
        if self is TooManyRequestsErrorBodyCode.DUPLICATE_COLLECTION:
            return duplicate_collection()
        if self is TooManyRequestsErrorBodyCode.DUPLICATE_USER_EMAIL:
            return duplicate_user_email()
        if self is TooManyRequestsErrorBodyCode.ECOMMERCE_NOT_ENABLED:
            return ecommerce_not_enabled()
        if self is TooManyRequestsErrorBodyCode.FORBIDDEN:
            return forbidden()
        if self is TooManyRequestsErrorBodyCode.FORMS_REQUIRE_REPUBLISH:
            return forms_require_republish()
        if self is TooManyRequestsErrorBodyCode.INCOMPATIBLE_WEBHOOK_FILTER:
            return incompatible_webhook_filter()
        if self is TooManyRequestsErrorBodyCode.INTERNAL_ERROR:
            return internal_error()
        if self is TooManyRequestsErrorBodyCode.INVALID_AUTH_VERSION:
            return invalid_auth_version()
        if self is TooManyRequestsErrorBodyCode.INVALID_CREDENTIALS:
            return invalid_credentials()
        if self is TooManyRequestsErrorBodyCode.INVALID_DOMAIN:
            return invalid_domain()
        if self is TooManyRequestsErrorBodyCode.INVALID_TIME_RANGE:
            return invalid_time_range()
        if self is TooManyRequestsErrorBodyCode.INVALID_USER_EMAIL:
            return invalid_user_email()
        if self is TooManyRequestsErrorBodyCode.ITEM_NOT_FOUND:
            return item_not_found()
        if self is TooManyRequestsErrorBodyCode.MISSING_SCOPES:
            return missing_scopes()
        if self is TooManyRequestsErrorBodyCode.NO_DOMAINS:
            return no_domains()
        if self is TooManyRequestsErrorBodyCode.NOT_AUTHORIZED:
            return not_authorized()
        if self is TooManyRequestsErrorBodyCode.NOT_ENTERPRISE_PLAN_SITE:
            return not_enterprise_plan_site()
        if self is TooManyRequestsErrorBodyCode.NOT_ENTERPRISE_PLAN_WORKSPACE:
            return not_enterprise_plan_workspace()
        if self is TooManyRequestsErrorBodyCode.ORDER_NOT_FOUND:
            return order_not_found()
        if self is TooManyRequestsErrorBodyCode.RESOURCE_NOT_FOUND:
            return resource_not_found()
        if self is TooManyRequestsErrorBodyCode.SERVICE_UNAVAILABLE:
            return service_unavailable()
        if self is TooManyRequestsErrorBodyCode.TIME_RANGE_TOO_WIDE:
            return time_range_too_wide()
        if self is TooManyRequestsErrorBodyCode.TOO_MANY_REQUESTS:
            return too_many_requests()
        if self is TooManyRequestsErrorBodyCode.UNSUPPORTED_VERSION:
            return unsupported_version()
        if self is TooManyRequestsErrorBodyCode.UNSUPPORTED_WEBHOOK_TRIGGER_TYPE:
            return unsupported_webhook_trigger_type()
        if self is TooManyRequestsErrorBodyCode.USER_LIMIT_REACHED:
            return user_limit_reached()
        if self is TooManyRequestsErrorBodyCode.USER_NOT_FOUND:
            return user_not_found()
        if self is TooManyRequestsErrorBodyCode.USERS_NOT_ENABLED:
            return users_not_enabled()
        if self is TooManyRequestsErrorBodyCode.VALIDATION_ERROR:
