...
class RawVectorOperationsV2Client:
    ...
    ) -> HttpResponse[HttpapiGenericRespCustomerDeleteResp]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=HttpapiGenericRespCustomerDeleteResp,
    ...
    def insert(
        ...
        *,
        ...
        partition_name: typing.Optional[str] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[HttpapiGenericRespCustomerInsertResp]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=HttpapiGenericRespCustomerInsertResp,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def upsert(
        ...
        *,
        ...
        partition_name: typing.Optional[str] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[HttpapiGenericRespCustomerUpsertResp]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=HttpapiGenericRespCustomerUpsertResp,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                ...
                "vector": convert_and_respect_annotation_metadata(
                    object_=vector, annotation=typing.Sequence[Vector], direction="write"
                ),
                ...
                "searchParams": convert_and_respect_annotation_metadata(
                    object_=search_params, annotation=SearchParams, direction="write"
                ),
                "partitionNames": partition_names,
            },
            headers={
...
class AsyncRawVectorOperationsV2Client:
    ...
    async def delete(
        ...
        *,
        ...
        partition_name: typing.Optional[str] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[HttpapiGenericRespCustomerDeleteResp]:
        """
        This operation deletes entities by their IDs or with a boolean expression.
    ...
    async def insert(
        ...
        *,
        ...
        partition_name: typing.Optional[str] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[HttpapiGenericRespCustomerInsertResp]:
        """
        This operation inserts data into a specific collection. You can insert a maximum of 100 entities at a time. To insert large volumes of data, please use [the bulk-insert API](https://docs.zilliz.com/docs/data-import).
    ...
    async def upsert(
        ...
        *,
        ...
        partition_name: typing.Optional[str] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[HttpapiGenericRespCustomerUpsertResp]:
        """
        This operation inserts new records into the database or updates existing ones.  Currently, this endpoint does not apply to the collections that have autoId enabled.
