...
class UpdateDistributionRequestDistributionConfigCacheBehaviorsItemsItemForwardedValues(UniversalBaseModel):
    """
    ...
    headers: typing_extensions.Annotated[
        typing.Optional[UpdateDistributionRequestDistributionConfigCacheBehaviorsItemsItemForwardedValuesHeaders],
