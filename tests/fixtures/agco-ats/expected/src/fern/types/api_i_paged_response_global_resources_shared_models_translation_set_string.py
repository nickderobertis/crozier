...
class ApiIPagedResponseGlobalResourcesSharedModelsTranslationSetString(UniversalBaseModel):
    entities: typing_extensions.Annotated[
        typing.Optional[typing.List[GlobalResourcesSharedModelsTranslationSetString]],
