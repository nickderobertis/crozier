...
class UpdateSkuProductsResponseFieldDataEcSkuBillingMethod(enum.StrEnum):
    """
    ...
    def visit(self, one_time: typing.Callable[[], T_Result], subscription: typing.Callable[[], T_Result]) -> T_Result:
        if self is UpdateSkuProductsResponseFieldDataEcSkuBillingMethod.ONE_TIME:
            return one_time()
        if self is UpdateSkuProductsResponseFieldDataEcSkuBillingMethod.SUBSCRIPTION:
            return subscription()
