...
class CreateDistributionWithTagsResultDistributionDistributionConfigCustomErrorResponses(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[
            typing.List[CreateDistributionWithTagsResultDistributionDistributionConfigCustomErrorResponsesItemsItem]
        ],
