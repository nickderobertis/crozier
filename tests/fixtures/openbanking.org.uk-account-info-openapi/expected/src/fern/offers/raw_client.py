...
class RawOffersClient:
    ...
    def get_accounts_account_id_offers(
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"accounts/{encode_path_param(account_id)}/offers",
            method="GET",
    ...
    def get_offers(self, *, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[ObReadOffer1]:
        """
        Parameters
        ----------
        request_options : typing.Optional[RequestOptions]
...
class AsyncRawOffersClient:
    ...
    async def get_accounts_account_id_offers(
        self, account_id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[ObReadOffer1]:
        """
        Parameters
        ----------
        account_id : str
