...
class CompactionSettingsOutputModelSettings_Anthropic(UniversalBaseModel):
...
class CompactionSettingsOutputModelSettings_Azure(UniversalBaseModel):
...
class CompactionSettingsOutputModelSettings_Bedrock(UniversalBaseModel):
...
class CompactionSettingsOutputModelSettings_ChatgptOauth(UniversalBaseModel):
...
class CompactionSettingsOutputModelSettings_Deepseek(UniversalBaseModel):
...
class CompactionSettingsOutputModelSettings_GoogleAi(UniversalBaseModel):
...
class CompactionSettingsOutputModelSettings_GoogleVertex(UniversalBaseModel):
...
class CompactionSettingsOutputModelSettings_Groq(UniversalBaseModel):
...
class CompactionSettingsOutputModelSettings_Openai(UniversalBaseModel):
...
class CompactionSettingsOutputModelSettings_Together(UniversalBaseModel):
...
class CompactionSettingsOutputModelSettings_Xai(UniversalBaseModel):
...
class CompactionSettingsOutputModelSettings_Zai(UniversalBaseModel):
...
CompactionSettingsOutputModelSettings = typing_extensions.Annotated[
    typing.Union[
