...
class ReportTrips(UniversalBaseModel):
    ...
    driver_name: typing_extensions.Annotated[
        typing.Optional[str], FieldMetadata(alias="driverName"), pydantic.Field(alias="driverName")
    ] = None
    driver_unique_id: typing_extensions.Annotated[
        typing.Optional[int], FieldMetadata(alias="driverUniqueId"), pydantic.Field(alias="driverUniqueId")
    ] = None
    duration: typing.Optional[int] = None
    end_address: typing_extensions.Annotated[
        typing.Optional[str], FieldMetadata(alias="endAddress"), pydantic.Field(alias="endAddress")
    ] = None
    end_lat: typing_extensions.Annotated[
        typing.Optional[float], FieldMetadata(alias="endLat"), pydantic.Field(alias="endLat")
    ] = None
    end_lon: typing_extensions.Annotated[
        typing.Optional[float], FieldMetadata(alias="endLon"), pydantic.Field(alias="endLon")
    ] = None
    ...
    start_address: typing_extensions.Annotated[
        typing.Optional[str], FieldMetadata(alias="startAddress"), pydantic.Field(alias="startAddress")
    ] = None
    start_lat: typing_extensions.Annotated[
        typing.Optional[float], FieldMetadata(alias="startLat"), pydantic.Field(alias="startLat")
    ] = None
    start_lon: typing_extensions.Annotated[
        typing.Optional[float], FieldMetadata(alias="startLon"), pydantic.Field(alias="startLon")
    ] = None
