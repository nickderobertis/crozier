...
class SingleComponentResponseOfDestinyItemSocketsComponent(UniversalBaseModel):
    data: typing.Optional[DestinyEntitiesItemsDestinyItemSocketsComponent] = None
