...
class ReportGenerationConfigApiModelTargetTimeRange_Absolute(UniversalBaseModel):
    """
    Time range
    """
...
class ReportGenerationConfigApiModelTargetTimeRange_Relative(UniversalBaseModel):
    """
    Time range
    """
...
class ReportGenerationConfigApiModelTargetTimeRange_ToNow(UniversalBaseModel):
    """
    Time range
    """
...
ReportGenerationConfigApiModelTargetTimeRange = typing_extensions.Annotated[
    typing.Union[
