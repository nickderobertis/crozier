...
class CreateCollectionsResponseFieldsItem(UniversalBaseModel):
    """
    ...
    type: CreateCollectionsResponseFieldsItemType = pydantic.Field()
    """
    ...
    validations: typing.Optional[CreateCollectionsResponseFieldsItemValidations] = pydantic.Field(default=None)
    """
