...
class CacheBehaviorsItemsItemForwardedValues(UniversalBaseModel):
    """
    ...
    headers: typing_extensions.Annotated[
        typing.Optional[CacheBehaviorsItemsItemForwardedValuesHeaders],
    ...
    query_string_cache_keys: typing_extensions.Annotated[
        typing.Optional[CacheBehaviorsItemsItemForwardedValuesQueryStringCacheKeys],
