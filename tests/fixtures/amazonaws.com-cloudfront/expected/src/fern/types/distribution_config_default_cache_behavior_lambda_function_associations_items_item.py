...
class DistributionConfigDefaultCacheBehaviorLambdaFunctionAssociationsItemsItem(UniversalBaseModel):
    """
    ...
    event_type: typing_extensions.Annotated[
        typing.Optional[DistributionConfigDefaultCacheBehaviorLambdaFunctionAssociationsItemsItemEventType],
