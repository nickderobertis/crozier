...
class DescribeStackResourceOutputStackResourceDetailModuleInfo(UniversalBaseModel):
    """
    Contains information about the module from which the resource was created, if the resource was created from a module included in the stack template.
    """

    type_hierarchy: typing_extensions.Annotated[typing.Optional[str], FieldMetadata(alias="TypeHierarchy")] = (
    ...
    logical_id_hierarchy: typing_extensions.Annotated[
        typing.Optional[str], FieldMetadata(alias="LogicalIdHierarchy")
    ] = pydantic.Field(default=None)
    """
