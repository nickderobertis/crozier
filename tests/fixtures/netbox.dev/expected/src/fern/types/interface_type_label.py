...
class InterfaceTypeLabel(str, enum.Enum):
    VIRTUAL = "Virtual"
    BRIDGE = "Bridge"
    ...
    def visit(
        ...
        if self is InterfaceTypeLabel.VIRTUAL:
            return virtual()
        if self is InterfaceTypeLabel.BRIDGE:
            return bridge()
        if self is InterfaceTypeLabel.LINK_AGGREGATION_GROUP_LAG:
            return link_aggregation_group_lag()
        if self is InterfaceTypeLabel.ONE_HUNDRED_BASE_FX10100ME_FIBER:
            return one_hundred_base_fx10100me_fiber()
        if self is InterfaceTypeLabel.ONE_HUNDRED_BASE_LFX10100ME_FIBER:
            return one_hundred_base_lfx10100me_fiber()
        if self is InterfaceTypeLabel.ONE_HUNDRED_BASE_TX10100ME:
            return one_hundred_base_tx10100me()
        if self is InterfaceTypeLabel.ONE_HUNDRED_BASE_T110100ME_SINGLE_PAIR:
            return one_hundred_base_t110100me_single_pair()
        if self is InterfaceTypeLabel.ONE_THOUSAND_BASE_T1GE:
            return one_thousand_base_t1ge()
        if self is InterfaceTypeLabel.TWO5GBASE_T25GE:
            return two5gbase_t25ge()
        if self is InterfaceTypeLabel.FIVE_GBASE_T5GE:
            return five_gbase_t5ge()
        if self is InterfaceTypeLabel.TEN_GBASE_T10GE:
            return ten_gbase_t10ge()
        if self is InterfaceTypeLabel.TEN_GBASE_CX410GE:
            return ten_gbase_cx410ge()
        if self is InterfaceTypeLabel.GBIC1GE:
            return gbic1ge()
        if self is InterfaceTypeLabel.SFP1GE:
            return sfp1ge()
        if self is InterfaceTypeLabel.SFP10GE:
            return sfp10ge()
        if self is InterfaceTypeLabel.XFP10GE:
            return xfp10ge()
        if self is InterfaceTypeLabel.XENPAK10GE:
            return xenpak10ge()
        if self is InterfaceTypeLabel.X210GE:
            return x210ge()
        if self is InterfaceTypeLabel.SFP2825GE:
            return sfp2825ge()
        if self is InterfaceTypeLabel.SFP5650GE:
            return sfp5650ge()
        if self is InterfaceTypeLabel.QSFP40GE:
            return qsfp40ge()
        if self is InterfaceTypeLabel.QSFP2850GE:
            return qsfp2850ge()
        if self is InterfaceTypeLabel.CFP100GE:
            return cfp100ge()
        if self is InterfaceTypeLabel.CFP2100GE:
            return cfp2100ge()
        if self is InterfaceTypeLabel.CFP2200GE:
            return cfp2200ge()
        if self is InterfaceTypeLabel.CFP4100GE:
            return cfp4100ge()
        if self is InterfaceTypeLabel.CISCO_CPAK100GE:
            return cisco_cpak100ge()
        if self is InterfaceTypeLabel.QSFP28100GE:
            return qsfp28100ge()
        if self is InterfaceTypeLabel.QSFP56200GE:
            return qsfp56200ge()
        if self is InterfaceTypeLabel.QSFP_DD400GE:
            return qsfp_dd400ge()
        if self is InterfaceTypeLabel.OSFP400GE:
            return osfp400ge()
        if self is InterfaceTypeLabel.QSFP_DD800GE:
            return qsfp_dd800ge()
        if self is InterfaceTypeLabel.OSFP800GE:
            return osfp800ge()
        if self is InterfaceTypeLabel.ONE_THOUSAND_BASE_KX1GE:
            return one_thousand_base_kx1ge()
        if self is InterfaceTypeLabel.TEN_GBASE_KR10GE:
            return ten_gbase_kr10ge()
        if self is InterfaceTypeLabel.TEN_GBASE_KX410GE:
            return ten_gbase_kx410ge()
        if self is InterfaceTypeLabel.TWENTY_FIVE_GBASE_KR25GE:
            return twenty_five_gbase_kr25ge()
        if self is InterfaceTypeLabel.FORTY_GBASE_KR440GE:
            return forty_gbase_kr440ge()
        if self is InterfaceTypeLabel.FIFTY_GBASE_KR50GE:
            return fifty_gbase_kr50ge()
        if self is InterfaceTypeLabel.ONE_HUNDRED_GBASE_KP4100GE:
            return one_hundred_gbase_kp4100ge()
        if self is InterfaceTypeLabel.ONE_HUNDRED_GBASE_KR2100GE:
            return one_hundred_gbase_kr2100ge()
        if self is InterfaceTypeLabel.ONE_HUNDRED_GBASE_KR4100GE:
            return one_hundred_gbase_kr4100ge()
        if self is InterfaceTypeLabel.IEEE80211A:
            return ieee80211a()
        if self is InterfaceTypeLabel.IEEE80211BG:
            return ieee80211bg()
        if self is InterfaceTypeLabel.IEEE80211N:
            return ieee80211n()
        if self is InterfaceTypeLabel.IEEE80211AC:
            return ieee80211ac()
        if self is InterfaceTypeLabel.IEEE80211AD:
            return ieee80211ad()
        if self is InterfaceTypeLabel.IEEE80211AX:
            return ieee80211ax()
        if self is InterfaceTypeLabel.IEEE80211AY:
            return ieee80211ay()
        if self is InterfaceTypeLabel.IEEE802151BLUETOOTH:
            return ieee802151bluetooth()
        if self is InterfaceTypeLabel.OTHER_WIRELESS:
            return other_wireless()
        if self is InterfaceTypeLabel.GSM:
            return gsm()
        if self is InterfaceTypeLabel.CDMA:
            return cdma()
        if self is InterfaceTypeLabel.LTE:
            return lte()
        if self is InterfaceTypeLabel.OC3STM1:
            return oc3stm1()
        if self is InterfaceTypeLabel.OC12STM4:
            return oc12stm4()
        if self is InterfaceTypeLabel.OC48STM16:
            return oc48stm16()
        if self is InterfaceTypeLabel.OC192STM64:
            return oc192stm64()
        if self is InterfaceTypeLabel.OC768STM256:
            return oc768stm256()
        if self is InterfaceTypeLabel.OC1920STM640:
            return oc1920stm640()
        if self is InterfaceTypeLabel.OC3840STM1234:
            return oc3840stm1234()
        if self is InterfaceTypeLabel.SFP1GFC:
            return sfp1gfc()
        if self is InterfaceTypeLabel.SFP2GFC:
            return sfp2gfc()
        if self is InterfaceTypeLabel.SFP4GFC:
            return sfp4gfc()
        if self is InterfaceTypeLabel.SFP8GFC:
            return sfp8gfc()
        if self is InterfaceTypeLabel.SFP16GFC:
            return sfp16gfc()
        if self is InterfaceTypeLabel.SFP2832GFC:
            return sfp2832gfc()
        if self is InterfaceTypeLabel.QSFP64GFC:
            return qsfp64gfc()
        if self is InterfaceTypeLabel.QSFP28128GFC:
            return qsfp28128gfc()
        if self is InterfaceTypeLabel.SDR2GBPS:
            return sdr2gbps()
        if self is InterfaceTypeLabel.DDR4GBPS:
            return ddr4gbps()
        if self is InterfaceTypeLabel.QDR8GBPS:
            return qdr8gbps()
        if self is InterfaceTypeLabel.FDR1010GBPS:
            return fdr1010gbps()
        if self is InterfaceTypeLabel.FDR135GBPS:
            return fdr135gbps()
        if self is InterfaceTypeLabel.EDR25GBPS:
            return edr25gbps()
        if self is InterfaceTypeLabel.HDR50GBPS:
            return hdr50gbps()
        if self is InterfaceTypeLabel.NDR100GBPS:
            return ndr100gbps()
        if self is InterfaceTypeLabel.XDR250GBPS:
            return xdr250gbps()
        if self is InterfaceTypeLabel.T11544MBPS:
            return t11544mbps()
        if self is InterfaceTypeLabel.E12048MBPS:
            return e12048mbps()
        if self is InterfaceTypeLabel.T345MBPS:
            return t345mbps()
        if self is InterfaceTypeLabel.E334MBPS:
            return e334mbps()
        if self is InterfaceTypeLabel.X_DSL:
            return x_dsl()
        if self is InterfaceTypeLabel.DOCSIS:
            return docsis()
        if self is InterfaceTypeLabel.GPON25GBPS125GPS:
            return gpon25gbps125gps()
        if self is InterfaceTypeLabel.XG_PON10GBPS25GBPS:
            return xg_pon10gbps25gbps()
        if self is InterfaceTypeLabel.XGS_PON10GBPS:
            return xgs_pon10gbps()
        if self is InterfaceTypeLabel.NG_PON2TWDM_PON4X10GBPS:
            return ng_pon2twdm_pon4x10gbps()
        if self is InterfaceTypeLabel.EPON1GBPS:
            return epon1gbps()
        if self is InterfaceTypeLabel.TEN_G_EPON10GBPS:
            return ten_g_epon10gbps()
        if self is InterfaceTypeLabel.CISCO_STACK_WISE:
            return cisco_stack_wise()
        if self is InterfaceTypeLabel.CISCO_STACK_WISE_PLUS:
            return cisco_stack_wise_plus()
        if self is InterfaceTypeLabel.CISCO_FLEX_STACK:
            return cisco_flex_stack()
        if self is InterfaceTypeLabel.CISCO_FLEX_STACK_PLUS:
            return cisco_flex_stack_plus()
        if self is InterfaceTypeLabel.CISCO_STACK_WISE80:
            return cisco_stack_wise80()
        if self is InterfaceTypeLabel.CISCO_STACK_WISE160:
            return cisco_stack_wise160()
        if self is InterfaceTypeLabel.CISCO_STACK_WISE320:
            return cisco_stack_wise320()
        if self is InterfaceTypeLabel.CISCO_STACK_WISE480:
            return cisco_stack_wise480()
        if self is InterfaceTypeLabel.CISCO_STACK_WISE1T:
            return cisco_stack_wise1t()
        if self is InterfaceTypeLabel.JUNIPER_VCP:
            return juniper_vcp()
        if self is InterfaceTypeLabel.EXTREME_SUMMIT_STACK:
            return extreme_summit_stack()
        if self is InterfaceTypeLabel.EXTREME_SUMMIT_STACK128:
            return extreme_summit_stack128()
        if self is InterfaceTypeLabel.EXTREME_SUMMIT_STACK256:
            return extreme_summit_stack256()
        if self is InterfaceTypeLabel.EXTREME_SUMMIT_STACK512:
            return extreme_summit_stack512()
        if self is InterfaceTypeLabel.OTHER:
            return other()
