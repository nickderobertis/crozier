...
class GetOrdersResponseTotalsExtrasItem(UniversalBaseModel):
    """
    Extra order items, includes discounts, shipping, and taxes.
    """

    type: typing.Optional[GetOrdersResponseTotalsExtrasItemType] = pydantic.Field(default=None)
    """
    ...
    price: typing.Optional[GetOrdersResponseTotalsExtrasItemPrice] = pydantic.Field(default=None)
    """
