...
class UpdateCustomFontsResponseCustomFont(UniversalBaseModel):
    """
    ...
    format: typing.Optional[UpdateCustomFontsResponseCustomFontFormat] = pydantic.Field(default=None)
    """
    ...
    axes: typing.List[UpdateCustomFontsResponseCustomFontAxesItem] = pydantic.Field()
    """
