...
class RawInvoicesClient:
    ...
    def getinvoice(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"invoices/{encode_path_param(capture_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def updateinvoice(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"invoices/{encode_path_param(capture_id)}/update-details",
            method="POST",
            json={
                "invoice_number": invoice_number,
                "invoice_url": invoice_url,
    ...
    def confirminvoicepayment(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"invoices/{encode_path_param(capture_id)}/confirm-payment",
            method="POST",
            json={
    ...
    def extendinvoiceduration(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"invoices/{encode_path_param(capture_id)}/extend-duration",
            method="POST",
            json={
                "duration": duration,
            },
    ...
    def pauseinvoicedunning(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"invoice/{encode_path_param(capture_id)}/pause-dunning",
            method="POST",
            request_options=request_options,
        )
        try:
