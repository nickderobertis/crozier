...
class DestinyComponentsItemsDestinyItemReusablePlugsComponent(UniversalBaseModel):
    plugs: typing.Optional[typing.Dict[str, typing.List[DestinySocketsDestinyItemPlugBase]]] = pydantic.Field(
        default=None
    )
    """
