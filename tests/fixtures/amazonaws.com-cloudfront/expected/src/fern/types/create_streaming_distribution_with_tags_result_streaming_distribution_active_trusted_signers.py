...
class CreateStreamingDistributionWithTagsResultStreamingDistributionActiveTrustedSigners(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[
            typing.List[CreateStreamingDistributionWithTagsResultStreamingDistributionActiveTrustedSignersItemsItem]
        ],
