...
class RawRewardRecipientClient:
    ...
    ) -> HttpResponse[typing.List[RewardRecipientListing]]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=typing.List[RewardRecipientListing],
    ...
    ) -> HttpResponse[RewardRecipientRead]:
        """
        Used to view Rewards.
...
class AsyncRawRewardRecipientClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._client_wrapper = client_wrapper

    async def list_all_reward_recipient_for_user(
        self, user_id: int, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[typing.List[RewardRecipientListing]]:
        """
        Used to view Rewards.
    ...
    async def read_reward_recipient_for_user(
        self, user_id: int, item_id: int, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[RewardRecipientRead]:
        """
        Used to view Rewards.
