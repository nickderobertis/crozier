...
class GetUpdateStackInstancesRequestDeploymentTargetsAccountFilterType(str, enum.Enum):
    """
    ...
    def visit(
        ...
        if self is GetUpdateStackInstancesRequestDeploymentTargetsAccountFilterType.NONE:
            return none()
        if self is GetUpdateStackInstancesRequestDeploymentTargetsAccountFilterType.INTERSECTION:
            return intersection()
        if self is GetUpdateStackInstancesRequestDeploymentTargetsAccountFilterType.DIFFERENCE:
            return difference()
        if self is GetUpdateStackInstancesRequestDeploymentTargetsAccountFilterType.UNION:
            return union()
