...
class GetDistributionConfigResultDistributionConfigCacheBehaviorsItemsItemForwardedValues(UniversalBaseModel):
    """
    ...
    headers: typing_extensions.Annotated[
        typing.Optional[GetDistributionConfigResultDistributionConfigCacheBehaviorsItemsItemForwardedValuesHeaders],
