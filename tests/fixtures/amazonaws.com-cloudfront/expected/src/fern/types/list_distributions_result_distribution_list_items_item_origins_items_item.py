...
class ListDistributionsResultDistributionListItemsItemOriginsItemsItem(UniversalBaseModel):
    """
    ...
    custom_headers: typing_extensions.Annotated[
        typing.Optional[ListDistributionsResultDistributionListItemsItemOriginsItemsItemCustomHeaders],
    ...
    s3origin_config: typing_extensions.Annotated[
        typing.Optional[ListDistributionsResultDistributionListItemsItemOriginsItemsItemS3OriginConfig],
    ...
    custom_origin_config: typing_extensions.Annotated[
        typing.Optional[ListDistributionsResultDistributionListItemsItemOriginsItemsItemCustomOriginConfig],
