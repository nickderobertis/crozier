...
class DestinyDefinitionsDestinyItemStatBlockDefinition(UniversalBaseModel):
    """
    ...
    stats: typing.Optional[typing.Dict[str, DestinyDefinitionsDestinyInventoryItemStatDefinition]] = pydantic.Field(
        default=None
    )
    """
