...
class RawWhitelistSddClient:
    ...
    ) -> HttpResponse[typing.List[WhitelistSddMonetaryAccountPayingListing]]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=typing.List[WhitelistSddMonetaryAccountPayingListing],
    ...
    ) -> HttpResponse[WhitelistSddMonetaryAccountPayingRead]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=WhitelistSddMonetaryAccountPayingRead,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    ) -> HttpResponse[typing.List[WhitelistSddListing]]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=typing.List[WhitelistSddListing],
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawWhitelistSddClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._client_wrapper = client_wrapper

    async def list_all_whitelist_sdd_for_user_monetary_account(
        self, user_id: int, monetary_account_id: int, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[typing.List[WhitelistSddMonetaryAccountPayingListing]]:
        """
        Get a listing of all SDD whitelist entries for a target monetary account.
    ...
    async def read_whitelist_sdd_for_user_monetary_account(
        ...
        *,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[WhitelistSddMonetaryAccountPayingRead]:
        """
        Get a specific SDD whitelist entry.
    ...
    async def list_all_whitelist_sdd_for_user(
        self, user_id: int, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[typing.List[WhitelistSddListing]]:
        """
        Get a listing of all recurring SDD whitelist entries for a target monetary account.
    ...
    async def read_whitelist_sdd_for_user(
        self, user_id: int, item_id: int, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[WhitelistSddRead]:
        """
        Get a specific recurring SDD whitelist entry.
