...
class CreateProductsRequestSkuFieldDataEcSkuBillingMethod(enum.StrEnum):
    """
    ...
    def visit(self, one_time: typing.Callable[[], T_Result], subscription: typing.Callable[[], T_Result]) -> T_Result:
        if self is CreateProductsRequestSkuFieldDataEcSkuBillingMethod.ONE_TIME:
            return one_time()
        if self is CreateProductsRequestSkuFieldDataEcSkuBillingMethod.SUBSCRIPTION:
            return subscription()
