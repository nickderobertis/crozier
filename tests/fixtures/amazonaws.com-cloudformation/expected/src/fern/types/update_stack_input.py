...
class UpdateStackInput(UniversalBaseModel):
    ...
    stack_name: typing_extensions.Annotated[
        ...
        pydantic.Field(alias="StackName", description="The name or unique stack ID of the stack to update."),
    ]
    """
    ...
    stack_policy_during_update_body: typing_extensions.Annotated[
        typing.Optional[str],
        FieldMetadata(alias="StackPolicyDuringUpdateBody"),
        pydantic.Field(
            alias="StackPolicyDuringUpdateBody",
    ...
    stack_policy_during_update_url: typing_extensions.Annotated[
        typing.Optional[str],
        FieldMetadata(alias="StackPolicyDuringUpdateURL"),
        pydantic.Field(
            alias="StackPolicyDuringUpdateURL",
    ...
    role_arn: typing_extensions.Annotated[
        ...
        pydantic.Field(
            alias="RoleARN",
            description="<p>The Amazon Resource Name (ARN) of an Identity and Access Management (IAM) role that CloudFormation assumes to update the stack. CloudFormation uses the role's credentials to make calls on your behalf. CloudFormation always uses this role for all future operations on the stack. Provided that users have permission to operate on the stack, CloudFormation uses this role even if the users don't have permission to pass it. Ensure that the role grants least privilege.</p> <p>If you don't specify a value, CloudFormation uses the role that was previously associated with the stack. If no role is available, CloudFormation uses a temporary session that is generated from your user credentials.</p>",
        ),
    ] = None
    """
    ...
    rollback_configuration: typing_extensions.Annotated[
        typing.Optional[UpdateStackInputRollbackConfiguration],
    ...
    disable_rollback: typing_extensions.Annotated[
        ...
        pydantic.Field(
            ...
            description="<p>Preserve the state of previously provisioned resources when an operation fails.</p> <p>Default: <code>False</code> </p>",
        ),
    ] = None
    """
