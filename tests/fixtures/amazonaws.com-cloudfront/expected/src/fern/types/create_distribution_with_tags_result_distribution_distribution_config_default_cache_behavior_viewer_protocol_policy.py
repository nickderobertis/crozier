...
class CreateDistributionWithTagsResultDistributionDistributionConfigDefaultCacheBehaviorViewerProtocolPolicy(
    enum.StrEnum
):
    """
    ...
    def visit(
        ...
        if (
            self
            is CreateDistributionWithTagsResultDistributionDistributionConfigDefaultCacheBehaviorViewerProtocolPolicy.ALLOW_ALL
        ):
            return allow_all()
        if (
            self
            is CreateDistributionWithTagsResultDistributionDistributionConfigDefaultCacheBehaviorViewerProtocolPolicy.HTTPS_ONLY
        ):
            return https_only()
        if (
            self
            is CreateDistributionWithTagsResultDistributionDistributionConfigDefaultCacheBehaviorViewerProtocolPolicy.REDIRECT_TO_HTTPS
        ):
