...
class UpdateDistributionResultDistributionDistributionConfigOriginsItemsItemCustomHeaders(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[
            typing.List[UpdateDistributionResultDistributionDistributionConfigOriginsItemsItemCustomHeadersItemsItem]
        ],
