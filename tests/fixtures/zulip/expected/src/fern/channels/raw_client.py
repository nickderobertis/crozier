...
class RawChannelsClient:
    ...
    ) -> HttpResponse[GetStreamIdResponse]:
        """
    ...
    def get_stream_topics(
    ...
    ) -> HttpResponse[GetStreamTopicsResponse]:
        """
        ...
        **Changes**: Before Zulip 12.0 (feature level 480), this
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"users/me/{encode_path_param(stream_id)}/topics",
            method="GET",
            params={
    ...
    def get_subscriptions(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[GetSubscriptionsResponse]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=GetSubscriptionsResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            data={
                "subscriptions": convert_and_respect_annotation_metadata(
                    ...
                    annotation=typing.Sequence[SubscribeRequestSubscriptionsItem],
                    direction="write",
                ),
                "principals": convert_and_respect_annotation_metadata(
                    object_=principals, annotation=Principals, direction="write"
                ),
                ...
                "message_retention_days": convert_and_respect_annotation_metadata(
                    object_=message_retention_days, annotation=MessageRetentionDays, direction="write"
                ),
                "default_push_notifications": default_push_notifications,
                "topics_policy": topics_policy,
                "can_add_subscribers_group": convert_and_respect_annotation_metadata(
                    object_=can_add_subscribers_group, annotation=ChannelCanAddSubscribersGroup, direction="write"
                ),
                "can_remove_subscribers_group": convert_and_respect_annotation_metadata(
                    object_=can_remove_subscribers_group, annotation=CanRemoveSubscribersGroup, direction="write"
                ),
                "can_administer_channel_group": convert_and_respect_annotation_metadata(
                    object_=can_administer_channel_group, annotation=CanAdministerChannelGroup, direction="write"
                ),
                "can_delete_any_message_group": convert_and_respect_annotation_metadata(
                    object_=can_delete_any_message_group, annotation=CanDeleteAnyMessageGroup, direction="write"
                ),
                "can_delete_own_message_group": convert_and_respect_annotation_metadata(
                    object_=can_delete_own_message_group, annotation=CanDeleteOwnMessageGroup, direction="write"
                ),
                "can_move_messages_out_of_channel_group": convert_and_respect_annotation_metadata(
                    object_=can_move_messages_out_of_channel_group,
                    annotation=CanMoveMessagesOutOfChannelGroup,
                    direction="write",
                ),
                "can_move_messages_within_channel_group": convert_and_respect_annotation_metadata(
                    object_=can_move_messages_within_channel_group,
                    annotation=CanMoveMessagesWithinChannelGroup,
                    direction="write",
                ),
                "can_send_message_group": convert_and_respect_annotation_metadata(
                    object_=can_send_message_group, annotation=CanSendMessageGroup, direction="write"
                ),
                "can_subscribe_group": convert_and_respect_annotation_metadata(
                    object_=can_subscribe_group, annotation=CanSubscribeGroup, direction="write"
                ),
                "can_resolve_topics_group": convert_and_respect_annotation_metadata(
                    object_=can_resolve_topics_group, annotation=CanResolveTopicsGroup, direction="write"
                ),
                "can_create_topic_group": convert_and_respect_annotation_metadata(
                    object_=can_create_topic_group, annotation=CanCreateTopicGroup, direction="write"
                ),
                "folder_id": folder_id,
    ...
    def update_subscriptions(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[UpdateSubscriptionsResponse]:
        """
        ...
        **Changes**: Before Zulip 10.0 (feature level 362),
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            data={
                "delete": delete,
                "add": convert_and_respect_annotation_metadata(
                    object_=add, annotation=typing.Sequence[UpdateSubscriptionsRequestAddItem], direction="write"
                ),
            },
            headers={
                "content-type": "application/x-www-form-urlencoded",
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=UpdateSubscriptionsResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def get_subscription_status(
    ...
    ) -> HttpResponse[GetSubscriptionStatusResponse]:
        """
        ...
        **Changes**: Prior to Zulip 12.0 (feature level 458), this endpoint
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"users/{encode_path_param(user_id)}/subscriptions/{encode_path_param(stream_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=GetSubscriptionStatusResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def get_user_channels(
    ...
    ) -> HttpResponse[GetUserChannelsResponse]:
        """
        ...
        **Changes**: Prior to Zulip 12.0 (feature level 458), target users that
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"users/{encode_path_param(user_id)}/channels",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def update_subscription_settings(
        ...
        **Changes**: Prior to Zulip 5.0 (feature level 111), the response object
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            method="POST",
            data={
                "subscription_data": convert_and_respect_annotation_metadata(
                    object_=subscription_data,
                    annotation=typing.Sequence[UpdateSubscriptionSettingsRequestSubscriptionDataItem],
                    direction="write",
                ),
            },
            headers={
    ...
    def update_subscription_property(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"users/me/subscriptions/{encode_path_param(stream_id)}",
            method="PATCH",
            data={
                "property": property,
                "value": convert_and_respect_annotation_metadata(
                    object_=value, annotation=SubscriptionPropertyValue, direction="write"
                ),
            },
            headers={
                "content-type": "application/x-www-form-urlencoded",
    ...
    def get_subscribers(
        self, stream_id: int, *, request_options: typing.Optional[RequestOptions] = None
    ) -> HttpResponse[GetSubscribersResponse]:
        """
        ...
        **Changes**: Before Zulip 12.0 (feature level 480), this
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"streams/{encode_path_param(stream_id)}/members",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def get_streams(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[GetStreamsResponse]:
        """
    ...
    def get_stream_by_id(
        self, stream_id: int, *, request_options: typing.Optional[RequestOptions] = None
    ) -> HttpResponse[GetStreamByIdResponse]:
        """
        ...
        **Changes**: Before Zulip 12.0 (feature level 480), this
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"streams/{encode_path_param(stream_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
        ...
        **Changes**: Before Zulip 10.0 (feature level 362), channel privacy could not be
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            data={
                ...
                "topics_policy": topics_policy,
                "can_add_subscribers_group": convert_and_respect_annotation_metadata(
                    object_=can_add_subscribers_group,
                    annotation=UpdateStreamRequestCanAddSubscribersGroup,
                    direction="write",
                ),
                "can_remove_subscribers_group": convert_and_respect_annotation_metadata(
                    object_=can_remove_subscribers_group,
                    annotation=UpdateStreamRequestCanRemoveSubscribersGroup,
                    direction="write",
                ),
                "can_administer_channel_group": convert_and_respect_annotation_metadata(
                    object_=can_administer_channel_group,
                    annotation=UpdateStreamRequestCanAdministerChannelGroup,
                    direction="write",
                ),
                "can_delete_any_message_group": convert_and_respect_annotation_metadata(
                    object_=can_delete_any_message_group,
                    annotation=UpdateStreamRequestCanDeleteAnyMessageGroup,
                    direction="write",
                ),
                "can_delete_own_message_group": convert_and_respect_annotation_metadata(
                    object_=can_delete_own_message_group,
                    annotation=UpdateStreamRequestCanDeleteOwnMessageGroup,
                    direction="write",
                ),
                "can_move_messages_out_of_channel_group": convert_and_respect_annotation_metadata(
                    object_=can_move_messages_out_of_channel_group,
                    annotation=UpdateStreamRequestCanMoveMessagesOutOfChannelGroup,
                    direction="write",
                ),
                "can_move_messages_within_channel_group": convert_and_respect_annotation_metadata(
                    object_=can_move_messages_within_channel_group,
                    annotation=UpdateStreamRequestCanMoveMessagesWithinChannelGroup,
                    direction="write",
                ),
                "can_send_message_group": convert_and_respect_annotation_metadata(
                    object_=can_send_message_group, annotation=UpdateStreamRequestCanSendMessageGroup, direction="write"
                ),
                "can_subscribe_group": convert_and_respect_annotation_metadata(
                    object_=can_subscribe_group, annotation=UpdateStreamRequestCanSubscribeGroup, direction="write"
                ),
                "can_resolve_topics_group": convert_and_respect_annotation_metadata(
                    object_=can_resolve_topics_group,
                    annotation=UpdateStreamRequestCanResolveTopicsGroup,
                    direction="write",
                ),
                "can_create_topic_group": convert_and_respect_annotation_metadata(
                    object_=can_create_topic_group, annotation=UpdateStreamRequestCanCreateTopicGroup, direction="write"
                ),
            },
            headers={
                "content-type": "application/x-www-form-urlencoded",
    ...
    def get_stream_email_address(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[GetStreamEmailAddressResponse]:
        """
        ...
        **Changes**: Prior to Zulip 12.0 (feature level 448), users without
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"streams/{encode_path_param(stream_id)}/email_address",
            method="GET",
            params={
                "sender_id": sender_id,
            },
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=GetStreamEmailAddressResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def delete_topic(
    ...
    ) -> HttpResponse[DeleteTopicResponse]:
        """
        ...
        **Changes**: Before Zulip 9.0 (feature level 256), the server never sent
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"streams/{encode_path_param(stream_id)}/delete_topic",
            method="POST",
            data={
    ...
    def create_channel(
        ...
        *,
        ...
        default_push_notifications: typing.Optional[DefaultPushNotifications] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[CreateChannelResponse]:
        """
    ...
    def create_channel_folder(
        ...
        *,
        ...
        description: typing.Optional[str] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[CreateChannelFolderResponse]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=CreateChannelFolderResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    ) -> HttpResponse[GetChannelFoldersResponse]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=GetChannelFoldersResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def update_channel_folder(
        ...
        **Changes**: New in Zulip 11.0 (feature level 389).
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"channel_folders/{encode_path_param(channel_folder_id)}",
            method="PATCH",
            data={
                "name": name,
                "description": description,
    ...
    def create_big_blue_button_video_call(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[CreateBigBlueButtonVideoCallResponse]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=CreateBigBlueButtonVideoCallResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    ) -> HttpResponse[CreateNextcloudTalkVideoCallResponse]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=CreateNextcloudTalkVideoCallResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def create_webex_video_call(
        self, *, request_options: typing.Optional[RequestOptions] = None
    ) -> HttpResponse[CreateWebexVideoCallResponse]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=CreateWebexVideoCallResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def create_constructor_groups_video_call(
        self, *, request_options: typing.Optional[RequestOptions] = None
    ) -> HttpResponse[CreateConstructorGroupsVideoCallResponse]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=CreateConstructorGroupsVideoCallResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawChannelsClient:
    ...
    async def get_stream_id(
        self, *, stream: str, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[GetStreamIdResponse]:
        """
        Get the unique ID of a given channel.
    ...
    async def get_stream_topics(
        ...
        *,
        allow_empty_topic_name: typing.Optional[bool] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[GetStreamTopicsResponse]:
        """
        Get all topics the user has access to in a specific channel.
    ...
    async def get_subscriptions(
        ...
        *,
        include_subscribers: typing.Optional[GetSubscriptionsRequestIncludeSubscribers] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[GetSubscriptionsResponse]:
        """
        Get all channels that the user is subscribed to.
    ...
    async def update_subscriptions(
        ...
        *,
        ...
        add: typing.Optional[typing.Sequence[UpdateSubscriptionsRequestAddItem]] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[UpdateSubscriptionsResponse]:
        """
        Update which channels you are subscribed to.
    ...
    async def get_subscription_status(
        self, user_id: int, stream_id: int, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[GetSubscriptionStatusResponse]:
        """
        Check whether a user is subscribed to a channel.
    ...
    async def get_user_channels(
        self, user_id: int, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[GetUserChannelsResponse]:
        """
        Gets the list of channels that the target user is subscribed to.
    ...
    async def get_subscribers(
        self, stream_id: int, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[GetSubscribersResponse]:
        """
        Get all users subscribed to a channel.
    ...
    async def get_streams(
        ...
        *,
        ...
        include_can_access_content: typing.Optional[bool] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[GetStreamsResponse]:
        """
        Get all channels that the user [has access to](/help/channel-permissions).
    ...
    async def get_stream_by_id(
        self, stream_id: int, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[GetStreamByIdResponse]:
        """
        Fetch details for the channel with the ID `stream_id`.
    ...
    async def get_stream_email_address(
        ...
        *,
        sender_id: typing.Optional[int] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[GetStreamEmailAddressResponse]:
        """
        Get email address of a channel.
    ...
    async def delete_topic(
        self, stream_id: int, *, topic_name: str, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[DeleteTopicResponse]:
        """
        Delete all messages in a topic.
    ...
    async def create_channel(
        ...
        *,
        ...
        default_push_notifications: typing.Optional[DefaultPushNotifications] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[CreateChannelResponse]:
        """
        Create a new [channel](/help/create-channels), and optionally subscribe
        users to the newly created channel.
    ...
    async def create_channel_folder(
        ...
        *,
        ...
        description: typing.Optional[str] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[CreateChannelFolderResponse]:
        """
        Create a new [channel folder](/help/channel-folders).
    ...
    async def get_channel_folders(
        self, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[GetChannelFoldersResponse]:
        """
        Fetches all of the [channel folders](/help/channel-folders) in the
        organization, sorted by the `order` field.
    ...
    async def create_big_blue_button_video_call(
        ...
        *,
        ...
        voice_only: typing.Optional[bool] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[CreateBigBlueButtonVideoCallResponse]:
        """
        Create a video call URL for a BigBlueButton video call.
        Requires [BigBlueButton 2.4+](/integrations/big-blue-button)
        to be configured on the Zulip server.
    ...
    async def create_nextcloud_talk_video_call(
        self, *, room_name: str, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[CreateNextcloudTalkVideoCallResponse]:
        """
        Create a video call URL for a Nextcloud Talk video call. Requires
        [Nextcloud Talk](/integrations/nextcloud-talk) to be configured on the
        Zulip server.
    ...
    async def create_webex_video_call(
        self, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[CreateWebexVideoCallResponse]:
        """
        Create a video call URL for a Webex video call.
    ...
    async def create_constructor_groups_video_call(
        self, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[CreateConstructorGroupsVideoCallResponse]:
        """
        Create a video call URL for a Constructor Groups video call.
        Requires [Constructor Groups](/integrations/constructor-groups)
        to be configured on the Zulip server.
