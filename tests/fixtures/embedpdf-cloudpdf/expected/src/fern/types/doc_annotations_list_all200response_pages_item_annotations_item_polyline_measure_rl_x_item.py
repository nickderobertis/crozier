...
class DocAnnotationsListAll200ResponsePagesItemAnnotationsItemPolylineMeasureRlXItem(UniversalBaseModel):
    unit: str
    ...
    label_position: typing_extensions.Annotated[
        typing.Optional[DocAnnotationsListAll200ResponsePagesItemAnnotationsItemPolylineMeasureRlXItemLabelPosition],
