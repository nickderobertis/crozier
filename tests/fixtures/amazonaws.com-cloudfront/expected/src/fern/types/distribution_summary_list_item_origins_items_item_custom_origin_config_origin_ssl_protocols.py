...
class DistributionSummaryListItemOriginsItemsItemCustomOriginConfigOriginSslProtocols(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.List[DistributionSummaryListItemOriginsItemsItemCustomOriginConfigOriginSslProtocolsItemsItem],
