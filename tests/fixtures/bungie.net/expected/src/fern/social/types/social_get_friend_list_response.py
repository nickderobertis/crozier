...
from ...types.social_friends_bungie_friend_list_response import SocialFriendsBungieFriendListResponse


class SocialGetFriendListResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[SocialFriendsBungieFriendListResponse], FieldMetadata(alias="Response")
    ] = None
