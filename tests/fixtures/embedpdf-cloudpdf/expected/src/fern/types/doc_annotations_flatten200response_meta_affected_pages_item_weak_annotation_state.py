...
class DocAnnotationsFlatten200ResponseMetaAffectedPagesItemWeakAnnotationState_Unknown(UniversalBaseModel):
...
class DocAnnotationsFlatten200ResponseMetaAffectedPagesItemWeakAnnotationState_Known(UniversalBaseModel):
...
DocAnnotationsFlatten200ResponseMetaAffectedPagesItemWeakAnnotationState = typing_extensions.Annotated[
    typing.Union[
