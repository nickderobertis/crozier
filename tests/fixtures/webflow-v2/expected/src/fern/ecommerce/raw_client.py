...
class RawEcommerceClient:
    ...
    def get_settings(
    ...
    ) -> HttpResponse[GetSettingsEcommerceResponse]:
        """
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"sites/{encode_path_param(site_id)}/ecommerce/settings",
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=GetSettingsEcommerceResponse,
...
class AsyncRawEcommerceClient:
    ...
    async def get_settings(
        self, site_id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[GetSettingsEcommerceResponse]:
        """
        Retrieve ecommerce settings for a site.
