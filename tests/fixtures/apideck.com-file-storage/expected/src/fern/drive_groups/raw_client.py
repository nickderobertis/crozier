...
class RawDriveGroupsClient:
    ...
    ) -> HttpResponse[GetDriveGroupsResponse]:
        """
        List DriveGroups
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            params={
                ...
                "filter": convert_and_respect_annotation_metadata(
                    object_=filter, annotation=DriveGroupsFilter, direction="write"
                ),
                "fields": fields,
            },
    ...
    def add(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[CreateDriveGroupResponse]:
        """
        Create DriveGroup
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=CreateDriveGroupResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def one(
        ...
        *,
        ...
        fields: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[GetDriveGroupResponse]:
        """
        Get DriveGroup
    ...
    ) -> HttpResponse[DeleteDriveGroupResponse]:
        """
        Delete DriveGroup
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=DeleteDriveGroupResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def update(
        ...
        *,
        ...
        updated_by: typing.Optional[UpdatedBy] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[UpdateDriveGroupResponse]:
        """
        Update DriveGroup
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=UpdateDriveGroupResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawDriveGroupsClient:
    ...
    async def all_(
        ...
        *,
        ...
        fields: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[GetDriveGroupsResponse]:
        """
        List DriveGroups
    ...
    async def add(
        ...
        *,
        ...
        updated_by: typing.Optional[UpdatedBy] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[CreateDriveGroupResponse]:
        """
        Create DriveGroup
    ...
    async def one(
        ...
        *,
        ...
        fields: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[GetDriveGroupResponse]:
        """
        Get DriveGroup
    ...
    async def delete(
        self, id: str, *, raw: typing.Optional[bool] = None, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[DeleteDriveGroupResponse]:
        """
        Delete DriveGroup
    ...
    async def update(
        ...
        *,
        ...
        updated_by: typing.Optional[UpdatedBy] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[UpdateDriveGroupResponse]:
        """
        Update DriveGroup
