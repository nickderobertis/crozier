...
from ...types.destiny_responses_destiny_profile_response import DestinyResponsesDestinyProfileResponse


class Destiny2GetProfileResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[DestinyResponsesDestinyProfileResponse], FieldMetadata(alias="Response")
    ] = None
