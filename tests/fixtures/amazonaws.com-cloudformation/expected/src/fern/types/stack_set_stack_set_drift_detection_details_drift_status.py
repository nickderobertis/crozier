...
class StackSetStackSetDriftDetectionDetailsDriftStatus(str, enum.Enum):
    """
    ...
    def visit(
        ...
        if self is StackSetStackSetDriftDetectionDetailsDriftStatus.DRIFTED:
            return drifted()
        if self is StackSetStackSetDriftDetectionDetailsDriftStatus.IN_SYNC:
            return in_sync()
        if self is StackSetStackSetDriftDetectionDetailsDriftStatus.NOT_CHECKED:
            return not_checked()
