    ...
    def create_card_debit_for_user(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"user/{encode_path_param(user_id)}/card-debit",
            method="POST",
            json={
...
class AsyncRawCardDebitClient:
    ...
    async def create_card_debit_for_user(
        ...
        *,
        ...
        preferred_name_on_card: typing.Optional[str] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[CardDebitCreate]:
        """
        Create a new debit card request.
