...
class EcommNewOrderPayloadPayloadPurchasedItemsItemVariantImageFile(UniversalBaseModel):
    ...
    variants: typing.Optional[
        typing.List[EcommNewOrderPayloadPayloadPurchasedItemsItemVariantImageFileVariantsItem]
