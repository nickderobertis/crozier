...
class DescribeTypeOutput(UniversalBaseModel):
    ...
    type: typing_extensions.Annotated[typing.Optional[DescribeTypeOutputType], FieldMetadata(alias="Type")] = (
    ...
    default_version_id: typing_extensions.Annotated[typing.Optional[str], FieldMetadata(alias="DefaultVersionId")] = (
        pydantic.Field(default=None)
    )
    """
    ...
    is_default_version: typing_extensions.Annotated[typing.Optional[bool], FieldMetadata(alias="IsDefaultVersion")] = (
        pydantic.Field(default=None)
    )
    """
    ...
    type_tests_status: typing_extensions.Annotated[
        typing.Optional[DescribeTypeOutputTypeTestsStatus], FieldMetadata(alias="TypeTestsStatus")
    ] = pydantic.Field(default=None)
    """
    ...
    type_tests_status_description: typing_extensions.Annotated[
        typing.Optional[str], FieldMetadata(alias="TypeTestsStatusDescription")
    ] = pydantic.Field(default=None)
    """
    ...
    provisioning_type: typing_extensions.Annotated[
        typing.Optional[DescribeTypeOutputProvisioningType], FieldMetadata(alias="ProvisioningType")
    ] = pydantic.Field(default=None)
    """
    ...
    deprecated_status: typing_extensions.Annotated[
        typing.Optional[DescribeTypeOutputDeprecatedStatus], FieldMetadata(alias="DeprecatedStatus")
    ] = pydantic.Field(default=None)
    """
    ...
    logging_config: typing_extensions.Annotated[
        typing.Optional[DescribeTypeOutputLoggingConfig], FieldMetadata(alias="LoggingConfig")
    ] = pydantic.Field(default=None)
    """
    ...
    required_activated_types: typing_extensions.Annotated[
        typing.Optional[typing.List[RequiredActivatedType]], FieldMetadata(alias="RequiredActivatedTypes")
    ] = pydantic.Field(default=None)
    """
    ...
    execution_role_arn: typing_extensions.Annotated[typing.Optional[str], FieldMetadata(alias="ExecutionRoleArn")] = (
        pydantic.Field(default=None)
    )
    """
    ...
    visibility: typing_extensions.Annotated[
        typing.Optional[DescribeTypeOutputVisibility], FieldMetadata(alias="Visibility")
    ] = pydantic.Field(default=None)
    """
    ...
    documentation_url: typing_extensions.Annotated[typing.Optional[str], FieldMetadata(alias="DocumentationUrl")] = (
        pydantic.Field(default=None)
    )
    """
    ...
    time_created: typing_extensions.Annotated[typing.Optional[dt.datetime], FieldMetadata(alias="TimeCreated")] = (
        pydantic.Field(default=None)
    )
    """
    ...
    configuration_schema: typing_extensions.Annotated[
        typing.Optional[str], FieldMetadata(alias="ConfigurationSchema")
    ] = pydantic.Field(default=None)
    """
    ...
    original_type_name: typing_extensions.Annotated[typing.Optional[str], FieldMetadata(alias="OriginalTypeName")] = (
        pydantic.Field(default=None)
    )
    """
    ...
    original_type_arn: typing_extensions.Annotated[typing.Optional[str], FieldMetadata(alias="OriginalTypeArn")] = (
        pydantic.Field(default=None)
    )
    """
    ...
    latest_public_version: typing_extensions.Annotated[
        typing.Optional[str], FieldMetadata(alias="LatestPublicVersion")
    ] = pydantic.Field(default=None)
    """
    ...
    auto_update: typing_extensions.Annotated[typing.Optional[bool], FieldMetadata(alias="AutoUpdate")] = pydantic.Field(
        default=None
    )
    """
