...
class MessagesEvent(UniversalBaseModel):
    ...
    **Changes**: Before Zulip 7.0 (feature level 163), access to a
    ...
    display_recipient: typing.Optional[MessagesEventDisplayRecipient] = pydantic.Field(default=None)
    """
    Data on the recipient of the message. Will be one of the following:
    """

    edit_history: typing.Optional[typing.List[MessagesEventEditHistoryItem]] = pydantic.Field(default=None)
    """
    ...
    **Changes**: Before Zulip 10.0 (feature level 334), `empty_topic_name`
    ...
    submessages: typing.Optional[typing.List[MessagesEventSubmessagesItem]] = pydantic.Field(default=None)
    """
    ...
    topic_links: typing.Optional[typing.List[MessagesEventTopicLinksItem]] = pydantic.Field(default=None)
    """
