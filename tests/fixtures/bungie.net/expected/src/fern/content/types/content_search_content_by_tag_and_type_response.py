...
from ...types.search_result_of_content_item_public_contract import SearchResultOfContentItemPublicContract


class ContentSearchContentByTagAndTypeResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[SearchResultOfContentItemPublicContract], FieldMetadata(alias="Response")
    ] = None
