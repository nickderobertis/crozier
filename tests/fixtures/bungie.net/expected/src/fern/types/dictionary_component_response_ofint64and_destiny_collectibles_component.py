...
class DictionaryComponentResponseOfint64AndDestinyCollectiblesComponent(UniversalBaseModel):
    data: typing.Optional[typing.Dict[str, DestinyComponentsCollectiblesDestinyCollectiblesComponent]] = None
