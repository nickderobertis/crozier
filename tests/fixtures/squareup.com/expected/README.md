...
response = client.mobile_authorization.with_raw_response.create_mobile_authorization_code(
    ...
)
...
```python
client.mobile_authorization.create_mobile_authorization_code(..., request_options={
    "max_retries": 1
})
```
