...
class DestinyDefinitionsDestinyNodeStepDefinition(UniversalBaseModel):
    ...
    affects_level: typing_extensions.Annotated[
        typing.Optional[bool],
        FieldMetadata(alias="affectsLevel"),
        pydantic.Field(
            alias="affectsLevel",
    ...
    affects_quality: typing_extensions.Annotated[
        typing.Optional[bool],
        FieldMetadata(alias="affectsQuality"),
        pydantic.Field(
            alias="affectsQuality",
    ...
    can_activate_next_step: typing_extensions.Annotated[
        typing.Optional[bool],
        FieldMetadata(alias="canActivateNextStep"),
        pydantic.Field(
            alias="canActivateNextStep",
    ...
    interaction_description: typing_extensions.Annotated[
        typing.Optional[str],
        FieldMetadata(alias="interactionDescription"),
        pydantic.Field(
    ...
    is_next_step_random: typing_extensions.Annotated[
        typing.Optional[bool],
        FieldMetadata(alias="isNextStepRandom"),
        pydantic.Field(
            alias="isNextStepRandom",
    ...
    next_step_index: typing_extensions.Annotated[
        typing.Optional[int],
        FieldMetadata(alias="nextStepIndex"),
        pydantic.Field(
            alias="nextStepIndex",
    ...
    node_step_hash: typing_extensions.Annotated[
        typing.Optional[int],
        FieldMetadata(alias="nodeStepHash"),
        pydantic.Field(
            alias="nodeStepHash",
    ...
    perk_hashes: typing_extensions.Annotated[
        typing.Optional[typing.List[int]],
        FieldMetadata(alias="perkHashes"),
        pydantic.Field(
            alias="perkHashes",
    ...
    start_progression_bar_at_progress: typing_extensions.Annotated[
        typing.Optional[int],
        FieldMetadata(alias="startProgressionBarAtProgress"),
        pydantic.Field(
            alias="startProgressionBarAtProgress",
    ...
    stat_hashes: typing_extensions.Annotated[
        typing.Optional[typing.List[int]],
        FieldMetadata(alias="statHashes"),
        pydantic.Field(
            alias="statHashes",
    ...
    step_groups: typing_extensions.Annotated[
        ...
        FieldMetadata(alias="stepGroups"),
        pydantic.Field(
            alias="stepGroups",
