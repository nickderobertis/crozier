...
class OAuth2Specification(UniversalBaseModel):
    ...
    oauth_flow_init_parameters: typing_extensions.Annotated[
        ...
        FieldMetadata(alias="oauthFlowInitParameters"),
        pydantic.Field(
            alias="oauthFlowInitParameters",
    ...
    oauth_flow_output_parameters: typing_extensions.Annotated[
        typing.List[typing.List[str]],
        FieldMetadata(alias="oauthFlowOutputParameters"),
        pydantic.Field(
            alias="oauthFlowOutputParameters",
    ...
    root_object: typing_extensions.Annotated[
        ...
        FieldMetadata(alias="rootObject"),
        pydantic.Field(
            alias="rootObject",
