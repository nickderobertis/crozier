...
from .streaming_distribution_active_trusted_signers_items_item import StreamingDistributionActiveTrustedSignersItemsItem


class StreamingDistributionActiveTrustedSigners(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[typing.List[StreamingDistributionActiveTrustedSignersItemsItem]],
