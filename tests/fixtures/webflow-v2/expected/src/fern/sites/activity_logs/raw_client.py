...
class RawActivityLogsClient:
    ...
    def list(
        ...
        *,
    ...
    ) -> HttpResponse[ListActivityLogsResponse]:
        """
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"sites/{encode_path_param(site_id)}/activity_logs",
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=ListActivityLogsResponse,
...
class AsyncRawActivityLogsClient:
    ...
    async def list(
        ...
        *,
        ...
        offset: typing.Optional[int] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[ListActivityLogsResponse]:
        """
        Retrieve Activity Logs for a specific Site.
