...
class GetUserResponseUser(UniversalBaseModel):
    ...
    group_users: typing.List[GetUserResponseUserGroupUsersItem]
    groups: typing.List[GetUserResponseUserGroupsItem]
    ...
    user_auth_tokens: typing.List[GetUserResponseUserUserAuthTokensItem]
    user_fields: typing.Optional[GetUserResponseUserUserFields] = None
