...
class CreateStreamingDistributionResultStreamingDistributionStreamingDistributionConfig(UniversalBaseModel):
    """
    ...
    aliases: typing_extensions.Annotated[
        typing.Optional[CreateStreamingDistributionResultStreamingDistributionStreamingDistributionConfigAliases],
    ...
    logging: typing_extensions.Annotated[
        typing.Optional[CreateStreamingDistributionResultStreamingDistributionStreamingDistributionConfigLogging],
    ...
    price_class: typing_extensions.Annotated[
        typing.Optional[CreateStreamingDistributionResultStreamingDistributionStreamingDistributionConfigPriceClass],
