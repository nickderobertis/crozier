...
class UpdateStackInstancesInput(UniversalBaseModel):
    ...
    accounts: typing_extensions.Annotated[
        ...
        pydantic.Field(
            alias="Accounts",
            description="<p>[Self-managed permissions] The names of one or more Amazon Web Services accounts for which you want to update parameter values for stack instances. The overridden parameter values will be applied to all stack instances in the specified accounts and Amazon Web Services Regions.</p> <p>You can specify <code>Accounts</code> or <code>DeploymentTargets</code>, but not both.</p>",
        ),
    ] = None
    """
    ...
    deployment_targets: typing_extensions.Annotated[
        typing.Optional[UpdateStackInstancesInputDeploymentTargets],
        FieldMetadata(alias="DeploymentTargets"),
        pydantic.Field(
            alias="DeploymentTargets",
            description="<p>[Service-managed permissions] The Organizations accounts for which you want to update parameter values for stack instances. If your update targets OUs, the overridden parameter values only apply to the accounts that are currently in the target OUs and their child OUs. Accounts added to the target OUs and their child OUs in the future won't use the overridden values.</p> <p>You can specify <code>Accounts</code> or <code>DeploymentTargets</code>, but not both.</p>",
        ),
    ] = None
    """
    ...
    operation_preferences: typing_extensions.Annotated[
        typing.Optional[UpdateStackInstancesInputOperationPreferences],
    ...
    call_as: typing_extensions.Annotated[
        typing.Optional[UpdateStackInstancesInputCallAs],
