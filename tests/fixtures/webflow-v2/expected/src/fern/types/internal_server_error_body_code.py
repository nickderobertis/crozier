...
class InternalServerErrorBodyCode(enum.StrEnum):
    """
    Error code
    """
    ...
    def visit(
        ...
        if self is InternalServerErrorBodyCode.ANALYZE_FILTER_CONFLICT:
            return analyze_filter_conflict()
        if self is InternalServerErrorBodyCode.ANALYZE_INPUT_VALIDATION:
            return analyze_input_validation()
        if self is InternalServerErrorBodyCode.ANALYZE_UNSUPPORTED_FILTER:
            return analyze_unsupported_filter()
        if self is InternalServerErrorBodyCode.BAD_REQUEST:
            return bad_request()
        if self is InternalServerErrorBodyCode.BEFORE_HISTORICAL_FLOOR:
            return before_historical_floor()
        if self is InternalServerErrorBodyCode.COLLECTION_NOT_FOUND:
            return collection_not_found()
        if self is InternalServerErrorBodyCode.CONFLICT:
            return conflict()
        if self is InternalServerErrorBodyCode.DUPLICATE_COLLECTION:
            return duplicate_collection()
        if self is InternalServerErrorBodyCode.DUPLICATE_USER_EMAIL:
            return duplicate_user_email()
        if self is InternalServerErrorBodyCode.ECOMMERCE_NOT_ENABLED:
            return ecommerce_not_enabled()
        if self is InternalServerErrorBodyCode.FORBIDDEN:
            return forbidden()
        if self is InternalServerErrorBodyCode.FORMS_REQUIRE_REPUBLISH:
            return forms_require_republish()
        if self is InternalServerErrorBodyCode.INCOMPATIBLE_WEBHOOK_FILTER:
            return incompatible_webhook_filter()
        if self is InternalServerErrorBodyCode.INTERNAL_ERROR:
            return internal_error()
        if self is InternalServerErrorBodyCode.INVALID_AUTH_VERSION:
            return invalid_auth_version()
        if self is InternalServerErrorBodyCode.INVALID_CREDENTIALS:
            return invalid_credentials()
        if self is InternalServerErrorBodyCode.INVALID_DOMAIN:
            return invalid_domain()
        if self is InternalServerErrorBodyCode.INVALID_TIME_RANGE:
            return invalid_time_range()
        if self is InternalServerErrorBodyCode.INVALID_USER_EMAIL:
            return invalid_user_email()
        if self is InternalServerErrorBodyCode.ITEM_NOT_FOUND:
            return item_not_found()
        if self is InternalServerErrorBodyCode.MISSING_SCOPES:
            return missing_scopes()
        if self is InternalServerErrorBodyCode.NO_DOMAINS:
            return no_domains()
        if self is InternalServerErrorBodyCode.NOT_AUTHORIZED:
            return not_authorized()
        if self is InternalServerErrorBodyCode.NOT_ENTERPRISE_PLAN_SITE:
            return not_enterprise_plan_site()
        if self is InternalServerErrorBodyCode.NOT_ENTERPRISE_PLAN_WORKSPACE:
            return not_enterprise_plan_workspace()
        if self is InternalServerErrorBodyCode.ORDER_NOT_FOUND:
            return order_not_found()
        if self is InternalServerErrorBodyCode.RESOURCE_NOT_FOUND:
            return resource_not_found()
        if self is InternalServerErrorBodyCode.SERVICE_UNAVAILABLE:
            return service_unavailable()
        if self is InternalServerErrorBodyCode.TIME_RANGE_TOO_WIDE:
            return time_range_too_wide()
        if self is InternalServerErrorBodyCode.TOO_MANY_REQUESTS:
            return too_many_requests()
        if self is InternalServerErrorBodyCode.UNSUPPORTED_VERSION:
            return unsupported_version()
        if self is InternalServerErrorBodyCode.UNSUPPORTED_WEBHOOK_TRIGGER_TYPE:
            return unsupported_webhook_trigger_type()
        if self is InternalServerErrorBodyCode.USER_LIMIT_REACHED:
            return user_limit_reached()
        if self is InternalServerErrorBodyCode.USER_NOT_FOUND:
            return user_not_found()
        if self is InternalServerErrorBodyCode.USERS_NOT_ENABLED:
            return users_not_enabled()
        if self is InternalServerErrorBodyCode.VALIDATION_ERROR:
