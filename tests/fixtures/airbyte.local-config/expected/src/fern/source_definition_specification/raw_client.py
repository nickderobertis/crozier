...
class RawSourceDefinitionSpecificationClient:
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=SourceDefinitionSpecificationRead,
...
class AsyncRawSourceDefinitionSpecificationClient:
    ...
    async def get_source_definition_specification(
        ...
        *,
        ...
        workspace_id: WorkspaceId,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[SourceDefinitionSpecificationRead]:
        """
        Parameters
        ----------
        source_definition_id : SourceDefinitionId
