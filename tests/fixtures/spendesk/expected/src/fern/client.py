...
if typing.TYPE_CHECKING:
    ...
    from .analytical.client import AnalyticalClient, AsyncAnalyticalClient
    ...
    from .spend_data.client import AsyncSpendDataClient, SpendDataClient
...
class FernApi:
    ...
    def __init__(
        ...
        *,
        ...
        self._spend_data: typing.Optional[SpendDataClient] = None
        self._analytical: typing.Optional[AnalyticalClient] = None
    ...
    @property
    def spend_data(self):
        if self._spend_data is None:
            from .spend_data.client import SpendDataClient

            self._spend_data = SpendDataClient(client_wrapper=self._client_wrapper)
        return self._spend_data

    @property
    def analytical(self):
        if self._analytical is None:
            from .analytical.client import AnalyticalClient

            self._analytical = AnalyticalClient(client_wrapper=self._client_wrapper)
...
class AsyncFernApi:
    ...
    def __init__(
        ...
        *,
        ...
        self._spend_data: typing.Optional[AsyncSpendDataClient] = None
        self._analytical: typing.Optional[AsyncAnalyticalClient] = None
    ...
    def spend_data(self):
        if self._spend_data is None:
            from .spend_data.client import AsyncSpendDataClient

            self._spend_data = AsyncSpendDataClient(client_wrapper=self._client_wrapper)
        return self._spend_data

    @property
    def analytical(self):
        if self._analytical is None:
            from .analytical.client import AsyncAnalyticalClient

            self._analytical = AsyncAnalyticalClient(client_wrapper=self._client_wrapper)
        return self._analytical
