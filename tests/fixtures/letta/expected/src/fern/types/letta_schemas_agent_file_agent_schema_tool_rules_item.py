...
class LettaSchemasAgentFileAgentSchemaToolRulesItem_Conditional(UniversalBaseModel):
...
class LettaSchemasAgentFileAgentSchemaToolRulesItem_ConstrainChildTools(UniversalBaseModel):
...
class LettaSchemasAgentFileAgentSchemaToolRulesItem_ContinueLoop(UniversalBaseModel):
...
class LettaSchemasAgentFileAgentSchemaToolRulesItem_ExitLoop(UniversalBaseModel):
...
class LettaSchemasAgentFileAgentSchemaToolRulesItem_MaxCountPerStep(UniversalBaseModel):
...
class LettaSchemasAgentFileAgentSchemaToolRulesItem_ParentLastTool(UniversalBaseModel):
...
class LettaSchemasAgentFileAgentSchemaToolRulesItem_RequiredBeforeExit(UniversalBaseModel):
...
class LettaSchemasAgentFileAgentSchemaToolRulesItem_RequiresApproval(UniversalBaseModel):
...
class LettaSchemasAgentFileAgentSchemaToolRulesItem_RunFirst(UniversalBaseModel):
...
LettaSchemasAgentFileAgentSchemaToolRulesItem = typing_extensions.Annotated[
    typing.Union[
