...
class DocPagesSetScaleRequestMeasureAreaItem(UniversalBaseModel):
    unit: str
    conversion: float
    fraction: typing.Optional[DocPagesSetScaleRequestMeasureAreaItemFraction] = None
    ...
    label_position: typing_extensions.Annotated[
        typing.Optional[DocPagesSetScaleRequestMeasureAreaItemLabelPosition],
