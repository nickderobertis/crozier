...
from ...types.tokens_bungie_reward_display import TokensBungieRewardDisplay


class TokensGetBungieRewardsForPlatformUserResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[typing.Dict[str, TokensBungieRewardDisplay]], FieldMetadata(alias="Response")
    ] = None
