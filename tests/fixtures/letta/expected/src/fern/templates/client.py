...
class TemplatesClient:
    ...
    def createagentsfromtemplatenoproject(
        ...
        *,
        ...
        """
        _response = self._raw_client.createagentsfromtemplatenoproject(
            template_version,
            tags=tags,
            agent_name=agent_name,
            initial_message_sequence=initial_message_sequence,
    ...
    def listtemplates(
        ...
        *,
        ...
        """
        _response = self._raw_client.listtemplates(
            offset=offset,
            exact=exact,
            limit=limit,
            version=version,
    ...
    def createtemplatenoproject(
        ...
        *,
        ...
        """
        _response = self._raw_client.createtemplatenoproject(request=request, request_options=request_options)
        return _response.data
    ...
    def deletetemplatenoproject(
        ...
        """
        _response = self._raw_client.deletetemplatenoproject(template_name, request_options=request_options)
        return _response.data
    ...
    def updatecurrenttemplatefromagentfilenoproject(
        ...
        *,
        ...
        """
        _response = self._raw_client.updatecurrenttemplatefromagentfilenoproject(
            template_name,
    ...
    def legacymigration(
        ...
        """
        _response = self._raw_client.legacymigration(template_id, request_options=request_options)
        return _response.data
...
class AsyncTemplatesClient:
    ...
    async def createagentsfromtemplatenoproject(
        ...
        *,
        ...
        async def main() -> None:
            await client.templates.createagentsfromtemplatenoproject(
                template_version="template_version",
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.createagentsfromtemplatenoproject(
            template_version,
            tags=tags,
            agent_name=agent_name,
            initial_message_sequence=initial_message_sequence,
    ...
    async def listtemplates(
        ...
        *,
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.listtemplates(
            offset=offset,
            exact=exact,
            limit=limit,
            version=version,
    ...
    async def createtemplatenoproject(
        ...
        *,
        ...
        async def main() -> None:
            await client.templates.createtemplatenoproject(
                request=TemplatesCreateTemplateNoProjectRequest_Agent(
                    agent_id="agent_id",
                ),
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.createtemplatenoproject(request=request, request_options=request_options)
        return _response.data
    ...
    async def deletetemplatenoproject(
        ...
        async def main() -> None:
            await client.templates.deletetemplatenoproject(
                template_name="template_name",
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.deletetemplatenoproject(template_name, request_options=request_options)
        return _response.data
    ...
    async def updatecurrenttemplatefromagentfilenoproject(
        ...
        *,
        ...
        async def main() -> None:
            await client.templates.updatecurrenttemplatefromagentfilenoproject(
                template_name="template_name",
                agent_file_json={"key": "value"},
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.updatecurrenttemplatefromagentfilenoproject(
            template_name,
            agent_file_json=agent_file_json,
            update_existing_tools=update_existing_tools,
            save_existing_changes=save_existing_changes,
    ...
    async def legacymigration(
        ...
        async def main() -> None:
            await client.templates.legacymigration(
                template_id="templateId",
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.legacymigration(template_id, request_options=request_options)
        return _response.data
