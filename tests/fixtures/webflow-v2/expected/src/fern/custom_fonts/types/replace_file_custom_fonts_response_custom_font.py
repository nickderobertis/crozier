...
from .replace_file_custom_fonts_response_custom_font_axes_item import ReplaceFileCustomFontsResponseCustomFontAxesItem
...
class ReplaceFileCustomFontsResponseCustomFont(UniversalBaseModel):
    """
    ...
    format: typing.Optional[ReplaceFileCustomFontsResponseCustomFontFormat] = pydantic.Field(default=None)
    """
    ...
    axes: typing.List[ReplaceFileCustomFontsResponseCustomFontAxesItem] = pydantic.Field()
    """
