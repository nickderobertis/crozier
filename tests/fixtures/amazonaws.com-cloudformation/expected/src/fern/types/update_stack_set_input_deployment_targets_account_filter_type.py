...
class UpdateStackSetInputDeploymentTargetsAccountFilterType(str, enum.Enum):
    """
    ...
    def visit(
        ...
        if self is UpdateStackSetInputDeploymentTargetsAccountFilterType.NONE:
            return none()
        if self is UpdateStackSetInputDeploymentTargetsAccountFilterType.INTERSECTION:
            return intersection()
        if self is UpdateStackSetInputDeploymentTargetsAccountFilterType.DIFFERENCE:
            return difference()
        if self is UpdateStackSetInputDeploymentTargetsAccountFilterType.UNION:
            return union()
