...
client = FernApi(...)
response = client.medication.with_raw_response.route_for_getting_filtered_medication_requests(...)
...
```python
client.medication.route_for_getting_filtered_medication_requests(..., request_options={
    "max_retries": 1
})
```
