...
class NotFoundErrorBodyCode(enum.StrEnum):
    ...
    def visit(
        ...
        if self is NotFoundErrorBodyCode.ANALYZE_FILTER_CONFLICT:
            return analyze_filter_conflict()
        if self is NotFoundErrorBodyCode.ANALYZE_INPUT_VALIDATION:
            return analyze_input_validation()
        if self is NotFoundErrorBodyCode.ANALYZE_UNSUPPORTED_FILTER:
            return analyze_unsupported_filter()
        if self is NotFoundErrorBodyCode.BAD_REQUEST:
            return bad_request()
        if self is NotFoundErrorBodyCode.BEFORE_HISTORICAL_FLOOR:
            return before_historical_floor()
        if self is NotFoundErrorBodyCode.COLLECTION_NOT_FOUND:
            return collection_not_found()
        if self is NotFoundErrorBodyCode.CONFLICT:
            return conflict()
        if self is NotFoundErrorBodyCode.DUPLICATE_COLLECTION:
            return duplicate_collection()
        if self is NotFoundErrorBodyCode.DUPLICATE_USER_EMAIL:
            return duplicate_user_email()
        if self is NotFoundErrorBodyCode.ECOMMERCE_NOT_ENABLED:
            return ecommerce_not_enabled()
        if self is NotFoundErrorBodyCode.FORBIDDEN:
            return forbidden()
        if self is NotFoundErrorBodyCode.FORMS_REQUIRE_REPUBLISH:
            return forms_require_republish()
        if self is NotFoundErrorBodyCode.INCOMPATIBLE_WEBHOOK_FILTER:
            return incompatible_webhook_filter()
        if self is NotFoundErrorBodyCode.INTERNAL_ERROR:
            return internal_error()
        if self is NotFoundErrorBodyCode.INVALID_AUTH_VERSION:
            return invalid_auth_version()
        if self is NotFoundErrorBodyCode.INVALID_CREDENTIALS:
            return invalid_credentials()
        if self is NotFoundErrorBodyCode.INVALID_DOMAIN:
            return invalid_domain()
        if self is NotFoundErrorBodyCode.INVALID_TIME_RANGE:
            return invalid_time_range()
        if self is NotFoundErrorBodyCode.INVALID_USER_EMAIL:
            return invalid_user_email()
        if self is NotFoundErrorBodyCode.ITEM_NOT_FOUND:
            return item_not_found()
        if self is NotFoundErrorBodyCode.MISSING_SCOPES:
            return missing_scopes()
        if self is NotFoundErrorBodyCode.NO_DOMAINS:
            return no_domains()
        if self is NotFoundErrorBodyCode.NOT_AUTHORIZED:
            return not_authorized()
        if self is NotFoundErrorBodyCode.NOT_ENTERPRISE_PLAN_SITE:
            return not_enterprise_plan_site()
        if self is NotFoundErrorBodyCode.NOT_ENTERPRISE_PLAN_WORKSPACE:
            return not_enterprise_plan_workspace()
        if self is NotFoundErrorBodyCode.ORDER_NOT_FOUND:
            return order_not_found()
        if self is NotFoundErrorBodyCode.RESOURCE_NOT_FOUND:
            return resource_not_found()
        if self is NotFoundErrorBodyCode.SERVICE_UNAVAILABLE:
            return service_unavailable()
        if self is NotFoundErrorBodyCode.TIME_RANGE_TOO_WIDE:
            return time_range_too_wide()
        if self is NotFoundErrorBodyCode.TOO_MANY_REQUESTS:
            return too_many_requests()
        if self is NotFoundErrorBodyCode.UNSUPPORTED_VERSION:
            return unsupported_version()
        if self is NotFoundErrorBodyCode.UNSUPPORTED_WEBHOOK_TRIGGER_TYPE:
            return unsupported_webhook_trigger_type()
        if self is NotFoundErrorBodyCode.USER_LIMIT_REACHED:
            return user_limit_reached()
        if self is NotFoundErrorBodyCode.USER_NOT_FOUND:
            return user_not_found()
        if self is NotFoundErrorBodyCode.USERS_NOT_ENABLED:
            return users_not_enabled()
        if self is NotFoundErrorBodyCode.VALIDATION_ERROR:
