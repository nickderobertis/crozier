...
from ..types.templates_list_template_versions_request_offset import TemplatesListTemplateVersionsRequestOffset
from ..types.templates_list_templates_request_offset import TemplatesListTemplatesRequestOffset
from .types.templates_create_agents_from_template_no_project_request_initial_message_sequence_item import (
    TemplatesCreateAgentsFromTemplateNoProjectRequestInitialMessageSequenceItem,
)
from .types.templates_create_agents_from_template_no_project_response import (
...
from .types.templates_create_template_no_project_request import TemplatesCreateTemplateNoProjectRequest
from .types.templates_create_template_no_project_response import TemplatesCreateTemplateNoProjectResponse
from .types.templates_create_template_request_body import TemplatesCreateTemplateRequestBody
from .types.templates_create_template_response import TemplatesCreateTemplateResponse
from .types.templates_delete_template_no_project_response import TemplatesDeleteTemplateNoProjectResponse
...
from .types.templates_legacy_migration_response import TemplatesLegacyMigrationResponse
from .types.templates_list_template_versions_response import TemplatesListTemplateVersionsResponse
from .types.templates_list_templates_request_sort_by import TemplatesListTemplatesRequestSortBy
...
from .types.templates_save_template_version_request_block_reconciliation_strategy import (
...
from .types.templates_update_current_template_from_agent_file_no_project_response import (
...
class RawTemplatesClient:
    ...
    def createagentsfromtemplate(
        ...
        *,
        ...
        template_version : str
            The template version, formatted as {template-name}:{version-number} or {template-name}:latest. This endpoint is not available for self-hosted Letta.
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"v1/templates/{encode_path_param(project_id)}/{encode_path_param(template_version)}/agents",
            method="POST",
            json={
                "tags": tags,
    ...
    def createagentsfromtemplatenoproject(
        self,
        template_version: str,
        *,
        tags: typing.Optional[typing.Sequence[str]] = OMIT,
        agent_name: typing.Optional[str] = OMIT,
        initial_message_sequence: typing.Optional[
            typing.Sequence[TemplatesCreateAgentsFromTemplateNoProjectRequestInitialMessageSequenceItem]
        ] = OMIT,
        memory_variables: typing.Optional[typing.Dict[str, str]] = OMIT,
        tool_variables: typing.Optional[typing.Dict[str, str]] = OMIT,
        identity_ids: typing.Optional[typing.Sequence[str]] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[TemplatesCreateAgentsFromTemplateNoProjectResponse]:
        """
        Creates an Agent or multiple Agents from a template
        ...
        initial_message_sequence : typing.Optional[typing.Sequence[TemplatesCreateAgentsFromTemplateNoProjectRequestInitialMessageSequenceItem]]
            Set an initial sequence of messages, if not provided, the agent will start with the default message sequence, if an empty array is provided, the agent will start with no messages
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/templates/{encode_path_param(template_version)}/agents",
            method="POST",
            json={
                "tags": tags,
                "agent_name": agent_name,
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    TemplatesCreateAgentsFromTemplateNoProjectResponse,
                    parse_obj_as(
                        type_=TemplatesCreateAgentsFromTemplateNoProjectResponse,
                        object_=_response.json(),
                    ),
                )
    ...
    def listtemplates(
        self,
        *,
        offset: typing.Optional[TemplatesListTemplatesRequestOffset] = None,
        ...
        sort_by: typing.Optional[TemplatesListTemplatesRequestSortBy] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[TemplatesListTemplatesResponse]:
        """
        List all templates
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=TemplatesListTemplatesResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def createtemplatenoproject(
        self,
        *,
        request: TemplatesCreateTemplateNoProjectRequest,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[TemplatesCreateTemplateNoProjectResponse]:
        """
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json=convert_and_respect_annotation_metadata(
                object_=request, annotation=TemplatesCreateTemplateNoProjectRequest, direction="write"
            ),
            headers={
                "content-type": "application/json",
            },
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=TemplatesCreateTemplateNoProjectResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def savetemplateversion(
        ...
        *,
        ...
        preserve_sources_on_migration: typing.Optional[bool] = OMIT,
        block_reconciliation_strategy: typing.Optional[
            TemplatesSaveTemplateVersionRequestBlockReconciliationStrategy
        ] = OMIT,
        ...
        preserve_sources_on_migration : typing.Optional[bool]
        ...
        block_reconciliation_strategy : typing.Optional[TemplatesSaveTemplateVersionRequestBlockReconciliationStrategy]
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/templates/{encode_path_param(project_id)}/{encode_path_param(template_name)}",
            method="POST",
            json={
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=TemplatesSaveTemplateVersionResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=TemplatesDeleteTemplateResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def gettemplatesnapshot(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/templates/{encode_path_param(project_id)}/{encode_path_param(template_version)}/snapshot",
            method="GET",
            request_options=request_options,
        )
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=TemplatesGetTemplateSnapshotResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=TemplatesSetCurrentTemplateFromSnapshotResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def forktemplate(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/templates/{encode_path_param(project_id)}/{encode_path_param(template_version)}/fork",
            method="POST",
            json={
                "name": name,
            },
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=TemplatesForkTemplateResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def createtemplate(
        ...
        project_id: str,
        *,
        request: TemplatesCreateTemplateRequestBody,
        request_options: typing.Optional[RequestOptions] = None,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/templates/{encode_path_param(project_id)}",
            method="POST",
            json=convert_and_respect_annotation_metadata(
                object_=request, annotation=TemplatesCreateTemplateRequestBody, direction="write"
            ),
            headers={
                "content-type": "application/json",
            },
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=TemplatesCreateTemplateResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def deletetemplatenoproject(
        self, template_name: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> HttpResponse[TemplatesDeleteTemplateNoProjectResponse]:
        """
        Deletes all versions of a template with the specified name
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/templates/{encode_path_param(template_name)}",
            method="DELETE",
            json={},
            headers={
                "content-type": "application/json",
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=TemplatesDeleteTemplateNoProjectResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def updatecurrenttemplatefromagentfilenoproject(
        self,
        template_name: str,
        *,
        agent_file_json: typing.Dict[str, typing.Any],
        update_existing_tools: typing.Optional[bool] = OMIT,
        save_existing_changes: typing.Optional[bool] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[TemplatesUpdateCurrentTemplateFromAgentFileNoProjectResponse]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    TemplatesUpdateCurrentTemplateFromAgentFileNoProjectResponse,
                    parse_obj_as(
                        type_=TemplatesUpdateCurrentTemplateFromAgentFileNoProjectResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def renametemplate(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/templates/{encode_path_param(project_id)}/{encode_path_param(template_name)}/name",
            method="PATCH",
            json={
                "new_name": new_name,
            },
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=TemplatesRenameTemplateResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def updatetemplatedescription(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/templates/{encode_path_param(project_id)}/{encode_path_param(template_name)}/description",
            method="PATCH",
            json={
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=TemplatesUpdateTemplateDescriptionResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def listtemplateversions(
        ...
        name: str,
        *,
        offset: typing.Optional[TemplatesListTemplateVersionsRequestOffset] = None,
        limit: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/templates/{encode_path_param(project_id)}/{encode_path_param(name)}/versions",
            method="GET",
            params={
                "offset": offset,
                "limit": limit,
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=TemplatesListTemplateVersionsResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def migratedeployment(
        ...
        *,
        ...
        preserve_sources: typing.Optional[bool] = OMIT,
        memory_variables: typing.Optional[typing.Dict[str, str]] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
        ...
        preserve_sources : typing.Optional[bool]
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/templates/{encode_path_param(project_id)}/{encode_path_param(template_name)}/deployments/{encode_path_param(deployment_id)}/migrate",
            method="POST",
            json={
                "version": version,
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=TemplatesMigrateDeploymentResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def updatecurrenttemplatefromagentfile(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/templates/{encode_path_param(project_id)}/{encode_path_param(template_name)}/agent-file",
            method="PUT",
            json={
                "agent_file_json": agent_file_json,
                "update_existing_tools": update_existing_tools,
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    TemplatesUpdateCurrentTemplateFromAgentFileResponse,
                    parse_obj_as(
                        type_=TemplatesUpdateCurrentTemplateFromAgentFileResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def legacymigration(
    ...
    ) -> HttpResponse[TemplatesLegacyMigrationResponse]:
        """
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/legacy-templates/{encode_path_param(template_id)}/migrates",
            method="POST",
            json={},
            headers={
                "content-type": "application/json",
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=TemplatesLegacyMigrationResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawTemplatesClient:
    ...
    async def createagentsfromtemplatenoproject(
        self,
        template_version: str,
        *,
        tags: typing.Optional[typing.Sequence[str]] = OMIT,
        ...
        identity_ids: typing.Optional[typing.Sequence[str]] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[TemplatesCreateAgentsFromTemplateNoProjectResponse]:
        """
        Creates an Agent or multiple Agents from a template
    ...
    async def listtemplates(
        ...
        *,
        ...
        sort_by: typing.Optional[TemplatesListTemplatesRequestSortBy] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[TemplatesListTemplatesResponse]:
        """
        List all templates
    ...
    async def createtemplatenoproject(
        self,
        *,
        request: TemplatesCreateTemplateNoProjectRequest,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[TemplatesCreateTemplateNoProjectResponse]:
        """
        Creates a new template from an existing agent or agent file
    ...
    async def deletetemplatenoproject(
        self, template_name: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[TemplatesDeleteTemplateNoProjectResponse]:
        """
        Deletes all versions of a template with the specified name
    ...
    async def updatecurrenttemplatefromagentfilenoproject(
        self,
        template_name: str,
        *,
        agent_file_json: typing.Dict[str, typing.Any],
        ...
        save_existing_changes: typing.Optional[bool] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[TemplatesUpdateCurrentTemplateFromAgentFileNoProjectResponse]:
        """
        Updates the current working version of a template from an agent file
    ...
    async def legacymigration(
        self, template_id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[TemplatesLegacyMigrationResponse]:
        """
        Migrates a template from a legacy project to the default project. Only works if the template is currently in a legacy project.
