...
class DescribeStackResourceDriftsInput(UniversalBaseModel):
    stack_name: typing_extensions.Annotated[
        ...
        pydantic.Field(alias="StackName", description="The name of the stack for which you want drift information."),
    ]
    """
    ...
    next_token: typing_extensions.Annotated[
        ...
        pydantic.Field(
            alias="NextToken", description="A string that identifies the next page of stack resource drift results."
        ),
    ] = None
    """
