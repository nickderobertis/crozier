...
class GetFormSubmissionResponseSubmissionResponsesItem(UniversalBaseModel):
    ...
    answer: typing.Optional[GetFormSubmissionResponseSubmissionResponsesItemAnswer] = pydantic.Field(default=None)
    """
