...
if typing.TYPE_CHECKING:
    ...
    from .remote.client import AsyncRemoteClient, RemoteClient
...
class FernApi:
    ...
    def __init__(
        ...
        *,
        ...
        self._remote: typing.Optional[RemoteClient] = None
    ...
    def monitors(self):
        if self._monitors is None:
            from .monitors.client import MonitorsClient
    ...
    def remote(self):
        if self._remote is None:
            ...
            self._remote = RemoteClient(client_wrapper=self._client_wrapper)
        return self._remote
...
class AsyncFernApi:
    ...
    def __init__(
        ...
        *,
        ...
        self._remote: typing.Optional[AsyncRemoteClient] = None
    ...
    def monitors(self):
        if self._monitors is None:
            from .monitors.client import AsyncMonitorsClient
    ...
    def remote(self):
        if self._remote is None:
            from .remote.client import AsyncRemoteClient

            self._remote = AsyncRemoteClient(client_wrapper=self._client_wrapper)
        return self._remote
