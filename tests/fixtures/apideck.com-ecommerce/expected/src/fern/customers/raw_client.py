...
class RawCustomersClient:
    ...
    ) -> HttpResponse[GetEcommerceCustomersResponse]:
        """
        List Customers
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            params={
                ...
                "filter": convert_and_respect_annotation_metadata(
                    object_=filter, annotation=EcommerceCustomersFilter, direction="write"
                ),
                "fields": fields,
            },
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=GetEcommerceCustomersResponse,
    ...
    def one(
        ...
        *,
        ...
        fields: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[GetEcommerceCustomerResponse]:
        """
        Get Customer
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"ecommerce/customers/{jsonable_encoder(id)}",
            method="GET",
            params={
                "raw": raw,
                "fields": fields,
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=GetEcommerceCustomerResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawCustomersClient:
    ...
    async def all_(
        ...
        *,
        ...
        fields: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[GetEcommerceCustomersResponse]:
        """
        List Customers
    ...
    async def one(
        ...
        *,
        ...
        fields: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[GetEcommerceCustomerResponse]:
        """
        Get Customer
