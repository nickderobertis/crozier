...
class GetProductsResponseSkusItemFieldDataEcSkuBillingMethod(enum.StrEnum):
    """
    ...
    def visit(self, one_time: typing.Callable[[], T_Result], subscription: typing.Callable[[], T_Result]) -> T_Result:
        if self is GetProductsResponseSkusItemFieldDataEcSkuBillingMethod.ONE_TIME:
            return one_time()
        if self is GetProductsResponseSkusItemFieldDataEcSkuBillingMethod.SUBSCRIPTION:
            return subscription()
