...
class RawStandingOrdersClient:
    ...
    def get_accounts_account_id_standing_orders(
    ...
    ) -> HttpResponse[ObReadStandingOrder6]:
        """
        Parameters
        ----------
        account_id : str
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"accounts/{encode_path_param(account_id)}/standing-orders",
            method="GET",
...
class AsyncRawStandingOrdersClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._client_wrapper = client_wrapper

    async def get_accounts_account_id_standing_orders(
        self, account_id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[ObReadStandingOrder6]:
        """
        Parameters
        ----------
        account_id : str
