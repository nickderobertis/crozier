...
class CreateDistributionResultDistributionActiveTrustedSigners(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[typing.List[CreateDistributionResultDistributionActiveTrustedSignersItemsItem]],
