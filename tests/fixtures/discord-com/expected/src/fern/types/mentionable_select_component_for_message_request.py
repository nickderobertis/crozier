...
class MentionableSelectComponentForMessageRequest(UniversalBaseModel):
    type: int
    custom_id: str
    ...
    default_values: typing.Optional[typing.List[MentionableSelectComponentForMessageRequestDefaultValuesItem]] = None
