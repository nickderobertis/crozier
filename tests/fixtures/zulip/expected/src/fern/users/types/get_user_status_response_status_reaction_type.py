...
class GetUserStatusResponseStatusReactionType(enum.StrEnum):
    """
    ...
    **Changes**: New in Zulip 5.0 (feature level 86).
    ...
    def visit(
        ...
        if self is GetUserStatusResponseStatusReactionType.UNICODE_EMOJI:
            return unicode_emoji()
        if self is GetUserStatusResponseStatusReactionType.REALM_EMOJI:
            return realm_emoji()
        if self is GetUserStatusResponseStatusReactionType.ZULIP_EXTRA_EMOJI:
