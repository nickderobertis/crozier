...
class RawFileuploadtypesClient:
    ...
    ) -> HttpResponse[ApiPagedResponseCommunicationModelsFileUploadType]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ApiPagedResponseCommunicationModelsFileUploadType,
                    parse_obj_as(
                        type_=ApiPagedResponseCommunicationModelsFileUploadType,
...
class AsyncRawFileuploadtypesClient:
    ...
    async def get(
        ...
        *,
        ...
        offset: typing.Optional[int] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[ApiPagedResponseCommunicationModelsFileUploadType]:
        """
        No Documentation Found.
