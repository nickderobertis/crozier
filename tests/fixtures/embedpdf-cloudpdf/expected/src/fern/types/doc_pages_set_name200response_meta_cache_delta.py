...
from .doc_pages_set_name200response_meta_cache_delta_pages_item import DocPagesSetName200ResponseMetaCacheDeltaPagesItem


class DocPagesSetName200ResponseMetaCacheDelta(UniversalBaseModel):
    ...
    pages: typing.List[DocPagesSetName200ResponseMetaCacheDeltaPagesItem]
