...
class AlertStatusChangeRequestModelDismissalTimeRange_Absolute(UniversalBaseModel):
    """
...
class AlertStatusChangeRequestModelDismissalTimeRange_Relative(UniversalBaseModel):
    """
    Dismissal Time Range
    """
...
class AlertStatusChangeRequestModelDismissalTimeRange_ToNow(UniversalBaseModel):
    """
    Dismissal Time Range
    """
...
AlertStatusChangeRequestModelDismissalTimeRange = typing_extensions.Annotated[
    typing.Union[
