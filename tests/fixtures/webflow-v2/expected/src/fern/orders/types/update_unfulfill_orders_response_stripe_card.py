...
class UpdateUnfulfillOrdersResponseStripeCard(UniversalBaseModel):
    """
    ...
    brand: typing.Optional[UpdateUnfulfillOrdersResponseStripeCardBrand] = pydantic.Field(default=None)
    """
    ...
    expires: typing.Optional[UpdateUnfulfillOrdersResponseStripeCardExpires] = pydantic.Field(default=None)
    """
