...
class DescribeStackInstanceOutputStackInstanceStackInstanceStatusDetailedStatus(str, enum.Enum):
    """
    ...
    def visit(
        ...
        if self is DescribeStackInstanceOutputStackInstanceStackInstanceStatusDetailedStatus.PENDING:
            return pending()
        if self is DescribeStackInstanceOutputStackInstanceStackInstanceStatusDetailedStatus.RUNNING:
            return running()
        if self is DescribeStackInstanceOutputStackInstanceStackInstanceStatusDetailedStatus.SUCCEEDED:
            return succeeded()
        if self is DescribeStackInstanceOutputStackInstanceStackInstanceStatusDetailedStatus.FAILED:
            return failed()
        if self is DescribeStackInstanceOutputStackInstanceStackInstanceStatusDetailedStatus.CANCELLED:
            return cancelled()
        if self is DescribeStackInstanceOutputStackInstanceStackInstanceStatusDetailedStatus.INOPERABLE:
            return inoperable()
