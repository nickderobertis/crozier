...
class ApiPagedResponseContentSubmissionSharedBusinessEntitiesContentSubmission(UniversalBaseModel):
    """
    A response containing a page of results and metadata concerning the results
    """

    entities: typing_extensions.Annotated[
        typing.Optional[typing.List[ContentSubmissionSharedBusinessEntitiesContentSubmission]],
