...
class DestinyDefinitionsDestinyVendorInteractionDefinition(UniversalBaseModel):
    """
    ...
    replies: typing.Optional[typing.List[DestinyDefinitionsDestinyVendorInteractionReplyDefinition]] = pydantic.Field(
        default=None
    )
    """
