...
class RawOnboardingClient:
    def __init__(self, *, client_wrapper: SyncClientWrapper):
        self._client_wrapper = client_wrapper

    def get_onboarding_needed(
        self, *, request_options: typing.Optional[RequestOptions] = None
    ) -> HttpResponse[OnboardingNeededResponse]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=OnboardingNeededResponse,
...
class AsyncRawOnboardingClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._client_wrapper = client_wrapper

    async def get_onboarding_needed(
        self, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[OnboardingNeededResponse]:
        """
        Return whether onboarding is needed for this workspace.
