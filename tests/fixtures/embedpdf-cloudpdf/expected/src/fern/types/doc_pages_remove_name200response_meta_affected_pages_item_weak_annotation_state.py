...
class DocPagesRemoveName200ResponseMetaAffectedPagesItemWeakAnnotationState_Unknown(UniversalBaseModel):
...
class DocPagesRemoveName200ResponseMetaAffectedPagesItemWeakAnnotationState_Known(UniversalBaseModel):
...
DocPagesRemoveName200ResponseMetaAffectedPagesItemWeakAnnotationState = typing_extensions.Annotated[
    typing.Union[
