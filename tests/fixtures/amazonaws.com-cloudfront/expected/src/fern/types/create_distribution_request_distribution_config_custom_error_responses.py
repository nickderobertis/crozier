...
class CreateDistributionRequestDistributionConfigCustomErrorResponses(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[typing.List[CreateDistributionRequestDistributionConfigCustomErrorResponsesItemsItem]],
