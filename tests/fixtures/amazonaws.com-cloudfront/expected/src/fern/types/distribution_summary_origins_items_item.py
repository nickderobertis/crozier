...
from .distribution_summary_origins_items_item_s3origin_config import DistributionSummaryOriginsItemsItemS3OriginConfig


class DistributionSummaryOriginsItemsItem(UniversalBaseModel):
    """
    ...
    custom_headers: typing_extensions.Annotated[
        typing.Optional[DistributionSummaryOriginsItemsItemCustomHeaders],
    ...
    s3origin_config: typing_extensions.Annotated[
        typing.Optional[DistributionSummaryOriginsItemsItemS3OriginConfig],
    ...
    custom_origin_config: typing_extensions.Annotated[
        typing.Optional[DistributionSummaryOriginsItemsItemCustomOriginConfig],
