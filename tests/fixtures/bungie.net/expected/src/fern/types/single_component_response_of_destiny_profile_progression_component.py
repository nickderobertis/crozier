...
class SingleComponentResponseOfDestinyProfileProgressionComponent(UniversalBaseModel):
    data: typing.Optional[DestinyComponentsProfilesDestinyProfileProgressionComponent] = None
