...
from .compaction_settings_output_model_settings import CompactionSettingsOutputModelSettings


class CompactionSettingsOutput(UniversalBaseModel):
    """
    ...
    model_settings: typing.Optional[CompactionSettingsOutputModelSettings] = pydantic.Field(default=None)
    """
    ...
    mode: typing.Optional[CompactionSettingsOutputMode] = pydantic.Field(default=None)
    """
