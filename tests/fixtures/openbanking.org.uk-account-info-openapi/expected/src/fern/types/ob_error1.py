...
class ObError1(UniversalBaseModel):
    error_code: typing_extensions.Annotated[str, FieldMetadata(alias="ErrorCode")] = pydantic.Field()
    """
    ...
    path: typing_extensions.Annotated[typing.Optional[str], FieldMetadata(alias="Path")] = pydantic.Field(default=None)
    """
