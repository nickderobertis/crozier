...
class StackInstanceSummaryDriftStatus(str, enum.Enum):
    """
    ...
    def visit(
        ...
        if self is StackInstanceSummaryDriftStatus.DRIFTED:
            return drifted()
        if self is StackInstanceSummaryDriftStatus.IN_SYNC:
            return in_sync()
        if self is StackInstanceSummaryDriftStatus.UNKNOWN:
            return unknown()
        if self is StackInstanceSummaryDriftStatus.NOT_CHECKED:
            return not_checked()
