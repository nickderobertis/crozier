...
class PostLinksPublicResponse(UniversalBaseModel):
    ...
    expires_at: typing_extensions.Annotated[
        typing.Optional[PostLinksPublicResponseExpiresAt],
    ...
    ttl: typing.Optional[PostLinksPublicResponseTtl] = pydantic.Field(default=None)
    """
    ...
    split_urlv2: typing_extensions.Annotated[
        typing.Optional[typing.List[PostLinksPublicResponseSplitUrlv2Item]],
    ...
    redirect_type: typing_extensions.Annotated[
        typing.Optional[PostLinksPublicResponseRedirectType],
    ...
    source: typing.Optional[PostLinksPublicResponseSource] = pydantic.Field(default=None)
    """
    Link source
    """

    user: typing_extensions.Annotated[
        typing.Optional[PostLinksPublicResponseUser], FieldMetadata(alias="User"), pydantic.Field(alias="User")
    ] = None
