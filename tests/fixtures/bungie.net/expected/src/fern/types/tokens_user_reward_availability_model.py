...
class TokensUserRewardAvailabilityModel(UniversalBaseModel):
    availability_model: typing_extensions.Annotated[
        typing.Optional[TokensRewardAvailabilityModel], FieldMetadata(alias="AvailabilityModel")
    ] = None
    is_available_for_user: typing_extensions.Annotated[
        typing.Optional[bool], FieldMetadata(alias="IsAvailableForUser")
    ] = None
    is_unlocked_for_user: typing_extensions.Annotated[
        typing.Optional[bool], FieldMetadata(alias="IsUnlockedForUser")
    ] = None
