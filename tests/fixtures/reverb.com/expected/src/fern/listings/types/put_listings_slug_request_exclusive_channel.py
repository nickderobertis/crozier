...
class PutListingsSlugRequestExclusiveChannel(enum.StrEnum):
    ...
    def visit(
        ...
        if self is PutListingsSlugRequestExclusiveChannel.SELLER_SITE:
            return seller_site()
        if self is PutListingsSlugRequestExclusiveChannel.REVERB:
            return reverb()
        if self is PutListingsSlugRequestExclusiveChannel.NONE:
            return none()
