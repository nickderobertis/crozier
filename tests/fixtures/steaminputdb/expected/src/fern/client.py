...
if typing.TYPE_CHECKING:
    ...
    from .steam.client import AsyncSteamClient, SteamClient
...
class FernApi:
    ...
    def __init__(
        ...
        *,
        ...
        self._steam: typing.Optional[SteamClient] = None
    ...
    def steam(self):
        if self._steam is None:
            ...
            self._steam = SteamClient(client_wrapper=self._client_wrapper)
        return self._steam
...
class AsyncFernApi:
    ...
    def __init__(
        ...
        *,
        ...
        self._steam: typing.Optional[AsyncSteamClient] = None
    ...
    def steam(self):
        if self._steam is None:
            from .steam.client import AsyncSteamClient

            self._steam = AsyncSteamClient(client_wrapper=self._client_wrapper)
        return self._steam
