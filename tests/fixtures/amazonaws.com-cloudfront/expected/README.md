...
client = FernApi(...)
response = client.with_raw_response.create_cloud_front_origin_access_identity20161125()
...
```python
client.create_cloud_front_origin_access_identity20161125(request_options={
    "max_retries": 1
})
```
