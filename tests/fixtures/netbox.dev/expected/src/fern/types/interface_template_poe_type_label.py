...
class InterfaceTemplatePoeTypeLabel(str, enum.Enum):
    ...
    def visit(
        ...
        if self is InterfaceTemplatePoeTypeLabel.EIGHT_HUNDRED_TWO3AF_TYPE1:
            return eight_hundred_two3af_type1()
        if self is InterfaceTemplatePoeTypeLabel.EIGHT_HUNDRED_TWO3AT_TYPE2:
            return eight_hundred_two3at_type2()
        if self is InterfaceTemplatePoeTypeLabel.EIGHT_HUNDRED_TWO3AZ_TYPE2:
            return eight_hundred_two3az_type2()
        if self is InterfaceTemplatePoeTypeLabel.EIGHT_HUNDRED_TWO3BT_TYPE3:
            return eight_hundred_two3bt_type3()
        if self is InterfaceTemplatePoeTypeLabel.EIGHT_HUNDRED_TWO3BT_TYPE4:
            return eight_hundred_two3bt_type4()
        if self is InterfaceTemplatePoeTypeLabel.PASSIVE24V2PAIR:
            return passive24v2pair()
        if self is InterfaceTemplatePoeTypeLabel.PASSIVE24V4PAIR:
            return passive24v4pair()
        if self is InterfaceTemplatePoeTypeLabel.PASSIVE48V2PAIR:
            return passive48v2pair()
        if self is InterfaceTemplatePoeTypeLabel.PASSIVE48V4PAIR:
