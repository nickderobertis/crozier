...
class MentionableSelectComponentResponse(UniversalBaseModel):
    type: int
    id: int
    custom_id: str
    ...
    default_values: typing.Optional[typing.List[MentionableSelectComponentResponseDefaultValuesItem]] = None
