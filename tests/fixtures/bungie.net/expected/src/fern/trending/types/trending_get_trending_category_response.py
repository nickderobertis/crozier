...
from ...types.search_result_of_trending_entry import SearchResultOfTrendingEntry


class TrendingGetTrendingCategoryResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[SearchResultOfTrendingEntry], FieldMetadata(alias="Response"), pydantic.Field(alias="Response")
    ] = None
...
update_forward_refs(TrendingGetTrendingCategoryResponse)
