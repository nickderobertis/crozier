...
from ...types.search_result_of_group_ban import SearchResultOfGroupBan


class GroupV2GetBannedMembersOfGroupResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[typing.Optional[SearchResultOfGroupBan], FieldMetadata(alias="Response")] = (
        None
    )
