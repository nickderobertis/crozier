...
from ...types.destiny_responses_destiny_vendors_response import DestinyResponsesDestinyVendorsResponse


class Destiny2GetVendorsResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[DestinyResponsesDestinyVendorsResponse], FieldMetadata(alias="Response")
    ] = None
