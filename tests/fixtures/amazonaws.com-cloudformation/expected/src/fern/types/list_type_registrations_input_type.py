...
class ListTypeRegistrationsInputType(str, enum.Enum):
    """
    ...
    def visit(
        ...
        if self is ListTypeRegistrationsInputType.RESOURCE:
            return resource()
        if self is ListTypeRegistrationsInputType.MODULE:
            return module()
        if self is ListTypeRegistrationsInputType.HOOK:
            return hook()
