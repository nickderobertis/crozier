...
class RawCurrencyConversionClient:
    ...
    def list_all_currency_conversion_for_user_monetary_account(
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"user/{jsonable_encoder(user_id)}/monetary-account/{jsonable_encoder(monetary_account_id)}/currency-conversion",
            method="GET",
    ...
    def read_currency_conversion_for_user_monetary_account(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"user/{jsonable_encoder(user_id)}/monetary-account/{jsonable_encoder(monetary_account_id)}/currency-conversion/{jsonable_encoder(item_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
