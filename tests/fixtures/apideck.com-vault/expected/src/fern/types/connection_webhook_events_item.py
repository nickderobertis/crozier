...
class ConnectionWebhookEventsItem(str, enum.Enum):
    ALL = "*"
    ...
    def visit(
        ...
        if self is ConnectionWebhookEventsItem.ALL:
            return all_()
        if self is ConnectionWebhookEventsItem.CRM_ACTIVITY_CREATED:
            return crm_activity_created()
        if self is ConnectionWebhookEventsItem.CRM_ACTIVITY_UPDATED:
            return crm_activity_updated()
        if self is ConnectionWebhookEventsItem.CRM_ACTIVITY_DELETED:
            return crm_activity_deleted()
        if self is ConnectionWebhookEventsItem.CRM_COMPANY_CREATED:
            return crm_company_created()
        if self is ConnectionWebhookEventsItem.CRM_COMPANY_UPDATED:
            return crm_company_updated()
        if self is ConnectionWebhookEventsItem.CRM_COMPANY_DELETED:
            return crm_company_deleted()
        if self is ConnectionWebhookEventsItem.CRM_CONTACT_CREATED:
            return crm_contact_created()
        if self is ConnectionWebhookEventsItem.CRM_CONTACT_UPDATED:
            return crm_contact_updated()
        if self is ConnectionWebhookEventsItem.CRM_CONTACT_DELETED:
            return crm_contact_deleted()
        if self is ConnectionWebhookEventsItem.CRM_LEAD_CREATED:
            return crm_lead_created()
        if self is ConnectionWebhookEventsItem.CRM_LEAD_UPDATED:
            return crm_lead_updated()
        if self is ConnectionWebhookEventsItem.CRM_LEAD_DELETED:
            return crm_lead_deleted()
        if self is ConnectionWebhookEventsItem.CRM_NOTE_CREATED:
            return crm_note_created()
        if self is ConnectionWebhookEventsItem.CRM_NOTES_UPDATED:
            return crm_notes_updated()
        if self is ConnectionWebhookEventsItem.CRM_NOTES_DELETED:
            return crm_notes_deleted()
        if self is ConnectionWebhookEventsItem.CRM_OPPORTUNITY_CREATED:
            return crm_opportunity_created()
        if self is ConnectionWebhookEventsItem.CRM_OPPORTUNITY_UPDATED:
            return crm_opportunity_updated()
        if self is ConnectionWebhookEventsItem.CRM_OPPORTUNITY_DELETED:
            return crm_opportunity_deleted()
        if self is ConnectionWebhookEventsItem.LEAD_LEAD_CREATED:
            return lead_lead_created()
        if self is ConnectionWebhookEventsItem.LEAD_LEAD_UPDATED:
            return lead_lead_updated()
        if self is ConnectionWebhookEventsItem.LEAD_LEAD_DELETED:
            return lead_lead_deleted()
        if self is ConnectionWebhookEventsItem.VAULT_CONNECTION_CREATED:
            return vault_connection_created()
        if self is ConnectionWebhookEventsItem.VAULT_CONNECTION_UPDATED:
            return vault_connection_updated()
        if self is ConnectionWebhookEventsItem.VAULT_CONNECTION_DISABLED:
            return vault_connection_disabled()
        if self is ConnectionWebhookEventsItem.VAULT_CONNECTION_DELETED:
            return vault_connection_deleted()
        if self is ConnectionWebhookEventsItem.VAULT_CONNECTION_CALLABLE:
            return vault_connection_callable()
        if self is ConnectionWebhookEventsItem.VAULT_CONNECTION_TOKEN_REFRESH_FAILED:
            return vault_connection_token_refresh_failed()
        if self is ConnectionWebhookEventsItem.ATS_JOB_CREATED:
            return ats_job_created()
        if self is ConnectionWebhookEventsItem.ATS_JOB_UPDATED:
            return ats_job_updated()
        if self is ConnectionWebhookEventsItem.ATS_JOB_DELETED:
            return ats_job_deleted()
        if self is ConnectionWebhookEventsItem.ATS_APPLICANT_CREATED:
            return ats_applicant_created()
        if self is ConnectionWebhookEventsItem.ATS_APPLICANT_UPDATED:
            return ats_applicant_updated()
        if self is ConnectionWebhookEventsItem.ATS_APPLICANT_DELETED:
            return ats_applicant_deleted()
        if self is ConnectionWebhookEventsItem.ACCOUNTING_CUSTOMER_CREATED:
            return accounting_customer_created()
        if self is ConnectionWebhookEventsItem.ACCOUNTING_CUSTOMER_UPDATED:
            return accounting_customer_updated()
        if self is ConnectionWebhookEventsItem.ACCOUNTING_CUSTOMER_DELETED:
            return accounting_customer_deleted()
        if self is ConnectionWebhookEventsItem.ACCOUNTING_INVOICE_CREATED:
            return accounting_invoice_created()
        if self is ConnectionWebhookEventsItem.ACCOUNTING_INVOICE_UPDATED:
            return accounting_invoice_updated()
        if self is ConnectionWebhookEventsItem.ACCOUNTING_INVOICE_DELETED:
            return accounting_invoice_deleted()
        if self is ConnectionWebhookEventsItem.ACCOUNTING_INVOICE_ITEM_CREATED:
            return accounting_invoice_item_created()
        if self is ConnectionWebhookEventsItem.ACCOUNTING_INVOICE_ITEM_UPDATED:
            return accounting_invoice_item_updated()
        if self is ConnectionWebhookEventsItem.ACCOUNTING_INVOICE_ITEM_DELETED:
            return accounting_invoice_item_deleted()
        if self is ConnectionWebhookEventsItem.ACCOUNTING_LEDGER_ACCOUNT_CREATED:
            return accounting_ledger_account_created()
        if self is ConnectionWebhookEventsItem.ACCOUNTING_LEDGER_ACCOUNT_UPDATED:
            return accounting_ledger_account_updated()
        if self is ConnectionWebhookEventsItem.ACCOUNTING_LEDGER_ACCOUNT_DELETED:
            return accounting_ledger_account_deleted()
        if self is ConnectionWebhookEventsItem.ACCOUNTING_TAX_RATE_CREATED:
            return accounting_tax_rate_created()
        if self is ConnectionWebhookEventsItem.ACCOUNTING_TAX_RATE_UPDATED:
            return accounting_tax_rate_updated()
        if self is ConnectionWebhookEventsItem.ACCOUNTING_TAX_RATE_DELETED:
            return accounting_tax_rate_deleted()
        if self is ConnectionWebhookEventsItem.ACCOUNTING_BILL_CREATED:
            return accounting_bill_created()
        if self is ConnectionWebhookEventsItem.ACCOUNTING_BILL_UPDATED:
            return accounting_bill_updated()
        if self is ConnectionWebhookEventsItem.ACCOUNTING_BILL_DELETED:
            return accounting_bill_deleted()
        if self is ConnectionWebhookEventsItem.ACCOUNTING_PAYMENT_CREATED:
            return accounting_payment_created()
        if self is ConnectionWebhookEventsItem.ACCOUNTING_PAYMENT_UPDATED:
            return accounting_payment_updated()
        if self is ConnectionWebhookEventsItem.ACCOUNTING_PAYMENT_DELETED:
            return accounting_payment_deleted()
        if self is ConnectionWebhookEventsItem.ACCOUNTING_SUPPLIER_CREATED:
            return accounting_supplier_created()
        if self is ConnectionWebhookEventsItem.ACCOUNTING_SUPPLIER_UPDATED:
            return accounting_supplier_updated()
        if self is ConnectionWebhookEventsItem.ACCOUNTING_SUPPLIER_DELETED:
            return accounting_supplier_deleted()
        if self is ConnectionWebhookEventsItem.POS_ORDER_CREATED:
            return pos_order_created()
        if self is ConnectionWebhookEventsItem.POS_ORDER_UPDATED:
            return pos_order_updated()
        if self is ConnectionWebhookEventsItem.POS_ORDER_DELETED:
            return pos_order_deleted()
        if self is ConnectionWebhookEventsItem.POS_PRODUCT_CREATED:
            return pos_product_created()
        if self is ConnectionWebhookEventsItem.POS_PRODUCT_UPDATED:
            return pos_product_updated()
        if self is ConnectionWebhookEventsItem.POS_PRODUCT_DELETED:
            return pos_product_deleted()
        if self is ConnectionWebhookEventsItem.POS_PAYMENT_CREATED:
            return pos_payment_created()
        if self is ConnectionWebhookEventsItem.POS_PAYMENT_UPDATED:
            return pos_payment_updated()
        if self is ConnectionWebhookEventsItem.POS_PAYMENT_DELETED:
            return pos_payment_deleted()
        if self is ConnectionWebhookEventsItem.POS_MERCHANT_CREATED:
            return pos_merchant_created()
        if self is ConnectionWebhookEventsItem.POS_MERCHANT_UPDATED:
            return pos_merchant_updated()
        if self is ConnectionWebhookEventsItem.POS_MERCHANT_DELETED:
            return pos_merchant_deleted()
        if self is ConnectionWebhookEventsItem.POS_LOCATION_CREATED:
            return pos_location_created()
        if self is ConnectionWebhookEventsItem.POS_LOCATION_UPDATED:
            return pos_location_updated()
        if self is ConnectionWebhookEventsItem.POS_LOCATION_DELETED:
            return pos_location_deleted()
        if self is ConnectionWebhookEventsItem.POS_ITEM_CREATED:
            return pos_item_created()
        if self is ConnectionWebhookEventsItem.POS_ITEM_UPDATED:
            return pos_item_updated()
        if self is ConnectionWebhookEventsItem.POS_ITEM_DELETED:
            return pos_item_deleted()
        if self is ConnectionWebhookEventsItem.POS_MODIFIER_CREATED:
            return pos_modifier_created()
        if self is ConnectionWebhookEventsItem.POS_MODIFIER_UPDATED:
            return pos_modifier_updated()
        if self is ConnectionWebhookEventsItem.POS_MODIFIER_DELETED:
            return pos_modifier_deleted()
        if self is ConnectionWebhookEventsItem.POS_MODIFIER_GROUP_CREATED:
            return pos_modifier_group_created()
        if self is ConnectionWebhookEventsItem.POS_MODIFIER_GROUP_UPDATED:
            return pos_modifier_group_updated()
        if self is ConnectionWebhookEventsItem.POS_MODIFIER_GROUP_DELETED:
            return pos_modifier_group_deleted()
        if self is ConnectionWebhookEventsItem.HRIS_EMPLOYEE_CREATED:
            return hris_employee_created()
        if self is ConnectionWebhookEventsItem.HRIS_EMPLOYEE_UPDATED:
            return hris_employee_updated()
        if self is ConnectionWebhookEventsItem.HRIS_EMPLOYEE_DELETED:
            return hris_employee_deleted()
        if self is ConnectionWebhookEventsItem.HRIS_COMPANY_CREATED:
            return hris_company_created()
        if self is ConnectionWebhookEventsItem.HRIS_COMPANY_UPDATED:
            return hris_company_updated()
        if self is ConnectionWebhookEventsItem.HRIS_COMPANY_DELETED:
            return hris_company_deleted()
        if self is ConnectionWebhookEventsItem.FILE_STORAGE_FILE_CREATED:
            return file_storage_file_created()
        if self is ConnectionWebhookEventsItem.FILE_STORAGE_FILE_UPDATED:
            return file_storage_file_updated()
        if self is ConnectionWebhookEventsItem.FILE_STORAGE_FILE_DELETED:
            return file_storage_file_deleted()
        if self is ConnectionWebhookEventsItem.ISSUE_TRACKING_TICKET_CREATED:
            return issue_tracking_ticket_created()
        if self is ConnectionWebhookEventsItem.ISSUE_TRACKING_TICKET_UPDATED:
            return issue_tracking_ticket_updated()
        if self is ConnectionWebhookEventsItem.ISSUE_TRACKING_TICKET_DELETED:
