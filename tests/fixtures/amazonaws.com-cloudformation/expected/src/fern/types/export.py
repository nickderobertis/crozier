...
class Export(UniversalBaseModel):
    ...
    exporting_stack_id: typing_extensions.Annotated[typing.Optional[str], FieldMetadata(alias="ExportingStackId")] = (
    ...
    value: typing_extensions.Annotated[typing.Optional[str], FieldMetadata(alias="Value")] = pydantic.Field(
        default=None
    )
    """
