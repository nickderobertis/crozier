...
class CreateDistributionRequestDistributionConfigCacheBehaviors(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[typing.List[CreateDistributionRequestDistributionConfigCacheBehaviorsItemsItem]],
