...
class RawPaymentBatchClient:
    ...
    def list_all_payment_batch_for_user_monetary_account(
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"user/{encode_path_param(user_id)}/monetary-account/{encode_path_param(monetary_account_id)}/payment-batch",
            method="GET",
    ...
    def read_payment_batch_for_user_monetary_account(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"user/{encode_path_param(user_id)}/monetary-account/{encode_path_param(monetary_account_id)}/payment-batch/{encode_path_param(item_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
