...
class PaymentsClient:
    ...
    def cancel_payment_by_idempotency_key(
        ...
        """
        _response = self._raw_client.cancel_payment_by_idempotency_key(
    ...
    def update_payment(
        ...
        *,
        ...
        """
        _response = self._raw_client.update_payment(
    ...
    def cancel_payment(
        ...
        """
        _response = self._raw_client.cancel_payment(payment_id, request_options=request_options)
        return _response.data
    ...
    def complete_payment(
        ...
        """
        _response = self._raw_client.complete_payment(payment_id, request_options=request_options)
        return _response.data
...
class AsyncPaymentsClient:
    ...
    async def cancel_payment_by_idempotency_key(
        ...
        async def main() -> None:
            await client.payments.cancel_payment_by_idempotency_key(
                idempotency_key="idempotency_key",
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.cancel_payment_by_idempotency_key(
            idempotency_key=idempotency_key, request_options=request_options
        )
        return _response.data
    ...
    async def update_payment(
        ...
        *,
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.update_payment(
            payment_id, idempotency_key=idempotency_key, payment=payment, request_options=request_options
        )
        return _response.data
    ...
    async def cancel_payment(
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.cancel_payment(payment_id, request_options=request_options)
        return _response.data
    ...
    async def complete_payment(
        ...
        async def main() -> None:
            await client.payments.complete_payment(
                payment_id="payment_id",
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.complete_payment(payment_id, request_options=request_options)
        return _response.data
