...
class StackInstanceSummaryStackInstanceStatus(UniversalBaseModel):
    """
    The detailed status of the stack instance.
    """

    detailed_status: typing_extensions.Annotated[
        typing.Optional[StackInstanceSummaryStackInstanceStatusDetailedStatus], FieldMetadata(alias="DetailedStatus")
