...
class FilterModelTimeRange_Absolute(UniversalBaseModel):
    """
    Time range
    """
...
class FilterModelTimeRange_Relative(UniversalBaseModel):
    """
    Time range
    """
...
class FilterModelTimeRange_ToNow(UniversalBaseModel):
    """
    Time range
    """
...
FilterModelTimeRange = typing_extensions.Annotated[
    typing.Union[FilterModelTimeRange_Absolute, FilterModelTimeRange_Relative, FilterModelTimeRange_ToNow],
