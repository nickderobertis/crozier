...
if typing.TYPE_CHECKING:
    ...
    from .podcasts.client import AsyncPodcastsClient, PodcastsClient
...
class FernApi:
    ...
    def __init__(
        ...
        *,
        ...
        self._podcasts: typing.Optional[PodcastsClient] = None
    ...
    def podcasts(self):
        if self._podcasts is None:
            from .podcasts.client import PodcastsClient

            self._podcasts = PodcastsClient(client_wrapper=self._client_wrapper)
...
class AsyncFernApi:
    ...
    def __init__(
        ...
        *,
        ...
        self._podcasts: typing.Optional[AsyncPodcastsClient] = None
    ...
    def podcasts(self):
        if self._podcasts is None:
            from .podcasts.client import AsyncPodcastsClient

            self._podcasts = AsyncPodcastsClient(client_wrapper=self._client_wrapper)
        return self._podcasts
