...
class CreateDistributionResultDistributionDistributionConfigCacheBehaviors(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[typing.List[CreateDistributionResultDistributionDistributionConfigCacheBehaviorsItemsItem]],
