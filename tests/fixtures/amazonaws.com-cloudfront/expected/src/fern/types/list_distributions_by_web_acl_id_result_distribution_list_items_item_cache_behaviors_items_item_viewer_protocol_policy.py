...
class ListDistributionsByWebAclIdResultDistributionListItemsItemCacheBehaviorsItemsItemViewerProtocolPolicy(
    enum.StrEnum
):
    """
    ...
    def visit(
        ...
        if (
            self
            is ListDistributionsByWebAclIdResultDistributionListItemsItemCacheBehaviorsItemsItemViewerProtocolPolicy.ALLOW_ALL
        ):
            return allow_all()
        if (
            self
            is ListDistributionsByWebAclIdResultDistributionListItemsItemCacheBehaviorsItemsItemViewerProtocolPolicy.HTTPS_ONLY
        ):
            return https_only()
        if (
            self
            is ListDistributionsByWebAclIdResultDistributionListItemsItemCacheBehaviorsItemsItemViewerProtocolPolicy.REDIRECT_TO_HTTPS
        ):
