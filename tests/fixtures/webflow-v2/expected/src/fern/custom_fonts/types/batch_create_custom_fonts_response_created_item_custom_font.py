...
class BatchCreateCustomFontsResponseCreatedItemCustomFont(UniversalBaseModel):
    """
    ...
    format: typing.Optional[BatchCreateCustomFontsResponseCreatedItemCustomFontFormat] = pydantic.Field(default=None)
    """
    ...
    axes: typing.List[BatchCreateCustomFontsResponseCreatedItemCustomFontAxesItem] = pydantic.Field()
    """
