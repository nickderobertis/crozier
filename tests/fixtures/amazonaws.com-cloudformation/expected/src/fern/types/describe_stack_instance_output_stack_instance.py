...
class DescribeStackInstanceOutputStackInstance(UniversalBaseModel):
    """
    ...
    stack_set_id: typing_extensions.Annotated[
        ...
        pydantic.Field(
            alias="StackSetId",
            description="The name or unique ID of the stack set that the stack instance is associated with.",
        ),
    ] = None
    """
    ...
    region: typing_extensions.Annotated[
        ...
        pydantic.Field(
            alias="Region",
            description="The name of the Amazon Web Services Region that the stack instance is associated with.",
        ),
    ] = None
    """
    ...
    account: typing_extensions.Annotated[
        ...
        pydantic.Field(
            alias="Account",
            description="[Self-managed permissions] The name of the Amazon Web Services account that the stack instance is associated with.",
        ),
    ] = None
    """
    ...
    stack_id: typing_extensions.Annotated[
        ...
        pydantic.Field(alias="StackId", description="The ID of the stack instance."),
    ] = None
    """
    ...
    parameter_overrides: typing_extensions.Annotated[
        ...
        pydantic.Field(
            ...
            description="A list of parameters from the stack set template whose values have been overridden in this stack instance.",
        ),
    ] = None
    """
    ...
    status: typing_extensions.Annotated[
        typing.Optional[DescribeStackInstanceOutputStackInstanceStatus],
    ...
    stack_instance_status: typing_extensions.Annotated[
        typing.Optional[DescribeStackInstanceOutputStackInstanceStackInstanceStatus],
        FieldMetadata(alias="StackInstanceStatus"),
        pydantic.Field(alias="StackInstanceStatus", description="The detailed status of the stack instance."),
    ] = None
    """
    ...
    status_reason: typing_extensions.Annotated[
        ...
        pydantic.Field(
            alias="StatusReason",
            description="The explanation for the specific status code that's assigned to this stack instance.",
        ),
    ] = None
    """
    ...
    last_drift_check_timestamp: typing_extensions.Annotated[
        ...
        pydantic.Field(
            ...
            description="Most recent time when CloudFormation performed a drift detection operation on the stack instance. This value will be <code>NULL</code> for any stack instance on which drift detection hasn't yet been performed.",
        ),
    ] = None
    """
    ...
    last_operation_id: typing_extensions.Annotated[
        typing.Optional[str],
        FieldMetadata(alias="LastOperationId"),
        pydantic.Field(
            alias="LastOperationId",
            description="The last unique ID of a StackSet operation performed on a stack instance.",
        ),
    ] = None
    """
