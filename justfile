...
test-corpus-match:
    ...
    CROZIER_TEST_FETCHED_CORPUS=1 "$(./scripts/census-python.sh)" tests/surface_census_test.py ConjunctionCensusTests.test_case_11_is_absent_from_the_registered_corpus
