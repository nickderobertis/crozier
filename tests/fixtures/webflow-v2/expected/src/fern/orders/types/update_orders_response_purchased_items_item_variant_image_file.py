...
class UpdateOrdersResponsePurchasedItemsItemVariantImageFile(UniversalBaseModel):
    ...
    variants: typing.Optional[typing.List[UpdateOrdersResponsePurchasedItemsItemVariantImageFileVariantsItem]] = (
