...
class RemoteNetworksIpsecTunnelBgp(UniversalBaseModel):
    bgp_peer: typing.Optional[RemoteNetworksIpsecTunnelBgpBgpPeer] = None
    ...
    peering_type: typing.Optional[RemoteNetworksIpsecTunnelBgpPeeringType] = pydantic.Field(default=None)
    """
