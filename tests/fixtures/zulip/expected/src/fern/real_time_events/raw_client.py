...
from .types.register_queue_request_idle_queue_timeout import RegisterQueueRequestIdleQueueTimeout
...
class RawRealTimeEventsClient:
    ...
    def register_queue(
        ...
        *,
        ...
        idle_queue_timeout: typing.Optional[RegisterQueueRequestIdleQueueTimeout] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[RegisterQueueResponse]:
        """
        ...
        **Changes**: New in Zulip 12.0 (feature level 481),
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            data={
                ...
                "narrow": narrow,
                "idle_queue_timeout": convert_and_respect_annotation_metadata(
                    object_=idle_queue_timeout, annotation=RegisterQueueRequestIdleQueueTimeout, direction="write"
                ),
            },
            headers={
                "content-type": "application/x-www-form-urlencoded",
    ...
    def rest_error_handling(self, *, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[None]:
        """
...
class AsyncRawRealTimeEventsClient:
    ...
    async def register_queue(
        ...
        *,
        ...
        idle_queue_timeout: typing.Optional[RegisterQueueRequestIdleQueueTimeout] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[RegisterQueueResponse]:
        """
        This powerful endpoint can be used to register a Zulip "event queue"
        (subscribed to certain types of "events", or updates to the messages
        and other Zulip data the current user has access to), as well as to
