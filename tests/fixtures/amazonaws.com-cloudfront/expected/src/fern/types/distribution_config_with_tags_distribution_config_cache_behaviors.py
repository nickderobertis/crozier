...
class DistributionConfigWithTagsDistributionConfigCacheBehaviors(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[typing.List[DistributionConfigWithTagsDistributionConfigCacheBehaviorsItemsItem]],
