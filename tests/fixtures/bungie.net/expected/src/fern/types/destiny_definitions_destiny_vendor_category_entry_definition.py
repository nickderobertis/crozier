...
class DestinyDefinitionsDestinyVendorCategoryEntryDefinition(UniversalBaseModel):
    ...
    buy_string_override: typing_extensions.Annotated[typing.Optional[str], FieldMetadata(alias="buyStringOverride")] = (
    ...
    disabled_description: typing_extensions.Annotated[
        typing.Optional[str], FieldMetadata(alias="disabledDescription")
    ] = pydantic.Field(default=None)
    """
    ...
    hide_from_regular_purchase: typing_extensions.Annotated[
        typing.Optional[bool], FieldMetadata(alias="hideFromRegularPurchase")
    ] = pydantic.Field(default=None)
    """
    True if this category doesn't allow purchases.
    """

    hide_if_no_currency: typing_extensions.Annotated[typing.Optional[bool], FieldMetadata(alias="hideIfNoCurrency")] = (
        pydantic.Field(default=None)
    )
    """
    ...
    is_display_only: typing_extensions.Annotated[typing.Optional[bool], FieldMetadata(alias="isDisplayOnly")] = (
        pydantic.Field(default=None)
    )
    """
    ...
    is_preview: typing_extensions.Annotated[typing.Optional[bool], FieldMetadata(alias="isPreview")] = pydantic.Field(
        default=None
    )
    """
    ...
    quantity_available: typing_extensions.Annotated[typing.Optional[int], FieldMetadata(alias="quantityAvailable")] = (
        pydantic.Field(default=None)
    )
    """
    ...
    reset_interval_minutes_override: typing_extensions.Annotated[
        typing.Optional[int], FieldMetadata(alias="resetIntervalMinutesOverride")
    ] = None
    reset_offset_minutes_override: typing_extensions.Annotated[
        typing.Optional[int], FieldMetadata(alias="resetOffsetMinutesOverride")
    ] = None
    show_unavailable_items: typing_extensions.Annotated[
        typing.Optional[bool], FieldMetadata(alias="showUnavailableItems")
    ] = pydantic.Field(default=None)
    """
