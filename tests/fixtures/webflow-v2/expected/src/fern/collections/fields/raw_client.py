...
class RawFieldsClient:
    ...
    def create(
        ...
        *,
    ...
    ) -> HttpResponse[CreateFieldsResponse]:
        """
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"collections/{encode_path_param(collection_id)}/fields",
            base_url=self._client_wrapper.get_environment().base,
            method="POST",
            json=convert_and_respect_annotation_metadata(
                object_=request, annotation=CreateFieldsRequestBody, direction="write"
            ),
            headers={
    ...
    def delete(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"collections/{encode_path_param(collection_id)}/fields/{encode_path_param(field_id)}",
            base_url=self._client_wrapper.get_environment().base,
            method="DELETE",
            request_options=request_options,
        )
    ...
    def update(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[UpdateFieldsResponse]:
        """
...
class AsyncRawFieldsClient:
    ...
    async def create(
        ...
        *,
        request: CreateFieldsRequestBody,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[CreateFieldsResponse]:
        """
        Create a custom field in a collection.
    ...
    async def update(
        ...
        *,
        ...
        help_text: typing.Optional[str] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[UpdateFieldsResponse]:
        """
        Update a custom field in a collection.
