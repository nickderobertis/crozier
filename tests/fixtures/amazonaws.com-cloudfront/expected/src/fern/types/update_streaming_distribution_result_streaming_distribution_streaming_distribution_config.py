...
class UpdateStreamingDistributionResultStreamingDistributionStreamingDistributionConfig(UniversalBaseModel):
    """
    ...
    aliases: typing_extensions.Annotated[
        typing.Optional[UpdateStreamingDistributionResultStreamingDistributionStreamingDistributionConfigAliases],
    ...
    logging: typing_extensions.Annotated[
        typing.Optional[UpdateStreamingDistributionResultStreamingDistributionStreamingDistributionConfigLogging],
    ...
    price_class: typing_extensions.Annotated[
        typing.Optional[UpdateStreamingDistributionResultStreamingDistributionStreamingDistributionConfigPriceClass],
