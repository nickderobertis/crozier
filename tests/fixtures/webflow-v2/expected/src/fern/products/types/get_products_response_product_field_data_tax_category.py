...
class GetProductsResponseProductFieldDataTaxCategory(enum.StrEnum):
    """
    Product tax class
    """
    ...
    def visit(
        ...
        if self is GetProductsResponseProductFieldDataTaxCategory.STANDARD_TAXABLE:
            return standard_taxable()
        if self is GetProductsResponseProductFieldDataTaxCategory.STANDARD_EXEMPT:
            return standard_exempt()
        if self is GetProductsResponseProductFieldDataTaxCategory.BOOKS_RELIGIOUS:
            return books_religious()
        if self is GetProductsResponseProductFieldDataTaxCategory.BOOKS_TEXTBOOK:
            return books_textbook()
        if self is GetProductsResponseProductFieldDataTaxCategory.CLOTHING:
            return clothing()
        if self is GetProductsResponseProductFieldDataTaxCategory.CLOTHING_SWIMWEAR:
            return clothing_swimwear()
        if self is GetProductsResponseProductFieldDataTaxCategory.DIGITAL_GOODS:
            return digital_goods()
        if self is GetProductsResponseProductFieldDataTaxCategory.DIGITAL_SERVICE:
            return digital_service()
        if self is GetProductsResponseProductFieldDataTaxCategory.DRUGS_NON_PRESCRIPTION:
            return drugs_non_prescription()
        if self is GetProductsResponseProductFieldDataTaxCategory.DRUGS_PRESCRIPTION:
            return drugs_prescription()
        if self is GetProductsResponseProductFieldDataTaxCategory.FOOD_BOTTLED_WATER:
            return food_bottled_water()
        if self is GetProductsResponseProductFieldDataTaxCategory.FOOD_CANDY:
            return food_candy()
        if self is GetProductsResponseProductFieldDataTaxCategory.FOOD_GROCERIES:
            return food_groceries()
        if self is GetProductsResponseProductFieldDataTaxCategory.FOOD_PREPARED:
            return food_prepared()
        if self is GetProductsResponseProductFieldDataTaxCategory.FOOD_SODA:
            return food_soda()
        if self is GetProductsResponseProductFieldDataTaxCategory.FOOD_SUPPLEMENTS:
            return food_supplements()
        if self is GetProductsResponseProductFieldDataTaxCategory.MAGAZINE_INDIVIDUAL:
            return magazine_individual()
        if self is GetProductsResponseProductFieldDataTaxCategory.MAGAZINE_SUBSCRIPTION:
            return magazine_subscription()
        if self is GetProductsResponseProductFieldDataTaxCategory.SERVICE_ADMISSION:
            return service_admission()
        if self is GetProductsResponseProductFieldDataTaxCategory.SERVICE_ADVERTISING:
            return service_advertising()
        if self is GetProductsResponseProductFieldDataTaxCategory.SERVICE_DRY_CLEANING:
            return service_dry_cleaning()
        if self is GetProductsResponseProductFieldDataTaxCategory.SERVICE_HAIRDRESSING:
            return service_hairdressing()
        if self is GetProductsResponseProductFieldDataTaxCategory.SERVICE_INSTALLATION:
            return service_installation()
        if self is GetProductsResponseProductFieldDataTaxCategory.SERVICE_MISCELLANEOUS:
            return service_miscellaneous()
        if self is GetProductsResponseProductFieldDataTaxCategory.SERVICE_PARKING:
            return service_parking()
        if self is GetProductsResponseProductFieldDataTaxCategory.SERVICE_PRINTING:
            return service_printing()
        if self is GetProductsResponseProductFieldDataTaxCategory.SERVICE_PROFESSIONAL:
            return service_professional()
        if self is GetProductsResponseProductFieldDataTaxCategory.SERVICE_REPAIR:
            return service_repair()
        if self is GetProductsResponseProductFieldDataTaxCategory.SERVICE_TRAINING:
