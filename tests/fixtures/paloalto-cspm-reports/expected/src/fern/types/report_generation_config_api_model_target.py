...
from .report_generation_config_api_model_target_time_range import ReportGenerationConfigApiModelTargetTimeRange


class ReportGenerationConfigApiModelTarget(UniversalBaseModel):
    """
    Report definition
    """
