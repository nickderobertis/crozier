...
class LibraryCreationDtoSeriesCover(enum.StrEnum):
    FIRST = "FIRST"
    ...
    def visit(
        ...
        if self is LibraryCreationDtoSeriesCover.FIRST:
            return first()
        if self is LibraryCreationDtoSeriesCover.FIRST_UNREAD_OR_FIRST:
            return first_unread_or_first()
        if self is LibraryCreationDtoSeriesCover.FIRST_UNREAD_OR_LAST:
            return first_unread_or_last()
        if self is LibraryCreationDtoSeriesCover.LAST:
            return last()
