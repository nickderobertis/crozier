...
class UpdateStackSetInputDeploymentTargets(UniversalBaseModel):
    """
    ...
    account_filter_type: typing_extensions.Annotated[
        typing.Optional[UpdateStackSetInputDeploymentTargetsAccountFilterType], FieldMetadata(alias="AccountFilterType")
    ] = pydantic.Field(default=None)
    """
