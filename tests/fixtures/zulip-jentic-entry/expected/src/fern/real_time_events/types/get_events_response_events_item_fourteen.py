...
class GetEventsResponseEventsItemFourteen(UniversalBaseModel):
    """
    ...
    **Changes**: Prior to Zulip 11.0 (feature level 378), this
    ...
    type: typing.Optional[GetEventsResponseEventsItemFourteenType] = pydantic.Field(default=None)
    """
    The event's type, relevant both for client-side dispatch and server-side
    filtering by event type in [POST /register](/api/register-queue).
    """

    op: typing.Optional[GetEventsResponseEventsItemFourteenOp] = None
