...
class DestinyDefinitionsDestinyItemGearsetBlockDefinition(UniversalBaseModel):
    ...
    tracking_value_max: typing_extensions.Annotated[
        typing.Optional[int],
        FieldMetadata(alias="trackingValueMax"),
        pydantic.Field(
            alias="trackingValueMax", description="The maximum possible number of items that can be collected."
        ),
    ] = None
    """
