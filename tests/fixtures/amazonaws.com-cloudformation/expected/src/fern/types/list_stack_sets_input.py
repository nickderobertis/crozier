...
class ListStackSetsInput(UniversalBaseModel):
    ...
    status: typing_extensions.Annotated[typing.Optional[ListStackSetsInputStatus], FieldMetadata(alias="Status")] = (
    ...
    call_as: typing_extensions.Annotated[typing.Optional[ListStackSetsInputCallAs], FieldMetadata(alias="CallAs")] = (
        pydantic.Field(default=None)
    )
    """
