...
class FernApi:
    ...
    def get_holder(self, *, request_options: typing.Optional[RequestOptions] = None) -> Holder:
        """
        Parameters
        ----------
...
class AsyncFernApi:
    ...
    async def get_holder(self, *, request_options: typing.Optional[RequestOptions] = None) -> Holder:
        """
        Parameters
        ----------
        request_options : typing.Optional[RequestOptions]
