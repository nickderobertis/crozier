...
class ModifyMessageRequestBody_SystemMessage(UniversalBaseModel):
...
class ModifyMessageRequestBody_UserMessage(UniversalBaseModel):
...
class ModifyMessageRequestBody_ReasoningMessage(UniversalBaseModel):
...
class ModifyMessageRequestBody_AssistantMessage(UniversalBaseModel):
...
ModifyMessageRequestBody = typing_extensions.Annotated[
    typing.Union[
