...
class UpdateStreamingDistributionResultStreamingDistributionActiveTrustedSigners(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[
            typing.List[UpdateStreamingDistributionResultStreamingDistributionActiveTrustedSignersItemsItem]
        ],
