...
class EnquiryWithJobIds(UniversalBaseModel):
    id: float
    name: str
    ...
    job_ids: typing_extensions.Annotated[
        typing.List[typing.Optional[float]], FieldMetadata(alias="jobIds"), pydantic.Field(alias="jobIds")
    ]
