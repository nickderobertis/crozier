...
class PatchCollectionsResponseFieldsItem(UniversalBaseModel):
    """
    ...
    type: PatchCollectionsResponseFieldsItemType = pydantic.Field()
    """
    ...
    validations: typing.Optional[PatchCollectionsResponseFieldsItemValidations] = pydantic.Field(default=None)
    """
