...
class RawApisClient:
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            params={
                ...
                "filter": convert_and_respect_annotation_metadata(
                    object_=filter, annotation=ApisFilter, direction="write"
                ),
            },
    ...
    def one(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[GetApiResponse]:
        """
        Get API
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"connector/apis/{encode_path_param(id)}",
            method="GET",
            request_options=request_options,
        )
        try:
...
class AsyncRawApisClient:
    ...
    async def all_(
        ...
        *,
        ...
        filter: typing.Optional[ApisFilter] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[GetApisResponse]:
        """
        List APIs
    ...
    ) -> AsyncHttpResponse[GetApiResponse]:
        """
        Get API
