...
class ApplicationCommandSubcommandOptionResponse(UniversalBaseModel):
    type: int
    name: str
    ...
    options: typing.Optional[typing.List[ApplicationCommandSubcommandOptionResponseOptionsItem]] = None
