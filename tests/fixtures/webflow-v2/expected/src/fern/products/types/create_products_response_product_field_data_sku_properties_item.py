...
class CreateProductsResponseProductFieldDataSkuPropertiesItem(UniversalBaseModel):
    """
    ...
    enum: typing.List[CreateProductsResponseProductFieldDataSkuPropertiesItemEnumItem] = pydantic.Field()
    """
