...
class DescribeStackSetOperationOutputStackSetOperationOperationPreferences(UniversalBaseModel):
    """
    The preferences for how CloudFormation performs this stack set operation.
    """

    region_concurrency_type: typing_extensions.Annotated[
        typing.Optional[DescribeStackSetOperationOutputStackSetOperationOperationPreferencesRegionConcurrencyType],
