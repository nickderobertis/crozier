...
class V1WebhooksUpdateWebhookSubscriptionsItem(enum.StrEnum):
    ...
    def visit(
        ...
        if self is V1WebhooksUpdateWebhookSubscriptionsItem.FORECASTS_CREATED:
            return forecasts_created()
        if self is V1WebhooksUpdateWebhookSubscriptionsItem.FORECASTS_UPDATED:
            return forecasts_updated()
        if self is V1WebhooksUpdateWebhookSubscriptionsItem.FORECASTS_DELETED:
            return forecasts_deleted()
        if self is V1WebhooksUpdateWebhookSubscriptionsItem.HOURS_CREATED:
            return hours_created()
        if self is V1WebhooksUpdateWebhookSubscriptionsItem.HOURS_UPDATED:
            return hours_updated()
        if self is V1WebhooksUpdateWebhookSubscriptionsItem.HOURS_DELETED:
            return hours_deleted()
        if self is V1WebhooksUpdateWebhookSubscriptionsItem.LABELS_CREATED:
            return labels_created()
        if self is V1WebhooksUpdateWebhookSubscriptionsItem.LABELS_UPDATED:
            return labels_updated()
        if self is V1WebhooksUpdateWebhookSubscriptionsItem.LABELS_DELETED:
            return labels_deleted()
        if self is V1WebhooksUpdateWebhookSubscriptionsItem.PROJECTS_CREATED:
            return projects_created()
        if self is V1WebhooksUpdateWebhookSubscriptionsItem.PROJECTS_UPDATED:
            return projects_updated()
        if self is V1WebhooksUpdateWebhookSubscriptionsItem.PROJECTS_DELETED:
