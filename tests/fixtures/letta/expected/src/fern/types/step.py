...
class Step(UniversalBaseModel):
    ...
    completion_tokens_details: typing.Optional[typing.Dict[str, typing.Any]] = pydantic.Field(default=None)
    """
    Detailed completion token breakdown (e.g., reasoning_tokens).
    """

    prompt_tokens_details: typing.Optional[typing.Dict[str, typing.Any]] = pydantic.Field(default=None)
    """
    ...
    error_data: typing.Optional[typing.Dict[str, typing.Any]] = pydantic.Field(default=None)
    """
