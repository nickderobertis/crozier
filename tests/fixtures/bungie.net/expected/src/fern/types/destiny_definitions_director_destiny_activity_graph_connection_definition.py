...
class DestinyDefinitionsDirectorDestinyActivityGraphConnectionDefinition(UniversalBaseModel):
    ...
    dest_node_hash: typing_extensions.Annotated[typing.Optional[int], FieldMetadata(alias="destNodeHash")] = None
    source_node_hash: typing_extensions.Annotated[typing.Optional[int], FieldMetadata(alias="sourceNodeHash")] = None
