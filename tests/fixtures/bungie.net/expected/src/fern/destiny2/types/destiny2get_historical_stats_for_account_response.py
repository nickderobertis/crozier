...
from ...types.destiny_historical_stats_destiny_historical_stats_account_result import (
    DestinyHistoricalStatsDestinyHistoricalStatsAccountResult,
)


class Destiny2GetHistoricalStatsForAccountResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[DestinyHistoricalStatsDestinyHistoricalStatsAccountResult], FieldMetadata(alias="Response")
    ] = None
