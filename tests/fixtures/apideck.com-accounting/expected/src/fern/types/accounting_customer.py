...
class AccountingCustomer(UniversalBaseModel):
    ...
    parent: typing.Optional[LinkedParentCustomer] = None
    phone_numbers: typing.Optional[typing.List[PhoneNumber]] = None
    project: typing.Optional[bool] = pydantic.Field(default=None)
    """
    If true, indicates this is a Project.
    """

    row_version: typing.Optional[RowVersion] = None
    status: typing.Optional[AccountingCustomerStatus] = pydantic.Field(default=None)
    """
    Customer status
    """
