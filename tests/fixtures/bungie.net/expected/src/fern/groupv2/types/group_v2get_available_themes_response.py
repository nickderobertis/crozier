...
from ...types.config_group_theme import ConfigGroupTheme


class GroupV2GetAvailableThemesResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[typing.List[ConfigGroupTheme]], FieldMetadata(alias="Response")
    ] = None
