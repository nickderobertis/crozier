...
class OauthScope(enum.StrEnum):
    ...
    def visit(
        ...
        comments_read: typing.Callable[[], T_Result],
        comments_write: typing.Callable[[], T_Result],
        ...
        components_read: typing.Callable[[], T_Result],
        components_write: typing.Callable[[], T_Result],
        ...
        if self is OauthScope.CMS_WRITE:
            return cms_write()
        if self is OauthScope.COMMENTS_READ:
            return comments_read()
        if self is OauthScope.COMMENTS_WRITE:
        ...
        if self is OauthScope.PAGES_WRITE:
            return pages_write()
        if self is OauthScope.COMPONENTS_READ:
            return components_read()
        if self is OauthScope.COMPONENTS_WRITE:
            return components_write()
