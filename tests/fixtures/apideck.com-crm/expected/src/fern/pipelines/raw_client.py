...
class RawPipelinesClient:
    ...
    ) -> HttpResponse[GetPipelinesResponse]:
        """
        List pipelines
    ...
    def add(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[CreatePipelineResponse]:
        """
        Create pipeline
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                ...
                "stages": convert_and_respect_annotation_metadata(
                    object_=stages, annotation=typing.Sequence[PipelineStagesItem], direction="write"
                ),
    ...
    def one(
        ...
        *,
        ...
        fields: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[GetPipelineResponse]:
        """
        Get pipeline
    ...
    ) -> HttpResponse[DeletePipelineResponse]:
        """
        Delete pipeline
    ...
    def update(
        ...
        *,
        ...
        win_probability_enabled: typing.Optional[bool] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[UpdatePipelineResponse]:
        """
        Update pipeline
...
class AsyncRawPipelinesClient:
    ...
    async def all_(
        ...
        *,
        ...
        fields: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[GetPipelinesResponse]:
        """
        List pipelines
    ...
    async def add(
        ...
        *,
        ...
        win_probability_enabled: typing.Optional[bool] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[CreatePipelineResponse]:
        """
        Create pipeline
    ...
    async def one(
        ...
        *,
        ...
        fields: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[GetPipelineResponse]:
        """
        Get pipeline
    ...
    async def delete(
        self, id: str, *, raw: typing.Optional[bool] = None, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[DeletePipelineResponse]:
        """
        Delete pipeline
    ...
    async def update(
        ...
        *,
        ...
        win_probability_enabled: typing.Optional[bool] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[UpdatePipelineResponse]:
        """
        Update pipeline
