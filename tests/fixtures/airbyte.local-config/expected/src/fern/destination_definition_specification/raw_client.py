...
class RawDestinationDefinitionSpecificationClient:
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=DestinationDefinitionSpecificationRead,
...
class AsyncRawDestinationDefinitionSpecificationClient:
    ...
    async def get_destination_definition_specification(
        ...
        *,
        ...
        workspace_id: WorkspaceId,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[DestinationDefinitionSpecificationRead]:
        """
        Parameters
        ----------
        destination_definition_id : DestinationDefinitionId
