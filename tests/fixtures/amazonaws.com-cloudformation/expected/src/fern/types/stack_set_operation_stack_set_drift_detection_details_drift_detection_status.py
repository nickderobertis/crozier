...
class StackSetOperationStackSetDriftDetectionDetailsDriftDetectionStatus(str, enum.Enum):
    """
    ...
    def visit(
        ...
        if self is StackSetOperationStackSetDriftDetectionDetailsDriftDetectionStatus.COMPLETED:
            return completed()
        if self is StackSetOperationStackSetDriftDetectionDetailsDriftDetectionStatus.FAILED:
            return failed()
        if self is StackSetOperationStackSetDriftDetectionDetailsDriftDetectionStatus.PARTIAL_SUCCESS:
            return partial_success()
        if self is StackSetOperationStackSetDriftDetectionDetailsDriftDetectionStatus.IN_PROGRESS:
            return in_progress()
        if self is StackSetOperationStackSetDriftDetectionDetailsDriftDetectionStatus.STOPPED:
            return stopped()
