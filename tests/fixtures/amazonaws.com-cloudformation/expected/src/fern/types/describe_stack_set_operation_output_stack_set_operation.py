...
class DescribeStackSetOperationOutputStackSetOperation(UniversalBaseModel):
    """
    ...
    operation_id: typing_extensions.Annotated[
        ...
        pydantic.Field(alias="OperationId", description="The unique ID of a stack set operation."),
    ] = None
    """
    ...
    operation_preferences: typing_extensions.Annotated[
        typing.Optional[DescribeStackSetOperationOutputStackSetOperationOperationPreferences],
        FieldMetadata(alias="OperationPreferences"),
        pydantic.Field(
            alias="OperationPreferences",
            description="The preferences for how CloudFormation performs this stack set operation.",
        ),
    ] = None
    """
    ...
    retain_stacks: typing_extensions.Annotated[
        ...
        pydantic.Field(
            alias="RetainStacks",
            description="For stack set operations of action type <code>DELETE</code>, specifies whether to remove the stack instances from the specified stack set, but doesn't delete the stacks. You can't re-associate a retained stack, or add an existing, saved stack to a new stack set.",
        ),
    ] = None
    """
    ...
    deployment_targets: typing_extensions.Annotated[
        typing.Optional[DescribeStackSetOperationOutputStackSetOperationDeploymentTargets],
        FieldMetadata(alias="DeploymentTargets"),
        pydantic.Field(
            alias="DeploymentTargets",
            description="[Service-managed permissions] The Organizations accounts affected by the stack operation.",
        ),
    ] = None
    """
    ...
    stack_set_drift_detection_details: typing_extensions.Annotated[
        typing.Optional[DescribeStackSetOperationOutputStackSetOperationStackSetDriftDetectionDetails],
    ...
    status_details: typing_extensions.Annotated[
        typing.Optional[DescribeStackSetOperationOutputStackSetOperationStatusDetails],
        FieldMetadata(alias="StatusDetails"),
        pydantic.Field(alias="StatusDetails", description="Detailed information about the StackSet operation."),
    ] = None
    """
