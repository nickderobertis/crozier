...
| 78 | `xtrf.eu` | api-guru | https://api.apis.guru/v2/specs/xtrf.eu/2.0/openapi.json | `2.0` | Apache 2.0 | link-ok | XTRF Home Portal API with five inline-object `default` error response bodies |
