...
class GetProductsResponseSkusItemFieldData(UniversalBaseModel):
    """
    ...
    price: GetProductsResponseSkusItemFieldDataPrice = pydantic.Field()
    """
    price of SKU
    """

    compare_at_price: typing_extensions.Annotated[
        typing.Optional[GetProductsResponseSkusItemFieldDataCompareAtPrice],
    ...
    ec_sku_billing_method: typing_extensions.Annotated[
        typing.Optional[GetProductsResponseSkusItemFieldDataEcSkuBillingMethod],
    ...
    ec_sku_subscription_plan: typing_extensions.Annotated[
        typing.Optional[GetProductsResponseSkusItemFieldDataEcSkuSubscriptionPlan],
    ...
    sku_properties: typing_extensions.Annotated[
        typing.Optional[typing.List[GetProductsResponseSkusItemFieldDataSkuPropertiesItem]],
