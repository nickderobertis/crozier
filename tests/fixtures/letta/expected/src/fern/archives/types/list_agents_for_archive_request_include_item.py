...
class ListAgentsForArchiveRequestIncludeItem(enum.StrEnum):
    ...
    def visit(
        ...
        if self is ListAgentsForArchiveRequestIncludeItem.AGENT_BLOCKS:
            return agent_blocks()
        if self is ListAgentsForArchiveRequestIncludeItem.AGENT_IDENTITIES:
            return agent_identities()
        if self is ListAgentsForArchiveRequestIncludeItem.AGENT_MANAGED_GROUP:
            return agent_managed_group()
        if self is ListAgentsForArchiveRequestIncludeItem.AGENT_PENDING_APPROVAL:
            return agent_pending_approval()
        if self is ListAgentsForArchiveRequestIncludeItem.AGENT_SECRETS:
            return agent_secrets()
        if self is ListAgentsForArchiveRequestIncludeItem.AGENT_SOURCES:
            return agent_sources()
        if self is ListAgentsForArchiveRequestIncludeItem.AGENT_TAGS:
            return agent_tags()
        if self is ListAgentsForArchiveRequestIncludeItem.AGENT_TOOLS:
            return agent_tools()
