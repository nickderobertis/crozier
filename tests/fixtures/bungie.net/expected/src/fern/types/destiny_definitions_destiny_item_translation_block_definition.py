...
class DestinyDefinitionsDestinyItemTranslationBlockDefinition(UniversalBaseModel):
    ...
    default_dyes: typing_extensions.Annotated[
        typing.Optional[typing.List[DestinyDyeReference]], FieldMetadata(alias="defaultDyes")
    ] = None
    has_geometry: typing_extensions.Annotated[typing.Optional[bool], FieldMetadata(alias="hasGeometry")] = None
    locked_dyes: typing_extensions.Annotated[
        typing.Optional[typing.List[DestinyDyeReference]], FieldMetadata(alias="lockedDyes")
    ] = None
    weapon_pattern_hash: typing_extensions.Annotated[typing.Optional[int], FieldMetadata(alias="weaponPatternHash")] = (
        None
    )
    weapon_pattern_identifier: typing_extensions.Annotated[
        typing.Optional[str], FieldMetadata(alias="weaponPatternIdentifier")
    ] = None
