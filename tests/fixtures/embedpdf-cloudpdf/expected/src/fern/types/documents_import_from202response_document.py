...
class DocumentsImportFrom202ResponseDocument(UniversalBaseModel):
    id: str
    tenant_id: typing_extensions.Annotated[str, FieldMetadata(alias="tenantId"), pydantic.Field(alias="tenantId")]
    state: DocumentsImportFrom202ResponseDocumentState
    ...
    thumbnail_state: typing_extensions.Annotated[
        typing.Optional[DocumentsImportFrom202ResponseDocumentThumbnailState],
