...
class AuthClient_Oa1TwoLegged(UniversalBaseModel):
...
class AuthClient_Oa1ThreeLegged(UniversalBaseModel):
...
class AuthClient_Oa2AuthorizationCode(UniversalBaseModel):
...
class AuthClient_SessionAuth(UniversalBaseModel):
...
AuthClient = typing_extensions.Annotated[
    typing.Union[
        AuthClient_Oa1TwoLegged, AuthClient_Oa1ThreeLegged, AuthClient_Oa2AuthorizationCode, AuthClient_SessionAuth
    ],
