...
from .post_links_examples_response_links_item_split_urlv2item import PostLinksExamplesResponseLinksItemSplitUrlv2Item
...
class PostLinksExamplesResponseLinksItem(UniversalBaseModel):
    ...
    expires_at: typing_extensions.Annotated[
        typing.Optional[PostLinksExamplesResponseLinksItemExpiresAt],
    ...
    ttl: typing.Optional[PostLinksExamplesResponseLinksItemTtl] = pydantic.Field(default=None)
    """
    ...
    split_urlv2: typing_extensions.Annotated[
        typing.Optional[typing.List[PostLinksExamplesResponseLinksItemSplitUrlv2Item]],
    ...
    redirect_type: typing_extensions.Annotated[
        typing.Optional[PostLinksExamplesResponseLinksItemRedirectType],
    ...
    source: typing.Optional[PostLinksExamplesResponseLinksItemSource] = pydantic.Field(default=None)
    """
    Link source
    """

    user: typing_extensions.Annotated[
        typing.Optional[PostLinksExamplesResponseLinksItemUser],
