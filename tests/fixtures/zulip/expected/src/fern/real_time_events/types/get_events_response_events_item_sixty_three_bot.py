...
class GetEventsResponseEventsItemSixtyThreeBot(UniversalBaseModel):
    """
    ...
    services: typing.Optional[typing.List[GetEventsResponseEventsItemSixtyThreeBotServicesItem]] = pydantic.Field(
        default=None
    )
    """
