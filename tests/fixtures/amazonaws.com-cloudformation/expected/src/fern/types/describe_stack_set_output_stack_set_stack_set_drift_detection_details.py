...
class DescribeStackSetOutputStackSetStackSetDriftDetectionDetails(UniversalBaseModel):
    """
    ...
    drift_status: typing_extensions.Annotated[
        typing.Optional[DescribeStackSetOutputStackSetStackSetDriftDetectionDetailsDriftStatus],
    ...
    drift_detection_status: typing_extensions.Annotated[
        typing.Optional[DescribeStackSetOutputStackSetStackSetDriftDetectionDetailsDriftDetectionStatus],
