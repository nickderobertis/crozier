...
class DocAnnotationsListAll200ResponsePagesItemAnnotationsItemLineMeasureRlAngleItem(UniversalBaseModel):
    unit: str
    ...
    label_position: typing_extensions.Annotated[
        typing.Optional[DocAnnotationsListAll200ResponsePagesItemAnnotationsItemLineMeasureRlAngleItemLabelPosition],
