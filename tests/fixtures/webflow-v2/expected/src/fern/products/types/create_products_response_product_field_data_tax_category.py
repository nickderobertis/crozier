...
class CreateProductsResponseProductFieldDataTaxCategory(enum.StrEnum):
    """
    Product tax class
    """
    ...
    def visit(
        ...
        if self is CreateProductsResponseProductFieldDataTaxCategory.STANDARD_TAXABLE:
            return standard_taxable()
        if self is CreateProductsResponseProductFieldDataTaxCategory.STANDARD_EXEMPT:
            return standard_exempt()
        if self is CreateProductsResponseProductFieldDataTaxCategory.BOOKS_RELIGIOUS:
            return books_religious()
        if self is CreateProductsResponseProductFieldDataTaxCategory.BOOKS_TEXTBOOK:
            return books_textbook()
        if self is CreateProductsResponseProductFieldDataTaxCategory.CLOTHING:
            return clothing()
        if self is CreateProductsResponseProductFieldDataTaxCategory.CLOTHING_SWIMWEAR:
            return clothing_swimwear()
        if self is CreateProductsResponseProductFieldDataTaxCategory.DIGITAL_GOODS:
            return digital_goods()
        if self is CreateProductsResponseProductFieldDataTaxCategory.DIGITAL_SERVICE:
            return digital_service()
        if self is CreateProductsResponseProductFieldDataTaxCategory.DRUGS_NON_PRESCRIPTION:
            return drugs_non_prescription()
        if self is CreateProductsResponseProductFieldDataTaxCategory.DRUGS_PRESCRIPTION:
            return drugs_prescription()
        if self is CreateProductsResponseProductFieldDataTaxCategory.FOOD_BOTTLED_WATER:
            return food_bottled_water()
        if self is CreateProductsResponseProductFieldDataTaxCategory.FOOD_CANDY:
            return food_candy()
        if self is CreateProductsResponseProductFieldDataTaxCategory.FOOD_GROCERIES:
            return food_groceries()
        if self is CreateProductsResponseProductFieldDataTaxCategory.FOOD_PREPARED:
            return food_prepared()
        if self is CreateProductsResponseProductFieldDataTaxCategory.FOOD_SODA:
            return food_soda()
        if self is CreateProductsResponseProductFieldDataTaxCategory.FOOD_SUPPLEMENTS:
            return food_supplements()
        if self is CreateProductsResponseProductFieldDataTaxCategory.MAGAZINE_INDIVIDUAL:
            return magazine_individual()
        if self is CreateProductsResponseProductFieldDataTaxCategory.MAGAZINE_SUBSCRIPTION:
            return magazine_subscription()
        if self is CreateProductsResponseProductFieldDataTaxCategory.SERVICE_ADMISSION:
            return service_admission()
        if self is CreateProductsResponseProductFieldDataTaxCategory.SERVICE_ADVERTISING:
            return service_advertising()
        if self is CreateProductsResponseProductFieldDataTaxCategory.SERVICE_DRY_CLEANING:
            return service_dry_cleaning()
        if self is CreateProductsResponseProductFieldDataTaxCategory.SERVICE_HAIRDRESSING:
            return service_hairdressing()
        if self is CreateProductsResponseProductFieldDataTaxCategory.SERVICE_INSTALLATION:
            return service_installation()
        if self is CreateProductsResponseProductFieldDataTaxCategory.SERVICE_MISCELLANEOUS:
            return service_miscellaneous()
        if self is CreateProductsResponseProductFieldDataTaxCategory.SERVICE_PARKING:
            return service_parking()
        if self is CreateProductsResponseProductFieldDataTaxCategory.SERVICE_PRINTING:
            return service_printing()
        if self is CreateProductsResponseProductFieldDataTaxCategory.SERVICE_PROFESSIONAL:
            return service_professional()
        if self is CreateProductsResponseProductFieldDataTaxCategory.SERVICE_REPAIR:
            return service_repair()
        if self is CreateProductsResponseProductFieldDataTaxCategory.SERVICE_TRAINING:
