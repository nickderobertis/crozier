...
from ...types.destiny_milestones_destiny_milestone_content import DestinyMilestonesDestinyMilestoneContent


class Destiny2GetPublicMilestoneContentResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[DestinyMilestonesDestinyMilestoneContent], FieldMetadata(alias="Response")
    ] = None
