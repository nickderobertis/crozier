...
class RawClientSettingsClient:
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json=convert_and_respect_annotation_metadata(
                object_=request, annotation=typing.Dict[str, ClientSettingGlobalUpdateDto], direction="write"
            ),
            request_options=request_options,
            omit=OMIT,
        )
    ...
    ) -> HttpResponse[typing.Dict[str, ClientSettingDto]]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=typing.Dict[str, ClientSettingDto],
                        object_=_response.json(),
                    ),
                )
    ...
    def save_user_setting(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            method="PATCH",
            json=convert_and_respect_annotation_metadata(
                object_=request, annotation=typing.Dict[str, ClientSettingUserUpdateDto], direction="write"
            ),
            request_options=request_options,
            omit=OMIT,
        )
...
class AsyncRawClientSettingsClient:
    ...
    async def get_global_settings(
        self, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[typing.Dict[str, ClientSettingDto]]:
        """
        For unauthenticated users, only settings with 'allowUnauthorized=true' will be returned.
