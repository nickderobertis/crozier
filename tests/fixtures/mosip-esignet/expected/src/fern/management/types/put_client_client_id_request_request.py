...
class PutClientClientIdRequestRequest(UniversalBaseModel):
    ...
    client_name_lang_map: typing_extensions.Annotated[
        ...
        pydantic.Field(
            ...
            description="Client name in different languages. The 3 letter language code needs to be passed as key and \nclient name in the desired language needs to be passed as value",
        ),
    ]
    """
    ...
    status: PutClientClientIdRequestRequestStatus = pydantic.Field()
    """
    ...
    """
    Valid list of callback Uris of the relying party. When the authorize API is called, any one Uri from this list should be sent as redirect_uri. authorization_code will be redirected to this Uri on successful authentication.
    """

    user_claims: typing_extensions.Annotated[
        typing.List[PutClientClientIdRequestRequestUserClaimsItem],
    ...
    auth_context_refs: typing_extensions.Annotated[
        typing.List[PutClientClientIdRequestRequestAuthContextRefsItem],
    ...
    grant_types: typing_extensions.Annotated[
        typing.List[PutClientClientIdRequestRequestGrantTypesItem],
    ...
    client_auth_methods: typing_extensions.Annotated[
        typing.List[PutClientClientIdRequestRequestClientAuthMethodsItem],
    ...
    additional_config: typing_extensions.Annotated[
        typing.Optional[PutClientClientIdRequestRequestAdditionalConfig],
