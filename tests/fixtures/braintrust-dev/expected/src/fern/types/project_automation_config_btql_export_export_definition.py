...
class ProjectAutomationConfigBtqlExportExportDefinition_LogTraces(UniversalBaseModel):
    """
...
class ProjectAutomationConfigBtqlExportExportDefinition_LogSpans(UniversalBaseModel):
    """
    The definition of what to export
    """
...
class ProjectAutomationConfigBtqlExportExportDefinition_BtqlQuery(UniversalBaseModel):
    """
    The definition of what to export
    """
...
ProjectAutomationConfigBtqlExportExportDefinition = typing_extensions.Annotated[
    typing.Union[
