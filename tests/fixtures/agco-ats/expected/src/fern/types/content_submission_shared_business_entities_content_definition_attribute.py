...
class ContentSubmissionSharedBusinessEntitiesContentDefinitionAttribute(UniversalBaseModel):
    """
    ...
    content_definition_id: typing_extensions.Annotated[
        ...
        pydantic.Field(
            alias="ContentDefinitionID", description="The ID of the content definition to which this attribute belongs."
        ),
    ] = None
    """
