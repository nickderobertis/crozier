...
class WritablePowerOutlet(UniversalBaseModel):
    ...
    feed_leg: typing.Optional[WritablePowerOutletFeedLeg] = pydantic.Field(default=None)
    """
    ...
    type: typing.Optional[WritablePowerOutletType] = pydantic.Field(default=None)
    """
    Physical port type
    """
