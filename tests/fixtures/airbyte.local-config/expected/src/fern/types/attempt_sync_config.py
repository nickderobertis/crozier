...
class AttemptSyncConfig(UniversalBaseModel):
    destination_configuration: typing_extensions.Annotated[
        ...
        FieldMetadata(alias="destinationConfiguration"),
        pydantic.Field(alias="destinationConfiguration"),
    ]
    source_configuration: typing_extensions.Annotated[
        SourceConfiguration, FieldMetadata(alias="sourceConfiguration"), pydantic.Field(alias="sourceConfiguration")
    ]
