...
class GetApiLinksResponseLinksItem(UniversalBaseModel):
    ...
    expires_at: typing_extensions.Annotated[
        typing.Optional[GetApiLinksResponseLinksItemExpiresAt],
    ...
    ttl: typing.Optional[GetApiLinksResponseLinksItemTtl] = pydantic.Field(default=None)
    """
    ...
    split_urlv2: typing_extensions.Annotated[
        typing.Optional[typing.List[GetApiLinksResponseLinksItemSplitUrlv2Item]],
    ...
    redirect_type: typing_extensions.Annotated[
        typing.Optional[GetApiLinksResponseLinksItemRedirectType],
    ...
    source: typing.Optional[GetApiLinksResponseLinksItemSource] = pydantic.Field(default=None)
    """
    Link source
    """

    user: typing_extensions.Annotated[
        typing.Optional[GetApiLinksResponseLinksItemUser], FieldMetadata(alias="User"), pydantic.Field(alias="User")
    ] = None
