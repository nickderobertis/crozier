...
from ...types.destiny_advanced_awa_initialize_response import DestinyAdvancedAwaInitializeResponse


class Destiny2AwaInitializeRequestResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[DestinyAdvancedAwaInitializeResponse], FieldMetadata(alias="Response")
    ] = None
