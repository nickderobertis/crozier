...
class ObpcaData1OtherFeesChargesFeeChargeDetailItemOtherFeeType(UniversalBaseModel):
    """
    ...
    fee_category: typing_extensions.Annotated[
        ObpcaData1OtherFeesChargesFeeChargeDetailItemOtherFeeTypeFeeCategory, FieldMetadata(alias="FeeCategory")
    ] = pydantic.Field()
    """
