...
if typing.TYPE_CHECKING:
    from .execute.client import AsyncExecuteClient, ExecuteClient
...
class FernApi:
    ...
    apideck_downstream_authorization : typing.Optional[str]
    apideck_app_id : str
    api_key : str
    ...
    def __init__(
        ...
        *,
        ...
        self._execute: typing.Optional[ExecuteClient] = None

    @property
    def execute(self):
        if self._execute is None:
            from .execute.client import ExecuteClient

            self._execute = ExecuteClient(client_wrapper=self._client_wrapper)
...
class AsyncFernApi:
    ...
    def __init__(
        ...
        *,
        ...
        self._execute: typing.Optional[AsyncExecuteClient] = None

    @property
    def execute(self):
        if self._execute is None:
            from .execute.client import AsyncExecuteClient

            self._execute = AsyncExecuteClient(client_wrapper=self._client_wrapper)
        return self._execute
