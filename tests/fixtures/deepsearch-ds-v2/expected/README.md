...
client = FernApi(...)
response = client.content_manager.with_raw_response.add_project_data_index_document_metadata(...)
...
```python
client.content_manager.add_project_data_index_document_metadata(..., request_options={
    "max_retries": 1
})
```
