...
class RawReferencesAuthorisationDomainClient:
    ...
    ) -> HttpResponse[AuthorisationDomainsPage]:
        """
        Parameters
        ----------
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=AuthorisationDomainsPage,
    ...
    def get_an_authorisation_domain_by_name(
        ...
        *,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[AuthorisationDomain]:
        """
        Parameters
        ----------
        authorisation_domain_name : AuthorisationDomainName
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"references/authorisationdomains/{encode_path_param(authorisation_domain_name)}",
            method="GET",
            request_options=request_options,
        )
        try:
...
class AsyncRawReferencesAuthorisationDomainClient:
    ...
    async def reference_data_of_all_authorisation_domains(
        ...
        *,
        ...
        sort: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[AuthorisationDomainsPage]:
        """
        Parameters
        ----------
        page : typing.Optional[int]
    ...
    async def get_an_authorisation_domain_by_name(
        ...
        *,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[AuthorisationDomain]:
        """
        Parameters
        ----------
        authorisation_domain_name : AuthorisationDomainName
