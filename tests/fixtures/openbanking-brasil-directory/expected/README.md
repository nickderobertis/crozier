...
client = FernApi(...)
response = client.organisations.with_raw_response.get_all_organisations_that_the_logged_in_user_is_authorised_to_retrieve_from_trusted_services(...)
...
```python
client.organisations.get_all_organisations_that_the_logged_in_user_is_authorised_to_retrieve_from_trusted_services(..., request_options={
    "max_retries": 1
})
```
