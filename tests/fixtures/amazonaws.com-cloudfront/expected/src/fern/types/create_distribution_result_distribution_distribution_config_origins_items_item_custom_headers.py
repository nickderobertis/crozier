...
class CreateDistributionResultDistributionDistributionConfigOriginsItemsItemCustomHeaders(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[
            typing.List[CreateDistributionResultDistributionDistributionConfigOriginsItemsItemCustomHeadersItemsItem]
        ],
