...
class DocPagesInsertBlank200ResponseMetaAffectedPagesItemWeakAnnotationState_Unknown(UniversalBaseModel):
...
class DocPagesInsertBlank200ResponseMetaAffectedPagesItemWeakAnnotationState_Known(UniversalBaseModel):
...
DocPagesInsertBlank200ResponseMetaAffectedPagesItemWeakAnnotationState = typing_extensions.Annotated[
    typing.Union[
