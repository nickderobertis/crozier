...
class RefundOrdersResponsePurchasedItemsItem(UniversalBaseModel):
    """
    ...
    row_total: typing_extensions.Annotated[
        typing.Optional[RefundOrdersResponsePurchasedItemsItemRowTotal],
    ...
    variant_image: typing_extensions.Annotated[
        typing.Optional[RefundOrdersResponsePurchasedItemsItemVariantImage],
        FieldMetadata(alias="variantImage"),
        pydantic.Field(alias="variantImage"),
    ] = None
    variant_price: typing_extensions.Annotated[
        typing.Optional[RefundOrdersResponsePurchasedItemsItemVariantPrice],
