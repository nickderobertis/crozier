...
class ProductRelease(UniversalBaseModel):
    """
    ...
    uuid_: typing_extensions.Annotated[
        ...
        pydantic.Field(alias="uuid", description="A unique identifier for the TEA Product Release"),
    ]
    """
    A unique identifier for the TEA Product Release
    """

    product: typing.Optional[Uuid] = pydantic.Field(default=None)
    """
    ...
    product_name: typing_extensions.Annotated[
        ...
        pydantic.Field(alias="productName", description="Name of the TEA Product this release belongs to"),
    ] = None
    """
    ...
    """
    Timestamp when this Product Release was created in TEA (for sorting purposes)
    """

    release_date: typing_extensions.Annotated[
        typing.Optional[DateTime],
        FieldMetadata(alias="releaseDate"),
        pydantic.Field(alias="releaseDate", description="Timestamp of the product release"),
    ] = None
    """
    Timestamp of the product release
    """
    ...
    components: typing.List[ComponentRef] = pydantic.Field()
    """
