...
class GetOrdersResponseAllAddressesItem(UniversalBaseModel):
    """
    A customer address
    """

    type: typing.Optional[GetOrdersResponseAllAddressesItemType] = pydantic.Field(default=None)
    """
    The type of the order address (billing or shipping)
    """

    japan_type: typing_extensions.Annotated[
        typing.Optional[GetOrdersResponseAllAddressesItemJapanType],
