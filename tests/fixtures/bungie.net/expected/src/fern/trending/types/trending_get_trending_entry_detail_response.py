...
from ...types.trending_trending_detail import TrendingTrendingDetail


class TrendingGetTrendingEntryDetailResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[typing.Optional[TrendingTrendingDetail], FieldMetadata(alias="Response")] = (
        None
    )
