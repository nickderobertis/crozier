...
class ApplicationsApiUsage(UniversalBaseModel):
    api_calls: typing_extensions.Annotated[
        typing.Optional[typing.List[ApplicationsSeries]], FieldMetadata(alias="apiCalls")
    ...
    throttled_requests: typing_extensions.Annotated[
        typing.Optional[typing.List[ApplicationsSeries]], FieldMetadata(alias="throttledRequests")
    ] = pydantic.Field(default=None)
    """
