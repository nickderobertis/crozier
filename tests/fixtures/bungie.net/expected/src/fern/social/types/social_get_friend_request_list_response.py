...
from ...types.social_friends_bungie_friend_request_list_response import SocialFriendsBungieFriendRequestListResponse


class SocialGetFriendRequestListResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[SocialFriendsBungieFriendRequestListResponse], FieldMetadata(alias="Response")
    ] = None
