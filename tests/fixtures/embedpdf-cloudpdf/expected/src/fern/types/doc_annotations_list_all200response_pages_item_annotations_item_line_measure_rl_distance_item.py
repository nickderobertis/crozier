...
class DocAnnotationsListAll200ResponsePagesItemAnnotationsItemLineMeasureRlDistanceItem(UniversalBaseModel):
    unit: str
    ...
    label_position: typing_extensions.Annotated[
        typing.Optional[DocAnnotationsListAll200ResponsePagesItemAnnotationsItemLineMeasureRlDistanceItemLabelPosition],
