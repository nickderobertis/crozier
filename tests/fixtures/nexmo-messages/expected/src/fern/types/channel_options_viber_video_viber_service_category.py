...
class ChannelOptionsViberVideoViberServiceCategory(enum.StrEnum):
    """
    ...
    def visit(self, transaction: typing.Callable[[], T_Result], promotion: typing.Callable[[], T_Result]) -> T_Result:
        if self is ChannelOptionsViberVideoViberServiceCategory.TRANSACTION:
            return transaction()
        if self is ChannelOptionsViberVideoViberServiceCategory.PROMOTION:
            return promotion()
