...
class GetOrdersResponseStripeCard(UniversalBaseModel):
    """
    ...
    brand: typing.Optional[GetOrdersResponseStripeCardBrand] = pydantic.Field(default=None)
    """
    ...
    expires: typing.Optional[GetOrdersResponseStripeCardExpires] = pydantic.Field(default=None)
    """
