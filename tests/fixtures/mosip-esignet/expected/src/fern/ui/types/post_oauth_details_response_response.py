...
class PostOauthDetailsResponseResponse(UniversalBaseModel):
    ...
    client_name: typing_extensions.Annotated[
        ...
        pydantic.Field(alias="clientName", description="OIDC client name as registered."),
    ] = None
    """
    OIDC client name as registered.
    """
