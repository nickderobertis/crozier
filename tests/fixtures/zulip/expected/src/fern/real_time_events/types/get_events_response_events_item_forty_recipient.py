...
class GetEventsResponseEventsItemFortyRecipient(UniversalBaseModel):
    """
    Object containing details about recipients of message edit typing notification.
    """

    type: typing.Optional[GetEventsResponseEventsItemFortyRecipientType] = pydantic.Field(default=None)
    """
