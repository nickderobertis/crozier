...
class MonsterActionsItem(UniversalBaseModel):
    """
    Action available to a `Monster` in addition to the standard creature actions.
    """

    action_options: typing.Optional["Choice"] = None
    actions: typing.Optional[typing.List[MonsterActionsItemActionsItem]] = None
    attack_bonus: typing.Optional[float] = None
    attacks: typing.Optional[typing.List[MonsterActionsItemAttacksItem]] = None
    damage: typing.Optional[typing.List[MonsterActionsItemDamageItem]] = None
...
update_forward_refs(MonsterActionsItem)
