...
class RawInsightsClient:
    ...
    def list_all_insights_for_user(
    ...
    ) -> HttpResponse[typing.List[InsightListing]]:
        """
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"user/{encode_path_param(user_id)}/insights",
            method="GET",
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=typing.List[InsightListing],
...
class AsyncRawInsightsClient:
    ...
    async def list_all_insights_for_user(
        self, user_id: int, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[typing.List[InsightListing]]:
        """
        Used to get insights about transactions between given time range.
