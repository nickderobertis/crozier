...
if typing.TYPE_CHECKING:
    ...
    from .utilities.client import AsyncUtilitiesClient, UtilitiesClient
...
class FernApi:
    ...
    def __init__(
        ...
        *,
        ...
        self._utilities: typing.Optional[UtilitiesClient] = None
    ...
    def utilities(self):
        if self._utilities is None:
            from .utilities.client import UtilitiesClient

            self._utilities = UtilitiesClient(client_wrapper=self._client_wrapper)
    ...
    def event_subscriptions(self):
        if self._event_subscriptions is None:
            from .event_subscriptions.client import EventSubscriptionsClient
    ...
    def coupons(self):
        if self._coupons is None:
            from .coupons.client import CouponsClient
...
class AsyncFernApi:
    ...
    def __init__(
        ...
        *,
        ...
        self._utilities: typing.Optional[AsyncUtilitiesClient] = None
    ...
    def utilities(self):
        if self._utilities is None:
            from .utilities.client import AsyncUtilitiesClient

            self._utilities = AsyncUtilitiesClient(client_wrapper=self._client_wrapper)
        return self._utilities
    ...
    def event_subscriptions(self):
        if self._event_subscriptions is None:
            from .event_subscriptions.client import AsyncEventSubscriptionsClient
    ...
    def coupons(self):
        if self._coupons is None:
            from .coupons.client import AsyncCouponsClient
