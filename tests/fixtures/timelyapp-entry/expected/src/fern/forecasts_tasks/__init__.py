...
_dynamic_imports: typing.Dict[str, str] = {
    "ListTaskSummariesRequestCompleted": ".types",
    "ListTaskSummariesRequestResource": ".types",
    "ListTasksRequestCompleted": ".types",
    "ListTasksRequestOrder": ".types",
    "ListTasksRequestSort": ".types",
    "V1ForecastsCreateForecast": ".types",
    "V1ForecastsUpdateForecast": ".types",
}
