...
class AccountClient:
    ...
    def account_create_jwt(self, *, request_options: typing.Optional[RequestOptions] = None) -> Jwt:
        """
        ...
        """
        _response = self._raw_client.account_create_jwt(request_options=request_options)
        return _response.data
    ...
    def create_anonymous_session(self, *, request_options: typing.Optional[RequestOptions] = None) -> Session:
        """
        ...
        """
        _response = self._raw_client.create_anonymous_session(request_options=request_options)
        return _response.data
    ...
    def account_create_o_auth2session(
        ...
        *,
        ...
        """
        _response = self._raw_client.account_create_o_auth2session(
            provider, success=success, failure=failure, scopes=scopes, request_options=request_options
        )
        return _response.data
...
class AsyncAccountClient:
    ...
    async def account_create_jwt(self, *, request_options: typing.Optional[RequestOptions] = None) -> Jwt:
        """
        Use this endpoint to create a JSON Web Token. You can use the resulting JWT to authenticate on behalf of the current user when working with the Appwrite server-side API and SDKs. The JWT secret is valid for 15 minutes from its creation and will be invalid if the user will logout in that time frame.
        ...
        async def main() -> None:
            await client.account.account_create_jwt()


        asyncio.run(main())
        """
        _response = await self._raw_client.account_create_jwt(request_options=request_options)
        return _response.data
    ...
    async def create_session(
        ...
        async def main() -> None:
            await client.account.create_session(
                email="email",
                password="password",
            )
    ...
    async def create_anonymous_session(self, *, request_options: typing.Optional[RequestOptions] = None) -> Session:
        """
        Use this endpoint to allow a new user to register an anonymous account in your project. This route will also create a new session for the user. To allow the new user to convert an anonymous account to a normal account, you need to update its [email and password](/docs/client/account#accountUpdateEmail) or create an [OAuth2 session](/docs/client/account#accountCreateOAuth2Session).
        ...
        async def main() -> None:
            await client.account.create_anonymous_session()


        asyncio.run(main())
        """
        _response = await self._raw_client.create_anonymous_session(request_options=request_options)
        return _response.data
    ...
    async def account_create_o_auth2session(
        ...
        *,
        ...
        async def main() -> None:
            await client.account.account_create_o_auth2session(
                provider="provider",
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.account_create_o_auth2session(
            provider, success=success, failure=failure, scopes=scopes, request_options=request_options
        )
        return _response.data
