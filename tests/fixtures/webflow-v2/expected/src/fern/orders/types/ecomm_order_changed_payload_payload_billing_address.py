...
from .ecomm_order_changed_payload_payload_billing_address_type import EcommOrderChangedPayloadPayloadBillingAddressType


class EcommOrderChangedPayloadPayloadBillingAddress(UniversalBaseModel):
    """
    The billing address
    """

    type: typing.Optional[EcommOrderChangedPayloadPayloadBillingAddressType] = pydantic.Field(default=None)
    """
    The type of the order address (billing or shipping)
    """

    japan_type: typing_extensions.Annotated[
        typing.Optional[EcommOrderChangedPayloadPayloadBillingAddressJapanType],
