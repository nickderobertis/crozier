...
class PostPortfolioOptimizationMeanVarianceEfficientDiversifiedRequestConstraints(UniversalBaseModel):
    ...
    delta_return: typing_extensions.Annotated[typing.Optional[float], FieldMetadata(alias="deltaReturn")] = (
        pydantic.Field(default=None)
    )
    """
    ...
    delta_volatility: typing_extensions.Annotated[typing.Optional[float], FieldMetadata(alias="deltaVolatility")] = (
        pydantic.Field(default=None)
    )
    """
    ...
    portfolio_return: typing_extensions.Annotated[typing.Optional[float], FieldMetadata(alias="portfolioReturn")] = (
        pydantic.Field(default=None)
    )
    """
    ...
    portfolio_volatility: typing_extensions.Annotated[
        typing.Optional[float], FieldMetadata(alias="portfolioVolatility")
    ] = pydantic.Field(default=None)
    """
    The portfolio volatility; exclusive with portfolioReturn and riskTolerance
    """

    risk_tolerance: typing_extensions.Annotated[typing.Optional[float], FieldMetadata(alias="riskTolerance")] = (
        pydantic.Field(default=None)
    )
    """
