...
- *(census)* commit non-generation proofs for parameters and paths ([#286](https://github.com/nickderobertis/crozier/pull/286))
...
- *(census)* name the five branches a component pointer's segments address ([#250](https://github.com/nickderobertis/crozier/pull/250))
...
- *(surface)* settle the five security rows no registrable witness reaches ([#233](https://github.com/nickderobertis/crozier/pull/233))
...
- *(fixtures)* settle the schemas region's fixture backlog against real-world witnesses ([#216](https://github.com/nickderobertis/crozier/pull/216))

## [0.0.60](https://github.com/nickderobertis/crozier/compare/v0.0.59...v0.0.60) - 2026-09-04

### Added

- *(fixtures)* settle the comment, vocabulary and pointer-format probe rows against witnesses ([#206](https://github.com/nickderobertis/crozier/pull/206))
...
- *(fixtures)* settle the document version and schema dialect probe rows against witnesses ([#201](https://github.com/nickderobertis/crozier/pull/201))
...
- *(fixtures)* settle the vapid and mutual scheme and the scheme-reference probe rows ([#197](https://github.com/nickderobertis/crozier/pull/197))
