...
class UpdateProductsResponseFieldDataTaxCategory(enum.StrEnum):
    """
    Product tax class
    """
    ...
    def visit(
        ...
        if self is UpdateProductsResponseFieldDataTaxCategory.STANDARD_TAXABLE:
            return standard_taxable()
        if self is UpdateProductsResponseFieldDataTaxCategory.STANDARD_EXEMPT:
            return standard_exempt()
        if self is UpdateProductsResponseFieldDataTaxCategory.BOOKS_RELIGIOUS:
            return books_religious()
        if self is UpdateProductsResponseFieldDataTaxCategory.BOOKS_TEXTBOOK:
            return books_textbook()
        if self is UpdateProductsResponseFieldDataTaxCategory.CLOTHING:
            return clothing()
        if self is UpdateProductsResponseFieldDataTaxCategory.CLOTHING_SWIMWEAR:
            return clothing_swimwear()
        if self is UpdateProductsResponseFieldDataTaxCategory.DIGITAL_GOODS:
            return digital_goods()
        if self is UpdateProductsResponseFieldDataTaxCategory.DIGITAL_SERVICE:
            return digital_service()
        if self is UpdateProductsResponseFieldDataTaxCategory.DRUGS_NON_PRESCRIPTION:
            return drugs_non_prescription()
        if self is UpdateProductsResponseFieldDataTaxCategory.DRUGS_PRESCRIPTION:
            return drugs_prescription()
        if self is UpdateProductsResponseFieldDataTaxCategory.FOOD_BOTTLED_WATER:
            return food_bottled_water()
        if self is UpdateProductsResponseFieldDataTaxCategory.FOOD_CANDY:
            return food_candy()
        if self is UpdateProductsResponseFieldDataTaxCategory.FOOD_GROCERIES:
            return food_groceries()
        if self is UpdateProductsResponseFieldDataTaxCategory.FOOD_PREPARED:
            return food_prepared()
        if self is UpdateProductsResponseFieldDataTaxCategory.FOOD_SODA:
            return food_soda()
        if self is UpdateProductsResponseFieldDataTaxCategory.FOOD_SUPPLEMENTS:
            return food_supplements()
        if self is UpdateProductsResponseFieldDataTaxCategory.MAGAZINE_INDIVIDUAL:
            return magazine_individual()
        if self is UpdateProductsResponseFieldDataTaxCategory.MAGAZINE_SUBSCRIPTION:
            return magazine_subscription()
        if self is UpdateProductsResponseFieldDataTaxCategory.SERVICE_ADMISSION:
            return service_admission()
        if self is UpdateProductsResponseFieldDataTaxCategory.SERVICE_ADVERTISING:
            return service_advertising()
        if self is UpdateProductsResponseFieldDataTaxCategory.SERVICE_DRY_CLEANING:
            return service_dry_cleaning()
        if self is UpdateProductsResponseFieldDataTaxCategory.SERVICE_HAIRDRESSING:
            return service_hairdressing()
        if self is UpdateProductsResponseFieldDataTaxCategory.SERVICE_INSTALLATION:
            return service_installation()
        if self is UpdateProductsResponseFieldDataTaxCategory.SERVICE_MISCELLANEOUS:
            return service_miscellaneous()
        if self is UpdateProductsResponseFieldDataTaxCategory.SERVICE_PARKING:
            return service_parking()
        if self is UpdateProductsResponseFieldDataTaxCategory.SERVICE_PRINTING:
            return service_printing()
        if self is UpdateProductsResponseFieldDataTaxCategory.SERVICE_PROFESSIONAL:
            return service_professional()
        if self is UpdateProductsResponseFieldDataTaxCategory.SERVICE_REPAIR:
            return service_repair()
        if self is UpdateProductsResponseFieldDataTaxCategory.SERVICE_TRAINING:
