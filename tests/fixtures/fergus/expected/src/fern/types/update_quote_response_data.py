...
class UpdateQuoteResponseData(UniversalBaseModel):
    id: float
    ...
    sections: typing.Optional[typing.List[UpdateQuoteResponseDataSectionsItem]] = None
    deposit: typing.Optional[UpdateQuoteResponseDataDeposit] = None
    links: typing.Optional[typing.List[UpdateQuoteResponseDataLinksItem]] = None
    line_items: typing_extensions.Annotated[
        typing.Optional[typing.List[UpdateQuoteResponseDataLineItemsItem]],
...
update_forward_refs(UpdateQuoteResponseData)
