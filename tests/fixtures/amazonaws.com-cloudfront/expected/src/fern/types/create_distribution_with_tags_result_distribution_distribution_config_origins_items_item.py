...
class CreateDistributionWithTagsResultDistributionDistributionConfigOriginsItemsItem(UniversalBaseModel):
    """
    ...
    custom_headers: typing_extensions.Annotated[
        typing.Optional[CreateDistributionWithTagsResultDistributionDistributionConfigOriginsItemsItemCustomHeaders],
    ...
    s3origin_config: typing_extensions.Annotated[
        typing.Optional[CreateDistributionWithTagsResultDistributionDistributionConfigOriginsItemsItemS3OriginConfig],
