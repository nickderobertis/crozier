...
class CreateDistributionResultDistributionDistributionConfig(UniversalBaseModel):
    """
    ...
    aliases: typing_extensions.Annotated[
        typing.Optional[CreateDistributionResultDistributionDistributionConfigAliases],
    ...
    cache_behaviors: typing_extensions.Annotated[
        typing.Optional[CreateDistributionResultDistributionDistributionConfigCacheBehaviors],
    ...
    custom_error_responses: typing_extensions.Annotated[
        typing.Optional[CreateDistributionResultDistributionDistributionConfigCustomErrorResponses],
    ...
    logging: typing_extensions.Annotated[
        typing.Optional[CreateDistributionResultDistributionDistributionConfigLogging],
    ...
    price_class: typing_extensions.Annotated[
        typing.Optional[CreateDistributionResultDistributionDistributionConfigPriceClass],
    ...
    http_version: typing_extensions.Annotated[
        typing.Optional[CreateDistributionResultDistributionDistributionConfigHttpVersion],
