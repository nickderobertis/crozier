...
class ChangeResourceChangeReplacement(str, enum.Enum):
    """
    ...
    def visit(
        ...
        if self is ChangeResourceChangeReplacement.TRUE:
            return true()
        if self is ChangeResourceChangeReplacement.FALSE:
            return false()
        if self is ChangeResourceChangeReplacement.CONDITIONAL:
            return conditional()
