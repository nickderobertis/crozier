...
from ...types.social_friends_platform_friend_response import SocialFriendsPlatformFriendResponse


class SocialGetPlatformFriendListResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[SocialFriendsPlatformFriendResponse], FieldMetadata(alias="Response")
    ] = None
