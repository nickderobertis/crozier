...
class DocAnnotationsListAll200ResponsePagesItemAnnotationsItemLineMeasureRlSlopeItem(UniversalBaseModel):
    unit: str
    ...
    label_position: typing_extensions.Annotated[
        typing.Optional[DocAnnotationsListAll200ResponsePagesItemAnnotationsItemLineMeasureRlSlopeItemLabelPosition],
