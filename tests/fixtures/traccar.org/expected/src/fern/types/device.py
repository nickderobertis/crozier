...
class Device(UniversalBaseModel):
    ...
    geofence_ids: typing_extensions.Annotated[
        typing.Optional[typing.List[int]], FieldMetadata(alias="geofenceIds"), pydantic.Field(alias="geofenceIds")
    ] = None
    ...
    last_update: typing_extensions.Annotated[
        ...
        pydantic.Field(alias="lastUpdate", description="in IS0 8601 format. eg. `1963-11-22T18:30:00Z`"),
    ] = None
    """
