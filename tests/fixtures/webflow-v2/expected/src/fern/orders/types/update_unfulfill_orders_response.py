...
class UpdateUnfulfillOrdersResponse(UniversalBaseModel):
    ...
    status: typing.Optional[UpdateUnfulfillOrdersResponseStatus] = pydantic.Field(default=None)
    """
    ...
    dispute_last_status: typing_extensions.Annotated[
        typing.Optional[UpdateUnfulfillOrdersResponseDisputeLastStatus],
    ...
    customer_paid: typing_extensions.Annotated[
        typing.Optional[UpdateUnfulfillOrdersResponseCustomerPaid],
    ...
    net_amount: typing_extensions.Annotated[
        typing.Optional[UpdateUnfulfillOrdersResponseNetAmount],
    ...
    application_fee: typing_extensions.Annotated[
        typing.Optional[UpdateUnfulfillOrdersResponseApplicationFee],
    ...
    all_addresses: typing_extensions.Annotated[
        typing.Optional[typing.List[UpdateUnfulfillOrdersResponseAllAddressesItem]],
    ...
    shipping_address: typing_extensions.Annotated[
        typing.Optional[UpdateUnfulfillOrdersResponseShippingAddress],
    ...
    billing_address: typing_extensions.Annotated[
        typing.Optional[UpdateUnfulfillOrdersResponseBillingAddress],
    ...
    customer_info: typing_extensions.Annotated[
        typing.Optional[UpdateUnfulfillOrdersResponseCustomerInfo],
    ...
    purchased_items: typing_extensions.Annotated[
        typing.Optional[typing.List[UpdateUnfulfillOrdersResponsePurchasedItemsItem]],
    ...
    stripe_details: typing_extensions.Annotated[
        typing.Optional[UpdateUnfulfillOrdersResponseStripeDetails],
    ...
    stripe_card: typing_extensions.Annotated[
        typing.Optional[UpdateUnfulfillOrdersResponseStripeCard],
    ...
    paypal_details: typing_extensions.Annotated[
        typing.Optional[UpdateUnfulfillOrdersResponsePaypalDetails],
    ...
    metadata: typing.Optional[UpdateUnfulfillOrdersResponseMetadata] = None
    ...
    totals: typing.Optional[UpdateUnfulfillOrdersResponseTotals] = pydantic.Field(default=None)
    """
    An object describing various pricing totals
    """

    download_files: typing_extensions.Annotated[
        typing.Optional[typing.List[UpdateUnfulfillOrdersResponseDownloadFilesItem]],
