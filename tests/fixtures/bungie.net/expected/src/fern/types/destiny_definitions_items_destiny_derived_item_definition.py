...
class DestinyDefinitionsItemsDestinyDerivedItemDefinition(UniversalBaseModel):
    ...
    item_description: typing_extensions.Annotated[typing.Optional[str], FieldMetadata(alias="itemDescription")] = (
    ...
    item_detail: typing_extensions.Annotated[typing.Optional[str], FieldMetadata(alias="itemDetail")] = pydantic.Field(
        default=None
    )
    """
    ...
    item_name: typing_extensions.Annotated[typing.Optional[str], FieldMetadata(alias="itemName")] = pydantic.Field(
        default=None
    )
    """
