...
class ListStackInstancesInput(UniversalBaseModel):
    ...
    filters: typing_extensions.Annotated[
        typing.Optional[typing.List[StackInstanceFilter]], FieldMetadata(alias="Filters")
    ...
    stack_instance_account: typing_extensions.Annotated[
        typing.Optional[str], FieldMetadata(alias="StackInstanceAccount")
    ] = pydantic.Field(default=None)
    """
    ...
    stack_instance_region: typing_extensions.Annotated[
        typing.Optional[str], FieldMetadata(alias="StackInstanceRegion")
    ] = pydantic.Field(default=None)
    """
    ...
    call_as: typing_extensions.Annotated[
        typing.Optional[ListStackInstancesInputCallAs], FieldMetadata(alias="CallAs")
    ] = pydantic.Field(default=None)
    """
