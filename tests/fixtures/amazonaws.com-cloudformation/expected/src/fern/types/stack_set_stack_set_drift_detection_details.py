...
from .stack_set_stack_set_drift_detection_details_drift_status import StackSetStackSetDriftDetectionDetailsDriftStatus


class StackSetStackSetDriftDetectionDetails(UniversalBaseModel):
    """
    ...
    drift_status: typing_extensions.Annotated[
        typing.Optional[StackSetStackSetDriftDetectionDetailsDriftStatus],
    ...
    drift_detection_status: typing_extensions.Annotated[
        typing.Optional[StackSetStackSetDriftDetectionDetailsDriftDetectionStatus],
        FieldMetadata(alias="DriftDetectionStatus"),
        pydantic.Field(
            alias="DriftDetectionStatus",
            description="<p>The status of the stack set drift detection operation.</p> <ul> <li> <p> <code>COMPLETED</code>: The drift detection operation completed without failing on any stack instances.</p> </li> <li> <p> <code>FAILED</code>: The drift detection operation exceeded the specified failure tolerance.</p> </li> <li> <p> <code>PARTIAL_SUCCESS</code>: The drift detection operation completed without exceeding the failure tolerance for the operation.</p> </li> <li> <p> <code>IN_PROGRESS</code>: The drift detection operation is currently being performed.</p> </li> <li> <p> <code>STOPPED</code>: The user has canceled the drift detection operation.</p> </li> </ul>",
        ),
    ] = None
    """
    ...
    total_stack_instances_count: typing_extensions.Annotated[
        typing.Optional[int],
        FieldMetadata(alias="TotalStackInstancesCount"),
        pydantic.Field(
            alias="TotalStackInstancesCount",
            description="<p>The total number of stack instances belonging to this stack set.</p> <p>The total number of stack instances is equal to the total of:</p> <ul> <li> <p>Stack instances that match the stack set configuration.</p> </li> <li> <p>Stack instances that have drifted from the stack set configuration.</p> </li> <li> <p>Stack instances where the drift detection operation has failed.</p> </li> <li> <p>Stack instances currently being checked for drift.</p> </li> </ul>",
        ),
    ] = None
    """
    ...
    drifted_stack_instances_count: typing_extensions.Annotated[
        typing.Optional[int],
        FieldMetadata(alias="DriftedStackInstancesCount"),
        pydantic.Field(
            alias="DriftedStackInstancesCount",
            description="The number of stack instances that have drifted from the expected template and parameter configuration of the stack set. A stack instance is considered to have drifted if one or more of the resources in the associated stack don't match their expected configuration.",
        ),
    ] = None
    """
    ...
    in_sync_stack_instances_count: typing_extensions.Annotated[
        typing.Optional[int],
        FieldMetadata(alias="InSyncStackInstancesCount"),
        pydantic.Field(
            alias="InSyncStackInstancesCount",
            description="The number of stack instances which match the expected template and parameter configuration of the stack set.",
        ),
    ] = None
    """
    ...
    in_progress_stack_instances_count: typing_extensions.Annotated[
        typing.Optional[int],
        FieldMetadata(alias="InProgressStackInstancesCount"),
        pydantic.Field(
            alias="InProgressStackInstancesCount",
            description="The number of stack instances that are currently being checked for drift.",
        ),
    ] = None
    """
    ...
    failed_stack_instances_count: typing_extensions.Annotated[
        ...
        pydantic.Field(
            ...
            description="The number of stack instances for which the drift detection operation failed.",
        ),
    ] = None
    """
