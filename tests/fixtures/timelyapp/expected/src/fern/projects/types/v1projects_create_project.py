...
class V1ProjectsCreateProject(UniversalBaseModel):
    ...
    rate_type: V1ProjectsCreateProjectRateType = pydantic.Field()
    """
    ...
    budget_type: typing.Optional[V1ProjectsCreateProjectBudgetType] = pydantic.Field(default=None)
    """
    ...
    budget_scope: typing.Optional[V1ProjectsCreateProjectBudgetScope] = pydantic.Field(default=None)
    """
    ...
    users: typing.Optional[typing.List[V1ProjectsCreateProjectUsersItem]] = pydantic.Field(default=None)
    """
    Array of users to assign to the project with their hourly rates
    """

    labels: typing.Optional[typing.List[V1ProjectsCreateProjectLabelsItem]] = pydantic.Field(default=None)
    """
    Array of tags with their configurations
    """

    budget_recurrence: typing.Optional[typing.List[V1ProjectsCreateProjectBudgetRecurrenceItem]] = pydantic.Field(
        default=None
    )
    """
