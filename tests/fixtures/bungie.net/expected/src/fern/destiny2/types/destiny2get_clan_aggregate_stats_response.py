...
from ...types.destiny_historical_stats_destiny_clan_aggregate_stat import DestinyHistoricalStatsDestinyClanAggregateStat


class Destiny2GetClanAggregateStatsResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[typing.List[DestinyHistoricalStatsDestinyClanAggregateStat]], FieldMetadata(alias="Response")
    ] = None
