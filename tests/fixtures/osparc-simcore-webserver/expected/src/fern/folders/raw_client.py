...
class RawFoldersClient:
    ...
    ) -> HttpResponse[EnvelopeListFolderGet]:
        """
        Parameters
        ----------
    ...
    def create_folder(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[EnvelopeFolderGet]:
        """
        Parameters
        ----------
        name : DisplaySafeStr
    ...
    def get_folder(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v0/folders/{encode_path_param(folder_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def move_folder_to_workspace(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v0/folders/{encode_path_param(folder_id)}/workspaces/{encode_path_param(workspace_id)}:move",
            method="POST",
            request_options=request_options,
        )
        try:
...
class AsyncRawFoldersClient:
    ...
    async def list_folders(
        ...
        *,
        ...
        workspace_id: typing.Optional[int] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[EnvelopeListFolderGet]:
        """
        Parameters
        ----------
        filters : typing.Optional[str]
    ...
    async def create_folder(
        ...
        *,
        ...
        workspace_id: typing.Optional[int] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[EnvelopeFolderGet]:
        """
        Parameters
        ----------
        name : DisplaySafeStr
