...
from .doc_pages_rotate200response_meta_cache_delta_pages_item import DocPagesRotate200ResponseMetaCacheDeltaPagesItem


class DocPagesRotate200ResponseMetaCacheDelta(UniversalBaseModel):
    ...
    pages: typing.List[DocPagesRotate200ResponseMetaCacheDeltaPagesItem]
