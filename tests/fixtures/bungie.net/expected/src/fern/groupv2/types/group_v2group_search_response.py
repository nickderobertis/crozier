...
from ...types.groups_v2group_search_response import GroupsV2GroupSearchResponse


class GroupV2GroupSearchResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[GroupsV2GroupSearchResponse], FieldMetadata(alias="Response"), pydantic.Field(alias="Response")
    ] = None
