...
class ApiIPagedResponseAuthorizationCodesSharedModelsAuthorizationCode(UniversalBaseModel):
    entities: typing_extensions.Annotated[
        typing.Optional[typing.List[AuthorizationCodesSharedModelsAuthorizationCode]],
