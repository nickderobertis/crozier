...
class StopStackSetOperationInputCallAs(str, enum.Enum):
    """
    ...
    def visit(self, self_: typing.Callable[[], T_Result], delegated_admin: typing.Callable[[], T_Result]) -> T_Result:
        if self is StopStackSetOperationInputCallAs.SELF:
            return self_()
        if self is StopStackSetOperationInputCallAs.DELEGATED_ADMIN:
