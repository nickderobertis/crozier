...
class CreateDistributionWithTagsResultDistributionDistributionConfig(UniversalBaseModel):
    """
    ...
    aliases: typing_extensions.Annotated[
        typing.Optional[CreateDistributionWithTagsResultDistributionDistributionConfigAliases],
    ...
    cache_behaviors: typing_extensions.Annotated[
        typing.Optional[CreateDistributionWithTagsResultDistributionDistributionConfigCacheBehaviors],
    ...
    custom_error_responses: typing_extensions.Annotated[
        typing.Optional[CreateDistributionWithTagsResultDistributionDistributionConfigCustomErrorResponses],
    ...
    logging: typing_extensions.Annotated[
        typing.Optional[CreateDistributionWithTagsResultDistributionDistributionConfigLogging],
    ...
    price_class: typing_extensions.Annotated[
        typing.Optional[CreateDistributionWithTagsResultDistributionDistributionConfigPriceClass],
    ...
    http_version: typing_extensions.Annotated[
        typing.Optional[CreateDistributionWithTagsResultDistributionDistributionConfigHttpVersion],
