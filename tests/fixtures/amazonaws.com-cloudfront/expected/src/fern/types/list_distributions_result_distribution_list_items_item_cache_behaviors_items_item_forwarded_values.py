...
class ListDistributionsResultDistributionListItemsItemCacheBehaviorsItemsItemForwardedValues(UniversalBaseModel):
    """
    ...
    headers: typing_extensions.Annotated[
        typing.Optional[ListDistributionsResultDistributionListItemsItemCacheBehaviorsItemsItemForwardedValuesHeaders],
