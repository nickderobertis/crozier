...
class Client:
    ...
    def getavailablelocales(
        ...
        client = FernApi(api_key="YOUR_API_KEY", )
        client..getavailablelocales()
        """
...
class AsyncClient:
    ...
    async def getavailablelocales(
        ...
        client = AsyncFernApi(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client..getavailablelocales()
        asyncio.run(main())
        """
    ...
    async def getcommonsettings(
        ...
        client = AsyncFernApi(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client..getcommonsettings()
        asyncio.run(main())
        """
    ...
    async def getusersystemoverrides(
        ...
        client = AsyncFernApi(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client..getusersystemoverrides()
        asyncio.run(main())
        """
