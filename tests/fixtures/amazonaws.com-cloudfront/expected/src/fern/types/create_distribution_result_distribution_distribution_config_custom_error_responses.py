...
class CreateDistributionResultDistributionDistributionConfigCustomErrorResponses(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[
            typing.List[CreateDistributionResultDistributionDistributionConfigCustomErrorResponsesItemsItem]
        ],
