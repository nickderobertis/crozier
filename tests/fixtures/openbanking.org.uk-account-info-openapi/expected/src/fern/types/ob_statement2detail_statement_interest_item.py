...
class ObStatement2DetailStatementInterestItem(UniversalBaseModel):
    """
    Set of elements used to provide details of a generic interest amount related to the statement resource.
    """

    amount: typing_extensions.Annotated[ObActiveOrHistoricCurrencyAndAmount7, FieldMetadata(alias="Amount")]
    credit_debit_indicator: typing_extensions.Annotated[ObCreditDebitCode0, FieldMetadata(alias="CreditDebitIndicator")]
    description: typing_extensions.Annotated[typing.Optional[Description2], FieldMetadata(alias="Description")] = None
    frequency: typing_extensions.Annotated[
        typing.Optional[ObExternalStatementInterestFrequency1Code], FieldMetadata(alias="Frequency")
    ] = None
    rate: typing_extensions.Annotated[typing.Optional[ObRate11], FieldMetadata(alias="Rate")] = None
    rate_type: typing_extensions.Annotated[
        typing.Optional[ObExternalStatementInterestRateType1Code], FieldMetadata(alias="RateType")
    ] = None
    type: typing_extensions.Annotated[ObExternalStatementInterestType1Code, FieldMetadata(alias="Type")]
