...
class GroupsV2GroupUserInfoCard(UniversalBaseModel):
    last_seen_display_name: typing_extensions.Annotated[
        typing.Optional[str],
        FieldMetadata(alias="LastSeenDisplayName"),
        pydantic.Field(
            alias="LastSeenDisplayName",
    ...
    last_seen_display_name_type: typing_extensions.Annotated[
        typing.Optional[int],
        FieldMetadata(alias="LastSeenDisplayNameType"),
        pydantic.Field(alias="LastSeenDisplayNameType", description="The platform of the LastSeenDisplayName"),
    ] = None
    """
