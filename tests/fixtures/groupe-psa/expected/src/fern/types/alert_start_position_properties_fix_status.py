...
class AlertStartPositionPropertiesFixStatus(enum.StrEnum):
    """
    ...
    def visit(self, two_d: typing.Callable[[], T_Result], three_d: typing.Callable[[], T_Result]) -> T_Result:
        if self is AlertStartPositionPropertiesFixStatus.TWO_D:
            return two_d()
        if self is AlertStartPositionPropertiesFixStatus.THREE_D:
            return three_d()
