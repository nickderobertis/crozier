...
class ListPagesResponsePagesItem(UniversalBaseModel):
    """
    The Page object
    """
    ...
    seo: typing.Optional[ListPagesResponsePagesItemSeo] = pydantic.Field(default=None)
    """
    SEO-related fields for the Page
    """

    open_graph: typing_extensions.Annotated[
        typing.Optional[ListPagesResponsePagesItemOpenGraph],
