...
class UpdateUnfulfillOrdersResponseShippingAddress(UniversalBaseModel):
    """
    The shipping address
    """

    type: typing.Optional[UpdateUnfulfillOrdersResponseShippingAddressType] = pydantic.Field(default=None)
    """
    The type of the order address (billing or shipping)
    """

    japan_type: typing_extensions.Annotated[
        typing.Optional[UpdateUnfulfillOrdersResponseShippingAddressJapanType],
