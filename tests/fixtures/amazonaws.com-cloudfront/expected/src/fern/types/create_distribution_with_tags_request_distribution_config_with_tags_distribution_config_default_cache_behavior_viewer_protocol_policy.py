...
class CreateDistributionWithTagsRequestDistributionConfigWithTagsDistributionConfigDefaultCacheBehaviorViewerProtocolPolicy(
    enum.StrEnum
):
    """
    ...
    def visit(
        ...
        if (
            self
            is CreateDistributionWithTagsRequestDistributionConfigWithTagsDistributionConfigDefaultCacheBehaviorViewerProtocolPolicy.ALLOW_ALL
        ):
            return allow_all()
        if (
            self
            is CreateDistributionWithTagsRequestDistributionConfigWithTagsDistributionConfigDefaultCacheBehaviorViewerProtocolPolicy.HTTPS_ONLY
        ):
            return https_only()
        if (
            self
            is CreateDistributionWithTagsRequestDistributionConfigWithTagsDistributionConfigDefaultCacheBehaviorViewerProtocolPolicy.REDIRECT_TO_HTTPS
        ):
