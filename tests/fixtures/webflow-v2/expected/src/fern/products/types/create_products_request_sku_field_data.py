...
class CreateProductsRequestSkuFieldData(UniversalBaseModel):
    """
    ...
    price: CreateProductsRequestSkuFieldDataPrice = pydantic.Field()
    """
    price of SKU
    """

    compare_at_price: typing_extensions.Annotated[
        typing.Optional[CreateProductsRequestSkuFieldDataCompareAtPrice],
    ...
    ec_sku_billing_method: typing_extensions.Annotated[
        typing.Optional[CreateProductsRequestSkuFieldDataEcSkuBillingMethod],
    ...
    ec_sku_subscription_plan: typing_extensions.Annotated[
        typing.Optional[CreateProductsRequestSkuFieldDataEcSkuSubscriptionPlan],
    ...
    sku_properties: typing_extensions.Annotated[
        typing.Optional[typing.List[CreateProductsRequestSkuFieldDataSkuPropertiesItem]],
