...
class ChangeSetHook(UniversalBaseModel):
    ...
    invocation_point: typing_extensions.Annotated[
        typing.Optional[ChangeSetHookInvocationPoint],
        FieldMetadata(alias="InvocationPoint"),
        pydantic.Field(
            alias="InvocationPoint", description="Specifies the points in provisioning logic where a hook is invoked."
        ),
    ] = None
    """
    ...
    failure_mode: typing_extensions.Annotated[
        typing.Optional[ChangeSetHookFailureMode],
        FieldMetadata(alias="FailureMode"),
        pydantic.Field(
            alias="FailureMode",
    ...
    type_version_id: typing_extensions.Annotated[
        typing.Optional[str],
        FieldMetadata(alias="TypeVersionId"),
        pydantic.Field(alias="TypeVersionId", description="The version ID of the type specified."),
    ] = None
    """
    ...
    type_configuration_version_id: typing_extensions.Annotated[
        typing.Optional[str],
        FieldMetadata(alias="TypeConfigurationVersionId"),
        pydantic.Field(alias="TypeConfigurationVersionId", description="The version ID of the type configuration."),
    ] = None
    """
    ...
    target_details: typing_extensions.Annotated[
        typing.Optional[ChangeSetHookTargetDetails],
        FieldMetadata(alias="TargetDetails"),
        pydantic.Field(
            alias="TargetDetails", description="Specifies details about the target that the hook will run against."
        ),
    ] = None
    """
