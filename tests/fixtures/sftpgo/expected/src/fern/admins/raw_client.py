...
class RawAdminsClient:
    ...
    ) -> HttpResponse[GenerateAdminTotpSecretResponse]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=GenerateAdminTotpSecretResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def get_admins(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[typing.List[Admin]]:
        """
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                ...
                "filters": convert_and_respect_annotation_metadata(
                    object_=filters, annotation=AdminFilters, direction="write"
                ),
                "additional_info": additional_info,
                "groups": convert_and_respect_annotation_metadata(
                    object_=groups, annotation=typing.Sequence[AdminGroupMapping], direction="write"
                ),
    ...
    def get_admin_by_username(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"admins/{encode_path_param(username)}",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def update_admin(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"admins/{encode_path_param(username_)}",
            method="PUT",
            json={
                "id": id,
                "status": status,
    ...
    def disable_admin2fa(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"admins/{encode_path_param(username)}/2fa/disable",
            method="PUT",
            request_options=request_options,
        )
        try:
    ...
    def admin_forgot_password(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"admins/{encode_path_param(username)}/forgot-password",
            method="POST",
            request_options=request_options,
        )
        try:
    ...
    def admin_reset_password(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"admins/{encode_path_param(username)}/reset-password",
            method="POST",
            json={
                "code": code,
                "password": password,
...
class AsyncRawAdminsClient:
    ...
    async def get_admin_profile(
        self, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[AdminProfile]:
        """
        Returns the profile for the logged in admin
    ...
    async def generate_admin_totp_secret(
        self, *, config_name: typing.Optional[str] = OMIT, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[GenerateAdminTotpSecretResponse]:
        """
        Generates a new TOTP secret, including the QR code as png, using the specified configuration for the logged in admin
    ...
    async def get_admins(
        ...
        *,
        ...
        order: typing.Optional[GetAdminsRequestOrder] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[typing.List[Admin]]:
        """
        Returns an array with one or more admins. For security reasons hashed passwords are omitted in the response
