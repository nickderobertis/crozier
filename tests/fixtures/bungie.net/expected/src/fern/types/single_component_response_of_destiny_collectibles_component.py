...
class SingleComponentResponseOfDestinyCollectiblesComponent(UniversalBaseModel):
    data: typing.Optional[DestinyComponentsCollectiblesDestinyCollectiblesComponent] = None
