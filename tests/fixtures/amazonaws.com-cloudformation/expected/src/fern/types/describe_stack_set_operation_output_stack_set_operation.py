...
class DescribeStackSetOperationOutputStackSetOperation(UniversalBaseModel):
    ...
    action: typing_extensions.Annotated[
        typing.Optional[DescribeStackSetOperationOutputStackSetOperationAction], FieldMetadata(alias="Action")
    ] = pydantic.Field(default=None)
    """
    ...
    status: typing_extensions.Annotated[
        typing.Optional[DescribeStackSetOperationOutputStackSetOperationStatus], FieldMetadata(alias="Status")
    ] = pydantic.Field(default=None)
    """
