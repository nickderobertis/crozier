...
class PolicyRiskScoreModelRuleDataCriteria(UniversalBaseModel):
    """
    ...
    exposure: typing.Optional[PolicyRiskScoreModelRuleDataCriteriaExposure] = pydantic.Field(default=None)
    """
    File exposure
    """
