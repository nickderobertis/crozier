...
class DocAnnotationsListAll200ResponsePagesItemAnnotationsItemPolylineMeasureRlAreaItem(UniversalBaseModel):
    unit: str
    ...
    label_position: typing_extensions.Annotated[
        typing.Optional[DocAnnotationsListAll200ResponsePagesItemAnnotationsItemPolylineMeasureRlAreaItemLabelPosition],
