...
class PutOauthClientClientIdRequestRequest(UniversalBaseModel):
    ...
    status: PutOauthClientClientIdRequestRequestStatus = pydantic.Field()
    """
    ...
    user_claims: typing_extensions.Annotated[
        typing.List[PutOauthClientClientIdRequestRequestUserClaimsItem],
    ...
    auth_context_refs: typing_extensions.Annotated[
        typing.List[PutOauthClientClientIdRequestRequestAuthContextRefsItem],
    ...
    grant_types: typing_extensions.Annotated[
        typing.List[PutOauthClientClientIdRequestRequestGrantTypesItem],
    ...
    client_auth_methods: typing_extensions.Annotated[
        typing.List[PutOauthClientClientIdRequestRequestClientAuthMethodsItem],
