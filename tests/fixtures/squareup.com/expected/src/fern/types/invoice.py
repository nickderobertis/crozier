...
class Invoice(UniversalBaseModel):
    ...
    accepted_payment_methods: typing.Optional[InvoiceAcceptedPaymentMethods] = None
    ...
    delivery_method: typing.Optional[InvoiceDeliveryMethodInvoiceDeliveryMethod] = None
    ...
    next_payment_amount_money: typing.Optional[Money] = None
    ...
    primary_recipient: typing.Optional[InvoiceRecipient] = None
