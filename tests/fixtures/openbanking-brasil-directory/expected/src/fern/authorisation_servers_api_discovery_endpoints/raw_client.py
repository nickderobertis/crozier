...
class RawAuthorisationServersApiDiscoveryEndpointsClient:
    ...
    def get_all_api_discovery_endpoints_for_the_given_authorisation_server_and_api_version(
        ...
        *,
    ...
    ) -> HttpResponse[ApiDiscoveryEndpoints]:
        """
        Parameters
        ----------
        organisation_id : OrganisationId
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"organisations/{encode_path_param(organisation_id)}/authorisationservers/{encode_path_param(authorisation_server_id)}/apiresources/{encode_path_param(api_resource_id)}/apidiscoveryendpoints",
            method="GET",
            params={
                "page": page,
                "size": size,
    ...
    def get_an_authorisation_server_api_discovery_endpoint_by_id(
        ...
        *,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[ApiDiscoveryEndpoint]:
        """
        Parameters
        ----------
        organisation_id : OrganisationId
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"organisations/{encode_path_param(organisation_id)}/authorisationservers/{encode_path_param(authorisation_server_id)}/apiresources/{encode_path_param(api_resource_id)}/apidiscoveryendpoints/{encode_path_param(api_discovery_endpoint_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
...
class AsyncRawAuthorisationServersApiDiscoveryEndpointsClient:
    ...
    async def get_all_api_discovery_endpoints_for_the_given_authorisation_server_and_api_version(
        ...
        *,
        ...
        sort: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[ApiDiscoveryEndpoints]:
        """
        Parameters
        ----------
        organisation_id : OrganisationId
    ...
    async def get_an_authorisation_server_api_discovery_endpoint_by_id(
        ...
        *,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[ApiDiscoveryEndpoint]:
        """
        Parameters
        ----------
        organisation_id : OrganisationId
