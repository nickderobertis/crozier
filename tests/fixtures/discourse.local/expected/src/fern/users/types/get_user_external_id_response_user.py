...
from .get_user_external_id_response_user_user_auth_tokens_item import GetUserExternalIdResponseUserUserAuthTokensItem
...
class GetUserExternalIdResponseUser(UniversalBaseModel):
    admin: bool
    ...
    created_at: str
    custom_fields: GetUserExternalIdResponseUserCustomFields
    ...
    group_users: typing.List[GetUserExternalIdResponseUserGroupUsersItem]
    groups: typing.List[GetUserExternalIdResponseUserGroupsItem]
    ...
    user_auth_tokens: typing.List[GetUserExternalIdResponseUserUserAuthTokensItem]
    user_fields: typing.Optional[GetUserExternalIdResponseUserUserFields] = None
    user_notification_schedule: GetUserExternalIdResponseUserUserNotificationSchedule
    user_option: GetUserExternalIdResponseUserUserOption
    username: str
