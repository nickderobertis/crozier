...
class CreateDistributionWithTagsRequestDistributionConfigWithTagsDistributionConfigPriceClass(enum.StrEnum):
    """
    ...
    def visit(
        ...
        if (
            self
            is CreateDistributionWithTagsRequestDistributionConfigWithTagsDistributionConfigPriceClass.PRICE_CLASS100
        ):
            return price_class100()
        if (
            self
            is CreateDistributionWithTagsRequestDistributionConfigWithTagsDistributionConfigPriceClass.PRICE_CLASS200
        ):
            return price_class200()
        if (
            self
            is CreateDistributionWithTagsRequestDistributionConfigWithTagsDistributionConfigPriceClass.PRICE_CLASS_ALL
        ):
