...
class ForumPostSearchResponse(UniversalBaseModel):
    ...
    available_pages: typing_extensions.Annotated[typing.Optional[int], FieldMetadata(alias="availablePages")] = None
    ...
    recruitment_details: typing_extensions.Annotated[
        typing.Optional[typing.List[ForumForumRecruitmentDetail]], FieldMetadata(alias="recruitmentDetails")
    ] = None
    related_posts: typing_extensions.Annotated[
        typing.Optional[typing.List[ForumPostResponse]], FieldMetadata(alias="relatedPosts")
    ] = None
    ...
    searched_tags: typing_extensions.Annotated[
        typing.Optional[typing.List[TagsModelsContractsTagResponse]], FieldMetadata(alias="searchedTags")
    ] = None
