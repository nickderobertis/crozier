...
class DescribeStackSetOutputStackSet(UniversalBaseModel):
    ...
    status: typing_extensions.Annotated[
        typing.Optional[DescribeStackSetOutputStackSetStatus], FieldMetadata(alias="Status")
    ] = pydantic.Field(default=None)
    """
    ...
    auto_deployment: typing_extensions.Annotated[
        typing.Optional[DescribeStackSetOutputStackSetAutoDeployment], FieldMetadata(alias="AutoDeployment")
    ] = pydantic.Field(default=None)
    """
    ...
    permission_model: typing_extensions.Annotated[
        typing.Optional[DescribeStackSetOutputStackSetPermissionModel], FieldMetadata(alias="PermissionModel")
    ] = pydantic.Field(default=None)
    """
    ...
    managed_execution: typing_extensions.Annotated[
        typing.Optional[DescribeStackSetOutputStackSetManagedExecution], FieldMetadata(alias="ManagedExecution")
    ] = pydantic.Field(default=None)
    """
