...
class DestinyEntitiesVendorsDestinyVendorComponent(UniversalBaseModel):
    ...
    can_purchase: typing_extensions.Annotated[typing.Optional[bool], FieldMetadata(alias="canPurchase")] = (
    ...
    next_refresh_date: typing_extensions.Annotated[
        typing.Optional[dt.datetime], FieldMetadata(alias="nextRefreshDate")
    ] = pydantic.Field(default=None)
    """
    ...
    seasonal_rank: typing_extensions.Annotated[typing.Optional[int], FieldMetadata(alias="seasonalRank")] = (
        pydantic.Field(default=None)
    )
    """
    ...
    vendor_location_index: typing_extensions.Annotated[
        typing.Optional[int], FieldMetadata(alias="vendorLocationIndex")
    ] = pydantic.Field(default=None)
    """
