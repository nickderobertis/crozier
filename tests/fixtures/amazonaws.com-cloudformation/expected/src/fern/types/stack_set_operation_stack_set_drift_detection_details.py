...
class StackSetOperationStackSetDriftDetectionDetails(UniversalBaseModel):
    """
    ...
    drift_status: typing_extensions.Annotated[
        typing.Optional[StackSetOperationStackSetDriftDetectionDetailsDriftStatus],
    ...
    drift_detection_status: typing_extensions.Annotated[
        typing.Optional[StackSetOperationStackSetDriftDetectionDetailsDriftDetectionStatus],
