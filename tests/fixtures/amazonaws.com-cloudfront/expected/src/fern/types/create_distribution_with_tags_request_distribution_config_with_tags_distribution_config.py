...
class CreateDistributionWithTagsRequestDistributionConfigWithTagsDistributionConfig(UniversalBaseModel):
    """
    ...
    aliases: typing_extensions.Annotated[
        typing.Optional[CreateDistributionWithTagsRequestDistributionConfigWithTagsDistributionConfigAliases],
    ...
    cache_behaviors: typing_extensions.Annotated[
        typing.Optional[CreateDistributionWithTagsRequestDistributionConfigWithTagsDistributionConfigCacheBehaviors],
    ...
    logging: typing_extensions.Annotated[
        typing.Optional[CreateDistributionWithTagsRequestDistributionConfigWithTagsDistributionConfigLogging],
    ...
    price_class: typing_extensions.Annotated[
        typing.Optional[CreateDistributionWithTagsRequestDistributionConfigWithTagsDistributionConfigPriceClass],
    ...
    http_version: typing_extensions.Annotated[
        typing.Optional[CreateDistributionWithTagsRequestDistributionConfigWithTagsDistributionConfigHttpVersion],
