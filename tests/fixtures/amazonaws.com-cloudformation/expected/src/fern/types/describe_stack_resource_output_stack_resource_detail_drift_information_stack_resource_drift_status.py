...
class DescribeStackResourceOutputStackResourceDetailDriftInformationStackResourceDriftStatus(str, enum.Enum):
    """
    ...
    def visit(
        ...
        if self is DescribeStackResourceOutputStackResourceDetailDriftInformationStackResourceDriftStatus.IN_SYNC:
            return in_sync()
        if self is DescribeStackResourceOutputStackResourceDetailDriftInformationStackResourceDriftStatus.MODIFIED:
            return modified()
        if self is DescribeStackResourceOutputStackResourceDetailDriftInformationStackResourceDriftStatus.DELETED:
            return deleted()
        if self is DescribeStackResourceOutputStackResourceDetailDriftInformationStackResourceDriftStatus.NOT_CHECKED:
            return not_checked()
