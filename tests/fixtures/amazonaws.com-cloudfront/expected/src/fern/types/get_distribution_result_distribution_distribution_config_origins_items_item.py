...
class GetDistributionResultDistributionDistributionConfigOriginsItemsItem(UniversalBaseModel):
    """
    ...
    custom_headers: typing_extensions.Annotated[
        typing.Optional[GetDistributionResultDistributionDistributionConfigOriginsItemsItemCustomHeaders],
    ...
    s3origin_config: typing_extensions.Annotated[
        typing.Optional[GetDistributionResultDistributionDistributionConfigOriginsItemsItemS3OriginConfig],
    ...
    custom_origin_config: typing_extensions.Annotated[
        typing.Optional[GetDistributionResultDistributionDistributionConfigOriginsItemsItemCustomOriginConfig],
