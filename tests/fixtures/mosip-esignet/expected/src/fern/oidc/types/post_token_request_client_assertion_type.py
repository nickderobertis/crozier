...
class PostTokenRequestClientAssertionType(enum.StrEnum):
    """
    ...
    def visit(self, urn_ietf_params_oauth_client_assertion_type_jwt_bearer: typing.Callable[[], T_Result]) -> T_Result:
        if self is PostTokenRequestClientAssertionType.URN_IETF_PARAMS_OAUTH_CLIENT_ASSERTION_TYPE_JWT_BEARER:
