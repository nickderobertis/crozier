...
class RawScheduledPaymentsClient:
    ...
    def get_accounts_account_id_scheduled_payments(
    ...
    ) -> HttpResponse[ObReadScheduledPayment3]:
        """
        Parameters
        ----------
        account_id : str
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"accounts/{encode_path_param(account_id)}/scheduled-payments",
            method="GET",
...
class AsyncRawScheduledPaymentsClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._client_wrapper = client_wrapper

    async def get_accounts_account_id_scheduled_payments(
        self, account_id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[ObReadScheduledPayment3]:
        """
        Parameters
        ----------
        account_id : str
