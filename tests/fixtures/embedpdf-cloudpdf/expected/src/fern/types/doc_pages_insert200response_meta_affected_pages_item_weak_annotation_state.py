...
class DocPagesInsert200ResponseMetaAffectedPagesItemWeakAnnotationState_Unknown(UniversalBaseModel):
...
class DocPagesInsert200ResponseMetaAffectedPagesItemWeakAnnotationState_Known(UniversalBaseModel):
...
DocPagesInsert200ResponseMetaAffectedPagesItemWeakAnnotationState = typing_extensions.Annotated[
    typing.Union[
