...
class RawSeriesPosterClient:
    ...
    def get_series_thumbnail(
        ...
        with self._client_wrapper.httpx_client.stream(
            f"api/v1/series/{encode_path_param(series_id)}/thumbnail",
            method="GET",
    ...
    def get_series_thumbnails(
        self, series_id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> HttpResponse[typing.List[ThumbnailSeriesDto]]:
        """
        Parameters
        ----------
        series_id : str
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"api/v1/series/{encode_path_param(series_id)}/thumbnails",
            method="GET",
            request_options=request_options,
        )
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=typing.List[ThumbnailSeriesDto],
                        object_=_response.json(),
                    ),
                )
    ...
    ) -> HttpResponse[ThumbnailSeriesDto]:
        """
        Required role: **ADMIN**
    ...
    def get_series_thumbnail_by_id(
        ...
        """
        with self._client_wrapper.httpx_client.stream(
            f"api/v1/series/{encode_path_param(series_id)}/thumbnails/{encode_path_param(thumbnail_id)}",
            method="GET",
            request_options=request_options,
        ) as _response:
    ...
    def mark_series_thumbnail_selected(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"api/v1/series/{encode_path_param(series_id)}/thumbnails/{encode_path_param(thumbnail_id)}/selected",
            method="PUT",
            request_options=request_options,
        )
        try:
...
class AsyncRawSeriesPosterClient:
    ...
    async def get_series_thumbnails(
        self, series_id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[typing.List[ThumbnailSeriesDto]]:
        """
        Parameters
        ----------
        series_id : str
    ...
    async def add_user_uploaded_series_thumbnail(
        ...
        *,
        ...
        selected: typing.Optional[bool] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[ThumbnailSeriesDto]:
        """
        Required role: **ADMIN**
