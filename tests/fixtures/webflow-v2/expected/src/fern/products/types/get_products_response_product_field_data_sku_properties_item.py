...
class GetProductsResponseProductFieldDataSkuPropertiesItem(UniversalBaseModel):
    """
    ...
    enum: typing.List[GetProductsResponseProductFieldDataSkuPropertiesItemEnumItem] = pydantic.Field()
    """
