...
class PostOauthDetailsV3Response(UniversalBaseModel):
    ...
    response: typing.Optional[PostOauthDetailsV3ResponseResponse] = None
    errors: typing.Optional[typing.List[PostOauthDetailsV3ResponseErrorsItem]] = pydantic.Field(default=None)
    """
