        ...
        * [Wikipedia, Variance](https://en.wikipedia.org/wiki/Variance)
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json=convert_and_respect_annotation_metadata(
                object_=request, annotation=PostAssetsVarianceRequest, direction="write"
            ),
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=PostAssetsVarianceResponse,
...
class AsyncRawAssetsVarianceClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._client_wrapper = client_wrapper

    async def variance(
        self, *, request: PostAssetsVarianceRequest, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[PostAssetsVarianceResponse]:
        """
        Compute the variance of one or several asset(s) from either:
        * The asset returns
        * The asset covariance matrix
