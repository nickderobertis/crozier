...
class RawStatsClient:
    ...
    def global_live_stats(self, *, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[Stats]:
        """
    ...
    def service_live_stats(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"api/live/{encode_path_param(id)}",
            method="GET",
            request_options=request_options,
        )
        try:
