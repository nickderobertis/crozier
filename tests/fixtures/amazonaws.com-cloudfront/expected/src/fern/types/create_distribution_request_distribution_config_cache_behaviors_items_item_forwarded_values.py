...
class CreateDistributionRequestDistributionConfigCacheBehaviorsItemsItemForwardedValues(UniversalBaseModel):
    """
    ...
    headers: typing_extensions.Annotated[
        typing.Optional[CreateDistributionRequestDistributionConfigCacheBehaviorsItemsItemForwardedValuesHeaders],
