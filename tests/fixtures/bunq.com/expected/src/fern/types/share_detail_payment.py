...
class ShareDetailPayment(UniversalBaseModel):
    make_draft_payments: typing.Optional[bool] = pydantic.Field(default=None)
    """
    If set to true, the invited user will be able to make draft payments from the shared account.
    """

    make_payments: typing.Optional[bool] = pydantic.Field(default=None)
    """
