...
class ClientSideAccessTokensCreateClientSideAccessTokenResponsePolicy(UniversalBaseModel):
    version: ClientSideAccessTokensCreateClientSideAccessTokenResponsePolicyVersion
