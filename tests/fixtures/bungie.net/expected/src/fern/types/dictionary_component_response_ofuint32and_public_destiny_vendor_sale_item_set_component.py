...
class DictionaryComponentResponseOfuint32AndPublicDestinyVendorSaleItemSetComponent(UniversalBaseModel):
    data: typing.Optional[typing.Dict[str, DestinyResponsesPublicDestinyVendorSaleItemSetComponent]] = None
