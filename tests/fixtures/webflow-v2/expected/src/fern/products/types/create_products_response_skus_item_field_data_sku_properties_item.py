...
class CreateProductsResponseSkusItemFieldDataSkuPropertiesItem(UniversalBaseModel):
    """
    ...
    enum: typing.List[CreateProductsResponseSkusItemFieldDataSkuPropertiesItemEnumItem] = pydantic.Field()
    """
