...
class DeviceWithConfigContext(UniversalBaseModel):
    airflow: typing.Optional[DeviceWithConfigContextAirflow] = None
    ...
    status: typing.Optional[DeviceWithConfigContextStatus] = None
