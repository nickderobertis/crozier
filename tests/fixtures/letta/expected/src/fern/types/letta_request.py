...
class LettaRequest(UniversalBaseModel):
    messages: typing.Optional[typing.List[LettaRequestMessagesItem]] = pydantic.Field(default=None)
    """
    The messages to be sent to the agent.
    """

    input: typing.Optional[LettaRequestInput] = pydantic.Field(default=None)
    """
