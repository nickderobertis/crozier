...
from ...types.destiny_responses_destiny_linked_profiles_response import DestinyResponsesDestinyLinkedProfilesResponse


class Destiny2GetLinkedProfilesResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[DestinyResponsesDestinyLinkedProfilesResponse], FieldMetadata(alias="Response")
    ] = None
