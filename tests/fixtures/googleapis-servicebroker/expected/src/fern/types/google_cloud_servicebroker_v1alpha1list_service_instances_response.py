...
class GoogleCloudServicebrokerV1Alpha1ListServiceInstancesResponse(UniversalBaseModel):
    """
    ...
    instances: typing.Optional[typing.List[GoogleCloudServicebrokerV1Alpha1ServiceInstance]] = pydantic.Field(
        default=None
    )
    """
