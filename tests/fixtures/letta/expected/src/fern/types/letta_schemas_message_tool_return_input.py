...
class LettaSchemasMessageToolReturnInput(UniversalBaseModel):
    tool_call_id: typing.Optional[typing.Any] = pydantic.Field(default=None)
    """
    The ID for the tool call
    """

    status: LettaSchemasMessageToolReturnInputStatus = pydantic.Field()
    """
    ...
    func_response: typing.Optional[LettaSchemasMessageToolReturnInputFuncResponse] = pydantic.Field(default=None)
    """
