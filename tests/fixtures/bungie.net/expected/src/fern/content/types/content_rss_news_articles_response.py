...
from ...types.content_news_article_rss_response import ContentNewsArticleRssResponse


class ContentRssNewsArticlesResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[ContentNewsArticleRssResponse], FieldMetadata(alias="Response")
    ] = None
