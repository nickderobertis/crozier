...
from ...types.content_models_content_type_description import ContentModelsContentTypeDescription


class ContentGetContentTypeResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[ContentModelsContentTypeDescription], FieldMetadata(alias="Response")
    ] = None
...
update_forward_refs(ContentGetContentTypeResponse)
