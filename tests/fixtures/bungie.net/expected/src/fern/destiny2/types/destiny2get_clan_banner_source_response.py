...
from ...types.config_clan_banner_clan_banner_source import ConfigClanBannerClanBannerSource


class Destiny2GetClanBannerSourceResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[ConfigClanBannerClanBannerSource], FieldMetadata(alias="Response")
    ] = None
