...
from ...types.fireteam_fireteam_response import FireteamFireteamResponse


class FireteamGetClanFireteamResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[FireteamFireteamResponse], FieldMetadata(alias="Response"), pydantic.Field(alias="Response")
    ] = None
