...
class DescribeTypeInputType(str, enum.Enum):
    """
    ...
    def visit(
        ...
        if self is DescribeTypeInputType.RESOURCE:
            return resource()
        if self is DescribeTypeInputType.MODULE:
            return module()
        if self is DescribeTypeInputType.HOOK:
            return hook()
