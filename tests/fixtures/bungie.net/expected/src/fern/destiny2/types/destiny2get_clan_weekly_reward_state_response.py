...
from ...types.destiny_milestones_destiny_milestone import DestinyMilestonesDestinyMilestone


class Destiny2GetClanWeeklyRewardStateResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[DestinyMilestonesDestinyMilestone], FieldMetadata(alias="Response")
    ] = None
