...
class BaseAlarmTriggerPositionProperties(CreatedAtField):
    ...
    type: typing.Optional[BaseAlarmTriggerPositionPropertiesType] = None
    fix_status: typing_extensions.Annotated[
        typing.Optional[BaseAlarmTriggerPositionPropertiesFixStatus],
