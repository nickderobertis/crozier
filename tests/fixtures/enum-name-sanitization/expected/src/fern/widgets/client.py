...
class WidgetsClient:
    ...
    def list_widgets(
        self, *, size: typing.Optional[str] = None, request_options: typing.Optional[RequestOptions] = None
    ) -> Widget:
        """
        Parameters
        ----------
        ...
        """
        _response = self._raw_client.list_widgets(size=size, request_options=request_options)
...
class AsyncWidgetsClient:
    ...
    async def list_widgets(
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.list_widgets(size=size, request_options=request_options)
        return _response.data
