...
class DistributionSummaryListItemDefaultCacheBehaviorLambdaFunctionAssociations(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[
            typing.List[DistributionSummaryListItemDefaultCacheBehaviorLambdaFunctionAssociationsItemsItem]
        ],
