...
from .create_products_response_product_field_data_tax_category import CreateProductsResponseProductFieldDataTaxCategory


class CreateProductsResponseProductFieldData(UniversalBaseModel):
    """
    ...
    sku_properties: typing_extensions.Annotated[
        typing.Optional[typing.List[CreateProductsResponseProductFieldDataSkuPropertiesItem]],
    ...
    tax_category: typing_extensions.Annotated[
        typing.Optional[CreateProductsResponseProductFieldDataTaxCategory],
    ...
    ec_product_type: typing_extensions.Annotated[
        typing.Optional[CreateProductsResponseProductFieldDataEcProductType],
