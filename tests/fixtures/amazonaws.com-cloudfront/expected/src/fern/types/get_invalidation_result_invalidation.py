...
from .get_invalidation_result_invalidation_invalidation_batch import GetInvalidationResultInvalidationInvalidationBatch


class GetInvalidationResultInvalidation(UniversalBaseModel):
    """
