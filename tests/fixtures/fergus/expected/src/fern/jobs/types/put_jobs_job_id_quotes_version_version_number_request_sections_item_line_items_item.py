...
class PutJobsJobIdQuotesVersionVersionNumberRequestSectionsItemLineItemsItem(UniversalBaseModel):
    quote_line_item_id: typing_extensions.Annotated[
        typing.Optional[float], FieldMetadata(alias="quoteLineItemId"), pydantic.Field(alias="quoteLineItemId")
    ] = None
