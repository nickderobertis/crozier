...
class UpdateDistributionRequestDistributionConfigDefaultCacheBehaviorForwardedValues(UniversalBaseModel):
    """
    ...
    headers: typing_extensions.Annotated[
        typing.Optional[UpdateDistributionRequestDistributionConfigDefaultCacheBehaviorForwardedValuesHeaders],
