...
class DestinyDefinitionsDestinyItemInvestmentStatDefinition(UniversalBaseModel):
    ...
    is_conditionally_active: typing_extensions.Annotated[
        typing.Optional[bool], FieldMetadata(alias="isConditionallyActive")
    ...
    stat_type_hash: typing_extensions.Annotated[typing.Optional[int], FieldMetadata(alias="statTypeHash")] = (
        pydantic.Field(default=None)
    )
    """
