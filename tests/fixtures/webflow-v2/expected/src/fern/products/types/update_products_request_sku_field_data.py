...
class UpdateProductsRequestSkuFieldData(UniversalBaseModel):
    """
    ...
    price: UpdateProductsRequestSkuFieldDataPrice = pydantic.Field()
    """
    price of SKU
    """

    compare_at_price: typing_extensions.Annotated[
        typing.Optional[UpdateProductsRequestSkuFieldDataCompareAtPrice],
    ...
    ec_sku_billing_method: typing_extensions.Annotated[
        typing.Optional[UpdateProductsRequestSkuFieldDataEcSkuBillingMethod],
    ...
    ec_sku_subscription_plan: typing_extensions.Annotated[
        typing.Optional[UpdateProductsRequestSkuFieldDataEcSkuSubscriptionPlan],
    ...
    sku_properties: typing_extensions.Annotated[
        typing.Optional[typing.List[UpdateProductsRequestSkuFieldDataSkuPropertiesItem]],
