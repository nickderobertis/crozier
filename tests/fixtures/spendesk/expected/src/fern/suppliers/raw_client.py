...
class RawSuppliersClient:
    ...
    def updatesuppliers(
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json=convert_and_respect_annotation_metadata(
                object_=request, annotation=typing.Sequence[SupplierInput], direction="write"
            ),
            request_options=request_options,
            omit=OMIT,
        )
    ...
    def getsupplier(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[None]:
        """
        Parameters
        ----------
        id : str
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"suppliers/{encode_path_param(id)}",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def updatesupplierstatus(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"suppliers/{encode_path_param(id)}/status",
            method="PATCH",
            json={
                "status": status,
            },
