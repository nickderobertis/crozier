...
from ...types.config_user_theme import ConfigUserTheme


class UserGetAvailableThemesResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[typing.List[ConfigUserTheme]], FieldMetadata(alias="Response"), pydantic.Field(alias="Response")
    ] = None
