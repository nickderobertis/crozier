...
from .update_products_response_field_data_sku_properties_item import UpdateProductsResponseFieldDataSkuPropertiesItem
from .update_products_response_field_data_tax_category import UpdateProductsResponseFieldDataTaxCategory


class UpdateProductsResponseFieldData(UniversalBaseModel):
    """
    ...
    sku_properties: typing_extensions.Annotated[
        typing.Optional[typing.List[UpdateProductsResponseFieldDataSkuPropertiesItem]],
    ...
    tax_category: typing_extensions.Annotated[
        typing.Optional[UpdateProductsResponseFieldDataTaxCategory],
    ...
    ec_product_type: typing_extensions.Annotated[
        typing.Optional[UpdateProductsResponseFieldDataEcProductType],
