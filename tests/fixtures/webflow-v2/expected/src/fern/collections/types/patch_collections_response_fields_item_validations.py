...
class PatchCollectionsResponseFieldsItemValidations(UniversalBaseModel):
    """
    The validations for the field
    """

    additional_properties: typing_extensions.Annotated[
        typing.Optional[PatchCollectionsResponseFieldsItemValidationsAdditionalProperties],
