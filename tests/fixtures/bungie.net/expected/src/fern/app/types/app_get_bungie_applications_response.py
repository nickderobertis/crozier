...
from ...types.applications_application import ApplicationsApplication


class AppGetBungieApplicationsResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[typing.List[ApplicationsApplication]], FieldMetadata(alias="Response")
    ] = None
