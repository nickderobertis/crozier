...
class GetDistributionConfigResultDistributionConfigDefaultCacheBehaviorForwardedValues(UniversalBaseModel):
    """
    ...
    headers: typing_extensions.Annotated[
        typing.Optional[GetDistributionConfigResultDistributionConfigDefaultCacheBehaviorForwardedValuesHeaders],
