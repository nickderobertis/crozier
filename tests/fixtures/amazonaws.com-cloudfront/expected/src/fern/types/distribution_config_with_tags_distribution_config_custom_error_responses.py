...
class DistributionConfigWithTagsDistributionConfigCustomErrorResponses(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[typing.List[DistributionConfigWithTagsDistributionConfigCustomErrorResponsesItemsItem]],
