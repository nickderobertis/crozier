...
class JobsClient:
    ...
    def list_active_jobs(
        ...
        *,
        ...
        """
        _response = self._raw_client.list_active_jobs(
            source_id=source_id,
            before=before,
            after=after,
            limit=limit,
    ...
    def retrieve_job(self, job_id: str, *, request_options: typing.Optional[RequestOptions] = None) -> Job:
        """
    ...
    def delete_job(self, job_id: str, *, request_options: typing.Optional[RequestOptions] = None) -> Job:
        """
...
class AsyncJobsClient:
    ...
    async def list_active_jobs(
        ...
        *,
        ...
        async def main() -> None:
            await client.jobs.list_active_jobs()


        asyncio.run(main())
        """
        _response = await self._raw_client.list_active_jobs(
            source_id=source_id,
            before=before,
            after=after,
            limit=limit,
    ...
    async def retrieve_job(self, job_id: str, *, request_options: typing.Optional[RequestOptions] = None) -> Job:
        """
        Get the status of a job.
        ...
        async def main() -> None:
            await client.jobs.retrieve_job(
                job_id="job-123e4567-e89b-42d3-8456-426614174000",
            )
    ...
    async def delete_job(self, job_id: str, *, request_options: typing.Optional[RequestOptions] = None) -> Job:
        """
        Delete a job by its job_id.
