...
class RegisterQueueResponseRealmUserSettingsDefaults(UniversalBaseModel):
    """
    ...
    **Changes**: New in Zulip 11.0 (feature level 385).
    ...
    emojiset_choices: typing.Optional[
        typing.List[RegisterQueueResponseRealmUserSettingsDefaultsEmojisetChoicesItem]
