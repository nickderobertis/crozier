...
class DistributionListItemsItemDefaultCacheBehaviorForwardedValuesCookies(UniversalBaseModel):
    """
    ...
    whitelisted_names: typing_extensions.Annotated[
        typing.Optional[DistributionListItemsItemDefaultCacheBehaviorForwardedValuesCookiesWhitelistedNames],
