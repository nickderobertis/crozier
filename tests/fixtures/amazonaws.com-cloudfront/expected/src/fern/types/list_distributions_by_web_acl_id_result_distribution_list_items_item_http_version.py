...
class ListDistributionsByWebAclIdResultDistributionListItemsItemHttpVersion(enum.StrEnum):
    """
    ...
    def visit(self, http11: typing.Callable[[], T_Result], http2: typing.Callable[[], T_Result]) -> T_Result:
        if self is ListDistributionsByWebAclIdResultDistributionListItemsItemHttpVersion.HTTP11:
            return http11()
        if self is ListDistributionsByWebAclIdResultDistributionListItemsItemHttpVersion.HTTP2:
            return http2()
