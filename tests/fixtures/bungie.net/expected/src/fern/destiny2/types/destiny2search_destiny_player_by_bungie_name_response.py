...
from ...types.user_user_info_card import UserUserInfoCard


class Destiny2SearchDestinyPlayerByBungieNameResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[typing.List[UserUserInfoCard]], FieldMetadata(alias="Response")
    ] = None
