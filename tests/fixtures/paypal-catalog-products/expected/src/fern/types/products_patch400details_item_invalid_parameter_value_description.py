...
class ProductsPatch400DetailsItemInvalidParameterValueDescription(enum.StrEnum):
    ...
    def visit(self, the_value_of_a_field_is_invalid: typing.Callable[[], T_Result]) -> T_Result:
        if self is ProductsPatch400DetailsItemInvalidParameterValueDescription.THE_VALUE_OF_A_FIELD_IS_INVALID:
