...
class MessagesBase(UniversalBaseModel):
    """
    ...
    **Changes**: Before Zulip 7.0 (feature level 163), access to a
    ...
    display_recipient: typing.Optional[MessagesBaseDisplayRecipient] = pydantic.Field(default=None)
    """
    ...
    edit_history: typing.Optional[typing.List[MessagesBaseEditHistoryItem]] = pydantic.Field(default=None)
    """
    ...
    **Changes**: Before Zulip 10.0 (feature level 334), `empty_topic_name`
    ...
    submessages: typing.Optional[typing.List[MessagesBaseSubmessagesItem]] = pydantic.Field(default=None)
    """
    ...
    topic_links: typing.Optional[typing.List[MessagesBaseTopicLinksItem]] = pydantic.Field(default=None)
    """
