...
class DistributionSummaryCacheBehaviorsItemsItemForwardedValues(UniversalBaseModel):
    """
    ...
    headers: typing_extensions.Annotated[
        typing.Optional[DistributionSummaryCacheBehaviorsItemsItemForwardedValuesHeaders],
    ...
    query_string_cache_keys: typing_extensions.Annotated[
        typing.Optional[DistributionSummaryCacheBehaviorsItemsItemForwardedValuesQueryStringCacheKeys],
