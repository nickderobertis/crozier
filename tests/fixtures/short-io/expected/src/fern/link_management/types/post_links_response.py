...
class PostLinksResponse(UniversalBaseModel):
    ...
    expires_at: typing_extensions.Annotated[
        typing.Optional[PostLinksResponseExpiresAt],
    ...
    ttl: typing.Optional[PostLinksResponseTtl] = pydantic.Field(default=None)
    """
    ...
    split_urlv2: typing_extensions.Annotated[
        typing.Optional[typing.List[PostLinksResponseSplitUrlv2Item]],
    ...
    redirect_type: typing_extensions.Annotated[
        typing.Optional[PostLinksResponseRedirectType],
    ...
    source: typing.Optional[PostLinksResponseSource] = pydantic.Field(default=None)
    """
    Link source
    """

    user: typing_extensions.Annotated[
        typing.Optional[PostLinksResponseUser], FieldMetadata(alias="User"), pydantic.Field(alias="User")
    ] = None
