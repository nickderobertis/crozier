...
class RawExportRibClient:
    ...
    def list_all_export_rib_for_user_monetary_account(
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"user/{jsonable_encoder(user_id)}/monetary-account/{jsonable_encoder(monetary_account_id)}/export-rib",
            method="GET",
    ...
    def read_export_rib_for_user_monetary_account(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"user/{jsonable_encoder(user_id)}/monetary-account/{jsonable_encoder(monetary_account_id)}/export-rib/{jsonable_encoder(item_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
