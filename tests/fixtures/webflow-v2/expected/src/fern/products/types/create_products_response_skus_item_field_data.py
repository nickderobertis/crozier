...
class CreateProductsResponseSkusItemFieldData(UniversalBaseModel):
    """
    ...
    price: CreateProductsResponseSkusItemFieldDataPrice = pydantic.Field()
    """
    price of SKU
    """

    compare_at_price: typing_extensions.Annotated[
        typing.Optional[CreateProductsResponseSkusItemFieldDataCompareAtPrice],
    ...
    ec_sku_billing_method: typing_extensions.Annotated[
        typing.Optional[CreateProductsResponseSkusItemFieldDataEcSkuBillingMethod],
    ...
    ec_sku_subscription_plan: typing_extensions.Annotated[
        typing.Optional[CreateProductsResponseSkusItemFieldDataEcSkuSubscriptionPlan],
    ...
    sku_properties: typing_extensions.Annotated[
        typing.Optional[typing.List[CreateProductsResponseSkusItemFieldDataSkuPropertiesItem]],
