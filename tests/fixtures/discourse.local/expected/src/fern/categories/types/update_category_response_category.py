...
from .update_category_response_category_group_permissions_item import UpdateCategoryResponseCategoryGroupPermissionsItem
...
class UpdateCategoryResponseCategory(UniversalBaseModel):
    ...
    can_edit: bool
    color: str
    custom_fields: UpdateCategoryResponseCategoryCustomFields
    ...
    form_template_ids: typing.List[typing.Optional[typing.Any]]
    group_permissions: typing.List[UpdateCategoryResponseCategoryGroupPermissionsItem]
    ...
    required_tag_groups: typing.List[UpdateCategoryResponseCategoryRequiredTagGroupsItem]
    search_priority: int
