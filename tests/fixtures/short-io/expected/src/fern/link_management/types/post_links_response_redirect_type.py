...
class PostLinksResponseRedirectType(enum.StrEnum):
    """
    ...
    def visit(
        ...
        if self is PostLinksResponseRedirectType.THREE_HUNDRED_ONE:
            return three_hundred_one()
        if self is PostLinksResponseRedirectType.THREE_HUNDRED_TWO:
            return three_hundred_two()
        if self is PostLinksResponseRedirectType.THREE_HUNDRED_SEVEN:
            return three_hundred_seven()
        if self is PostLinksResponseRedirectType.THREE_HUNDRED_EIGHT:
