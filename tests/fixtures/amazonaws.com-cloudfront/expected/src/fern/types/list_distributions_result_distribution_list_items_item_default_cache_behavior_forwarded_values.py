...
class ListDistributionsResultDistributionListItemsItemDefaultCacheBehaviorForwardedValues(UniversalBaseModel):
    """
    ...
    headers: typing_extensions.Annotated[
        typing.Optional[ListDistributionsResultDistributionListItemsItemDefaultCacheBehaviorForwardedValuesHeaders],
