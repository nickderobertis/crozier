...
class DistributionListItemsItemDefaultCacheBehaviorLambdaFunctionAssociationsItemsItem(UniversalBaseModel):
    """
    ...
    event_type: typing_extensions.Annotated[
        typing.Optional[DistributionListItemsItemDefaultCacheBehaviorLambdaFunctionAssociationsItemsItemEventType],
