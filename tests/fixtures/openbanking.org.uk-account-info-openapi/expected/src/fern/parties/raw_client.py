...
class RawPartiesClient:
    ...
    def get_accounts_account_id_parties(
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"accounts/{encode_path_param(account_id)}/parties",
            method="GET",
    ...
    def get_accounts_account_id_party(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"accounts/{encode_path_param(account_id)}/party",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def get_party(self, *, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[ObReadParty2]:
        """
        Parameters
        ----------
        request_options : typing.Optional[RequestOptions]
...
class AsyncRawPartiesClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._client_wrapper = client_wrapper

    async def get_accounts_account_id_parties(
        self, account_id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[ObReadParty3]:
        """
        Parameters
        ----------
        account_id : str
    ...
    async def get_accounts_account_id_party(
        self, account_id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[ObReadParty2]:
        """
        Parameters
        ----------
        account_id : str
