...
class DictionaryComponentResponseOfuint32AndDestinyItemPlugObjectivesComponent(UniversalBaseModel):
    data: typing.Optional[typing.Dict[str, DestinyComponentsItemsDestinyItemPlugObjectivesComponent]] = None
