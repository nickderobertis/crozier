...
class UpdateStreamingDistributionRequestStreamingDistributionConfig(UniversalBaseModel):
    """
    ...
    aliases: typing_extensions.Annotated[
        typing.Optional[UpdateStreamingDistributionRequestStreamingDistributionConfigAliases],
    ...
    logging: typing_extensions.Annotated[
        typing.Optional[UpdateStreamingDistributionRequestStreamingDistributionConfigLogging],
    ...
    price_class: typing_extensions.Annotated[
        typing.Optional[UpdateStreamingDistributionRequestStreamingDistributionConfigPriceClass],
