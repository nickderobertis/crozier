...
from ...types.search_result_of_group_member_application import SearchResultOfGroupMemberApplication


class GroupV2GetInvitedIndividualsResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[SearchResultOfGroupMemberApplication], FieldMetadata(alias="Response")
    ] = None
