...
class StackSetStackSetDriftDetectionDetailsDriftDetectionStatus(str, enum.Enum):
    """
    ...
    def visit(
        ...
        if self is StackSetStackSetDriftDetectionDetailsDriftDetectionStatus.COMPLETED:
            return completed()
        if self is StackSetStackSetDriftDetectionDetailsDriftDetectionStatus.FAILED:
            return failed()
        if self is StackSetStackSetDriftDetectionDetailsDriftDetectionStatus.PARTIAL_SUCCESS:
            return partial_success()
        if self is StackSetStackSetDriftDetectionDetailsDriftDetectionStatus.IN_PROGRESS:
            return in_progress()
        if self is StackSetStackSetDriftDetectionDetailsDriftDetectionStatus.STOPPED:
            return stopped()
