...
class UpdateSitesResponse(UniversalBaseModel):
    ...
    custom_domains: typing_extensions.Annotated[
        typing.Optional[typing.List[UpdateSitesResponseCustomDomainsItem]],
        FieldMetadata(alias="customDomains"),
        pydantic.Field(alias="customDomains"),
    ] = None
    locales: typing.Optional[UpdateSitesResponseLocales] = None
    ...
    data_collection_type: typing_extensions.Annotated[
        typing.Optional[UpdateSitesResponseDataCollectionType],
