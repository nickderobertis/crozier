...
class GetDistributionConfigResultDistributionConfigDefaultCacheBehavior(UniversalBaseModel):
    """
    ...
    lambda_function_associations: typing_extensions.Annotated[
        typing.Optional[GetDistributionConfigResultDistributionConfigDefaultCacheBehaviorLambdaFunctionAssociations],
