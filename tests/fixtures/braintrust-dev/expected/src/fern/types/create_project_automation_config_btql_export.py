...
class CreateProjectAutomationConfigBtqlExport(UniversalBaseModel):
    export_definition: CreateProjectAutomationConfigBtqlExportExportDefinition = pydantic.Field()
    """
    ...
    format: CreateProjectAutomationConfigBtqlExportFormat = pydantic.Field()
    """
