...
class CreateSkuProductsResponseSkusItemFieldDataEcSkuSubscriptionPlan(UniversalBaseModel):
    """
    ...
    interval: typing.Optional[CreateSkuProductsResponseSkusItemFieldDataEcSkuSubscriptionPlanInterval] = pydantic.Field(
        default=None
    )
    """
    ...
    plans: typing.Optional[typing.List[CreateSkuProductsResponseSkusItemFieldDataEcSkuSubscriptionPlanPlansItem]] = None
