...
class ListDistributionsByWebAclIdResultDistributionList(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[typing.List[ListDistributionsByWebAclIdResultDistributionListItemsItem]],
