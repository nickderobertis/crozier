...
class GetEventsResponseEventsItemSixtySeven(UniversalBaseModel):
    """
    ...
    **Changes**: Starting with Zulip 10.0 (feature level 303), this
    ...
    type: typing.Optional[GetEventsResponseEventsItemSixtySevenType] = pydantic.Field(default=None)
    """
    The event's type, relevant both for client-side dispatch and server-side
    filtering by event type in [POST /register](/api/register-queue).
    """

    op: typing.Optional[GetEventsResponseEventsItemSixtySevenOp] = None
    ...
    **Deprecated** and will be removed in a future release.
    ...
    data: typing.Optional[GetEventsResponseEventsItemSixtySevenData] = pydantic.Field(default=None)
    """
