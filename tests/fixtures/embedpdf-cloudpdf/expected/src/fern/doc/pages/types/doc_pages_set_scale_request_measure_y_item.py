...
from .doc_pages_set_scale_request_measure_y_item_label_position import DocPagesSetScaleRequestMeasureYItemLabelPosition


class DocPagesSetScaleRequestMeasureYItem(UniversalBaseModel):
    unit: str
    conversion: float
    fraction: typing.Optional[DocPagesSetScaleRequestMeasureYItemFraction] = None
    ...
    label_position: typing_extensions.Annotated[
        typing.Optional[DocPagesSetScaleRequestMeasureYItemLabelPosition],
