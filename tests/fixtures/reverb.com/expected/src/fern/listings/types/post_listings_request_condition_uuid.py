...
class PostListingsRequestConditionUuid(str, enum.Enum):
    """
    Condition UUID
    """
    ...
    def visit(
        ...
        if self is PostListingsRequestConditionUuid.FBF3566896A04BAA_BCDE_AB18D6B1B329:
            return fbf3566896a04baa_bcde_ab18d6b1b329()
        if self is PostListingsRequestConditionUuid.SIX_A9DFCAD600B46C89E08CE6E5057921E:
            return six_a9dfcad600b46c89e08ce6e5057921e()
        if self is PostListingsRequestConditionUuid.UNDEFINED76D044C8865E_BB40E669E934:
            return undefined76d044c8865e_bb40e669e934()
        if self is PostListingsRequestConditionUuid.F7A3F48C972A44C6B01A0CD27488D3F6:
            return f7a3f48c972a44c6b01a0cd27488d3f6()
        if self is PostListingsRequestConditionUuid.AE4D91141BD74EC5A4BA6653AF5AC84D:
            return ae4d91141bd74ec5a4ba6653af5ac84d()
        if self is PostListingsRequestConditionUuid.DF268AD1C4624BA6B6DB_E007E23922EA:
            return df268ad1c4624ba6b6db_e007e23922ea()
        if self is PostListingsRequestConditionUuid.AC5B9C1E_DC78466DB0B37CF712967A48:
            return ac5b9c1e_dc78466db0b37cf712967a48()
        if self is PostListingsRequestConditionUuid.SIX_DB7DF88293B4017A1C1CDB5E599FA1A:
            return six_db7df88293b4017a1c1cdb5e599fa1a()
        if self is PostListingsRequestConditionUuid.UNDEFINED_F60C24413AD181F5EBA7A856F:
            return undefined_f60c24413ad181f5eba7a856f()
        if self is PostListingsRequestConditionUuid.SEVEN_C3F45DE2AE04C818400FDB6B1D74890:
