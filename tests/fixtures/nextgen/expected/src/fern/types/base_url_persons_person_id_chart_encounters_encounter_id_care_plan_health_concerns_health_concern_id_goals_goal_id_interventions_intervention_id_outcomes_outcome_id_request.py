...
class BaseUrlPersonsPersonIdChartEncountersEncounterIdCarePlanHealthConcernsHealthConcernIdGoalsGoalIdInterventionsInterventionIdOutcomesOutcomeIdRequest(
    UniversalBaseModel
):
    outcome: str
