...
class UpdateContentComponentsRequestNodesItemChoices(UniversalBaseModel):
    """
    ...
    choices: typing.List[UpdateContentComponentsRequestNodesItemChoicesChoicesItem] = pydantic.Field()
    """
