...
class MessageResponse(UniversalBaseModel):
    ...
    stickers: typing.Optional[typing.List[MessageResponseStickersItem]] = None
    ...
    nonce: typing.Optional[MessageResponseNonce] = None
    ...
    interaction_metadata: typing.Optional[MessageResponseInteractionMetadata] = None
    message_snapshots: typing.Optional[typing.List[MessageSnapshotResponse]] = None
    reactions: typing.Optional[typing.List[MessageReactionResponse]] = None
    referenced_message: typing.Optional[BasicMessageResponse] = None
