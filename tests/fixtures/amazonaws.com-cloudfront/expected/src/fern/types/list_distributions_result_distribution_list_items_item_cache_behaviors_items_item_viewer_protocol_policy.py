...
class ListDistributionsResultDistributionListItemsItemCacheBehaviorsItemsItemViewerProtocolPolicy(enum.StrEnum):
    """
    ...
    def visit(
        ...
        if (
            self
            is ListDistributionsResultDistributionListItemsItemCacheBehaviorsItemsItemViewerProtocolPolicy.ALLOW_ALL
        ):
            return allow_all()
        if (
            self
            is ListDistributionsResultDistributionListItemsItemCacheBehaviorsItemsItemViewerProtocolPolicy.HTTPS_ONLY
        ):
            return https_only()
        if (
            self
            is ListDistributionsResultDistributionListItemsItemCacheBehaviorsItemsItemViewerProtocolPolicy.REDIRECT_TO_HTTPS
        ):
