...
from .update_distribution_request_distribution_config_aliases import UpdateDistributionRequestDistributionConfigAliases
...
from .update_distribution_request_distribution_config_logging import UpdateDistributionRequestDistributionConfigLogging
from .update_distribution_request_distribution_config_origins import UpdateDistributionRequestDistributionConfigOrigins
...
class UpdateDistributionRequestDistributionConfig(UniversalBaseModel):
    """
    ...
    aliases: typing_extensions.Annotated[
        typing.Optional[UpdateDistributionRequestDistributionConfigAliases],
    ...
    cache_behaviors: typing_extensions.Annotated[
        typing.Optional[UpdateDistributionRequestDistributionConfigCacheBehaviors],
    ...
    custom_error_responses: typing_extensions.Annotated[
        typing.Optional[UpdateDistributionRequestDistributionConfigCustomErrorResponses],
    ...
    logging: typing_extensions.Annotated[
        typing.Optional[UpdateDistributionRequestDistributionConfigLogging],
    ...
    price_class: typing_extensions.Annotated[
        typing.Optional[UpdateDistributionRequestDistributionConfigPriceClass],
    ...
    http_version: typing_extensions.Annotated[
        typing.Optional[UpdateDistributionRequestDistributionConfigHttpVersion],
