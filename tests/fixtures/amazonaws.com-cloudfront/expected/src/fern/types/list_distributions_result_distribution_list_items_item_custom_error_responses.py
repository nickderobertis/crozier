...
class ListDistributionsResultDistributionListItemsItemCustomErrorResponses(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[typing.List[ListDistributionsResultDistributionListItemsItemCustomErrorResponsesItemsItem]],
