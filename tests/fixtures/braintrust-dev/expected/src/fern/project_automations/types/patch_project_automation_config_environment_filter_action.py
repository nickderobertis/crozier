...
class PatchProjectAutomationConfigEnvironmentFilterAction_Webhook(UniversalBaseModel):
    """
...
class PatchProjectAutomationConfigEnvironmentFilterAction_Slack(UniversalBaseModel):
    """
    The action to take when the automation rule is triggered
    """
...
PatchProjectAutomationConfigEnvironmentFilterAction = typing_extensions.Annotated[
    typing.Union[
