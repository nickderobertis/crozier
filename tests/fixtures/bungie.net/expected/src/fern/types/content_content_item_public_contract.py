...
class ContentContentItemPublicContract(UniversalBaseModel):
    ...
    cms_path: typing_extensions.Annotated[typing.Optional[str], FieldMetadata(alias="cmsPath")] = None
    comment_summary: typing_extensions.Annotated[
        typing.Optional[ContentCommentSummary], FieldMetadata(alias="commentSummary")
    ] = None
    content_id: typing_extensions.Annotated[typing.Optional[int], FieldMetadata(alias="contentId")] = None
    creation_date: typing_extensions.Annotated[typing.Optional[dt.datetime], FieldMetadata(alias="creationDate")] = None
    has_age_gate: typing_extensions.Annotated[typing.Optional[bool], FieldMetadata(alias="hasAgeGate")] = None
    minimum_age: typing_extensions.Annotated[typing.Optional[int], FieldMetadata(alias="minimumAge")] = None
    modify_date: typing_extensions.Annotated[typing.Optional[dt.datetime], FieldMetadata(alias="modifyDate")] = None
    properties: typing.Optional[typing.Dict[str, typing.Dict[str, typing.Optional[typing.Any]]]] = pydantic.Field(
        default=None
    )
    """
    ...
    rating_image_path: typing_extensions.Annotated[typing.Optional[str], FieldMetadata(alias="ratingImagePath")] = None
