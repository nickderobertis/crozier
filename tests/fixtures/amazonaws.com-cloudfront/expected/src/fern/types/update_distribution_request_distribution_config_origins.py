...
class UpdateDistributionRequestDistributionConfigOrigins(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[typing.List[UpdateDistributionRequestDistributionConfigOriginsItemsItem]],
