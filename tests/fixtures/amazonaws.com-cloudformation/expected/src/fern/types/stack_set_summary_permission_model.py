...
class StackSetSummaryPermissionModel(str, enum.Enum):
    """
    ...
    def visit(
        ...
        if self is StackSetSummaryPermissionModel.SERVICE_MANAGED:
            return service_managed()
        if self is StackSetSummaryPermissionModel.SELF_MANAGED:
            return self_managed()
