...
class GetCreateStackInstancesRequestDeploymentTargets(UniversalBaseModel):
    """
    ...
    account_filter_type: typing_extensions.Annotated[
        typing.Optional[GetCreateStackInstancesRequestDeploymentTargetsAccountFilterType],
