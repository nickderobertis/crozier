...
class RawAccountingClient:
    ...
    def downloadjournal(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"journals/{encode_path_param(key)}",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def listjournaltemplates(self, *, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[None]:
        """
        Parameters
        ----------
        request_options : typing.Optional[RequestOptions]
...
class AsyncRawAccountingClient:
    ...
    async def listjournaltemplates(
