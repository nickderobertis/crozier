...
class SingleComponentResponseOfDestinyStringVariablesComponent(UniversalBaseModel):
    data: typing.Optional[DestinyComponentsStringVariablesDestinyStringVariablesComponent] = None
