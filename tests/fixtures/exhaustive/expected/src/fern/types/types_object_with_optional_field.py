...
class TypesObjectWithOptionalField(UniversalBaseModel):
    ...
    set_: typing_extensions.Annotated[typing.Optional[typing.List[str]], FieldMetadata(alias="set")] = None
    map_: typing_extensions.Annotated[
        typing.Optional[typing.Dict[str, typing.Optional[str]]], FieldMetadata(alias="map")
    ] = None
