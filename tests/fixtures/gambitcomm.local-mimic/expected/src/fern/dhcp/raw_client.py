...
class RawDhcpClient:
    ...
    def protocol_dhcp_get_args(
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"mimic/agent/{jsonable_encoder(agent_num)}/protocol/msg/dhcp/get/args",
            method="GET",
    ...
    def protocol_dhcp_get_config(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"mimic/agent/{jsonable_encoder(agent_num)}/protocol/msg/dhcp/get/config",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def protocol_dhcp_get_statistics(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"mimic/agent/{jsonable_encoder(agent_num)}/protocol/msg/dhcp/get/statistics",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def protocol_dhcp_get_trace(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"mimic/agent/{jsonable_encoder(agent_num)}/protocol/msg/dhcp/get/trace",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def protocol_dhcp_params(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"mimic/agent/{jsonable_encoder(agent_num)}/protocol/msg/dhcp/params",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def protocol_dhcp_set_config(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"mimic/agent/{jsonable_encoder(agent_num)}/protocol/msg/dhcp/set/config/{jsonable_encoder(argument)}/{jsonable_encoder(value)}",
            method="PUT",
            request_options=request_options,
        )
        try:
    ...
    def protocol_dhcp_set_trace(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"mimic/agent/{jsonable_encoder(agent_num)}/protocol/msg/dhcp/set/trace/{jsonable_encoder(enable_or_not)}",
            method="PUT",
            request_options=request_options,
        )
        try:
