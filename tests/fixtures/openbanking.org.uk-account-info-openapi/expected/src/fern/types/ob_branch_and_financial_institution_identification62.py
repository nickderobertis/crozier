...
class ObBranchAndFinancialInstitutionIdentification62(UniversalBaseModel):
    """
    Financial institution servicing an account for the debtor.
    """

    identification: typing_extensions.Annotated[
        typing.Optional[Identification2], FieldMetadata(alias="Identification"), pydantic.Field(alias="Identification")
    ] = None
