...
class DestinyDefinitionsDestinyVendorDisplayPropertiesDefinition(UniversalBaseModel):
    ...
    large_icon: typing_extensions.Annotated[typing.Optional[str], FieldMetadata(alias="largeIcon")] = pydantic.Field(
        default=None
    )
    """
    ...
    map_icon: typing_extensions.Annotated[typing.Optional[str], FieldMetadata(alias="mapIcon")] = pydantic.Field(
        default=None
    )
    """
