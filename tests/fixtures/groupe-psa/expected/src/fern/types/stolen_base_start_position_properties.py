...
class StolenBaseStartPositionProperties(CreatedAtField):
    ...
    type: typing.Optional[StolenBaseStartPositionPropertiesType] = None
    fix_status: typing_extensions.Annotated[
        typing.Optional[StolenBaseStartPositionPropertiesFixStatus],
