...
if typing.TYPE_CHECKING:
    from .gadgets.client import AsyncGadgetsClient, GadgetsClient
...
class FernApi:
    ...
    def __init__(
        ...
        *,
        ...
        self._gadgets: typing.Optional[GadgetsClient] = None
    ...
    def gadgets(self):
        if self._gadgets is None:
            from .gadgets.client import GadgetsClient

            self._gadgets = GadgetsClient(client_wrapper=self._client_wrapper)
...
class AsyncFernApi:
    ...
    def __init__(
        ...
        *,
        ...
        self._gadgets: typing.Optional[AsyncGadgetsClient] = None
    ...
    def gadgets(self):
        if self._gadgets is None:
            from .gadgets.client import AsyncGadgetsClient

            self._gadgets = AsyncGadgetsClient(client_wrapper=self._client_wrapper)
        return self._gadgets
