...
class DictionaryComponentResponseOfuint32AndDestinyItemRenderComponent(UniversalBaseModel):
    data: typing.Optional[typing.Dict[str, DestinyEntitiesItemsDestinyItemRenderComponent]] = None
