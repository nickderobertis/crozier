...
class RawNotesClient:
    ...
    ) -> HttpResponse[DeleteNoteResponse]:
        """
        Delete note
    ...
    def update(
        ...
        *,
        ...
        updated_by: typing.Optional[str] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[UpdateNoteResponse]:
        """
        Update note
...
class AsyncRawNotesClient:
    ...
    async def one(
        ...
        *,
        ...
        fields: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[GetNoteResponse]:
        """
        Get note
    ...
    async def delete(
        self, id: str, *, raw: typing.Optional[bool] = None, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[DeleteNoteResponse]:
        """
        Delete note
    ...
    async def update(
        ...
        *,
        ...
        updated_by: typing.Optional[str] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[UpdateNoteResponse]:
        """
        Update note
