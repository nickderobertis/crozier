...
class GetCreateChangeSetRequestRollbackConfiguration(UniversalBaseModel):
    """
    ...
    rollback_triggers: typing_extensions.Annotated[
        typing.Optional[typing.List[RollbackTrigger]], FieldMetadata(alias="RollbackTriggers")
    ...
    monitoring_time_in_minutes: typing_extensions.Annotated[
        typing.Optional[int], FieldMetadata(alias="MonitoringTimeInMinutes")
    ] = pydantic.Field(default=None)
    """
