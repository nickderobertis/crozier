...
class NotificationBase(UniversalBaseModel):
    ...
    data_id: typing_extensions.Annotated[typing.Optional[str], FieldMetadata(alias="dataId")] = None
    last_updated: typing.Optional[int] = None
    max_tries: typing.Optional[int] = None
    queue_id: typing_extensions.Annotated[typing.Optional[str], FieldMetadata(alias="queueId")] = None
