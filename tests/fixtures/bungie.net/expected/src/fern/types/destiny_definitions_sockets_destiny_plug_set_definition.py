...
class DestinyDefinitionsSocketsDestinyPlugSetDefinition(UniversalBaseModel):
    """
    ...
    is_fake_plug_set: typing_extensions.Annotated[
        typing.Optional[bool],
        FieldMetadata(alias="isFakePlugSet"),
        pydantic.Field(
            alias="isFakePlugSet",
    ...
    reusable_plug_items: typing_extensions.Annotated[
        typing.Optional[typing.List[DestinyDefinitionsDestinyItemSocketEntryPlugItemRandomizedDefinition]],
