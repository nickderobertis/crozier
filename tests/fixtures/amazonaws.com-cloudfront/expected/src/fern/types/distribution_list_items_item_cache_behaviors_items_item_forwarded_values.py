...
class DistributionListItemsItemCacheBehaviorsItemsItemForwardedValues(UniversalBaseModel):
    """
    ...
    headers: typing_extensions.Annotated[
        typing.Optional[DistributionListItemsItemCacheBehaviorsItemsItemForwardedValuesHeaders],
    ...
    query_string_cache_keys: typing_extensions.Annotated[
        typing.Optional[DistributionListItemsItemCacheBehaviorsItemsItemForwardedValuesQueryStringCacheKeys],
