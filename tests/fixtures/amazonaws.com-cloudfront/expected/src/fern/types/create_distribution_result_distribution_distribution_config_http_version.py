...
class CreateDistributionResultDistributionDistributionConfigHttpVersion(enum.StrEnum):
    """
    ...
    def visit(self, http11: typing.Callable[[], T_Result], http2: typing.Callable[[], T_Result]) -> T_Result:
        if self is CreateDistributionResultDistributionDistributionConfigHttpVersion.HTTP11:
            return http11()
        if self is CreateDistributionResultDistributionDistributionConfigHttpVersion.HTTP2:
            return http2()
