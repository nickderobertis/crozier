...
class RawFormsClient:
    ...
    def list(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"sites/{encode_path_param(site_id)}/forms",
    ...
    def get_submission(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"form_submissions/{encode_path_param(form_submission_id)}",
            base_url=self._client_wrapper.get_environment().base,
            method="GET",
            request_options=request_options,
        )
...
class AsyncRawFormsClient:
    ...
    async def get(
        self, form_id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[GetFormsResponse]:
        """
        Get information about a given form.
