...
class CreateStreamingDistributionResultStreamingDistributionActiveTrustedSigners(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[
            typing.List[CreateStreamingDistributionResultStreamingDistributionActiveTrustedSignersItemsItem]
        ],
