...
from .register_queue_response_user_status_value_reaction_type import RegisterQueueResponseUserStatusValueReactionType


class RegisterQueueResponseUserStatusValue(UniversalBaseModel):
    """
    ...
    **Changes**: New in Zulip 5.0 (feature level 86).
    ...
    reaction_type: typing.Optional[RegisterQueueResponseUserStatusValueReactionType] = pydantic.Field(default=None)
    """
