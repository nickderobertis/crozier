...
class ListStreamingDistributionsResultStreamingDistributionList(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[typing.List[ListStreamingDistributionsResultStreamingDistributionListItemsItem]],
        FieldMetadata(alias="Items"),
        pydantic.Field(
            alias="Items",
            description="A complex type that contains one <code>StreamingDistributionSummary</code> element for each distribution that was created by the current AWS account.",
        ),
    ] = None
    """
