...
class SingleComponentResponseOfDestinyItemTalentGridComponent(UniversalBaseModel):
    data: typing.Optional[DestinyEntitiesItemsDestinyItemTalentGridComponent] = None
