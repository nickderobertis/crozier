...
class ModifyMessageResponse_SystemMessage(UniversalBaseModel):
...
class ModifyMessageResponse_UserMessage(UniversalBaseModel):
...
class ModifyMessageResponse_ReasoningMessage(UniversalBaseModel):
...
class ModifyMessageResponse_HiddenReasoningMessage(UniversalBaseModel):
...
class ModifyMessageResponse_ToolCallMessage(UniversalBaseModel):
...
class ModifyMessageResponse_ToolReturnMessage(UniversalBaseModel):
...
class ModifyMessageResponse_AssistantMessage(UniversalBaseModel):
...
class ModifyMessageResponse_ApprovalRequestMessage(UniversalBaseModel):
...
class ModifyMessageResponse_ApprovalResponseMessage(UniversalBaseModel):
...
class ModifyMessageResponse_Summary(UniversalBaseModel):
...
class ModifyMessageResponse_Event(UniversalBaseModel):
...
ModifyMessageResponse = typing_extensions.Annotated[
    typing.Union[
