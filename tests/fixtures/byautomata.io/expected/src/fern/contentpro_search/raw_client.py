...
class RawContentproSearchClient:
    ...
    ) -> HttpResponse[GetContentproSearchResponse]:
        """
        Parameters
        ----------
        terms : str
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=GetContentproSearchResponse,
