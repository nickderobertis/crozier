...
class WidgetsClient:
    ...
    def search_widgets(self, *, request_options: typing.Optional[RequestOptions] = None) -> SearchWidgetsResponse:
        """
        Parameters
        ----------
        ...
        """
        _response = self._raw_client.search_widgets(request_options=request_options)
...
class AsyncWidgetsClient:
    ...
    async def search_widgets(self, *, request_options: typing.Optional[RequestOptions] = None) -> SearchWidgetsResponse:
        """
        Parameters
        ----------
        request_options : typing.Optional[RequestOptions]
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.search_widgets(request_options=request_options)
        return _response.data
