...
class PostClientMgmtClientRequestRequestAdditionalConfig(UniversalBaseModel):
    """
    ...
    userinfo_response_type: typing.Optional[PostClientMgmtClientRequestRequestAdditionalConfigUserinfoResponseType] = (
