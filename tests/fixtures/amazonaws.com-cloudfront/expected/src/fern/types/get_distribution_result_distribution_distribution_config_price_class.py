...
class GetDistributionResultDistributionDistributionConfigPriceClass(enum.StrEnum):
    """
    ...
    def visit(
        ...
        if self is GetDistributionResultDistributionDistributionConfigPriceClass.PRICE_CLASS100:
            return price_class100()
        if self is GetDistributionResultDistributionDistributionConfigPriceClass.PRICE_CLASS200:
            return price_class200()
        if self is GetDistributionResultDistributionDistributionConfigPriceClass.PRICE_CLASS_ALL:
