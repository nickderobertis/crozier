...
class GetProductsResponseSkusItemFieldDataEcSkuSubscriptionPlanPlansItem(UniversalBaseModel):
    platform: typing.Optional[GetProductsResponseSkusItemFieldDataEcSkuSubscriptionPlanPlansItemPlatform] = (
    ...
    status: typing.Optional[GetProductsResponseSkusItemFieldDataEcSkuSubscriptionPlanPlansItemStatus] = pydantic.Field(
        default=None
    )
    """
