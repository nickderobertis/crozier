...
class DistributionSummaryDefaultCacheBehaviorLambdaFunctionAssociationsItemsItem(UniversalBaseModel):
    """
    ...
    event_type: typing_extensions.Annotated[
        typing.Optional[DistributionSummaryDefaultCacheBehaviorLambdaFunctionAssociationsItemsItemEventType],
