...
from .distribution_distribution_config_custom_error_responses import DistributionDistributionConfigCustomErrorResponses
from .distribution_distribution_config_default_cache_behavior import DistributionDistributionConfigDefaultCacheBehavior
...
class DistributionDistributionConfig(UniversalBaseModel):
    """
    ...
    aliases: typing_extensions.Annotated[
        typing.Optional[DistributionDistributionConfigAliases],
    ...
    cache_behaviors: typing_extensions.Annotated[
        typing.Optional[DistributionDistributionConfigCacheBehaviors],
    ...
    custom_error_responses: typing_extensions.Annotated[
        typing.Optional[DistributionDistributionConfigCustomErrorResponses],
    ...
    logging: typing_extensions.Annotated[
        typing.Optional[DistributionDistributionConfigLogging],
    ...
    price_class: typing_extensions.Annotated[
        typing.Optional[DistributionDistributionConfigPriceClass],
    ...
    http_version: typing_extensions.Annotated[
        typing.Optional[DistributionDistributionConfigHttpVersion],
