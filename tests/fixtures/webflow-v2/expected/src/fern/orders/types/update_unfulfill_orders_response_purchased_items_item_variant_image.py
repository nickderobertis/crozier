...
class UpdateUnfulfillOrdersResponsePurchasedItemsItemVariantImage(UniversalBaseModel):
    url: typing.Optional[str] = pydantic.Field(default=None)
    """
    The hosted location for the Variant's image
    """

    file: typing.Optional[UpdateUnfulfillOrdersResponsePurchasedItemsItemVariantImageFile] = None
