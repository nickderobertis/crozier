...
class RawTransferwiseTransferRequirementClient:
    ...
    ) -> HttpResponse[TransferwiseTransferRequirementCreate]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=TransferwiseTransferRequirementCreate,
...
class AsyncRawTransferwiseTransferRequirementClient:
    ...
    async def create_transferwise_transfer_requirement_for_user_transferwise_quote(
        ...
        *,
        ...
        detail: typing.Optional[typing.Sequence[TransferwiseRequirementField]] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[TransferwiseTransferRequirementCreate]:
        """
        Used to determine the account requirements for Transferwise transfers.
