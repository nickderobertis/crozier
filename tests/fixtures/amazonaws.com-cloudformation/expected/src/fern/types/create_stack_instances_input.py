...
class CreateStackInstancesInput(UniversalBaseModel):
    ...
    deployment_targets: typing_extensions.Annotated[
        typing.Optional[CreateStackInstancesInputDeploymentTargets], FieldMetadata(alias="DeploymentTargets")
    ] = pydantic.Field(default=None)
    """
    ...
    operation_preferences: typing_extensions.Annotated[
        typing.Optional[CreateStackInstancesInputOperationPreferences], FieldMetadata(alias="OperationPreferences")
    ] = pydantic.Field(default=None)
    """
    ...
    call_as: typing_extensions.Annotated[
        typing.Optional[CreateStackInstancesInputCallAs], FieldMetadata(alias="CallAs")
    ] = pydantic.Field(default=None)
    """
