...
class PostLinksLinkIdResponse(UniversalBaseModel):
    ...
    expires_at: typing_extensions.Annotated[
        typing.Optional[PostLinksLinkIdResponseExpiresAt],
    ...
    ttl: typing.Optional[PostLinksLinkIdResponseTtl] = pydantic.Field(default=None)
    """
    ...
    split_urlv2: typing_extensions.Annotated[
        typing.Optional[typing.List[PostLinksLinkIdResponseSplitUrlv2Item]],
    ...
    redirect_type: typing_extensions.Annotated[
        typing.Optional[PostLinksLinkIdResponseRedirectType],
    ...
    source: typing.Optional[PostLinksLinkIdResponseSource] = pydantic.Field(default=None)
    """
    Link source
    """

    user: typing_extensions.Annotated[
        typing.Optional[PostLinksLinkIdResponseUser], FieldMetadata(alias="User"), pydantic.Field(alias="User")
    ] = None
