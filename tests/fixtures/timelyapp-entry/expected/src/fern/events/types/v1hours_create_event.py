...
class V1HoursCreateEvent(UniversalBaseModel):
    ...
    timestamps: typing.Optional[typing.List[V1HoursCreateEventTimestampsItem]] = None
    external_links: typing.Optional[typing.List[V1HoursCreateEventExternalLinksItem]] = None
