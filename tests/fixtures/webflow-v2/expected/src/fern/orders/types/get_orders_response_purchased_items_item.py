...
class GetOrdersResponsePurchasedItemsItem(UniversalBaseModel):
    """
    ...
    row_total: typing_extensions.Annotated[
        typing.Optional[GetOrdersResponsePurchasedItemsItemRowTotal],
    ...
    variant_image: typing_extensions.Annotated[
        typing.Optional[GetOrdersResponsePurchasedItemsItemVariantImage],
        FieldMetadata(alias="variantImage"),
        pydantic.Field(alias="variantImage"),
    ] = None
    variant_price: typing_extensions.Annotated[
        typing.Optional[GetOrdersResponsePurchasedItemsItemVariantPrice],
