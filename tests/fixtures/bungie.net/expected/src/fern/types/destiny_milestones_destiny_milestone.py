...
from .destiny_milestones_destiny_milestone_challenge_activity import DestinyMilestonesDestinyMilestoneChallengeActivity
...
class DestinyMilestonesDestinyMilestone(UniversalBaseModel):
    """
    ...
    activities: typing.Optional[typing.List[DestinyMilestonesDestinyMilestoneChallengeActivity]] = pydantic.Field(
        default=None
    )
    """
    ...
    rewards: typing.Optional[typing.List[DestinyMilestonesDestinyMilestoneRewardCategory]] = pydantic.Field(
        default=None
    )
    """
    ...
    values: typing.Optional[typing.Dict[str, float]] = pydantic.Field(default=None)
    """
    ...
    vendors: typing.Optional[typing.List[DestinyMilestonesDestinyMilestoneVendor]] = pydantic.Field(default=None)
    """
