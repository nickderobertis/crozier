...
class DestinyDefinitionsDestinyTalentNodeDefinition(UniversalBaseModel):
    ...
    auto_unlocks: typing_extensions.Annotated[typing.Optional[bool], FieldMetadata(alias="autoUnlocks")] = (
    ...
    binary_pair_node_index: typing_extensions.Annotated[
        typing.Optional[int], FieldMetadata(alias="binaryPairNodeIndex")
    ] = pydantic.Field(default=None)
    """
    ...
    exclusive_with_node_hashes: typing_extensions.Annotated[
        typing.Optional[typing.List[int]], FieldMetadata(alias="exclusiveWithNodeHashes")
    ] = pydantic.Field(default=None)
    """
    ...
    ignore_for_completion: typing_extensions.Annotated[
        typing.Optional[bool], FieldMetadata(alias="ignoreForCompletion")
    ] = pydantic.Field(default=None)
    """
    ...
    is_random: typing_extensions.Annotated[typing.Optional[bool], FieldMetadata(alias="isRandom")] = pydantic.Field(
        default=None
    )
    """
    ...
    is_random_repurchasable: typing_extensions.Annotated[
        typing.Optional[bool], FieldMetadata(alias="isRandomRepurchasable")
    ] = pydantic.Field(default=None)
    """
    ...
    last_step_repeats: typing_extensions.Annotated[typing.Optional[bool], FieldMetadata(alias="lastStepRepeats")] = (
        pydantic.Field(default=None)
    )
    """
    ...
    layout_identifier: typing_extensions.Annotated[typing.Optional[str], FieldMetadata(alias="layoutIdentifier")] = (
        pydantic.Field(default=None)
    )
    """
    ...
    node_style_identifier: typing_extensions.Annotated[
        typing.Optional[str], FieldMetadata(alias="nodeStyleIdentifier")
    ] = pydantic.Field(default=None)
    """
    ...
    prerequisite_node_indexes: typing_extensions.Annotated[
        typing.Optional[typing.List[int]], FieldMetadata(alias="prerequisiteNodeIndexes")
    ] = pydantic.Field(default=None)
    """
    ...
    random_start_progression_bar_at_progression: typing_extensions.Annotated[
        typing.Optional[int], FieldMetadata(alias="randomStartProgressionBarAtProgression")
    ] = pydantic.Field(default=None)
    """
