...
class CreateDistributionResultDistributionActiveTrustedSignersItemsItem(UniversalBaseModel):
    """
    ...
    key_pair_ids: typing_extensions.Annotated[
        typing.Optional[CreateDistributionResultDistributionActiveTrustedSignersItemsItemKeyPairIds],
