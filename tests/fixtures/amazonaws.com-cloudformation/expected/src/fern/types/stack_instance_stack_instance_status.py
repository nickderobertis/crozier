...
class StackInstanceStackInstanceStatus(UniversalBaseModel):
    """
    The detailed status of the stack instance.
    """

    detailed_status: typing_extensions.Annotated[
        typing.Optional[StackInstanceStackInstanceStatusDetailedStatus], FieldMetadata(alias="DetailedStatus")
