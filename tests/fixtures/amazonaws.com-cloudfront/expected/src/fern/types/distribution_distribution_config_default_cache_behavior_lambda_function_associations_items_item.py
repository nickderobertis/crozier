...
class DistributionDistributionConfigDefaultCacheBehaviorLambdaFunctionAssociationsItemsItem(UniversalBaseModel):
    """
    ...
    event_type: typing_extensions.Annotated[
        typing.Optional[DistributionDistributionConfigDefaultCacheBehaviorLambdaFunctionAssociationsItemsItemEventType],
