...
class GetEventsResponseEventsItemMessageTypeMessageType(enum.StrEnum):
    """
    ...
    **Changes**: In Zulip 8.0 (feature level 215), replaced the
    ...
    def visit(self, direct: typing.Callable[[], T_Result], stream: typing.Callable[[], T_Result]) -> T_Result:
        if self is GetEventsResponseEventsItemMessageTypeMessageType.DIRECT:
            return direct()
        if self is GetEventsResponseEventsItemMessageTypeMessageType.STREAM:
            return stream()
