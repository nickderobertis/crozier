...
from .top_events_reports_response_bucketing_granularity_period import TopEventsReportsResponseBucketingGranularityPeriod


class TopEventsReportsResponseBucketing(UniversalBaseModel):
    """
