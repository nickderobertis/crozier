...
class TopDimensionsReportsRequestDimension(enum.StrEnum):
    """
    ...
    def visit(
        ...
        if self is TopDimensionsReportsRequestDimension.COUNTRY:
            return country()
        if self is TopDimensionsReportsRequestDimension.REGION:
            return region()
        if self is TopDimensionsReportsRequestDimension.DEVICE_TYPE:
            return device_type()
        if self is TopDimensionsReportsRequestDimension.OS:
            return os()
        if self is TopDimensionsReportsRequestDimension.BROWSER:
            return browser()
        if self is TopDimensionsReportsRequestDimension.LANGUAGE:
            return language()
        if self is TopDimensionsReportsRequestDimension.LOCALE:
            return locale()
        if self is TopDimensionsReportsRequestDimension.REFERRER:
            return referrer()
        if self is TopDimensionsReportsRequestDimension.TRAFFIC_SOURCE:
            return traffic_source()
        if self is TopDimensionsReportsRequestDimension.UTM_CAMPAIGN:
            return utm_campaign()
        if self is TopDimensionsReportsRequestDimension.UTM_CONTENT:
            return utm_content()
        if self is TopDimensionsReportsRequestDimension.UTM_MEDIUM:
            return utm_medium()
        if self is TopDimensionsReportsRequestDimension.UTM_SOURCE:
            return utm_source()
        if self is TopDimensionsReportsRequestDimension.UTM_TERM:
            return utm_term()
        if self is TopDimensionsReportsRequestDimension.AUDIENCE_IDS:
            return audience_ids()
