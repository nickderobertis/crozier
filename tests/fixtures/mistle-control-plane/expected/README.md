...
client = FernApi(...)
response = client.internal.with_raw_response.post_internal_integration_connections_refresh_resource(...)
...
```python
client.internal.post_internal_integration_connections_refresh_resource(..., request_options={
    "max_retries": 1
})
```
