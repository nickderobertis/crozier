...
class DocAnnotationsListAll200ResponsePagesItemAnnotationsItemPolygonMeasureRlAreaItem(UniversalBaseModel):
    unit: str
    ...
    label_position: typing_extensions.Annotated[
        typing.Optional[DocAnnotationsListAll200ResponsePagesItemAnnotationsItemPolygonMeasureRlAreaItemLabelPosition],
