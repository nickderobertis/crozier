...
class PageHashKnownDtoAction(enum.StrEnum):
    ...
    def visit(
        ...
        if self is PageHashKnownDtoAction.DELETE_AUTO:
            return delete_auto()
        if self is PageHashKnownDtoAction.DELETE_MANUAL:
            return delete_manual()
        if self is PageHashKnownDtoAction.IGNORE:
            return ignore()
