...
class DescribeStackSetOutputStackSetStackSetDriftDetectionDetailsDriftStatus(str, enum.Enum):
    """
    ...
    def visit(
        ...
        if self is DescribeStackSetOutputStackSetStackSetDriftDetectionDetailsDriftStatus.DRIFTED:
            return drifted()
        if self is DescribeStackSetOutputStackSetStackSetDriftDetectionDetailsDriftStatus.IN_SYNC:
            return in_sync()
        if self is DescribeStackSetOutputStackSetStackSetDriftDetectionDetailsDriftStatus.NOT_CHECKED:
            return not_checked()
