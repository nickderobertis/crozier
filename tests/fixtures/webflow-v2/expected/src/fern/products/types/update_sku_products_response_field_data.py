...
from .update_sku_products_response_field_data_compare_at_price import UpdateSkuProductsResponseFieldDataCompareAtPrice
...
class UpdateSkuProductsResponseFieldData(UniversalBaseModel):
    """
    ...
    price: UpdateSkuProductsResponseFieldDataPrice = pydantic.Field()
    """
    price of SKU
    """

    compare_at_price: typing_extensions.Annotated[
        typing.Optional[UpdateSkuProductsResponseFieldDataCompareAtPrice],
    ...
    ec_sku_billing_method: typing_extensions.Annotated[
        typing.Optional[UpdateSkuProductsResponseFieldDataEcSkuBillingMethod],
    ...
    ec_sku_subscription_plan: typing_extensions.Annotated[
        typing.Optional[UpdateSkuProductsResponseFieldDataEcSkuSubscriptionPlan],
    ...
    sku_properties: typing_extensions.Annotated[
        typing.Optional[typing.List[UpdateSkuProductsResponseFieldDataSkuPropertiesItem]],
