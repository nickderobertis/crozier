...
class RawAssetsKurtosisClient:
    ...
    ) -> HttpResponse[PostAssetsKurtosisResponse]:
        """
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                "assets": convert_and_respect_annotation_metadata(
                    object_=assets, annotation=typing.Sequence[PostAssetsKurtosisRequestAssetsItem], direction="write"
                ),
            },
            headers={
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=PostAssetsKurtosisResponse,
...
class AsyncRawAssetsKurtosisClient:
    ...
    async def kurtosis(
        ...
        *,
        assets: typing.Sequence[PostAssetsKurtosisRequestAssetsItem],
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[PostAssetsKurtosisResponse]:
        """
        Compute the kurtosis of one or several asset(s), from the asset returns.
