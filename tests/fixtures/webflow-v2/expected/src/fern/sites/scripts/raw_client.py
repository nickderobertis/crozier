...
class RawScriptsClient:
    ...
    def get_custom_code(
    ...
    ) -> HttpResponse[GetCustomCodeScriptsResponse]:
        """
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"sites/{encode_path_param(site_id)}/custom_code",
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=GetCustomCodeScriptsResponse,
    ...
    ) -> HttpResponse[UpsertCustomCodeScriptsResponse]:
        """
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                "scripts": convert_and_respect_annotation_metadata(
                    object_=scripts,
                    annotation=typing.Sequence[UpsertCustomCodeScriptsRequestScriptsItem],
                    direction="write",
                ),
            },
            headers={
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=UpsertCustomCodeScriptsResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def list_custom_code_blocks(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[ListCustomCodeBlocksScriptsResponse]:
        """
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"sites/{encode_path_param(site_id)}/custom_code/blocks",
            base_url=self._client_wrapper.get_environment().base,
            method="GET",
            params={
                "offset": offset,
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=ListCustomCodeBlocksScriptsResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawScriptsClient:
    ...
    async def get_custom_code(
        self, site_id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[GetCustomCodeScriptsResponse]:
        """
        Get all scripts applied to a site by the App.
    ...
    async def upsert_custom_code(
        ...
        *,
        scripts: typing.Optional[typing.Sequence[UpsertCustomCodeScriptsRequestScriptsItem]] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[UpsertCustomCodeScriptsResponse]:
        """
        Apply registered scripts to a site. If you have multiple scripts your App needs to apply or maintain on a site, ensure they are always included in the request body for this endpoint. To remove individual scripts, simply call this endpoint without the script in the request body.
    ...
    async def list_custom_code_blocks(
        ...
        *,
        ...
        limit: typing.Optional[int] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[ListCustomCodeBlocksScriptsResponse]:
        """
        Get a list of scripts that have been applied to a site and/or individual pages.
