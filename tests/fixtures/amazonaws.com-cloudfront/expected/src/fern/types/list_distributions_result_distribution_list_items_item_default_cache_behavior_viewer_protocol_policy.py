...
class ListDistributionsResultDistributionListItemsItemDefaultCacheBehaviorViewerProtocolPolicy(enum.StrEnum):
    """
    ...
    def visit(
        ...
        if self is ListDistributionsResultDistributionListItemsItemDefaultCacheBehaviorViewerProtocolPolicy.ALLOW_ALL:
            return allow_all()
        if self is ListDistributionsResultDistributionListItemsItemDefaultCacheBehaviorViewerProtocolPolicy.HTTPS_ONLY:
            return https_only()
        if (
            self
            is ListDistributionsResultDistributionListItemsItemDefaultCacheBehaviorViewerProtocolPolicy.REDIRECT_TO_HTTPS
        ):
