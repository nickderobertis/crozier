...
class DescribeStackResourceOutputStackResourceDetail(UniversalBaseModel):
    ...
    resource_status: typing_extensions.Annotated[
        DescribeStackResourceOutputStackResourceDetailResourceStatus, FieldMetadata(alias="ResourceStatus")
    ] = pydantic.Field()
    """
    ...
    module_info: typing_extensions.Annotated[
        typing.Optional[DescribeStackResourceOutputStackResourceDetailModuleInfo], FieldMetadata(alias="ModuleInfo")
    ] = pydantic.Field(default=None)
    """
