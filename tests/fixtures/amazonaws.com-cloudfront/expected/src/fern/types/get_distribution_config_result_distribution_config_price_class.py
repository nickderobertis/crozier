...
class GetDistributionConfigResultDistributionConfigPriceClass(enum.StrEnum):
    """
    ...
    def visit(
        ...
        if self is GetDistributionConfigResultDistributionConfigPriceClass.PRICE_CLASS100:
            return price_class100()
        if self is GetDistributionConfigResultDistributionConfigPriceClass.PRICE_CLASS200:
            return price_class200()
        if self is GetDistributionConfigResultDistributionConfigPriceClass.PRICE_CLASS_ALL:
