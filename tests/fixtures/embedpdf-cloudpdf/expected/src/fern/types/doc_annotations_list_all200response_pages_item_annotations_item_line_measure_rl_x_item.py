...
class DocAnnotationsListAll200ResponsePagesItemAnnotationsItemLineMeasureRlXItem(UniversalBaseModel):
    unit: str
    conversion: typing.Optional[float] = None
    fraction: typing.Optional[DocAnnotationsListAll200ResponsePagesItemAnnotationsItemLineMeasureRlXItemFraction] = None
    ...
    label_position: typing_extensions.Annotated[
        typing.Optional[DocAnnotationsListAll200ResponsePagesItemAnnotationsItemLineMeasureRlXItemLabelPosition],
