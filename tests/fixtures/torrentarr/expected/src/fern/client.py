...
if typing.TYPE_CHECKING:
    ...
    from .web_ui.client import AsyncWebUiClient, WebUiClient
...
class FernApi:
    ...
    def __init__(
        ...
        *,
        ...
        self._web_ui: typing.Optional[WebUiClient] = None
    ...
    def web_ui(self):
        if self._web_ui is None:
            from .web_ui.client import WebUiClient

            self._web_ui = WebUiClient(client_wrapper=self._client_wrapper)
        return self._web_ui
...
class AsyncFernApi:
    ...
    def __init__(
        ...
        *,
        ...
        self._web_ui: typing.Optional[AsyncWebUiClient] = None
    ...
    def web_ui(self):
        if self._web_ui is None:
            from .web_ui.client import AsyncWebUiClient

            self._web_ui = AsyncWebUiClient(client_wrapper=self._client_wrapper)
        return self._web_ui
