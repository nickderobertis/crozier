...
client = FernApi(...)
response = client.link_queries.with_raw_response.fetch_and_inspect_open_graph_tags_for_a_url_public_h_captcha_protected(...)
...
```python
client.link_queries.fetch_and_inspect_open_graph_tags_for_a_url_public_h_captcha_protected(..., request_options={
    "max_retries": 1
})
```
