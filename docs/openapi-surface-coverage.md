...
`tests/fixtures/<name>/openapi.*` documents, and the 102 `link-ok` documents
...
- **`just surface-census`**, for the classifications and for criterion 4. The
  ...
  rather than restated here. It reads **133** registered sources, of which
  **116** carry a committed golden.
...
reports zero across all 133 registered sources. So the inconsistency between the
