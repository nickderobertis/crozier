...
class AlertStatusChangeRequestModelFilterTimeRange_Absolute(UniversalBaseModel):
    """
    Time range
    """
...
class AlertStatusChangeRequestModelFilterTimeRange_Relative(UniversalBaseModel):
    """
    Time range
    """
...
class AlertStatusChangeRequestModelFilterTimeRange_ToNow(UniversalBaseModel):
    """
    Time range
    """
...
AlertStatusChangeRequestModelFilterTimeRange = typing_extensions.Annotated[
    typing.Union[
