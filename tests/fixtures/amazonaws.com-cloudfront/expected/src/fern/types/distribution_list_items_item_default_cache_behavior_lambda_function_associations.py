...
class DistributionListItemsItemDefaultCacheBehaviorLambdaFunctionAssociations(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[typing.List[DistributionListItemsItemDefaultCacheBehaviorLambdaFunctionAssociationsItemsItem]],
