...
class StackSetOperationSummary(UniversalBaseModel):
    ...
    action: typing_extensions.Annotated[
        typing.Optional[StackSetOperationSummaryAction], FieldMetadata(alias="Action")
    ] = pydantic.Field(default=None)
    """
    ...
    status: typing_extensions.Annotated[
        typing.Optional[StackSetOperationSummaryStatus], FieldMetadata(alias="Status")
    ] = pydantic.Field(default=None)
    """
    ...
    status_details: typing_extensions.Annotated[
        typing.Optional[StackSetOperationSummaryStatusDetails], FieldMetadata(alias="StatusDetails")
    ] = pydantic.Field(default=None)
    """
