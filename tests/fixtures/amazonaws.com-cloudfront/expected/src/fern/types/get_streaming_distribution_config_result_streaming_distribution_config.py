...
class GetStreamingDistributionConfigResultStreamingDistributionConfig(UniversalBaseModel):
    """
    ...
    aliases: typing_extensions.Annotated[
        typing.Optional[GetStreamingDistributionConfigResultStreamingDistributionConfigAliases],
    ...
    logging: typing_extensions.Annotated[
        typing.Optional[GetStreamingDistributionConfigResultStreamingDistributionConfigLogging],
    ...
    price_class: typing_extensions.Annotated[
        typing.Optional[GetStreamingDistributionConfigResultStreamingDistributionConfigPriceClass],
