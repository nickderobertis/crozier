...
class DistributionDistributionConfigOriginsItemsItemCustomHeaders(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[typing.List[DistributionDistributionConfigOriginsItemsItemCustomHeadersItemsItem]],
