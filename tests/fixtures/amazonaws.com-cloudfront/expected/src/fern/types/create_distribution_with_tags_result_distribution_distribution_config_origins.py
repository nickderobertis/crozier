...
class CreateDistributionWithTagsResultDistributionDistributionConfigOrigins(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[typing.List[CreateDistributionWithTagsResultDistributionDistributionConfigOriginsItemsItem]],
