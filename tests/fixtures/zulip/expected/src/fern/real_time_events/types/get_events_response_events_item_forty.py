...
class GetEventsResponseEventsItemForty(UniversalBaseModel):
    """
    ...
    **Changes**: New in Zulip 10.0 (feature level 351). Previously,
    ...
    type: typing.Optional[GetEventsResponseEventsItemFortyType] = pydantic.Field(default=None)
    """
    The event's type, relevant both for client-side dispatch and server-side
    filtering by event type in [POST /register](/api/register-queue).
    """

    op: typing.Optional[GetEventsResponseEventsItemFortyOp] = None
    ...
    recipient: typing.Optional[GetEventsResponseEventsItemFortyRecipient] = pydantic.Field(default=None)
    """
