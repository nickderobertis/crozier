...
from .update_system_models_available_update_group_subscription import UpdateSystemModelsAvailableUpdateGroupSubscription


class ApiPagedResponseUpdateSystemModelsAvailableUpdateGroupSubscription(UniversalBaseModel):
    """
    A response containing a page of results and metadata concerning the results
    """

    entities: typing_extensions.Annotated[
        typing.Optional[typing.List[UpdateSystemModelsAvailableUpdateGroupSubscription]],
