...
class GetEventsResponseEventsItemSixtyThree(UniversalBaseModel):
    """
    ...
    **Changes**: Removed the `rendered_description` property in
    ...
    type: typing.Optional[GetEventsResponseEventsItemSixtyThreeType] = pydantic.Field(default=None)
    """
    The event's type, relevant both for client-side dispatch and server-side
    filtering by event type in [POST /register](/api/register-queue).
    """

    op: typing.Optional[GetEventsResponseEventsItemSixtyThreeOp] = None
    property: typing.Optional[str] = pydantic.Field(default=None)
    """
    The name of the property that was changed.
    """

    value: typing.Optional[GetEventsResponseEventsItemSixtyThreeValue] = pydantic.Field(default=None)
    """
