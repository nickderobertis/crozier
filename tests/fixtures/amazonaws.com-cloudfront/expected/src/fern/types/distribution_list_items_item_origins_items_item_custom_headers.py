...
class DistributionListItemsItemOriginsItemsItemCustomHeaders(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[typing.List[DistributionListItemsItemOriginsItemsItemCustomHeadersItemsItem]],
