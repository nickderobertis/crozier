...
class PredictionsPredictionsItemPredictionsZeroItemAttentionMap(UniversalBaseModel):
    ...
    label: str
    source: typing.Optional[PredictionsPredictionsItemPredictionsZeroItemAttentionMapSource] = None
