...
class ResourceChangeAction(str, enum.Enum):
    """
    ...
    def visit(
        ...
        if self is ResourceChangeAction.ADD:
            return add()
        if self is ResourceChangeAction.MODIFY:
            return modify()
        if self is ResourceChangeAction.REMOVE:
            return remove()
        if self is ResourceChangeAction.IMPORT:
            return import_()
        if self is ResourceChangeAction.DYNAMIC:
            return dynamic()
