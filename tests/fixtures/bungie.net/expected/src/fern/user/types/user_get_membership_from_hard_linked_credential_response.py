...
from ...types.user_hard_linked_user_membership import UserHardLinkedUserMembership


class UserGetMembershipFromHardLinkedCredentialResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[UserHardLinkedUserMembership], FieldMetadata(alias="Response"), pydantic.Field(alias="Response")
    ] = None
