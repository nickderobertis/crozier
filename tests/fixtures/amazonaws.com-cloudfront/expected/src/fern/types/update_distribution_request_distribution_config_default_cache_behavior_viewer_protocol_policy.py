...
class UpdateDistributionRequestDistributionConfigDefaultCacheBehaviorViewerProtocolPolicy(enum.StrEnum):
    """
    ...
    def visit(
        ...
        if self is UpdateDistributionRequestDistributionConfigDefaultCacheBehaviorViewerProtocolPolicy.ALLOW_ALL:
            return allow_all()
        if self is UpdateDistributionRequestDistributionConfigDefaultCacheBehaviorViewerProtocolPolicy.HTTPS_ONLY:
            return https_only()
        if (
            self
            is UpdateDistributionRequestDistributionConfigDefaultCacheBehaviorViewerProtocolPolicy.REDIRECT_TO_HTTPS
        ):
