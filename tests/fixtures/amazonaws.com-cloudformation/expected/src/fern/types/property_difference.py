...
class PropertyDifference(UniversalBaseModel):
    ...
    property_path: typing_extensions.Annotated[
        str,
        FieldMetadata(alias="PropertyPath"),
        pydantic.Field(alias="PropertyPath", description="The fully-qualified path to the resource property."),
    ]
    """
    ...
    expected_value: typing_extensions.Annotated[
        ...
        pydantic.Field(
            alias="ExpectedValue",
            description="The expected property value of the resource property, as defined in the stack template and any values specified as template parameters.",
        ),
    ]
    """
    ...
    actual_value: typing_extensions.Annotated[
        str,
        FieldMetadata(alias="ActualValue"),
        pydantic.Field(alias="ActualValue", description="The actual property value of the resource property."),
    ]
    """
    ...
    difference_type: typing_extensions.Annotated[
        ...
        FieldMetadata(alias="DifferenceType"),
        pydantic.Field(
            alias="DifferenceType",
            description="<p>The type of property difference.</p> <ul> <li> <p> <code>ADD</code>: A value has been added to a resource property that's an array or list data type.</p> </li> <li> <p> <code>REMOVE</code>: The property has been removed from the current resource configuration.</p> </li> <li> <p> <code>NOT_EQUAL</code>: The current property value differs from its expected value (as defined in the stack template and any values specified as template parameters).</p> </li> </ul>",
        ),
    ]
    """
