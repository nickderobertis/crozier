...
class PartitionNames(UniversalBaseModel):
    ...
    partition_names: typing_extensions.Annotated[
        typing.List[str],
        FieldMetadata(alias="partitionNames"),
        pydantic.Field(alias="partitionNames", description="The list of names of the target partitions."),
    ]
    """
