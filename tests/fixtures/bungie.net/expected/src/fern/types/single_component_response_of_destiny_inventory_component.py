...
class SingleComponentResponseOfDestinyInventoryComponent(UniversalBaseModel):
    data: typing.Optional[DestinyEntitiesInventoryDestinyInventoryComponent] = None
