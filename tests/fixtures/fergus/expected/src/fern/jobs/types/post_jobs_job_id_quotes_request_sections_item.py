...
class PostJobsJobIdQuotesRequestSectionsItem(UniversalBaseModel):
    name: str
    favourite_section_id: typing_extensions.Annotated[
        typing.Optional[PostJobsJobIdQuotesRequestSectionsItemFavouriteSectionId],
    ...
    favourite_section_ids: typing_extensions.Annotated[
        typing.Optional[PostJobsJobIdQuotesRequestSectionsItemFavouriteSectionIds],
    ...
    line_items: typing_extensions.Annotated[
        typing.Optional[typing.List[PostJobsJobIdQuotesRequestSectionsItemLineItemsItem]],
...
update_forward_refs(PostJobsJobIdQuotesRequestSectionsItem, UpsertQuoteSection=UpsertQuoteSection)
