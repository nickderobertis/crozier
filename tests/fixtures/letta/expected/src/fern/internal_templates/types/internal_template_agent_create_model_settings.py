...
class InternalTemplateAgentCreateModelSettings_Anthropic(UniversalBaseModel):
...
class InternalTemplateAgentCreateModelSettings_Azure(UniversalBaseModel):
...
class InternalTemplateAgentCreateModelSettings_Bedrock(UniversalBaseModel):
...
class InternalTemplateAgentCreateModelSettings_ChatgptOauth(UniversalBaseModel):
...
class InternalTemplateAgentCreateModelSettings_Deepseek(UniversalBaseModel):
...
class InternalTemplateAgentCreateModelSettings_GoogleAi(UniversalBaseModel):
...
class InternalTemplateAgentCreateModelSettings_GoogleVertex(UniversalBaseModel):
...
class InternalTemplateAgentCreateModelSettings_Groq(UniversalBaseModel):
...
class InternalTemplateAgentCreateModelSettings_Openai(UniversalBaseModel):
...
class InternalTemplateAgentCreateModelSettings_Together(UniversalBaseModel):
...
class InternalTemplateAgentCreateModelSettings_Xai(UniversalBaseModel):
...
class InternalTemplateAgentCreateModelSettings_Zai(UniversalBaseModel):
...
InternalTemplateAgentCreateModelSettings = typing_extensions.Annotated[
    typing.Union[
