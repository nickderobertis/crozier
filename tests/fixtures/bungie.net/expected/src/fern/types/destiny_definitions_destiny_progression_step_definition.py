...
class DestinyDefinitionsDestinyProgressionStepDefinition(UniversalBaseModel):
    ...
    display_effect_type: typing_extensions.Annotated[typing.Optional[int], FieldMetadata(alias="displayEffectType")] = (
    ...
    progress_total: typing_extensions.Annotated[typing.Optional[int], FieldMetadata(alias="progressTotal")] = (
        pydantic.Field(default=None)
    )
    """
