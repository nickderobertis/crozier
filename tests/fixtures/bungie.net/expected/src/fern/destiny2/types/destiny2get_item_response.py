...
from ...types.destiny_responses_destiny_item_response import DestinyResponsesDestinyItemResponse


class Destiny2GetItemResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[DestinyResponsesDestinyItemResponse], FieldMetadata(alias="Response")
    ] = None
