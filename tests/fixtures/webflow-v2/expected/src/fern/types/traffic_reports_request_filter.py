...
class TrafficReportsRequestFilter(UniversalBaseModel):
    """
    ...
    audience_ids: typing_extensions.Annotated[
        typing.Optional[TrafficReportsRequestFilterAudienceIds],
    ...
    browser: typing.Optional[TrafficReportsRequestFilterBrowser] = pydantic.Field(default=None)
    """
    Operators for filtering a single dimension. Specify at least one of `eq`, `in`, `ne`, or `nin`.
    """

    collection_id: typing_extensions.Annotated[
        typing.Optional[TrafficReportsRequestFilterCollectionId],
    ...
    country: typing.Optional[TrafficReportsRequestFilterCountry] = pydantic.Field(default=None)
    """
    Operators for filtering a single dimension. Specify at least one of `eq`, `in`, `ne`, or `nin`.
    """

    day_of_week: typing_extensions.Annotated[
        typing.Optional[TrafficReportsRequestFilterDayOfWeek],
    ...
    device_brand: typing_extensions.Annotated[
        typing.Optional[TrafficReportsRequestFilterDeviceBrand],
    ...
    device_type: typing_extensions.Annotated[
        typing.Optional[TrafficReportsRequestFilterDeviceType],
    ...
    domain: typing.Optional[TrafficReportsRequestFilterDomain] = pydantic.Field(default=None)
    """
    Operators for filtering a single dimension. Specify at least one of `eq`, `in`, `ne`, or `nin`.
    """

    item_slug: typing_extensions.Annotated[
        typing.Optional[TrafficReportsRequestFilterItemSlug],
    ...
    language: typing.Optional[TrafficReportsRequestFilterLanguage] = pydantic.Field(default=None)
    """
    Operators for filtering a single dimension. Specify at least one of `eq`, `in`, `ne`, or `nin`.
    """

    locale: typing.Optional[TrafficReportsRequestFilterLocale] = pydantic.Field(default=None)
    """
    Operators for filtering a single dimension. Specify at least one of `eq`, `in`, `ne`, or `nin`.
    """

    next_collection_id: typing_extensions.Annotated[
        typing.Optional[TrafficReportsRequestFilterNextCollectionId],
    ...
    next_item_slug: typing_extensions.Annotated[
        typing.Optional[TrafficReportsRequestFilterNextItemSlug],
    ...
    next_page_id: typing_extensions.Annotated[
        typing.Optional[TrafficReportsRequestFilterNextPageId],
    ...
    os: typing.Optional[TrafficReportsRequestFilterOs] = pydantic.Field(default=None)
    """
    Operators for filtering a single dimension. Specify at least one of `eq`, `in`, `ne`, or `nin`.
    """

    page_id: typing_extensions.Annotated[
        typing.Optional[TrafficReportsRequestFilterPageId],
    ...
    page_path: typing_extensions.Annotated[
        typing.Optional[TrafficReportsRequestFilterPagePath],
    ...
    previous_collection_id: typing_extensions.Annotated[
        typing.Optional[TrafficReportsRequestFilterPreviousCollectionId],
    ...
    previous_item_slug: typing_extensions.Annotated[
        typing.Optional[TrafficReportsRequestFilterPreviousItemSlug],
    ...
    previous_page_id: typing_extensions.Annotated[
        typing.Optional[TrafficReportsRequestFilterPreviousPageId],
    ...
    referrer: typing.Optional[TrafficReportsRequestFilterReferrer] = pydantic.Field(default=None)
    """
    Operators for filtering a single dimension. Specify at least one of `eq`, `in`, `ne`, or `nin`.
    """

    region: typing.Optional[TrafficReportsRequestFilterRegion] = pydantic.Field(default=None)
    """
    Operators for filtering a single dimension. Specify at least one of `eq`, `in`, `ne`, or `nin`.
    """

    time_of_day: typing_extensions.Annotated[
        typing.Optional[TrafficReportsRequestFilterTimeOfDay],
    ...
    timezone: typing.Optional[TrafficReportsRequestFilterTimezone] = pydantic.Field(default=None)
    """
    Operators for filtering a single dimension. Specify at least one of `eq`, `in`, `ne`, or `nin`.
    """

    traffic_source: typing_extensions.Annotated[
        typing.Optional[TrafficReportsRequestFilterTrafficSource],
    ...
    utm_campaign: typing_extensions.Annotated[
        typing.Optional[TrafficReportsRequestFilterUtmCampaign],
    ...
    utm_content: typing_extensions.Annotated[
        typing.Optional[TrafficReportsRequestFilterUtmContent],
    ...
    utm_medium: typing_extensions.Annotated[
        typing.Optional[TrafficReportsRequestFilterUtmMedium],
    ...
    utm_source: typing_extensions.Annotated[
        typing.Optional[TrafficReportsRequestFilterUtmSource],
    ...
    utm_term: typing_extensions.Annotated[
        typing.Optional[TrafficReportsRequestFilterUtmTerm],
    ...
    visit_status: typing_extensions.Annotated[
        typing.Optional[TrafficReportsRequestFilterVisitStatus],
