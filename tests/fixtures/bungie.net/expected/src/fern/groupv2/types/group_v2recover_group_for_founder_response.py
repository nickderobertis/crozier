...
from ...types.groups_v2group_membership_search_response import GroupsV2GroupMembershipSearchResponse


class GroupV2RecoverGroupForFounderResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[GroupsV2GroupMembershipSearchResponse], FieldMetadata(alias="Response")
    ] = None
