...
class DistributionConfigOriginsItemsItemCustomOriginConfig(UniversalBaseModel):
    """
    ...
    origin_ssl_protocols: typing_extensions.Annotated[
        typing.Optional[DistributionConfigOriginsItemsItemCustomOriginConfigOriginSslProtocols],
