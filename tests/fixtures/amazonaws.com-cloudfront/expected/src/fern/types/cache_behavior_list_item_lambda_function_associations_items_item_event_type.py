...
class CacheBehaviorListItemLambdaFunctionAssociationsItemsItemEventType(enum.StrEnum):
    """
    ...
    def visit(
        ...
        if self is CacheBehaviorListItemLambdaFunctionAssociationsItemsItemEventType.VIEWER_REQUEST:
            return viewer_request()
        if self is CacheBehaviorListItemLambdaFunctionAssociationsItemsItemEventType.VIEWER_RESPONSE:
            return viewer_response()
        if self is CacheBehaviorListItemLambdaFunctionAssociationsItemsItemEventType.ORIGIN_REQUEST:
            return origin_request()
        if self is CacheBehaviorListItemLambdaFunctionAssociationsItemsItemEventType.ORIGIN_RESPONSE:
