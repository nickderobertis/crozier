...
class DestinyDefinitionsDestinyItemPerkEntryDefinition(UniversalBaseModel):
    ...
    perk_visibility: typing_extensions.Annotated[typing.Optional[int], FieldMetadata(alias="perkVisibility")] = (
    ...
    requirement_display_string: typing_extensions.Annotated[
        typing.Optional[str], FieldMetadata(alias="requirementDisplayString")
    ] = pydantic.Field(default=None)
    """
