...
class DistributionDistributionConfigDefaultCacheBehaviorForwardedValuesCookies(UniversalBaseModel):
    """
    ...
    whitelisted_names: typing_extensions.Annotated[
        typing.Optional[DistributionDistributionConfigDefaultCacheBehaviorForwardedValuesCookiesWhitelistedNames],
