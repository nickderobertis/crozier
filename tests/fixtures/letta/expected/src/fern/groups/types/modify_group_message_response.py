...
class ModifyGroupMessageResponse_SystemMessage(UniversalBaseModel):
...
class ModifyGroupMessageResponse_UserMessage(UniversalBaseModel):
...
class ModifyGroupMessageResponse_ReasoningMessage(UniversalBaseModel):
...
class ModifyGroupMessageResponse_HiddenReasoningMessage(UniversalBaseModel):
...
class ModifyGroupMessageResponse_ToolCallMessage(UniversalBaseModel):
...
class ModifyGroupMessageResponse_ToolReturnMessage(UniversalBaseModel):
...
class ModifyGroupMessageResponse_AssistantMessage(UniversalBaseModel):
...
class ModifyGroupMessageResponse_ApprovalRequestMessage(UniversalBaseModel):
...
class ModifyGroupMessageResponse_ApprovalResponseMessage(UniversalBaseModel):
...
class ModifyGroupMessageResponse_Summary(UniversalBaseModel):
...
class ModifyGroupMessageResponse_Event(UniversalBaseModel):
...
ModifyGroupMessageResponse = typing_extensions.Annotated[
    typing.Union[
