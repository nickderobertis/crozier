...
class CreateDistributionWithTagsRequestDistributionConfigWithTagsDistributionConfigCacheBehaviorsItemsItemViewerProtocolPolicy(
    enum.StrEnum
):
    """
    ...
    def visit(
        ...
        if (
            self
            is CreateDistributionWithTagsRequestDistributionConfigWithTagsDistributionConfigCacheBehaviorsItemsItemViewerProtocolPolicy.ALLOW_ALL
        ):
            return allow_all()
        if (
            self
            is CreateDistributionWithTagsRequestDistributionConfigWithTagsDistributionConfigCacheBehaviorsItemsItemViewerProtocolPolicy.HTTPS_ONLY
        ):
            return https_only()
        if (
            self
            is CreateDistributionWithTagsRequestDistributionConfigWithTagsDistributionConfigCacheBehaviorsItemsItemViewerProtocolPolicy.REDIRECT_TO_HTTPS
        ):
