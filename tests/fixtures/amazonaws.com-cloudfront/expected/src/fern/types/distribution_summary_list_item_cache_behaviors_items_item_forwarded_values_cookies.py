...
class DistributionSummaryListItemCacheBehaviorsItemsItemForwardedValuesCookies(UniversalBaseModel):
    """
    ...
    whitelisted_names: typing_extensions.Annotated[
        typing.Optional[DistributionSummaryListItemCacheBehaviorsItemsItemForwardedValuesCookiesWhitelistedNames],
