...
class SearchResultOfTrendingEntry(UniversalBaseModel):
    ...
    results: typing.Optional[typing.List["TrendingTrendingEntry"]] = None
...
update_forward_refs(SearchResultOfTrendingEntry, TrendingTrendingEntry=TrendingTrendingEntry)
