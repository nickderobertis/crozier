...
class UpdateUserGroupRequestCanAddMembersGroup(UniversalBaseModel):
    """
    ...
    **Changes**: New in Zulip 10.0 (feature level 305). Previously, this
    ...
    new: UpdateUserGroupRequestCanAddMembersGroupNew = pydantic.Field()
    """
    The new [group-setting value](/api/group-setting-values) for who would
    have this permission.
    """

    old: typing.Optional[UpdateUserGroupRequestCanAddMembersGroupOld] = pydantic.Field(default=None)
    """
