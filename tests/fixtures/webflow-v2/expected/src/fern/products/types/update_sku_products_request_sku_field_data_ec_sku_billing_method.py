...
class UpdateSkuProductsRequestSkuFieldDataEcSkuBillingMethod(enum.StrEnum):
    """
    ...
    def visit(self, one_time: typing.Callable[[], T_Result], subscription: typing.Callable[[], T_Result]) -> T_Result:
        if self is UpdateSkuProductsRequestSkuFieldDataEcSkuBillingMethod.ONE_TIME:
            return one_time()
        if self is UpdateSkuProductsRequestSkuFieldDataEcSkuBillingMethod.SUBSCRIPTION:
            return subscription()
