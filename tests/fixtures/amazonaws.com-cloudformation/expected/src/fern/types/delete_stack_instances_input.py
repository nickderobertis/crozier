...
class DeleteStackInstancesInput(UniversalBaseModel):
    ...
    deployment_targets: typing_extensions.Annotated[
        typing.Optional[DeleteStackInstancesInputDeploymentTargets], FieldMetadata(alias="DeploymentTargets")
    ] = pydantic.Field(default=None)
    """
    ...
    operation_preferences: typing_extensions.Annotated[
        typing.Optional[DeleteStackInstancesInputOperationPreferences], FieldMetadata(alias="OperationPreferences")
    ] = pydantic.Field(default=None)
    """
    Preferences for how CloudFormation performs this stack set operation.
    """

    retain_stacks: typing_extensions.Annotated[bool, FieldMetadata(alias="RetainStacks")] = pydantic.Field()
    """
    ...
    call_as: typing_extensions.Annotated[
        typing.Optional[DeleteStackInstancesInputCallAs], FieldMetadata(alias="CallAs")
    ] = pydantic.Field(default=None)
    """
