...
from .policy_scan_config_model_target_alert_rule_policy_filter import PolicyScanConfigModelTargetAlertRulePolicyFilter
from .policy_scan_config_model_target_included_resource_lists import PolicyScanConfigModelTargetIncludedResourceLists
from .target_tag_model import TargetTagModel


class PolicyScanConfigModelTarget(UniversalBaseModel):
    """
    ...
    alert_rule_policy_filter: typing_extensions.Annotated[
        typing.Optional[PolicyScanConfigModelTargetAlertRulePolicyFilter],
    ...
    included_resource_lists: typing_extensions.Annotated[
        typing.Optional[PolicyScanConfigModelTargetIncludedResourceLists],
