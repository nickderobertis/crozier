...
class PostPortfolioOptimizationMeanVarianceEfficientDiversifiedRequestConstraints(UniversalBaseModel):
    ...
    delta_return: typing_extensions.Annotated[
        typing.Optional[float],
        FieldMetadata(alias="deltaReturn"),
        pydantic.Field(
            alias="deltaReturn", description="The relative tolerance over the mean-variance efficient portfolio return"
        ),
    ] = None
    """
    ...
    delta_volatility: typing_extensions.Annotated[
        typing.Optional[float],
        FieldMetadata(alias="deltaVolatility"),
        pydantic.Field(
            alias="deltaVolatility",
