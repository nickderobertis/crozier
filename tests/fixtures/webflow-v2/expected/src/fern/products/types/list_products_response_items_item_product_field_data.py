...
class ListProductsResponseItemsItemProductFieldData(UniversalBaseModel):
    """
    ...
    sku_properties: typing_extensions.Annotated[
        typing.Optional[typing.List[ListProductsResponseItemsItemProductFieldDataSkuPropertiesItem]],
    ...
    tax_category: typing_extensions.Annotated[
        typing.Optional[ListProductsResponseItemsItemProductFieldDataTaxCategory],
    ...
    ec_product_type: typing_extensions.Annotated[
        typing.Optional[ListProductsResponseItemsItemProductFieldDataEcProductType],
