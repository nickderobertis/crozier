...
class DestinyDefinitionsDestinyVendorAcceptedItemDefinition(UniversalBaseModel):
    ...
    accepted_inventory_bucket_hash: typing_extensions.Annotated[
        typing.Optional[int],
        FieldMetadata(alias="acceptedInventoryBucketHash"),
        pydantic.Field(
            alias="acceptedInventoryBucketHash",
    ...
    destination_inventory_bucket_hash: typing_extensions.Annotated[
        typing.Optional[int],
        FieldMetadata(alias="destinationInventoryBucketHash"),
        pydantic.Field(
            alias="destinationInventoryBucketHash",
