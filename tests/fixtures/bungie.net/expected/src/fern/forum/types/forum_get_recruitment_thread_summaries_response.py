...
from ...types.forum_forum_recruitment_detail import ForumForumRecruitmentDetail


class ForumGetRecruitmentThreadSummariesResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[typing.List[ForumForumRecruitmentDetail]], FieldMetadata(alias="Response")
    ] = None
