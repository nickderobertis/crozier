...
class ServerAndOrganizationsClient:
    ...
    def create_custom_profile_field(
        ...
        *,
        ...
        hint: typing.Optional[str] = OMIT,
        field_data: typing.Optional[typing.Dict[str, typing.Any]] = OMIT,
        display_in_profile_summary: typing.Optional[bool] = OMIT,
        required: typing.Optional[bool] = OMIT,
        editable_by_user: typing.Optional[bool] = OMIT,
        use_for_user_matching: typing.Optional[bool] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
