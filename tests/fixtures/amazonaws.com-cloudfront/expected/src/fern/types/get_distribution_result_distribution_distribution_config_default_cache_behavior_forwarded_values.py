...
class GetDistributionResultDistributionDistributionConfigDefaultCacheBehaviorForwardedValues(UniversalBaseModel):
    """
    ...
    headers: typing_extensions.Annotated[
        typing.Optional[GetDistributionResultDistributionDistributionConfigDefaultCacheBehaviorForwardedValuesHeaders],
