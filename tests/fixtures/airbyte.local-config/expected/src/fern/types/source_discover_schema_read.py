...
class SourceDiscoverSchemaRead(UniversalBaseModel):
    ...
    breaking_change: typing_extensions.Annotated[typing.Optional[bool], FieldMetadata(alias="breakingChange")] = None
    ...
    connection_status: typing_extensions.Annotated[
        typing.Optional[ConnectionStatus], FieldMetadata(alias="connectionStatus")
    ] = None
