...
class DatabaseClient:
    ...
    def list_collections(
        ...
        *,
        ...
        """
        _response = self._raw_client.list_collections(
    ...
    def create_collection(
        ...
        *,
        ...
        _response = self._raw_client.create_collection(
            name=name, read=read, rules=rules, write=write, request_options=request_options
        )
        return _response.data
    ...
    def get_collection(
        ...
        """
        _response = self._raw_client.get_collection(collection_id, request_options=request_options)
        return _response.data
    ...
    def update_collection(
        ...
        *,
        ...
        _response = self._raw_client.update_collection(
            collection_id, name=name, read=read, rules=rules, write=write, request_options=request_options
        )
        return _response.data
    ...
    def delete_collection(self, collection_id: str, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        """
        _response = self._raw_client.delete_collection(collection_id, request_options=request_options)
        return _response.data
...
class AsyncDatabaseClient:
    ...
    async def list_collections(
        ...
        *,
        ...
        async def main() -> None:
            await client.database.list_collections()


        asyncio.run(main())
        """
        _response = await self._raw_client.list_collections(
            search=search, limit=limit, offset=offset, order_type=order_type, request_options=request_options
        )
        return _response.data
    ...
    async def get_collection(
        ...
        async def main() -> None:
            await client.database.get_collection(
                collection_id="collectionId",
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.get_collection(collection_id, request_options=request_options)
        return _response.data
    ...
    async def delete_collection(
        ...
        async def main() -> None:
            await client.database.delete_collection(
                collection_id="collectionId",
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.delete_collection(collection_id, request_options=request_options)
        return _response.data
