...
class DistributionDistributionConfigDefaultCacheBehaviorForwardedValues(UniversalBaseModel):
    """
    ...
    headers: typing_extensions.Annotated[
        typing.Optional[DistributionDistributionConfigDefaultCacheBehaviorForwardedValuesHeaders],
    ...
    query_string_cache_keys: typing_extensions.Annotated[
        typing.Optional[DistributionDistributionConfigDefaultCacheBehaviorForwardedValuesQueryStringCacheKeys],
