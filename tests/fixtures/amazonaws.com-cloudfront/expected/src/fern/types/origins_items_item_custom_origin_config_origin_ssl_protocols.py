...
class OriginsItemsItemCustomOriginConfigOriginSslProtocols(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.List[OriginsItemsItemCustomOriginConfigOriginSslProtocolsItemsItem],
