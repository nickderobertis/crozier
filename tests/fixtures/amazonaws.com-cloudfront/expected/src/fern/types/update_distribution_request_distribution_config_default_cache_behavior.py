...
class UpdateDistributionRequestDistributionConfigDefaultCacheBehavior(UniversalBaseModel):
    """
    ...
    lambda_function_associations: typing_extensions.Annotated[
        typing.Optional[UpdateDistributionRequestDistributionConfigDefaultCacheBehaviorLambdaFunctionAssociations],
