...
class DictionaryComponentResponseOfint64AndDestinyCurrenciesComponent(UniversalBaseModel):
    data: typing.Optional[typing.Dict[str, DestinyComponentsInventoryDestinyCurrenciesComponent]] = None
