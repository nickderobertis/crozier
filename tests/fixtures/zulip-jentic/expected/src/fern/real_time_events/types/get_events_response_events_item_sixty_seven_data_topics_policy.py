...
class GetEventsResponseEventsItemSixtySevenDataTopicsPolicy(enum.StrEnum):
    """
    ...
    **Changes**: New in Zulip 11.0 (feature level 392). Previously, this was
    ...
    def visit(
        ...
        if self is GetEventsResponseEventsItemSixtySevenDataTopicsPolicy.ALLOW_EMPTY_TOPIC:
            return allow_empty_topic()
        if self is GetEventsResponseEventsItemSixtySevenDataTopicsPolicy.DISABLE_EMPTY_TOPIC:
