...
class GetFullTextSearchResponse(UniversalBaseModel):
    ...
    sparql_query: typing_extensions.Annotated[
        ...
        pydantic.Field(alias="sparqlQuery", description="The SPARQL query that was used for retrieving the results"),
    ] = None
    """
