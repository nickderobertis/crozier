...
from .get_products_response_product_field_data_ec_product_type import GetProductsResponseProductFieldDataEcProductType
...
class GetProductsResponseProductFieldData(UniversalBaseModel):
    """
    ...
    sku_properties: typing_extensions.Annotated[
        typing.Optional[typing.List[GetProductsResponseProductFieldDataSkuPropertiesItem]],
    ...
    tax_category: typing_extensions.Annotated[
        typing.Optional[GetProductsResponseProductFieldDataTaxCategory],
    ...
    ec_product_type: typing_extensions.Annotated[
        typing.Optional[GetProductsResponseProductFieldDataEcProductType],
