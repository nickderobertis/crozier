...
from ...types.global_alert import GlobalAlert


class GetGlobalAlertsResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[typing.List[GlobalAlert]], FieldMetadata(alias="Response"), pydantic.Field(alias="Response")
    ] = None
