...
class DistributionConfigCacheBehaviorsItemsItemViewerProtocolPolicy(enum.StrEnum):
    """
    ...
    def visit(
        ...
        if self is DistributionConfigCacheBehaviorsItemsItemViewerProtocolPolicy.ALLOW_ALL:
            return allow_all()
        if self is DistributionConfigCacheBehaviorsItemsItemViewerProtocolPolicy.HTTPS_ONLY:
            return https_only()
        if self is DistributionConfigCacheBehaviorsItemsItemViewerProtocolPolicy.REDIRECT_TO_HTTPS:
