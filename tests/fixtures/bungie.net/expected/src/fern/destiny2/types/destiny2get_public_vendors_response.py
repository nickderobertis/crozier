...
from ...types.destiny_responses_destiny_public_vendors_response import DestinyResponsesDestinyPublicVendorsResponse


class Destiny2GetPublicVendorsResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[DestinyResponsesDestinyPublicVendorsResponse], FieldMetadata(alias="Response")
    ] = None
