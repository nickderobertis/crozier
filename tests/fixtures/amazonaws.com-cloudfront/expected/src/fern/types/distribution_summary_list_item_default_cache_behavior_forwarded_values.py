...
class DistributionSummaryListItemDefaultCacheBehaviorForwardedValues(UniversalBaseModel):
    """
    ...
    headers: typing_extensions.Annotated[
        typing.Optional[DistributionSummaryListItemDefaultCacheBehaviorForwardedValuesHeaders],
    ...
    query_string_cache_keys: typing_extensions.Annotated[
        typing.Optional[DistributionSummaryListItemDefaultCacheBehaviorForwardedValuesQueryStringCacheKeys],
