...
class ResolveCommentThreadCommentsResponse(UniversalBaseModel):
    """
    ...
    author: ResolveCommentThreadCommentsResponseAuthor
    mentioned_users: typing_extensions.Annotated[
        typing.List[ResolveCommentThreadCommentsResponseMentionedUsersItem],
