...
class ListDistributionsResultDistributionListItemsItemOrigins(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[typing.List[ListDistributionsResultDistributionListItemsItemOriginsItemsItem]],
