...
from ...types.user_general_user import UserGeneralUser


class UserGetBungieNetUserByIdResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[typing.Optional[UserGeneralUser], FieldMetadata(alias="Response")] = None
