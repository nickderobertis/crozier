...
class RawSitesClient:
    ...
    def create(
        ...
        *,
    ...
    ) -> HttpResponse[CreateSitesResponse]:
        """
        Create a site.
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"workspaces/{encode_path_param(workspace_id)}/sites",
    ...
    def update(
        ...
        *,
        ...
        parent_folder_id: typing.Optional[str] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[UpdateSitesResponse]:
        """
        Update a site.
    ...
    def get_custom_domain(
        self, site_id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> HttpResponse[GetCustomDomainSitesResponse]:
        """
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"sites/{encode_path_param(site_id)}/custom_domains",
            base_url=self._client_wrapper.get_environment().base,
            method="GET",
            request_options=request_options,
        )
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=GetCustomDomainSitesResponse,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def publish(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[PublishSitesResponse]:
        """
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"sites/{encode_path_param(site_id)}/publish",
            base_url=self._client_wrapper.get_environment().base,
            method="POST",
            json={
...
class AsyncRawSitesClient:
    ...
    async def create(
        ...
        *,
        ...
        parent_folder_id: typing.Optional[str] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[CreateSitesResponse]:
        """
        Create a site.
    ...
    async def get(
        self, site_id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[GetSitesResponse]:
        """
        Get details of a site.
    ...
    async def update(
        ...
        *,
        ...
        parent_folder_id: typing.Optional[str] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[UpdateSitesResponse]:
        """
        Update a site.
    ...
    async def get_custom_domain(
        self, site_id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[GetCustomDomainSitesResponse]:
        """
        Get a list of all custom domains related to site.
    ...
    async def publish(
        ...
        *,
        ...
        page_id: typing.Optional[str] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[PublishSitesResponse]:
        """
        Publishes a site or an individual page to one or more domains.
        If multiple individual pages are published to staging, publishing from staging to production publishes all staged changes.
