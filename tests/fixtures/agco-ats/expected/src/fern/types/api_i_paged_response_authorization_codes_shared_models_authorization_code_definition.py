...
class ApiIPagedResponseAuthorizationCodesSharedModelsAuthorizationCodeDefinition(UniversalBaseModel):
    entities: typing_extensions.Annotated[
        typing.Optional[typing.List[AuthorizationCodesSharedModelsAuthorizationCodeDefinition]],
