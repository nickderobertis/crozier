...
class ListStackInstancesInputCallAs(str, enum.Enum):
    """
    ...
    def visit(self, self_: typing.Callable[[], T_Result], delegated_admin: typing.Callable[[], T_Result]) -> T_Result:
        if self is ListStackInstancesInputCallAs.SELF:
            return self_()
        if self is ListStackInstancesInputCallAs.DELEGATED_ADMIN:
