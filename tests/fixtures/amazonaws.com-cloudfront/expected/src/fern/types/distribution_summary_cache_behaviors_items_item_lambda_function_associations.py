...
class DistributionSummaryCacheBehaviorsItemsItemLambdaFunctionAssociations(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[typing.List[DistributionSummaryCacheBehaviorsItemsItemLambdaFunctionAssociationsItemsItem]],
