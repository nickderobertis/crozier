...
from ...types.destiny_responses_destiny_item_change_response import DestinyResponsesDestinyItemChangeResponse


class Destiny2InsertSocketPlugFreeResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[DestinyResponsesDestinyItemChangeResponse], FieldMetadata(alias="Response")
    ] = None
