...
class PostPortfolioOptimizationMinimumVarianceDiversifiedRequestConstraints(UniversalBaseModel):
    ...
    delta_volatility: typing_extensions.Annotated[
        ...
        pydantic.Field(
            alias="deltaVolatility", description="The relative tolerance over the minimum variance portfolio volatility"
        ),
    ] = None
    """
