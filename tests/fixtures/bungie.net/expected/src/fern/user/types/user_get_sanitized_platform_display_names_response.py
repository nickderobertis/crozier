...
class UserGetSanitizedPlatformDisplayNamesResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[typing.Optional[typing.Dict[str, str]], FieldMetadata(alias="Response")] = (
        None
    )
