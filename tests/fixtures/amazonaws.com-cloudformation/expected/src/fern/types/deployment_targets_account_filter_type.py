...
class DeploymentTargetsAccountFilterType(str, enum.Enum):
    """
    ...
    def visit(
        ...
        if self is DeploymentTargetsAccountFilterType.NONE:
            return none()
        if self is DeploymentTargetsAccountFilterType.INTERSECTION:
            return intersection()
        if self is DeploymentTargetsAccountFilterType.DIFFERENCE:
            return difference()
        if self is DeploymentTargetsAccountFilterType.UNION:
            return union()
