...
class RegisterTypeInput(UniversalBaseModel):
    type: typing_extensions.Annotated[typing.Optional[RegisterTypeInputType], FieldMetadata(alias="Type")] = (
    ...
    type_name: typing_extensions.Annotated[str, FieldMetadata(alias="TypeName")] = pydantic.Field()
    """
    ...
    schema_handler_package: typing_extensions.Annotated[str, FieldMetadata(alias="SchemaHandlerPackage")] = (
        pydantic.Field()
    )
    """
    ...
    logging_config: typing_extensions.Annotated[
        typing.Optional[RegisterTypeInputLoggingConfig], FieldMetadata(alias="LoggingConfig")
    ] = pydantic.Field(default=None)
    """
