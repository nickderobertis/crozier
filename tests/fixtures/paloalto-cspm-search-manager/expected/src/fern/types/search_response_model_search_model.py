...
from .search_response_model_search_model_time_range import SearchResponseModelSearchModelTimeRange
from .ui_filter_model import UiFilterModel


class SearchResponseModelSearchModel(UniversalBaseModel):
    ...
    cloud_type: typing_extensions.Annotated[
        typing.Optional[SearchResponseModelSearchModelCloudType],
    ...
    data: typing.Optional[SearchModel] = None
    ...
    search_type: typing_extensions.Annotated[
        typing.Optional[SearchResponseModelSearchModelSearchType],
