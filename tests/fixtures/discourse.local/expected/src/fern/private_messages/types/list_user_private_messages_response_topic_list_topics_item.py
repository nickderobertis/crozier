...
class ListUserPrivateMessagesResponseTopicListTopicsItem(UniversalBaseModel):
    allowed_user_count: typing.Optional[int] = None
    ...
    participants: typing.Optional[typing.List[ListUserPrivateMessagesResponseTopicListTopicsItemParticipantsItem]] = (
        None
    )
    pinned: typing.Optional[bool] = None
    pinned_globally: typing.Optional[bool] = None
    posters: typing.Optional[typing.List[ListUserPrivateMessagesResponseTopicListTopicsItemPostersItem]] = None
