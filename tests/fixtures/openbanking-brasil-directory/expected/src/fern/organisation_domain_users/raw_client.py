...
class RawOrganisationDomainUsersClient:
    ...
    def all_users_for_the_given_authorisation_domain(
        ...
        *,
    ...
    ) -> HttpResponse[AuthorisationDomainUsersPage]:
        """
        Parameters
        ----------
        organisation_id : OrganisationId
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"organisations/{encode_path_param(organisation_id)}/{encode_path_param(authorisation_domain_name)}/users",
            method="GET",
            params={
                "page": page,
                "size": size,
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=AuthorisationDomainUsersPage,
    ...
    def authorisation_domain_user_details(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"organisations/{encode_path_param(organisation_id)}/{encode_path_param(authorisation_domain_name)}/users/{encode_path_param(user_email_id)}",
            method="GET",
            params={
                "page": page,
                "size": size,
...
class AsyncRawOrganisationDomainUsersClient:
    ...
    async def all_users_for_the_given_authorisation_domain(
        ...
        *,
        ...
        sort: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[AuthorisationDomainUsersPage]:
        """
        Parameters
        ----------
        organisation_id : OrganisationId
