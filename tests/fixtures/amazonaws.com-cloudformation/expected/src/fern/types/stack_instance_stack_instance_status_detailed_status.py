...
class StackInstanceStackInstanceStatusDetailedStatus(str, enum.Enum):
    """
    ...
    def visit(
        ...
        if self is StackInstanceStackInstanceStatusDetailedStatus.PENDING:
            return pending()
        if self is StackInstanceStackInstanceStatusDetailedStatus.RUNNING:
            return running()
        if self is StackInstanceStackInstanceStatusDetailedStatus.SUCCEEDED:
            return succeeded()
        if self is StackInstanceStackInstanceStatusDetailedStatus.FAILED:
            return failed()
        if self is StackInstanceStackInstanceStatusDetailedStatus.CANCELLED:
            return cancelled()
        if self is StackInstanceStackInstanceStatusDetailedStatus.INOPERABLE:
            return inoperable()
