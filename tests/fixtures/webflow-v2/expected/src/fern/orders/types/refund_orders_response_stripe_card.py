...
class RefundOrdersResponseStripeCard(UniversalBaseModel):
    """
    ...
    brand: typing.Optional[RefundOrdersResponseStripeCardBrand] = pydantic.Field(default=None)
    """
    ...
    expires: typing.Optional[RefundOrdersResponseStripeCardExpires] = pydantic.Field(default=None)
    """
