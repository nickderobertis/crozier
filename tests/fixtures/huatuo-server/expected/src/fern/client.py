...
if typing.TYPE_CHECKING:
    from .profiling.client import AsyncProfilingClient, ProfilingClient
...
class FernApi:
    ...
    def __init__(
        ...
        *,
        ...
        self._profiling: typing.Optional[ProfilingClient] = None
        self._tracing: typing.Optional[TracingClient] = None
    ...
    def profiling(self):
        if self._profiling is None:
            from .profiling.client import ProfilingClient

            self._profiling = ProfilingClient(client_wrapper=self._client_wrapper)
    ...
    def tracing(self):
        if self._tracing is None:
            ...
            self._tracing = TracingClient(client_wrapper=self._client_wrapper)
...
class AsyncFernApi:
    ...
    def __init__(
        ...
        *,
        ...
        self._profiling: typing.Optional[AsyncProfilingClient] = None
        self._tracing: typing.Optional[AsyncTracingClient] = None
    ...
    def profiling(self):
        if self._profiling is None:
            from .profiling.client import AsyncProfilingClient

            self._profiling = AsyncProfilingClient(client_wrapper=self._client_wrapper)
        return self._profiling
    ...
    def tracing(self):
        if self._tracing is None:
            ...
            self._tracing = AsyncTracingClient(client_wrapper=self._client_wrapper)
        return self._tracing
