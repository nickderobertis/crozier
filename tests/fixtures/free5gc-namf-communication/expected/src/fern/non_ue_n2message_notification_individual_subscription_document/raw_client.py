...
class RawNonUeN2MessageNotificationIndividualSubscriptionDocumentClient:
    ...
    def non_ue_n2info_un_subscribe(
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"non-ue-n2-messages/subscriptions/{encode_path_param(n2notify_subscription_id)}",
            method="DELETE",
...
class AsyncRawNonUeN2MessageNotificationIndividualSubscriptionDocumentClient:
