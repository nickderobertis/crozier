...
class WritableInterfacePoeType(str, enum.Enum):
    ...
    def visit(
        ...
        if self is WritableInterfacePoeType.TYPE1IEEE8023AF:
            return type1ieee8023af()
        if self is WritableInterfacePoeType.TYPE2IEEE8023AT:
            return type2ieee8023at()
        if self is WritableInterfacePoeType.TYPE2IEEE8023AZ:
            return type2ieee8023az()
        if self is WritableInterfacePoeType.TYPE3IEEE8023BT:
            return type3ieee8023bt()
        if self is WritableInterfacePoeType.TYPE4IEEE8023BT:
            return type4ieee8023bt()
        if self is WritableInterfacePoeType.PASSIVE24V2PAIR:
            return passive24v2pair()
        if self is WritableInterfacePoeType.PASSIVE24V4PAIR:
            return passive24v4pair()
        if self is WritableInterfacePoeType.PASSIVE48V2PAIR:
            return passive48v2pair()
        if self is WritableInterfacePoeType.PASSIVE48V4PAIR:
