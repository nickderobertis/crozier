...
from ...types.tokens_partner_offer_sku_history_response import TokensPartnerOfferSkuHistoryResponse


class TokensGetPartnerOfferSkuHistoryResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[typing.List[TokensPartnerOfferSkuHistoryResponse]], FieldMetadata(alias="Response")
    ] = None
