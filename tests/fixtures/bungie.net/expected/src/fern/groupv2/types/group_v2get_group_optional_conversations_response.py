...
from ...types.groups_v2group_optional_conversation import GroupsV2GroupOptionalConversation


class GroupV2GetGroupOptionalConversationsResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[typing.List[GroupsV2GroupOptionalConversation]], FieldMetadata(alias="Response")
    ] = None
