...
class RawPayrollsClient:
    ...
    ) -> HttpResponse[GetPayrollsResponse]:
        """
        List Payroll
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            params={
                ...
                "filter": convert_and_respect_annotation_metadata(
                    object_=filter, annotation=PayrollsFilter, direction="write"
                ),
                "fields": fields,
            },
    ...
    def one(
        ...
        *,
        ...
        fields: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[GetPayrollResponse]:
        """
        Get Payroll
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"hris/payrolls/{encode_path_param(payroll_id)}",
            method="GET",
            params={
                "raw": raw,
                "fields": fields,
...
class AsyncRawPayrollsClient:
    ...
    async def all_(
        ...
        *,
        ...
        fields: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[GetPayrollsResponse]:
        """
        List Payroll
    ...
    async def one(
        ...
        *,
        ...
        fields: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[GetPayrollResponse]:
        """
        Get Payroll
