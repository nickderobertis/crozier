...
class RawMonetaryAccountExternalClient:
    def __init__(self, *, client_wrapper: SyncClientWrapper):
        self._client_wrapper = client_wrapper

    def list_all_monetary_account_external_for_user(
        self, user_id: int, *, request_options: typing.Optional[RequestOptions] = None
    ) -> HttpResponse[typing.List[MonetaryAccountExternalListing]]:
        """
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"user/{encode_path_param(user_id)}/monetary-account-external",
            method="GET",
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=typing.List[MonetaryAccountExternalListing],
    ...
    def read_monetary_account_external_for_user(
    ...
    ) -> HttpResponse[MonetaryAccountExternalRead]:
        """
        Endpoint for managing monetary accounts which are connected to external services.
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"user/{encode_path_param(user_id)}/monetary-account-external/{encode_path_param(item_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=MonetaryAccountExternalRead,
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawMonetaryAccountExternalClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._client_wrapper = client_wrapper

    async def list_all_monetary_account_external_for_user(
        self, user_id: int, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[typing.List[MonetaryAccountExternalListing]]:
        """
        Endpoint for managing monetary accounts which are connected to external services.
    ...
    async def read_monetary_account_external_for_user(
        self, user_id: int, item_id: int, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[MonetaryAccountExternalRead]:
        """
        Endpoint for managing monetary accounts which are connected to external services.
