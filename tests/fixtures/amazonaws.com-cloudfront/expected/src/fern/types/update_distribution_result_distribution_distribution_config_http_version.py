...
class UpdateDistributionResultDistributionDistributionConfigHttpVersion(enum.StrEnum):
    """
    ...
    def visit(self, http11: typing.Callable[[], T_Result], http2: typing.Callable[[], T_Result]) -> T_Result:
        if self is UpdateDistributionResultDistributionDistributionConfigHttpVersion.HTTP11:
            return http11()
        if self is UpdateDistributionResultDistributionDistributionConfigHttpVersion.HTTP2:
            return http2()
