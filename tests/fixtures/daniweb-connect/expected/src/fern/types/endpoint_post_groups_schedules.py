...
class EndpointPostGroupsSchedules(UniversalBaseModel):
    data: typing.Optional[typing.List[EndpointPostGroupsSchedulesDataItem]] = None
...
update_forward_refs(EndpointPostGroupsSchedules)
