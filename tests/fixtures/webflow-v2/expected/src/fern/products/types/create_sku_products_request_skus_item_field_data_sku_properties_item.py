...
class CreateSkuProductsRequestSkusItemFieldDataSkuPropertiesItem(UniversalBaseModel):
    """
    ...
    enum: typing.List[CreateSkuProductsRequestSkusItemFieldDataSkuPropertiesItemEnumItem] = pydantic.Field()
    """
