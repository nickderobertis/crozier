...
The APIs.guru snapshot at `docs/openapi-surface/apis-guru-gap-witnesses.tsv` assigned these thirty keys to the probe route: no row carries both an admitted licence and a publisher-owned immutable reference. Each key has its own smallest probe, so the measurements remain separable. The 29 accepted documents were run through Fern Python 5.20.0 with the repository-pinned Fern CLI 5.67.1; generator validation and generation both completed successfully, and the complete comment-stripped packaged SDK is committed under `openapi-surface/probe-expected/<key>/`. Crozier is driven over every same input by `witness_supply_probes_match_fern_measurements` and matches every committed file under the corpus normalization. `ref-pointer-unnamed-segment` is the sole refusal: Fern emits no SDK and reports `Type name must begin with a letter`.

These are witness-supply settlements, not parity fixtures. A later real API document that is publisher-owned, redistribution-compatible, immutable, and Fern-accepted promotes the corresponding row to `golden` under the classification precedence. No probe or expectation below is a corpus row or Fern golden.

| gap | eligible | verified | verdict | measured outcome and supply blocker |
|---|---:|---:|---|---|
| `annotated-ref-target-closed-object` | 0 | 1 | discards | Probe [`annotated-ref-target-closed-object.yml`](openapi-surface/probes/annotated-ref-target-closed-object.yml). Fern generates the committed 39-file SDK; Crozier normalized comparison matches all 39 files. APIs.guru found 1 candidate row(s), but none has a publisher-owned immutable reference; licence screens: refused. A later registrable witness promotes this row to `golden`. |
| `annotated-ref-target-composed` | 0 | 2 | discards | Probe [`annotated-ref-target-composed.yml`](openapi-surface/probes/annotated-ref-target-composed.yml). Fern generates the committed 39-file SDK; Crozier normalized comparison matches all 39 files. APIs.guru found 2 candidate row(s), but none has a publisher-owned immutable reference; licence screens: admitted. A later registrable witness promotes this row to `golden`. |
| `annotated-ref-target-oneof` | 0 | 1 | discards | Probe [`annotated-ref-target-oneof.yml`](openapi-surface/probes/annotated-ref-target-oneof.yml). Fern generates the committed 39-file SDK; Crozier normalized comparison matches all 39 files. APIs.guru found 1 candidate row(s), but none has a publisher-owned immutable reference; licence screens: refused. A later registrable witness promotes this row to `golden`. |
| `annotated-ref-target-string-const` | 0 | 0 | discards | Probe [`annotated-ref-target-string-const.yml`](openapi-surface/probes/annotated-ref-target-string-const.yml). Fern generates the committed 39-file SDK; Crozier normalized comparison matches all 39 files. APIs.guru found no catalogue declaration. A later registrable witness promotes this row to `golden`. |
| `anyof-array-variant-anyof-nullable-item` | 0 | 0 | implements | Probe [`anyof-array-variant-anyof-nullable-item.yml`](openapi-surface/probes/anyof-array-variant-anyof-nullable-item.yml). Fern generates the committed 38-file SDK; Crozier normalized comparison matches all 38 files. APIs.guru found no catalogue declaration. A later registrable witness promotes this row to `golden`. |
| `anyof-array-variant-closed-object-item` | 0 | 1 | implements | Probe [`anyof-array-variant-closed-object-item.yml`](openapi-surface/probes/anyof-array-variant-closed-object-item.yml). Fern generates the committed 38-file SDK; Crozier normalized comparison matches all 38 files. APIs.guru found 1 candidate row(s), but none has a publisher-owned immutable reference; licence screens: refused. A later registrable witness promotes this row to `golden`. |
| `anyof-array-variant-empty-object-item` | 0 | 0 | implements | Probe [`anyof-array-variant-empty-object-item.yml`](openapi-surface/probes/anyof-array-variant-empty-object-item.yml). Fern generates the committed 39-file SDK; Crozier normalized comparison matches all 39 files. APIs.guru found no catalogue declaration. A later registrable witness promotes this row to `golden`. |
| `anyof-array-variant-oneof-nullable-item` | 0 | 0 | implements | Probe [`anyof-array-variant-oneof-nullable-item.yml`](openapi-surface/probes/anyof-array-variant-oneof-nullable-item.yml). Fern generates the committed 38-file SDK; Crozier normalized comparison matches all 38 files. APIs.guru found no catalogue declaration. A later registrable witness promotes this row to `golden`. |
| `anyof-array-variant-struct-item` | 0 | 2 | implements | Probe [`anyof-array-variant-struct-item.yml`](openapi-surface/probes/anyof-array-variant-struct-item.yml). Fern generates the committed 39-file SDK; Crozier normalized comparison matches all 39 files. APIs.guru found 2 candidate row(s), but none has a publisher-owned immutable reference; licence screens: refused. A later registrable witness promotes this row to `golden`. |
| `anyof-sole-member` | 0 | 6 | implements | Probe [`anyof-sole-member.yml`](openapi-surface/probes/anyof-sole-member.yml). Fern generates the committed 38-file SDK; Crozier normalized comparison matches all 38 files. APIs.guru found 6 candidate row(s), but none has a publisher-owned immutable reference; licence screens: admitted, refused, unknown. A later registrable witness promotes this row to `golden`. |
| `array-item-inheritance-union` | 0 | 0 | implements | Probe [`array-item-inheritance-union.yml`](openapi-surface/probes/array-item-inheritance-union.yml). Fern generates the committed 41-file SDK; Crozier normalized comparison matches all 41 files. APIs.guru found no catalogue declaration. A later registrable witness promotes this row to `golden`. |
| `array-item-pointer-walk-anyof` | 0 | 0 | discards | Probe [`array-item-pointer-walk-anyof.yml`](openapi-surface/probes/array-item-pointer-walk-anyof.yml). Fern generates the committed 39-file SDK; Crozier normalized comparison matches all 39 files. APIs.guru found no catalogue declaration. A later registrable witness promotes this row to `golden`. |
| `array-item-pointer-walk-oneof` | 0 | 0 | discards | Probe [`array-item-pointer-walk-oneof.yml`](openapi-surface/probes/array-item-pointer-walk-oneof.yml). Fern generates the committed 39-file SDK; Crozier normalized comparison matches all 39 files. APIs.guru found no catalogue declaration. A later registrable witness promotes this row to `golden`. |
| `oneof-array-variant-annotated-ref-item` | 0 | 0 | implements | Probe [`oneof-array-variant-annotated-ref-item.yml`](openapi-surface/probes/oneof-array-variant-annotated-ref-item.yml). Fern generates the committed 39-file SDK; Crozier normalized comparison matches all 39 files. APIs.guru found no catalogue declaration. A later registrable witness promotes this row to `golden`. |
| `oneof-array-variant-anyof-discriminated-union-item` | 0 | 0 | implements | Probe [`oneof-array-variant-anyof-discriminated-union-item.yml`](openapi-surface/probes/oneof-array-variant-anyof-discriminated-union-item.yml). Fern generates the committed 41-file SDK; Crozier normalized comparison matches all 41 files. APIs.guru found no catalogue declaration. A later registrable witness promotes this row to `golden`. |
| `oneof-array-variant-anyof-item` | 0 | 0 | implements | Probe [`oneof-array-variant-anyof-item.yml`](openapi-surface/probes/oneof-array-variant-anyof-item.yml). Fern generates the committed 39-file SDK; Crozier normalized comparison matches all 39 files. APIs.guru found no catalogue declaration. A later registrable witness promotes this row to `golden`. |
| `oneof-array-variant-anyof-nullable-item` | 0 | 0 | implements | Probe [`oneof-array-variant-anyof-nullable-item.yml`](openapi-surface/probes/oneof-array-variant-anyof-nullable-item.yml). Fern generates the committed 38-file SDK; Crozier normalized comparison matches all 38 files. APIs.guru found no catalogue declaration. A later registrable witness promotes this row to `golden`. |
| `oneof-array-variant-closed-object-item` | 0 | 0 | implements | Probe [`oneof-array-variant-closed-object-item.yml`](openapi-surface/probes/oneof-array-variant-closed-object-item.yml). Fern generates the committed 38-file SDK; Crozier normalized comparison matches all 38 files. APIs.guru found no catalogue declaration. A later registrable witness promotes this row to `golden`. |
| `oneof-array-variant-composed-item` | 0 | 0 | implements | Probe [`oneof-array-variant-composed-item.yml`](openapi-surface/probes/oneof-array-variant-composed-item.yml). Fern generates the committed 39-file SDK; Crozier normalized comparison matches all 39 files. APIs.guru found no catalogue declaration. A later registrable witness promotes this row to `golden`. |
| `oneof-array-variant-empty-object-item` | 0 | 0 | implements | Probe [`oneof-array-variant-empty-object-item.yml`](openapi-surface/probes/oneof-array-variant-empty-object-item.yml). Fern generates the committed 39-file SDK; Crozier normalized comparison matches all 39 files. APIs.guru found no catalogue declaration. A later registrable witness promotes this row to `golden`. |
| `oneof-bare-object-example-variant` | 0 | 0 | discards | Probe [`oneof-bare-object-example-variant.yml`](openapi-surface/probes/oneof-bare-object-example-variant.yml). Fern generates the committed 38-file SDK; Crozier normalized comparison matches all 38 files. APIs.guru found no catalogue declaration. A later registrable witness promotes this row to `golden`. |
| `property-sole-anyof-closed-object-member` | 0 | 0 | implements | Probe [`property-sole-anyof-closed-object-member.yml`](openapi-surface/probes/property-sole-anyof-closed-object-member.yml). Fern generates the committed 38-file SDK; Crozier normalized comparison matches all 38 files. APIs.guru found no catalogue declaration. A later registrable witness promotes this row to `golden`. |
| `property-sole-anyof-composed-member` | 0 | 0 | implements | Probe [`property-sole-anyof-composed-member.yml`](openapi-surface/probes/property-sole-anyof-composed-member.yml). Fern generates the committed 39-file SDK; Crozier normalized comparison matches all 39 files. APIs.guru found no catalogue declaration. A later registrable witness promotes this row to `golden`. |
| `property-sole-anyof-empty-object-member` | 0 | 0 | implements | Probe [`property-sole-anyof-empty-object-member.yml`](openapi-surface/probes/property-sole-anyof-empty-object-member.yml). Fern generates the committed 39-file SDK; Crozier normalized comparison matches all 39 files. APIs.guru found no catalogue declaration. A later registrable witness promotes this row to `golden`. |
| `property-sole-anyof-struct-member` | 0 | 0 | implements | Probe [`property-sole-anyof-struct-member.yml`](openapi-surface/probes/property-sole-anyof-struct-member.yml). Fern generates the committed 39-file SDK; Crozier normalized comparison matches all 39 files. APIs.guru found no catalogue declaration. A later registrable witness promotes this row to `golden`. |
| `property-sole-oneof-closed-object-member` | 0 | 0 | implements | Probe [`property-sole-oneof-closed-object-member.yml`](openapi-surface/probes/property-sole-oneof-closed-object-member.yml). Fern generates the committed 38-file SDK; Crozier normalized comparison matches all 38 files. APIs.guru found no catalogue declaration. A later registrable witness promotes this row to `golden`. |
| `property-sole-oneof-composed-member` | 0 | 0 | implements | Probe [`property-sole-oneof-composed-member.yml`](openapi-surface/probes/property-sole-oneof-composed-member.yml). Fern generates the committed 39-file SDK; Crozier normalized comparison matches all 39 files. APIs.guru found no catalogue declaration. A later registrable witness promotes this row to `golden`. |
| `property-sole-oneof-empty-object-member` | 0 | 0 | implements | Probe [`property-sole-oneof-empty-object-member.yml`](openapi-surface/probes/property-sole-oneof-empty-object-member.yml). Fern generates the committed 39-file SDK; Crozier normalized comparison matches all 39 files. APIs.guru found no catalogue declaration. A later registrable witness promotes this row to `golden`. |
| `ref-pointer-undeclared-component-head` | 0 | 0 | discards | Probe [`ref-pointer-undeclared-component-head.yml`](openapi-surface/probes/ref-pointer-undeclared-component-head.yml). Fern generates the committed 38-file SDK; Crozier normalized comparison matches all 38 files. APIs.guru found no catalogue declaration. A later registrable witness promotes this row to `golden`. |
| `ref-pointer-unnamed-segment` | 0 | 7 | refuses | Probe [`ref-pointer-unnamed-segment.yml`](openapi-surface/probes/ref-pointer-unnamed-segment.yml). Fern generation exits 1 with `Type name must begin with a letter`; no output tree is written. APIs.guru found 7 candidate row(s), but none has a publisher-owned immutable reference; licence screens: refused. A later registrable witness promotes this row to `golden`. |
