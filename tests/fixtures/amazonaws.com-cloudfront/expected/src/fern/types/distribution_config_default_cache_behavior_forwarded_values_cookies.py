...
class DistributionConfigDefaultCacheBehaviorForwardedValuesCookies(UniversalBaseModel):
    """
    ...
    whitelisted_names: typing_extensions.Annotated[
        typing.Optional[DistributionConfigDefaultCacheBehaviorForwardedValuesCookiesWhitelistedNames],
