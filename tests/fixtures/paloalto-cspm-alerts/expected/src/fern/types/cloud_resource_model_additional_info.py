...
class CloudResourceModelAdditionalInfo(UniversalBaseModel):
    """
    Additional info
    """
    ...
    node_type: typing_extensions.Annotated[
        typing.Optional[CloudResourceModelAdditionalInfoNodeType],
        FieldMetadata(alias="nodeType"),
        pydantic.Field(alias="nodeType"),
    ] = None
