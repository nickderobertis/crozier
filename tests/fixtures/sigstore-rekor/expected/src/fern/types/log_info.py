...
class LogInfo(UniversalBaseModel):
    inactive_shards: typing_extensions.Annotated[
        typing.Optional[typing.List[InactiveShardLogInfo]],
        FieldMetadata(alias="inactiveShards"),
        pydantic.Field(alias="inactiveShards"),
    ] = None
