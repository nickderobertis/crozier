...
from ...types.tokens_partner_reward_history_response import TokensPartnerRewardHistoryResponse


class TokensGetPartnerRewardHistoryResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[TokensPartnerRewardHistoryResponse], FieldMetadata(alias="Response")
    ] = None
