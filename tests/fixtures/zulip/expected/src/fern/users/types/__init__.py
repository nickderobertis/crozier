...
if typing.TYPE_CHECKING:
    ...
    from .delete_avatar_response import DeleteAvatarResponse
    ...
    from .upload_avatar_response import UploadAvatarResponse
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "DeleteAvatarResponse": ".delete_avatar_response",
    ...
    "GetUserPresenceResponsePresence": ".get_user_presence_response_presence",
    "GetUserPresenceResponsePresenceAggregated": ".get_user_presence_response_presence_aggregated",
    "GetUserPresenceResponsePresenceAggregatedStatus": ".get_user_presence_response_presence_aggregated_status",
    "GetUserPresenceResponsePresenceWebsite": ".get_user_presence_response_presence_website",
    "GetUserPresenceResponsePresenceWebsiteStatus": ".get_user_presence_response_presence_website_status",
