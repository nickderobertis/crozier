...
class DistributionConfigOriginsItemsItemCustomOriginConfigOriginSslProtocols(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.List[DistributionConfigOriginsItemsItemCustomOriginConfigOriginSslProtocolsItemsItem],
