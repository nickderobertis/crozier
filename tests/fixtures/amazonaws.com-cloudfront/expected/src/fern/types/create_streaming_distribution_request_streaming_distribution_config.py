...
class CreateStreamingDistributionRequestStreamingDistributionConfig(UniversalBaseModel):
    """
    ...
    aliases: typing_extensions.Annotated[
        typing.Optional[CreateStreamingDistributionRequestStreamingDistributionConfigAliases],
    ...
    logging: typing_extensions.Annotated[
        typing.Optional[CreateStreamingDistributionRequestStreamingDistributionConfigLogging],
    ...
    price_class: typing_extensions.Annotated[
        typing.Optional[CreateStreamingDistributionRequestStreamingDistributionConfigPriceClass],
