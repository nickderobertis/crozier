...
class CreateStackInstancesInputDeploymentTargetsAccountFilterType(str, enum.Enum):
    """
    ...
    def visit(
        ...
        if self is CreateStackInstancesInputDeploymentTargetsAccountFilterType.NONE:
            return none()
        if self is CreateStackInstancesInputDeploymentTargetsAccountFilterType.INTERSECTION:
            return intersection()
        if self is CreateStackInstancesInputDeploymentTargetsAccountFilterType.DIFFERENCE:
            return difference()
        if self is CreateStackInstancesInputDeploymentTargetsAccountFilterType.UNION:
            return union()
