...
from ...types.destiny_historical_stats_destiny_historical_weapon_stats_data import (
    DestinyHistoricalStatsDestinyHistoricalWeaponStatsData,
)


class Destiny2GetUniqueWeaponHistoryResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[DestinyHistoricalStatsDestinyHistoricalWeaponStatsData], FieldMetadata(alias="Response")
    ] = None
