...
class GetDistributionResultDistributionDistributionConfigOrigins(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[typing.List[GetDistributionResultDistributionDistributionConfigOriginsItemsItem]],
