...
class GetDistributionResultDistributionDistributionConfigOriginsItemsItemCustomHeaders(UniversalBaseModel):
    """
    ...
    items: typing_extensions.Annotated[
        typing.Optional[
            typing.List[GetDistributionResultDistributionDistributionConfigOriginsItemsItemCustomHeadersItemsItem]
        ],
