...
class ReserveWaiverAppliedNotificationResource(UniversalBaseModel):
    account_holder_id: typing_extensions.Annotated[
        str,
        FieldMetadata(alias="accountHolderId"),
        pydantic.Field(
            alias="accountHolderId",
            description="The unique identifier of the account holder whose reserves will be waived.",
        ),
    ]
    """
    The unique identifier of the account holder whose reserves will be waived.
    """
    ...
    event_date: typing_extensions.Annotated[
        ...
        pydantic.Field(
            alias="eventDate", description="The date in which a reserve waiver has been applied to this account."
        ),
    ]
    """
    The date in which a reserve waiver has been applied to this account.
    """
