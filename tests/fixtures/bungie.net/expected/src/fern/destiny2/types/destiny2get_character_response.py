...
from ...types.destiny_responses_destiny_character_response import DestinyResponsesDestinyCharacterResponse


class Destiny2GetCharacterResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[DestinyResponsesDestinyCharacterResponse], FieldMetadata(alias="Response")
    ] = None
