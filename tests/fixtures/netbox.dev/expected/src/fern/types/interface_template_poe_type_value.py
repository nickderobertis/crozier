...
class InterfaceTemplatePoeTypeValue(enum.StrEnum):
    ...
    def visit(
        ...
        if self is InterfaceTemplatePoeTypeValue.TYPE1IEEE8023AF:
            return type1ieee8023af()
        if self is InterfaceTemplatePoeTypeValue.TYPE2IEEE8023AT:
            return type2ieee8023at()
        if self is InterfaceTemplatePoeTypeValue.TYPE2IEEE8023AZ:
            return type2ieee8023az()
        if self is InterfaceTemplatePoeTypeValue.TYPE3IEEE8023BT:
            return type3ieee8023bt()
        if self is InterfaceTemplatePoeTypeValue.TYPE4IEEE8023BT:
            return type4ieee8023bt()
        if self is InterfaceTemplatePoeTypeValue.PASSIVE24V2PAIR:
            return passive24v2pair()
        if self is InterfaceTemplatePoeTypeValue.PASSIVE24V4PAIR:
            return passive24v4pair()
        if self is InterfaceTemplatePoeTypeValue.PASSIVE48V2PAIR:
            return passive48v2pair()
        if self is InterfaceTemplatePoeTypeValue.PASSIVE48V4PAIR:
