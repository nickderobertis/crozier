...
class ListProductsResponseItemsItemSkusItemFieldData(UniversalBaseModel):
    """
    ...
    price: ListProductsResponseItemsItemSkusItemFieldDataPrice = pydantic.Field()
    """
    price of SKU
    """

    compare_at_price: typing_extensions.Annotated[
        typing.Optional[ListProductsResponseItemsItemSkusItemFieldDataCompareAtPrice],
    ...
    ec_sku_billing_method: typing_extensions.Annotated[
        typing.Optional[ListProductsResponseItemsItemSkusItemFieldDataEcSkuBillingMethod],
    ...
    ec_sku_subscription_plan: typing_extensions.Annotated[
        typing.Optional[ListProductsResponseItemsItemSkusItemFieldDataEcSkuSubscriptionPlan],
    ...
    sku_properties: typing_extensions.Annotated[
        typing.Optional[typing.List[ListProductsResponseItemsItemSkusItemFieldDataSkuPropertiesItem]],
