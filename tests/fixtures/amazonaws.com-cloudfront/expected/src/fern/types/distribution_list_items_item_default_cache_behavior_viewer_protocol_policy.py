...
class DistributionListItemsItemDefaultCacheBehaviorViewerProtocolPolicy(enum.StrEnum):
    """
    ...
    def visit(
        ...
        if self is DistributionListItemsItemDefaultCacheBehaviorViewerProtocolPolicy.ALLOW_ALL:
            return allow_all()
        if self is DistributionListItemsItemDefaultCacheBehaviorViewerProtocolPolicy.HTTPS_ONLY:
            return https_only()
        if self is DistributionListItemsItemDefaultCacheBehaviorViewerProtocolPolicy.REDIRECT_TO_HTTPS:
