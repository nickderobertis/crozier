...
class LambdaFunctionAssociationsItemsItemEventType(enum.StrEnum):
    """
    ...
    def visit(
        ...
        if self is LambdaFunctionAssociationsItemsItemEventType.VIEWER_REQUEST:
            return viewer_request()
        if self is LambdaFunctionAssociationsItemsItemEventType.VIEWER_RESPONSE:
            return viewer_response()
        if self is LambdaFunctionAssociationsItemsItemEventType.ORIGIN_REQUEST:
            return origin_request()
        if self is LambdaFunctionAssociationsItemsItemEventType.ORIGIN_RESPONSE:
