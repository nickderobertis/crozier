...
class CreateDistributionRequestDistributionConfigPriceClass(enum.StrEnum):
    """
    ...
    def visit(
        ...
        if self is CreateDistributionRequestDistributionConfigPriceClass.PRICE_CLASS100:
            return price_class100()
        if self is CreateDistributionRequestDistributionConfigPriceClass.PRICE_CLASS200:
            return price_class200()
        if self is CreateDistributionRequestDistributionConfigPriceClass.PRICE_CLASS_ALL:
