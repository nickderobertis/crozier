...
class ApiIPagedResponseGlobalResourcesSharedModelsTranslationSet(UniversalBaseModel):
    entities: typing_extensions.Annotated[
        typing.Optional[typing.List[GlobalResourcesSharedModelsTranslationSet]],
