...
class CreateDistributionRequestDistributionConfigHttpVersion(enum.StrEnum):
    """
    ...
    def visit(self, http11: typing.Callable[[], T_Result], http2: typing.Callable[[], T_Result]) -> T_Result:
        if self is CreateDistributionRequestDistributionConfigHttpVersion.HTTP11:
            return http11()
        if self is CreateDistributionRequestDistributionConfigHttpVersion.HTTP2:
            return http2()
