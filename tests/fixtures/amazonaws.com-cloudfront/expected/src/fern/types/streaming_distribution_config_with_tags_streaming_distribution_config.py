...
class StreamingDistributionConfigWithTagsStreamingDistributionConfig(UniversalBaseModel):
    """
    ...
    aliases: typing_extensions.Annotated[
        typing.Optional[StreamingDistributionConfigWithTagsStreamingDistributionConfigAliases],
    ...
    logging: typing_extensions.Annotated[
        typing.Optional[StreamingDistributionConfigWithTagsStreamingDistributionConfigLogging],
    ...
    price_class: typing_extensions.Annotated[
        typing.Optional[StreamingDistributionConfigWithTagsStreamingDistributionConfigPriceClass],
