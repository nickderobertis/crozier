...
class DocPagesSetScaleRequestMeasureSlopeItem(UniversalBaseModel):
    unit: str
    conversion: float
    fraction: typing.Optional[DocPagesSetScaleRequestMeasureSlopeItemFraction] = None
    ...
    label_position: typing_extensions.Annotated[
        typing.Optional[DocPagesSetScaleRequestMeasureSlopeItemLabelPosition],
