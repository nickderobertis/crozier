...
class ApiIPagedResponseGlobalResourcesSharedModelsStringDefinition(UniversalBaseModel):
    entities: typing_extensions.Annotated[
        typing.Optional[typing.List[GlobalResourcesSharedModelsStringDefinition]],
