...
class GetOrdersResponseAllAddressesItemJapanType(enum.StrEnum):
    """
    ...
    def visit(self, kana: typing.Callable[[], T_Result], kanji: typing.Callable[[], T_Result]) -> T_Result:
        if self is GetOrdersResponseAllAddressesItemJapanType.KANA:
            return kana()
        if self is GetOrdersResponseAllAddressesItemJapanType.KANJI:
            return kanji()
