...
class FernApi:
    ...
    def _(self, *, query: str, request_options: typing.Optional[RequestOptions] = None) -> None:
        """
        ...
        """
        _response = self._raw_client._(query=query, request_options=request_options)
...
class AsyncFernApi:
    ...
    async def _(self, *, query: str, request_options: typing.Optional[RequestOptions] = None) -> None:
        """
        Returns a list of food item nutrition facts extracted from an input string containing food and beverage words.
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client._(query=query, request_options=request_options)
        return _response.data
