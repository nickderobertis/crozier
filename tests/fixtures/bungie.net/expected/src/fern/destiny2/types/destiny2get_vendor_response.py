...
from ...types.destiny_responses_destiny_vendor_response import DestinyResponsesDestinyVendorResponse


class Destiny2GetVendorResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[DestinyResponsesDestinyVendorResponse], FieldMetadata(alias="Response")
    ] = None
