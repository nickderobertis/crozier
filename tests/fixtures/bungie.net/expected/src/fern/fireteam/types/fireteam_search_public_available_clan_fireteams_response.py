...
from ...types.search_result_of_fireteam_summary import SearchResultOfFireteamSummary


class FireteamSearchPublicAvailableClanFireteamsResponse(UniversalBaseModel):
    ...
    response: typing_extensions.Annotated[
        typing.Optional[SearchResultOfFireteamSummary], FieldMetadata(alias="Response")
    ] = None
