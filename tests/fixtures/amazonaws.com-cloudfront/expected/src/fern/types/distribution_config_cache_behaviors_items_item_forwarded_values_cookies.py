...
class DistributionConfigCacheBehaviorsItemsItemForwardedValuesCookies(UniversalBaseModel):
    """
    ...
    whitelisted_names: typing_extensions.Annotated[
        typing.Optional[DistributionConfigCacheBehaviorsItemsItemForwardedValuesCookiesWhitelistedNames],
