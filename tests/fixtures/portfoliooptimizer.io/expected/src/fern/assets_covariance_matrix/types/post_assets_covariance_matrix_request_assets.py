...
class PostAssetsCovarianceMatrixRequestAssets(UniversalBaseModel):
    ...
    assets_volatilities: typing_extensions.Annotated[
        typing.List[float],
        FieldMetadata(alias="assetsVolatilities"),
        pydantic.Field(
            alias="assetsVolatilities", description="assetsVolatilities[i] is the volatility of the asset i"
        ),
    ]
    """
